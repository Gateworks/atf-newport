#ifndef __CAVM_CSRS_ROM_H__
#define __CAVM_CSRS_ROM_H__
 ...
 */
#define CAVM_ROM_BAR_E_ROM_PF_BAR0 (0x87d000000000ll)
#define CAVM_ROM_BAR_E_ROM_PF_BAR0_SIZE 0x10000ull
 ...
 */
#define CAVM_ROM_CRYPT_E_BSSK (2)
#define CAVM_ROM_CRYPT_E_NONE (0)
#define CAVM_ROM_CRYPT_E_SSK (1)
 ...
 *     into the client.
 */
#define CAVM_ROM_XFER_MSG_E_BOOT_DONE (0x2002)
#define CAVM_ROM_XFER_MSG_E_BOOT_ERROR (0x2001)
#define CAVM_ROM_XFER_MSG_E_BOOT_READX(a) (0x3000 + (a))
#define CAVM_ROM_XFER_MSG_E_BOOT_START (0x2000)
#define CAVM_ROM_XFER_MSG_E_FAILX(a) (0x4000 + (a))
#define CAVM_ROM_XFER_MSG_E_NONE (0)
#define CAVM_ROM_XFER_MSG_E_SERVER_ACK (0x1000)
#define CAVM_ROM_XFER_MSG_E_SERVER_ERROR (0x1001)
#define CAVM_ROM_XFER_MSG_E_SERVER_RETRY (0x1002)
 ...
 */
union cavm_rom_clib_s
{
    uint64_t u[32];
    struct cavm_rom_clib_s_s
    {
 ...
 * All fields in this structure are stored in the Flash in little-endian order.
 */
union cavm_rom_csib_s
{
    uint64_t u[32];
    struct cavm_rom_csib_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rom_csib_s_s cn8; */
    struct cavm_rom_csib_s_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t magic                 : 64; /**< [ 63:  0] Magic number.  Contains "CVM_CSIB" in ASCII (0x42495343_5f4d5643)
                                                                 to indicate a valid ROM_CSIB_S structure. */
...
union cavm_rom_memx
{
    ...
    /* struct cavm_rom_memx_s cn8; */
    struct cavm_rom_memx_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
#define bustype_CAVM_ROM_MEMX(a) CSR_TYPE_NCB
#define basename_CAVM_ROM_MEMX(a) "ROM_MEMX"
#define device_bar_CAVM_ROM_MEMX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ROM_MEMX(a) (a)
#define arguments_CAVM_ROM_MEMX(a) (a),-1,-1,-1

#endif /* __CAVM_CSRS_ROM_H__ */
