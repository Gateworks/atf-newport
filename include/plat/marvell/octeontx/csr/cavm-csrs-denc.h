#ifndef __CAVM_CSRS_DENC_H__
#define __CAVM_CSRS_DENC_H__
 ...
 */
union cavm_denc_common_cfg_s
{
    uint64_t u;
    struct cavm_denc_common_cfg_s_s
    {
    ...
    /* struct cavm_denc_common_cfg_s_s cn9; */
    /* struct cavm_denc_common_cfg_s_s cnf95xxp1; */
    struct cavm_denc_common_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t dw                    : 8;  /**< [ 39: 32] The number of data words per task. For [TASK_TYPE] = 0x0-0x6, this field
 ...
 */
union cavm_denc_epdcch_dci_cfg_s
{
    uint64_t u[7];
    struct cavm_denc_epdcch_dci_cfg_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_denc_epdcch_dci_cfg_s_s cn9; */
    /* struct cavm_denc_epdcch_dci_cfg_s_s cnf95xxp1; */
    struct cavm_denc_epdcch_dci_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_56_63        : 8;
        uint64_t start                 : 4;  /**< [ 55: 52] Resource mapping for this EPDCCH starts from the [START] symbol and
 ...
 */
union cavm_denc_epdcch_gen_cfg_s
{
    uint64_t u[3];
    struct cavm_denc_epdcch_gen_cfg_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_denc_epdcch_gen_cfg_s_s cn9; */
    /* struct cavm_denc_epdcch_gen_cfg_s_s cnf95xxp1; */
    struct cavm_denc_epdcch_gen_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_62_63        : 2;
        uint64_t aqpsk                 : 14; /**< [ 61: 48] The scaling factor {a}QPSK. Note that each modulated symbol is scaled
 ...
 */
union cavm_denc_generic_task_cfg_s
{
    uint64_t u[6];
    struct cavm_denc_generic_task_cfg_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_denc_generic_task_cfg_s_s cn9; */
    /* struct cavm_denc_generic_task_cfg_s_s cnf95xxp1; */
    struct cavm_denc_generic_task_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t out_by_o              : 2;  /**< [ 63: 62] Output data byte order.  See Baseband PHY (BPHY): Data Packing section
                                                                 for details. */
 ...
 */
union cavm_denc_pdcch_dci_cfg_s
{
    uint64_t u[2];
    struct cavm_denc_pdcch_dci_cfg_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_denc_pdcch_dci_cfg_s_s cn9; */
    /* struct cavm_denc_pdcch_dci_cfg_s_s cnf95xxp1; */
    struct cavm_denc_pdcch_dci_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
 ...
 */
union cavm_denc_pdcch_gen_cfg_s
{
    uint64_t u[15];
    struct cavm_denc_pdcch_gen_cfg_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_denc_pdcch_gen_cfg_s_s cn9; */
    /* struct cavm_denc_pdcch_gen_cfg_s_s cnf95xxp1; */
    struct cavm_denc_pdcch_gen_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_63           : 1;
        uint64_t c_init                : 31; /**< [ 62: 32] The initialization value C_init for the scrambler. */
 ...
 */
union cavm_denc_pdsch_task_cfg_s
{
    uint64_t u[8];
    struct cavm_denc_pdsch_task_cfg_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_63           : 1;
    ...
    /* struct cavm_denc_pdsch_task_cfg_s_s cn9; */
    /* struct cavm_denc_pdsch_task_cfg_s_s cnf95xxp1; */
    struct cavm_denc_pdsch_task_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_63           : 1;
        uint64_t in_by_o               : 2;  /**< [ 62: 61] Input data byte order.  See Baseband PHY (BPHY): Data Packing section
 ...
 */
union cavm_denc_rpdcch_gen_cfg_s
{
    uint64_t u[2];
    struct cavm_denc_rpdcch_gen_cfg_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_63           : 1;
        uint64_t c_init                : 31; /**< [ 62: 32] The initialization value C_init for the scrambler. */
    ...
    /* struct cavm_denc_rpdcch_gen_cfg_s_s cn9; */
    /* struct cavm_denc_rpdcch_gen_cfg_s_s cnf95xxp1; */
    struct cavm_denc_rpdcch_gen_cfg_s_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_63           : 1;
        uint64_t c_init                : 31; /**< [ 62: 32] The initialization value C_init for the scrambler. */
 ...
 */
union cavm_dencx_control
{
    uint64_t u;
    struct cavm_dencx_control_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_control_s cn; */
};
...
static inline uint64_t CAVM_DENCX_CONTROL(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=2))
        return 0x87e043480000ll + 0x8000ll * ((a) & 0x3);
    __cavm_csr_fatal("DENCX_CONTROL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_CONTROL(a) cavm_dencx_control_t
#define bustype_CAVM_DENCX_CONTROL(a) CSR_TYPE_RSL
 ...
 */
union cavm_dencx_error_enable0
{
    uint64_t u;
    struct cavm_dencx_error_enable0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_error_enable0_s cn; */
};
...
static inline uint64_t CAVM_DENCX_ERROR_ENABLE0(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=2))
        return 0x87e043480040ll + 0x8000ll * ((a) & 0x3);
    __cavm_csr_fatal("DENCX_ERROR_ENABLE0", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_ERROR_ENABLE0(a) cavm_dencx_error_enable0_t
#define bustype_CAVM_DENCX_ERROR_ENABLE0(a) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ERROR_ENABLE0(a) "DENCX_ERROR_ENABLE0"
#define busnum_CAVM_DENCX_ERROR_ENABLE0(a) (a)
#define arguments_CAVM_DENCX_ERROR_ENABLE0(a) (a),-1,-1,-1
 ...
 */
union cavm_dencx_error_source0
{
    uint64_t u;
    struct cavm_dencx_error_source0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_error_source0_s cn; */
};
...
static inline uint64_t CAVM_DENCX_ERROR_SOURCE0(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=2))
        return 0x87e043480030ll + 0x8000ll * ((a) & 0x3);
    __cavm_csr_fatal("DENCX_ERROR_SOURCE0", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_ERROR_SOURCE0(a) cavm_dencx_error_source0_t
#define bustype_CAVM_DENCX_ERROR_SOURCE0(a) CSR_TYPE_RSL
#define basename_CAVM_DENCX_ERROR_SOURCE0(a) "DENCX_ERROR_SOURCE0"
#define busnum_CAVM_DENCX_ERROR_SOURCE0(a) (a)
#define arguments_CAVM_DENCX_ERROR_SOURCE0(a) (a),-1,-1,-1
 ...
 */
union cavm_dencx_hab_jcfg0_ramx_data
{
    uint64_t u;
    struct cavm_dencx_hab_jcfg0_ramx_data_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_hab_jcfg0_ramx_data_s cn; */
};
...
static inline uint64_t CAVM_DENCX_HAB_JCFG0_RAMX_DATA(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=2) && (b<=255)))
        return 0x87e043482000ll + 0x8000ll * ((a) & 0x3) + 8ll * ((b) & 0xff);
    __cavm_csr_fatal("DENCX_HAB_JCFG0_RAMX_DATA", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_HAB_JCFG0_RAMX_DATA(a,b) cavm_dencx_hab_jcfg0_ramx_data_t
#define bustype_CAVM_DENCX_HAB_JCFG0_RAMX_DATA(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_HAB_JCFG0_RAMX_DATA(a,b) "DENCX_HAB_JCFG0_RAMX_DATA"
#define busnum_CAVM_DENCX_HAB_JCFG0_RAMX_DATA(a,b) (a)
#define arguments_CAVM_DENCX_HAB_JCFG0_RAMX_DATA(a,b) (a),(b),-1,-1
 ...
 */
union cavm_dencx_hab_jcfg1_ramx_data
{
    uint64_t u;
    struct cavm_dencx_hab_jcfg1_ramx_data_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t entry                 : 64; /**< [ 63:  0](R/W/H) Job configuration RAM entry. */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_dencx_hab_jcfg1_ramx_data_s cn; */
};
...
static inline uint64_t CAVM_DENCX_HAB_JCFG1_RAMX_DATA(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=2) && (b<=255)))
        return 0x87e043484000ll + 0x8000ll * ((a) & 0x3) + 8ll * ((b) & 0xff);
    __cavm_csr_fatal("DENCX_HAB_JCFG1_RAMX_DATA", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_HAB_JCFG1_RAMX_DATA(a,b) cavm_dencx_hab_jcfg1_ramx_data_t
#define bustype_CAVM_DENCX_HAB_JCFG1_RAMX_DATA(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_HAB_JCFG1_RAMX_DATA(a,b) "DENCX_HAB_JCFG1_RAMX_DATA"
#define busnum_CAVM_DENCX_HAB_JCFG1_RAMX_DATA(a,b) (a)
#define arguments_CAVM_DENCX_HAB_JCFG1_RAMX_DATA(a,b) (a),(b),-1,-1
 ...
 */
union cavm_dencx_hab_jcfg2_ramx_data
{
    uint64_t u;
    struct cavm_dencx_hab_jcfg2_ramx_data_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t entry                 : 64; /**< [ 63:  0](R/W/H) Job configuration RAM entry. */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_dencx_hab_jcfg2_ramx_data_s cn; */
};
...
static inline uint64_t CAVM_DENCX_HAB_JCFG2_RAMX_DATA(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=2) && (b<=255)))
        return 0x87e043486000ll + 0x8000ll * ((a) & 0x3) + 8ll * ((b) & 0xff);
    __cavm_csr_fatal("DENCX_HAB_JCFG2_RAMX_DATA", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_HAB_JCFG2_RAMX_DATA(a,b) cavm_dencx_hab_jcfg2_ramx_data_t
#define bustype_CAVM_DENCX_HAB_JCFG2_RAMX_DATA(a,b) CSR_TYPE_RSL
 ...
 */
union cavm_dencx_status
{
    uint64_t u;
    struct cavm_dencx_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
...
static inline uint64_t CAVM_DENCX_STATUS(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=2))
        return 0x87e043480018ll + 0x8000ll * ((a) & 0x3);
    __cavm_csr_fatal("DENCX_STATUS", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_STATUS(a) cavm_dencx_status_t
#define bustype_CAVM_DENCX_STATUS(a) CSR_TYPE_RSL
#define basename_CAVM_DENCX_STATUS(a) "DENCX_STATUS"
#define busnum_CAVM_DENCX_STATUS(a) (a)
#define arguments_CAVM_DENCX_STATUS(a) (a),-1,-1,-1
 ...
 */
union cavm_dencx_tc_config_err_flags_reg
{
    uint64_t u;
    struct cavm_dencx_tc_config_err_flags_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_tc_config_err_flags_reg_s cn9; */
    struct cavm_dencx_tc_config_err_flags_reg_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t error_epdcch_res2     : 3;  /**< [ 63: 61](RO) reserved. */
    ...
    struct cavm_dencx_tc_config_err_flags_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_DENCX_TC_CONFIG_ERR_FLAGS_REG(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=2))
        return 0x87e043481040ll + 0x8000ll * ((a) & 0x3);
    __cavm_csr_fatal("DENCX_TC_CONFIG_ERR_FLAGS_REG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_TC_CONFIG_ERR_FLAGS_REG(a) cavm_dencx_tc_config_err_flags_reg_t
#define bustype_CAVM_DENCX_TC_CONFIG_ERR_FLAGS_REG(a) CSR_TYPE_RSL
#define basename_CAVM_DENCX_TC_CONFIG_ERR_FLAGS_REG(a) "DENCX_TC_CONFIG_ERR_FLAGS_REG"
#define busnum_CAVM_DENCX_TC_CONFIG_ERR_FLAGS_REG(a) (a)
 ...
 */
union cavm_dencx_tc_control_reg
{
    uint64_t u;
    struct cavm_dencx_tc_control_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
    ...
    /* struct cavm_dencx_tc_control_reg_s cn; */
};
...
static inline uint64_t CAVM_DENCX_TC_CONTROL_REG(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=2))
        return 0x87e043481010ll + 0x8000ll * ((a) & 0x3);
    __cavm_csr_fatal("DENCX_TC_CONTROL_REG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_TC_CONTROL_REG(a) cavm_dencx_tc_control_reg_t
#define bustype_CAVM_DENCX_TC_CONTROL_REG(a) CSR_TYPE_RSL
#define basename_CAVM_DENCX_TC_CONTROL_REG(a) "DENCX_TC_CONTROL_REG"
#define busnum_CAVM_DENCX_TC_CONTROL_REG(a) (a)
#define arguments_CAVM_DENCX_TC_CONTROL_REG(a) (a),-1,-1,-1
 ...
 */
union cavm_dencx_tc_error_mask_reg
{
    uint64_t u;
    struct cavm_dencx_tc_error_mask_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_tc_error_mask_reg_s cn9; */
    struct cavm_dencx_tc_error_mask_reg_cnf95xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    struct cavm_dencx_tc_error_mask_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
...
static inline uint64_t CAVM_DENCX_TC_ERROR_MASK_REG(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=2))
        return 0x87e043481030ll + 0x8000ll * ((a) & 0x3);
    __cavm_csr_fatal("DENCX_TC_ERROR_MASK_REG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_TC_ERROR_MASK_REG(a) cavm_dencx_tc_error_mask_reg_t
#define bustype_CAVM_DENCX_TC_ERROR_MASK_REG(a) CSR_TYPE_RSL
#define basename_CAVM_DENCX_TC_ERROR_MASK_REG(a) "DENCX_TC_ERROR_MASK_REG"
#define busnum_CAVM_DENCX_TC_ERROR_MASK_REG(a) (a)
#define arguments_CAVM_DENCX_TC_ERROR_MASK_REG(a) (a),-1,-1,-1
 ...
 * the error(s).
 */
union cavm_dencx_tc_error_reg
{
    uint64_t u;
    struct cavm_dencx_tc_error_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_tc_error_reg_s cn9; */
    /* struct cavm_dencx_tc_error_reg_s cnf95xxp1; */
    struct cavm_dencx_tc_error_reg_cnf95xxp2
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_12_63        : 52;
...
static inline uint64_t CAVM_DENCX_TC_ERROR_REG(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=2))
        return 0x87e043481038ll + 0x8000ll * ((a) & 0x3);
    __cavm_csr_fatal("DENCX_TC_ERROR_REG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_TC_ERROR_REG(a) cavm_dencx_tc_error_reg_t
#define bustype_CAVM_DENCX_TC_ERROR_REG(a) CSR_TYPE_RSL
#define basename_CAVM_DENCX_TC_ERROR_REG(a) "DENCX_TC_ERROR_REG"
#define busnum_CAVM_DENCX_TC_ERROR_REG(a) (a)
#define arguments_CAVM_DENCX_TC_ERROR_REG(a) (a),-1,-1,-1
 ...
 */
union cavm_dencx_tc_main_reset_reg
{
    uint64_t u;
    struct cavm_dencx_tc_main_reset_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_tc_main_reset_reg_s cn; */
};
...
static inline uint64_t CAVM_DENCX_TC_MAIN_RESET_REG(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=2))
        return 0x87e043481000ll + 0x8000ll * ((a) & 0x3);
    __cavm_csr_fatal("DENCX_TC_MAIN_RESET_REG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_TC_MAIN_RESET_REG(a) cavm_dencx_tc_main_reset_reg_t
#define bustype_CAVM_DENCX_TC_MAIN_RESET_REG(a) CSR_TYPE_RSL
#define basename_CAVM_DENCX_TC_MAIN_RESET_REG(a) "DENCX_TC_MAIN_RESET_REG"
#define busnum_CAVM_DENCX_TC_MAIN_RESET_REG(a) (a)
 ...
 */
union cavm_dencx_tc_static_epdcch_regx
{
    uint64_t u;
    struct cavm_dencx_tc_static_epdcch_regx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_tc_static_epdcch_regx_s cn; */
};
...
static inline uint64_t CAVM_DENCX_TC_STATIC_EPDCCH_REGX(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=2) && (b<=65)))
        return 0x87e043481c00ll + 0x8000ll * ((a) & 0x3) + 8ll * ((b) & 0x7f);
    __cavm_csr_fatal("DENCX_TC_STATIC_EPDCCH_REGX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_TC_STATIC_EPDCCH_REGX(a,b) cavm_dencx_tc_static_epdcch_regx_t
#define bustype_CAVM_DENCX_TC_STATIC_EPDCCH_REGX(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_TC_STATIC_EPDCCH_REGX(a,b) "DENCX_TC_STATIC_EPDCCH_REGX"
#define busnum_CAVM_DENCX_TC_STATIC_EPDCCH_REGX(a,b) (a)
#define arguments_CAVM_DENCX_TC_STATIC_EPDCCH_REGX(a,b) (a),(b),-1,-1
 ...
 * write these registers, either at start-up or at any other time.
 */
union cavm_dencx_tc_static_pdcch_regx
{
    uint64_t u;
    struct cavm_dencx_tc_static_pdcch_regx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_dencx_tc_static_pdcch_regx_s cn; */
};
...
static inline uint64_t CAVM_DENCX_TC_STATIC_PDCCH_REGX(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=2) && (b<=31)))
        return 0x87e043481800ll + 0x8000ll * ((a) & 0x3) + 8ll * ((b) & 0x1f);
    __cavm_csr_fatal("DENCX_TC_STATIC_PDCCH_REGX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_TC_STATIC_PDCCH_REGX(a,b) cavm_dencx_tc_static_pdcch_regx_t
#define bustype_CAVM_DENCX_TC_STATIC_PDCCH_REGX(a,b) CSR_TYPE_RSL
#define basename_CAVM_DENCX_TC_STATIC_PDCCH_REGX(a,b) "DENCX_TC_STATIC_PDCCH_REGX"
#define busnum_CAVM_DENCX_TC_STATIC_PDCCH_REGX(a,b) (a)
#define arguments_CAVM_DENCX_TC_STATIC_PDCCH_REGX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_dencx_tc_status0_reg
{
    uint64_t u;
    ...
    /* struct cavm_dencx_tc_status0_reg_s cnf95xxp1; */
...
static inline uint64_t CAVM_DENCX_TC_STATUS0_REG(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=2))
        return 0x87e043481020ll + 0x8000ll * ((a) & 0x3);
    __cavm_csr_fatal("DENCX_TC_STATUS0_REG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_DENCX_TC_STATUS0_REG(a) cavm_dencx_tc_status0_reg_t
#define bustype_CAVM_DENCX_TC_STATUS0_REG(a) CSR_TYPE_RSL
