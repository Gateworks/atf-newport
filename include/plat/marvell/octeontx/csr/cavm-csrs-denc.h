...
union cavm_denc_common_cfg_s
{
    ...
    /* struct cavm_denc_common_cfg_s_s cn; */
};
...
union cavm_denc_epdcch_dci_cfg_s
{
    ...
    /* struct cavm_denc_epdcch_dci_cfg_s_s cn; */
};
...
union cavm_denc_epdcch_gen_cfg_s
{
    ...
    /* struct cavm_denc_epdcch_gen_cfg_s_s cn; */
};
...
union cavm_denc_generic_task_cfg_s
{
    ...
    /* struct cavm_denc_generic_task_cfg_s_s cn; */
};
...
union cavm_denc_pdcch_dci_cfg_s
{
    ...
    /* struct cavm_denc_pdcch_dci_cfg_s_s cn; */
};
...
union cavm_denc_pdcch_gen_cfg_s
{
    ...
    /* struct cavm_denc_pdcch_gen_cfg_s_s cn; */
};
...
union cavm_denc_pdsch_task_cfg_s
{
    ...
    /* struct cavm_denc_pdsch_task_cfg_s_s cn; */
};
...
union cavm_denc_rpdcch_gen_cfg_s
{
    ...
    /* struct cavm_denc_rpdcch_gen_cfg_s_s cn; */
};
...
static inline uint64_t CAVM_DENCX_CONTROL(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_CONTROL", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_ECO(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_ECO", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_ERROR_ENABLE0(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_ERROR_ENABLE0", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_ERROR_SOURCE0(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_ERROR_SOURCE0", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_HAB_JCFG0_RAMX_DATA(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("DENCX_HAB_JCFG0_RAMX_DATA", 2, a, b, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_HAB_JCFG1_RAMX_DATA(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("DENCX_HAB_JCFG1_RAMX_DATA", 2, a, b, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_HAB_JCFG2_RAMX_DATA(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("DENCX_HAB_JCFG2_RAMX_DATA", 2, a, b, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_SCRATCH(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_SCRATCH", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_STATUS(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_STATUS", 1, a, 0, 0, 0);
}
...
union cavm_dencx_tc_config_err_flags_reg
{
    ...
    /* struct cavm_dencx_tc_config_err_flags_reg_s cn; */
};
...
static inline uint64_t CAVM_DENCX_TC_CONFIG_ERR_FLAGS_REG(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_TC_CONFIG_ERR_FLAGS_REG", 1, a, 0, 0, 0);
}
...
union cavm_dencx_tc_config_regx
{
    ...
    /* struct cavm_dencx_tc_config_regx_s cn; */
};
...
static inline uint64_t CAVM_DENCX_TC_CONFIG_REGX(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("DENCX_TC_CONFIG_REGX", 2, a, b, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_TC_CONTROL_REG(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_TC_CONTROL_REG", 1, a, 0, 0, 0);
}
...
union cavm_dencx_tc_error_mask_reg
{
    ...
    /* struct cavm_dencx_tc_error_mask_reg_s cn; */
};
...
static inline uint64_t CAVM_DENCX_TC_ERROR_MASK_REG(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_TC_ERROR_MASK_REG", 1, a, 0, 0, 0);
}
...
union cavm_dencx_tc_error_reg
{
    ...
    /* struct cavm_dencx_tc_error_reg_s cn; */
};
...
static inline uint64_t CAVM_DENCX_TC_ERROR_REG(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_TC_ERROR_REG", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_TC_MAIN_RESET_REG(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_TC_MAIN_RESET_REG", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_TC_MAIN_START_REG(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_TC_MAIN_START_REG", 1, a, 0, 0, 0);
}
...
union cavm_dencx_tc_mon_reg
{
    ...
    /* struct cavm_dencx_tc_mon_reg_s cn; */
};
...
static inline uint64_t CAVM_DENCX_TC_MON_REG(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_TC_MON_REG", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_TC_STATIC_EPDCCH_REGX(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("DENCX_TC_STATIC_EPDCCH_REGX", 2, a, b, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_TC_STATIC_PDCCH_REGX(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("DENCX_TC_STATIC_PDCCH_REGX", 2, a, b, 0, 0);
}
...
union cavm_dencx_tc_status0_reg
{
    ...
    /* struct cavm_dencx_tc_status0_reg_s cn; */
};
...
static inline uint64_t CAVM_DENCX_TC_STATUS0_REG(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_TC_STATUS0_REG", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DENCX_TC_STATUS1_REG(unsigned long a)
{
    ...
    __cavm_csr_fatal("DENCX_TC_STATUS1_REG", 1, a, 0, 0, 0);
}
