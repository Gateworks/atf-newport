#ifndef __CAVM_CSRS_MDC_H__
#define __CAVM_CSRS_MDC_H__
 ...
 */
#define CAVM_MDC_INT_VEC_E_MDC_ECC_ERR (0)
 ...
 */
#define CAVM_MDC_RAS_UET_E_NOUC (4)
#define CAVM_MDC_RAS_UET_E_UC (0)
#define CAVM_MDC_RAS_UET_E_UEO (2)
#define CAVM_MDC_RAS_UET_E_UER (3)
#define CAVM_MDC_RAS_UET_E_UEU (1)
 ...
 */
union cavm_mdc_ras_entry_s
{
    uint64_t u;
    struct cavm_mdc_ras_entry_s_s
    {
 ...
 */
union cavm_mdc_active_pc
{
    uint64_t u;
    struct cavm_mdc_active_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mdc_active_pc_s cn; */
};
typedef union cavm_mdc_active_pc cavm_mdc_active_pc_t;

#define CAVM_MDC_ACTIVE_PC CAVM_MDC_ACTIVE_PC_FUNC()
...
#define bustype_CAVM_MDC_ACTIVE_PC CSR_TYPE_RSL
#define basename_CAVM_MDC_ACTIVE_PC "MDC_ACTIVE_PC"
#define device_bar_CAVM_MDC_ACTIVE_PC 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_ACTIVE_PC 0
#define arguments_CAVM_MDC_ACTIVE_PC -1,-1,-1,-1
 ...
 */
union cavm_mdc_bist_config
{
    uint64_t u;
    struct cavm_mdc_bist_config_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
#define CAVM_MDC_BIST_CONFIG CAVM_MDC_BIST_CONFIG_FUNC()
...
#define bustype_CAVM_MDC_BIST_CONFIG CSR_TYPE_RSL
#define basename_CAVM_MDC_BIST_CONFIG "MDC_BIST_CONFIG"
#define device_bar_CAVM_MDC_BIST_CONFIG 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_BIST_CONFIG 0
#define arguments_CAVM_MDC_BIST_CONFIG -1,-1,-1,-1
 ...
 */
union cavm_mdc_bist_control
{
    uint64_t u;
    struct cavm_mdc_bist_control_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mdc_bist_control_s cn; */
};
typedef union cavm_mdc_bist_control cavm_mdc_bist_control_t;

#define CAVM_MDC_BIST_CONTROL CAVM_MDC_BIST_CONTROL_FUNC()
...
#define bustype_CAVM_MDC_BIST_CONTROL CSR_TYPE_RSL
#define basename_CAVM_MDC_BIST_CONTROL "MDC_BIST_CONTROL"
#define device_bar_CAVM_MDC_BIST_CONTROL 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_BIST_CONTROL 0
#define arguments_CAVM_MDC_BIST_CONTROL -1,-1,-1,-1
 ...
 * MDC Configuration Register
 */
union cavm_mdc_bist_debug_mode
{
    uint64_t u;
    struct cavm_mdc_bist_debug_mode_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mdc_bist_debug_mode_s cn; */
};
typedef union cavm_mdc_bist_debug_mode cavm_mdc_bist_debug_mode_t;

#define CAVM_MDC_BIST_DEBUG_MODE CAVM_MDC_BIST_DEBUG_MODE_FUNC()
...
#define bustype_CAVM_MDC_BIST_DEBUG_MODE CSR_TYPE_RSL
#define basename_CAVM_MDC_BIST_DEBUG_MODE "MDC_BIST_DEBUG_MODE"
#define device_bar_CAVM_MDC_BIST_DEBUG_MODE 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_BIST_DEBUG_MODE 0
#define arguments_CAVM_MDC_BIST_DEBUG_MODE -1,-1,-1,-1
 ...
 */
union cavm_mdc_bist_failx
{
    uint64_t u;
    struct cavm_mdc_bist_failx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_MDC_BIST_FAILX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MDC_BIST_FAILX(unsigned long a)
{
...
#define bustype_CAVM_MDC_BIST_FAILX(a) CSR_TYPE_RSL
#define basename_CAVM_MDC_BIST_FAILX(a) "MDC_BIST_FAILX"
#define device_bar_CAVM_MDC_BIST_FAILX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_BIST_FAILX(a) (a)
#define arguments_CAVM_MDC_BIST_FAILX(a) (a),-1,-1,-1
 ...
 */
union cavm_mdc_bist_status
{
    uint64_t u;
    struct cavm_mdc_bist_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mdc_bist_status_s cn; */
};
typedef union cavm_mdc_bist_status cavm_mdc_bist_status_t;

#define CAVM_MDC_BIST_STATUS CAVM_MDC_BIST_STATUS_FUNC()
...
#define bustype_CAVM_MDC_BIST_STATUS CSR_TYPE_RSL
#define basename_CAVM_MDC_BIST_STATUS "MDC_BIST_STATUS"
#define device_bar_CAVM_MDC_BIST_STATUS 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_BIST_STATUS 0
#define arguments_CAVM_MDC_BIST_STATUS -1,-1,-1,-1
 ...
 */
union cavm_mdc_const
{
    uint64_t u;
    struct cavm_mdc_const_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mdc_const_s cn; */
};
typedef union cavm_mdc_const cavm_mdc_const_t;

#define CAVM_MDC_CONST CAVM_MDC_CONST_FUNC()
...
#define bustype_CAVM_MDC_CONST CSR_TYPE_RSL
#define basename_CAVM_MDC_CONST "MDC_CONST"
#define device_bar_CAVM_MDC_CONST 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_CONST 0
#define arguments_CAVM_MDC_CONST -1,-1,-1,-1
 ...
 */
union cavm_mdc_ecc_config
{
    uint64_t u;
    struct cavm_mdc_ecc_config_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_mdc_ecc_config_s cn; */
};
typedef union cavm_mdc_ecc_config cavm_mdc_ecc_config_t;

#define CAVM_MDC_ECC_CONFIG CAVM_MDC_ECC_CONFIG_FUNC()
...
#define bustype_CAVM_MDC_ECC_CONFIG CSR_TYPE_RSL
#define basename_CAVM_MDC_ECC_CONFIG "MDC_ECC_CONFIG"
#define device_bar_CAVM_MDC_ECC_CONFIG 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_ECC_CONFIG 0
#define arguments_CAVM_MDC_ECC_CONFIG -1,-1,-1,-1
 ...
 */
union cavm_mdc_ecc_status
{
    uint64_t u;
    struct cavm_mdc_ecc_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mdc_ecc_status_s cn; */
};
typedef union cavm_mdc_ecc_status cavm_mdc_ecc_status_t;

#define CAVM_MDC_ECC_STATUS CAVM_MDC_ECC_STATUS_FUNC()
...
#define bustype_CAVM_MDC_ECC_STATUS CSR_TYPE_RSL
#define basename_CAVM_MDC_ECC_STATUS "MDC_ECC_STATUS"
#define device_bar_CAVM_MDC_ECC_STATUS 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_ECC_STATUS 0
 ...
 */
union cavm_mdc_int_ena_w1c
{
    uint64_t u;
    struct cavm_mdc_int_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_mdc_int_ena_w1c_s cn; */
};
typedef union cavm_mdc_int_ena_w1c cavm_mdc_int_ena_w1c_t;

#define CAVM_MDC_INT_ENA_W1C CAVM_MDC_INT_ENA_W1C_FUNC()
...
#define bustype_CAVM_MDC_INT_ENA_W1C CSR_TYPE_RSL
#define basename_CAVM_MDC_INT_ENA_W1C "MDC_INT_ENA_W1C"
#define device_bar_CAVM_MDC_INT_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_INT_ENA_W1C 0
#define arguments_CAVM_MDC_INT_ENA_W1C -1,-1,-1,-1
 ...
 */
union cavm_mdc_int_ena_w1s
{
    uint64_t u;
    struct cavm_mdc_int_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_mdc_int_ena_w1s_s cn; */
};
typedef union cavm_mdc_int_ena_w1s cavm_mdc_int_ena_w1s_t;

#define CAVM_MDC_INT_ENA_W1S CAVM_MDC_INT_ENA_W1S_FUNC()
...
#define bustype_CAVM_MDC_INT_ENA_W1S CSR_TYPE_RSL
#define basename_CAVM_MDC_INT_ENA_W1S "MDC_INT_ENA_W1S"
#define device_bar_CAVM_MDC_INT_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_INT_ENA_W1S 0
#define arguments_CAVM_MDC_INT_ENA_W1S -1,-1,-1,-1
 ...
 */
union cavm_mdc_int_w1c
{
    uint64_t u;
    struct cavm_mdc_int_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_mdc_int_w1c_s cn; */
};
typedef union cavm_mdc_int_w1c cavm_mdc_int_w1c_t;

#define CAVM_MDC_INT_W1C CAVM_MDC_INT_W1C_FUNC()
...
#define bustype_CAVM_MDC_INT_W1C CSR_TYPE_RSL
#define basename_CAVM_MDC_INT_W1C "MDC_INT_W1C"
#define device_bar_CAVM_MDC_INT_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_INT_W1C 0
#define arguments_CAVM_MDC_INT_W1C -1,-1,-1,-1
 ...
 */
union cavm_mdc_int_w1s
{
    uint64_t u;
    struct cavm_mdc_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_mdc_int_w1s_s cn; */
};
typedef union cavm_mdc_int_w1s cavm_mdc_int_w1s_t;

#define CAVM_MDC_INT_W1S CAVM_MDC_INT_W1S_FUNC()
...
#define bustype_CAVM_MDC_INT_W1S CSR_TYPE_RSL
#define basename_CAVM_MDC_INT_W1S "MDC_INT_W1S"
#define device_bar_CAVM_MDC_INT_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_INT_W1S 0
#define arguments_CAVM_MDC_INT_W1S -1,-1,-1,-1
 ...
 * enumeration.
 */
union cavm_mdc_pf_msix_pbax
{
    uint64_t u;
    struct cavm_mdc_pf_msix_pbax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mdc_pf_msix_pbax_s cn; */
};
typedef union cavm_mdc_pf_msix_pbax cavm_mdc_pf_msix_pbax_t;

static inline uint64_t CAVM_MDC_PF_MSIX_PBAX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MDC_PF_MSIX_PBAX(unsigned long a)
{
...
#define bustype_CAVM_MDC_PF_MSIX_PBAX(a) CSR_TYPE_RSL
#define basename_CAVM_MDC_PF_MSIX_PBAX(a) "MDC_PF_MSIX_PBAX"
#define device_bar_CAVM_MDC_PF_MSIX_PBAX(a) 0x4 /* PF_BAR4 */
#define busnum_CAVM_MDC_PF_MSIX_PBAX(a) (a)
#define arguments_CAVM_MDC_PF_MSIX_PBAX(a) (a),-1,-1,-1
 ...
 */
union cavm_mdc_pf_msix_vecx_addr
{
    uint64_t u;
    struct cavm_mdc_pf_msix_vecx_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_MDC_PF_MSIX_VECX_ADDR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MDC_PF_MSIX_VECX_ADDR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a==0))
...
#define bustype_CAVM_MDC_PF_MSIX_VECX_ADDR(a) CSR_TYPE_RSL
#define basename_CAVM_MDC_PF_MSIX_VECX_ADDR(a) "MDC_PF_MSIX_VECX_ADDR"
#define device_bar_CAVM_MDC_PF_MSIX_VECX_ADDR(a) 0x4 /* PF_BAR4 */
#define busnum_CAVM_MDC_PF_MSIX_VECX_ADDR(a) (a)
#define arguments_CAVM_MDC_PF_MSIX_VECX_ADDR(a) (a),-1,-1,-1
 ...
 * This register is the MSI-X vector table, indexed by the MDC_INT_VEC_E enumeration.
 */
union cavm_mdc_pf_msix_vecx_ctl
{
    uint64_t u;
    struct cavm_mdc_pf_msix_vecx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mdc_pf_msix_vecx_ctl_s cn; */
};
typedef union cavm_mdc_pf_msix_vecx_ctl cavm_mdc_pf_msix_vecx_ctl_t;

static inline uint64_t CAVM_MDC_PF_MSIX_VECX_CTL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MDC_PF_MSIX_VECX_CTL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a==0))
...
#define bustype_CAVM_MDC_PF_MSIX_VECX_CTL(a) CSR_TYPE_RSL
#define basename_CAVM_MDC_PF_MSIX_VECX_CTL(a) "MDC_PF_MSIX_VECX_CTL"
#define device_bar_CAVM_MDC_PF_MSIX_VECX_CTL(a) 0x4 /* PF_BAR4 */
#define busnum_CAVM_MDC_PF_MSIX_VECX_CTL(a) (a)
#define arguments_CAVM_MDC_PF_MSIX_VECX_CTL(a) (a),-1,-1,-1
 ...
 */
union cavm_mdc_ras_romx
{
    uint64_t u;
    struct cavm_mdc_ras_romx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
typedef union cavm_mdc_ras_romx cavm_mdc_ras_romx_t;
...
#define bustype_CAVM_MDC_RAS_ROMX(a) CSR_TYPE_RSL
#define basename_CAVM_MDC_RAS_ROMX(a) "MDC_RAS_ROMX"
 ...
 */
union cavm_mdc_timeouts
{
    uint64_t u;
    struct cavm_mdc_timeouts_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mdc_timeouts_s cn; */
};
typedef union cavm_mdc_timeouts cavm_mdc_timeouts_t;

#define CAVM_MDC_TIMEOUTS CAVM_MDC_TIMEOUTS_FUNC()
...
#define bustype_CAVM_MDC_TIMEOUTS CSR_TYPE_RSL
#define basename_CAVM_MDC_TIMEOUTS "MDC_TIMEOUTS"
#define device_bar_CAVM_MDC_TIMEOUTS 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_TIMEOUTS 0
#define arguments_CAVM_MDC_TIMEOUTS -1,-1,-1,-1
 ...
 */
union cavm_mdc_win_cmd
{
    uint64_t u;
    struct cavm_mdc_win_cmd_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mdc_win_cmd_s cn; */
};
typedef union cavm_mdc_win_cmd cavm_mdc_win_cmd_t;

#define CAVM_MDC_WIN_CMD CAVM_MDC_WIN_CMD_FUNC()
...
#define bustype_CAVM_MDC_WIN_CMD CSR_TYPE_RSL
#define basename_CAVM_MDC_WIN_CMD "MDC_WIN_CMD"
#define device_bar_CAVM_MDC_WIN_CMD 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_WIN_CMD 0
#define arguments_CAVM_MDC_WIN_CMD -1,-1,-1,-1
 ...
 */
union cavm_mdc_win_dat
{
    uint64_t u;
    struct cavm_mdc_win_dat_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mdc_win_dat_s cn; */
};
typedef union cavm_mdc_win_dat cavm_mdc_win_dat_t;

#define CAVM_MDC_WIN_DAT CAVM_MDC_WIN_DAT_FUNC()
...
#define bustype_CAVM_MDC_WIN_DAT CSR_TYPE_RSL
#define basename_CAVM_MDC_WIN_DAT "MDC_WIN_DAT"
#define device_bar_CAVM_MDC_WIN_DAT 0x0 /* PF_BAR0 */
#define busnum_CAVM_MDC_WIN_DAT 0
#define arguments_CAVM_MDC_WIN_DAT -1,-1,-1,-1

#endif /* __CAVM_CSRS_MDC_H__ */
