#ifndef __CAVM_CSRS_ETF_MDAB_H__
#define __CAVM_CSRS_ETF_MDAB_H__
 ...
 */
union cavm_etf_mdabx_authstatus
{
    uint32_t u;
    struct cavm_etf_mdabx_authstatus_s
    {
    ...
    /* struct cavm_etf_mdabx_authstatus_s cn; */
};
typedef union cavm_etf_mdabx_authstatus cavm_etf_mdabx_authstatus_t;

static inline uint64_t CAVM_ETF_MDABX_AUTHSTATUS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_AUTHSTATUS(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fb8 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_AUTHSTATUS", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_AUTHSTATUS(a) cavm_etf_mdabx_authstatus_t
#define bustype_CAVM_ETF_MDABX_AUTHSTATUS(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_AUTHSTATUS(a) "ETF_MDABX_AUTHSTATUS"
#define busnum_CAVM_ETF_MDABX_AUTHSTATUS(a) (a)
#define arguments_CAVM_ETF_MDABX_AUTHSTATUS(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_bufwm
{
    uint32_t u;
    struct cavm_etf_mdabx_bufwm_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_bufwm_s cn; */
};
typedef union cavm_etf_mdabx_bufwm cavm_etf_mdabx_bufwm_t;

static inline uint64_t CAVM_ETF_MDABX_BUFWM(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_BUFWM(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113034 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_BUFWM", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_BUFWM(a) cavm_etf_mdabx_bufwm_t
#define bustype_CAVM_ETF_MDABX_BUFWM(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_BUFWM(a) "ETF_MDABX_BUFWM"
#define busnum_CAVM_ETF_MDABX_BUFWM(a) (a)
#define arguments_CAVM_ETF_MDABX_BUFWM(a) (a),-1,-1,-1
 ...
 * RRD reads.
 */
union cavm_etf_mdabx_cbuflevel
{
    uint32_t u;
    struct cavm_etf_mdabx_cbuflevel_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_cbuflevel_s cn; */
};
typedef union cavm_etf_mdabx_cbuflevel cavm_etf_mdabx_cbuflevel_t;

static inline uint64_t CAVM_ETF_MDABX_CBUFLEVEL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_CBUFLEVEL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113030 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_CBUFLEVEL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_CBUFLEVEL(a) cavm_etf_mdabx_cbuflevel_t
#define bustype_CAVM_ETF_MDABX_CBUFLEVEL(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_CBUFLEVEL(a) "ETF_MDABX_CBUFLEVEL"
#define busnum_CAVM_ETF_MDABX_CBUFLEVEL(a) (a)
#define arguments_CAVM_ETF_MDABX_CBUFLEVEL(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_cidr0
{
    uint32_t u;
    struct cavm_etf_mdabx_cidr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_cidr0_s cn; */
};
typedef union cavm_etf_mdabx_cidr0 cavm_etf_mdabx_cidr0_t;

static inline uint64_t CAVM_ETF_MDABX_CIDR0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_CIDR0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113ff0 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_CIDR0", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_CIDR0(a) cavm_etf_mdabx_cidr0_t
#define bustype_CAVM_ETF_MDABX_CIDR0(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_CIDR0(a) "ETF_MDABX_CIDR0"
#define busnum_CAVM_ETF_MDABX_CIDR0(a) (a)
#define arguments_CAVM_ETF_MDABX_CIDR0(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_cidr1
{
    uint32_t u;
    struct cavm_etf_mdabx_cidr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_mdabx_cidr1_s cn; */
};
typedef union cavm_etf_mdabx_cidr1 cavm_etf_mdabx_cidr1_t;

static inline uint64_t CAVM_ETF_MDABX_CIDR1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_CIDR1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113ff4 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_CIDR1", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_CIDR1(a) cavm_etf_mdabx_cidr1_t
#define bustype_CAVM_ETF_MDABX_CIDR1(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_CIDR1(a) "ETF_MDABX_CIDR1"
#define busnum_CAVM_ETF_MDABX_CIDR1(a) (a)
#define arguments_CAVM_ETF_MDABX_CIDR1(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_cidr2
{
    uint32_t u;
    struct cavm_etf_mdabx_cidr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_mdabx_cidr2_s cn; */
};
typedef union cavm_etf_mdabx_cidr2 cavm_etf_mdabx_cidr2_t;

static inline uint64_t CAVM_ETF_MDABX_CIDR2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_CIDR2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113ff8 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_CIDR2", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_CIDR2(a) cavm_etf_mdabx_cidr2_t
#define bustype_CAVM_ETF_MDABX_CIDR2(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_CIDR2(a) "ETF_MDABX_CIDR2"
#define busnum_CAVM_ETF_MDABX_CIDR2(a) (a)
#define arguments_CAVM_ETF_MDABX_CIDR2(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_cidr3
{
    uint32_t u;
    struct cavm_etf_mdabx_cidr3_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_mdabx_cidr3_s cn; */
};
typedef union cavm_etf_mdabx_cidr3 cavm_etf_mdabx_cidr3_t;

static inline uint64_t CAVM_ETF_MDABX_CIDR3(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_CIDR3(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113ffc + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_CIDR3", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_CIDR3(a) cavm_etf_mdabx_cidr3_t
#define bustype_CAVM_ETF_MDABX_CIDR3(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_CIDR3(a) "ETF_MDABX_CIDR3"
#define busnum_CAVM_ETF_MDABX_CIDR3(a) (a)
#define arguments_CAVM_ETF_MDABX_CIDR3(a) (a),-1,-1,-1
 ...
 * value.
 */
union cavm_etf_mdabx_claimclr
{
    uint32_t u;
    struct cavm_etf_mdabx_claimclr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_claimclr_s cn; */
};
typedef union cavm_etf_mdabx_claimclr cavm_etf_mdabx_claimclr_t;

static inline uint64_t CAVM_ETF_MDABX_CLAIMCLR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_CLAIMCLR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fa4 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_CLAIMCLR", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_CLAIMCLR(a) cavm_etf_mdabx_claimclr_t
#define bustype_CAVM_ETF_MDABX_CLAIMCLR(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_CLAIMCLR(a) "ETF_MDABX_CLAIMCLR"
#define busnum_CAVM_ETF_MDABX_CLAIMCLR(a) (a)
#define arguments_CAVM_ETF_MDABX_CLAIMCLR(a) (a),-1,-1,-1
 ...
 * be set.
 */
union cavm_etf_mdabx_claimset
{
    uint32_t u;
    struct cavm_etf_mdabx_claimset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 28; /**< [ 31:  4](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_mdabx_claimset_s cn; */
};
typedef union cavm_etf_mdabx_claimset cavm_etf_mdabx_claimset_t;

static inline uint64_t CAVM_ETF_MDABX_CLAIMSET(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_CLAIMSET(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fa0 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_CLAIMSET", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_CLAIMSET(a) cavm_etf_mdabx_claimset_t
#define bustype_CAVM_ETF_MDABX_CLAIMSET(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_CLAIMSET(a) "ETF_MDABX_CLAIMSET"
#define busnum_CAVM_ETF_MDABX_CLAIMSET(a) (a)
#define arguments_CAVM_ETF_MDABX_CLAIMSET(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_ctl
{
    uint32_t u;
    struct cavm_etf_mdabx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_ctl_s cn; */
};
typedef union cavm_etf_mdabx_ctl cavm_etf_mdabx_ctl_t;

static inline uint64_t CAVM_ETF_MDABX_CTL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_CTL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113020 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_CTL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_CTL(a) cavm_etf_mdabx_ctl_t
#define bustype_CAVM_ETF_MDABX_CTL(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_CTL(a) "ETF_MDABX_CTL"
#define busnum_CAVM_ETF_MDABX_CTL(a) (a)
#define arguments_CAVM_ETF_MDABX_CTL(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_devid
{
    uint32_t u;
    struct cavm_etf_mdabx_devid_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_devid_s cn; */
};
typedef union cavm_etf_mdabx_devid cavm_etf_mdabx_devid_t;

static inline uint64_t CAVM_ETF_MDABX_DEVID(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_DEVID(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fc8 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_DEVID", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_DEVID(a) cavm_etf_mdabx_devid_t
#define bustype_CAVM_ETF_MDABX_DEVID(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_DEVID(a) "ETF_MDABX_DEVID"
#define busnum_CAVM_ETF_MDABX_DEVID(a) (a)
#define arguments_CAVM_ETF_MDABX_DEVID(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_devid1
{
    uint32_t u;
    struct cavm_etf_mdabx_devid1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_devid1_s cn; */
};
typedef union cavm_etf_mdabx_devid1 cavm_etf_mdabx_devid1_t;

static inline uint64_t CAVM_ETF_MDABX_DEVID1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_DEVID1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fc4 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_DEVID1", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_DEVID1(a) cavm_etf_mdabx_devid1_t
#define bustype_CAVM_ETF_MDABX_DEVID1(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_DEVID1(a) "ETF_MDABX_DEVID1"
#define busnum_CAVM_ETF_MDABX_DEVID1(a) (a)
#define arguments_CAVM_ETF_MDABX_DEVID1(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_devtype
{
    uint32_t u;
    struct cavm_etf_mdabx_devtype_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_mdabx_devtype_s cn; */
};
typedef union cavm_etf_mdabx_devtype cavm_etf_mdabx_devtype_t;

static inline uint64_t CAVM_ETF_MDABX_DEVTYPE(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_DEVTYPE(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fcc + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_DEVTYPE", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_DEVTYPE(a) cavm_etf_mdabx_devtype_t
#define bustype_CAVM_ETF_MDABX_DEVTYPE(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_DEVTYPE(a) "ETF_MDABX_DEVTYPE"
#define busnum_CAVM_ETF_MDABX_DEVTYPE(a) (a)
#define arguments_CAVM_ETF_MDABX_DEVTYPE(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_ffcr
{
    uint32_t u;
    struct cavm_etf_mdabx_ffcr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_ffcr_s cn; */
};
typedef union cavm_etf_mdabx_ffcr cavm_etf_mdabx_ffcr_t;

static inline uint64_t CAVM_ETF_MDABX_FFCR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_FFCR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113304 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_FFCR", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_FFCR(a) cavm_etf_mdabx_ffcr_t
#define bustype_CAVM_ETF_MDABX_FFCR(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_FFCR(a) "ETF_MDABX_FFCR"
#define busnum_CAVM_ETF_MDABX_FFCR(a) (a)
#define arguments_CAVM_ETF_MDABX_FFCR(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_ffsr
{
    uint32_t u;
    struct cavm_etf_mdabx_ffsr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_ffsr_s cn; */
};
typedef union cavm_etf_mdabx_ffsr cavm_etf_mdabx_ffsr_t;

static inline uint64_t CAVM_ETF_MDABX_FFSR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_FFSR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113300 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_FFSR", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_FFSR(a) cavm_etf_mdabx_ffsr_t
#define bustype_CAVM_ETF_MDABX_FFSR(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_FFSR(a) "ETF_MDABX_FFSR"
#define busnum_CAVM_ETF_MDABX_FFSR(a) (a)
#define arguments_CAVM_ETF_MDABX_FFSR(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_itatbctr0
{
    uint32_t u;
    struct cavm_etf_mdabx_itatbctr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_itatbctr0_s cn; */
};
typedef union cavm_etf_mdabx_itatbctr0 cavm_etf_mdabx_itatbctr0_t;

static inline uint64_t CAVM_ETF_MDABX_ITATBCTR0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_ITATBCTR0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113ef8 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_ITATBCTR0", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_ITATBCTR0(a) cavm_etf_mdabx_itatbctr0_t
#define bustype_CAVM_ETF_MDABX_ITATBCTR0(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_ITATBCTR0(a) "ETF_MDABX_ITATBCTR0"
#define busnum_CAVM_ETF_MDABX_ITATBCTR0(a) (a)
#define arguments_CAVM_ETF_MDABX_ITATBCTR0(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_itatbctr1
{
    uint32_t u;
    struct cavm_etf_mdabx_itatbctr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_itatbctr1_s cn; */
};
typedef union cavm_etf_mdabx_itatbctr1 cavm_etf_mdabx_itatbctr1_t;

static inline uint64_t CAVM_ETF_MDABX_ITATBCTR1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_ITATBCTR1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113ef4 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_ITATBCTR1", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_ITATBCTR1(a) cavm_etf_mdabx_itatbctr1_t
#define bustype_CAVM_ETF_MDABX_ITATBCTR1(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_ITATBCTR1(a) "ETF_MDABX_ITATBCTR1"
#define busnum_CAVM_ETF_MDABX_ITATBCTR1(a) (a)
#define arguments_CAVM_ETF_MDABX_ITATBCTR1(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_itatbctr2
{
    uint32_t u;
    struct cavm_etf_mdabx_itatbctr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_itatbctr2_s cn; */
};
typedef union cavm_etf_mdabx_itatbctr2 cavm_etf_mdabx_itatbctr2_t;

static inline uint64_t CAVM_ETF_MDABX_ITATBCTR2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_ITATBCTR2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113ef0 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_ITATBCTR2", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_ITATBCTR2(a) cavm_etf_mdabx_itatbctr2_t
#define bustype_CAVM_ETF_MDABX_ITATBCTR2(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_ITATBCTR2(a) "ETF_MDABX_ITATBCTR2"
#define busnum_CAVM_ETF_MDABX_ITATBCTR2(a) (a)
#define arguments_CAVM_ETF_MDABX_ITATBCTR2(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_itatbdata0
{
    uint32_t u;
    struct cavm_etf_mdabx_itatbdata0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_itatbdata0_s cn; */
};
typedef union cavm_etf_mdabx_itatbdata0 cavm_etf_mdabx_itatbdata0_t;

static inline uint64_t CAVM_ETF_MDABX_ITATBDATA0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_ITATBDATA0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113eec + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_ITATBDATA0", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_ITATBDATA0(a) cavm_etf_mdabx_itatbdata0_t
#define bustype_CAVM_ETF_MDABX_ITATBDATA0(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_ITATBDATA0(a) "ETF_MDABX_ITATBDATA0"
#define busnum_CAVM_ETF_MDABX_ITATBDATA0(a) (a)
#define arguments_CAVM_ETF_MDABX_ITATBDATA0(a) (a),-1,-1,-1
 ...
 * 0x0.
 */
union cavm_etf_mdabx_itatbmctr1
{
    uint32_t u;
    struct cavm_etf_mdabx_itatbmctr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_itatbmctr1_s cn; */
};
typedef union cavm_etf_mdabx_itatbmctr1 cavm_etf_mdabx_itatbmctr1_t;

static inline uint64_t CAVM_ETF_MDABX_ITATBMCTR1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_ITATBMCTR1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113ed8 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_ITATBMCTR1", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_ITATBMCTR1(a) cavm_etf_mdabx_itatbmctr1_t
#define bustype_CAVM_ETF_MDABX_ITATBMCTR1(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_ITATBMCTR1(a) "ETF_MDABX_ITATBMCTR1"
#define busnum_CAVM_ETF_MDABX_ITATBMCTR1(a) (a)
#define arguments_CAVM_ETF_MDABX_ITATBMCTR1(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_itatbmctr2
{
    uint32_t u;
    struct cavm_etf_mdabx_itatbmctr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_itatbmctr2_s cn; */
};
typedef union cavm_etf_mdabx_itatbmctr2 cavm_etf_mdabx_itatbmctr2_t;

static inline uint64_t CAVM_ETF_MDABX_ITATBMCTR2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_ITATBMCTR2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113ed4 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_ITATBMCTR2", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_ITATBMCTR2(a) cavm_etf_mdabx_itatbmctr2_t
#define bustype_CAVM_ETF_MDABX_ITATBMCTR2(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_ITATBMCTR2(a) "ETF_MDABX_ITATBMCTR2"
#define busnum_CAVM_ETF_MDABX_ITATBMCTR2(a) (a)
#define arguments_CAVM_ETF_MDABX_ITATBMCTR2(a) (a),-1,-1,-1
 ...
 * DATA WIDTH)/8.
 */
union cavm_etf_mdabx_itatbmdata0
{
    uint32_t u;
    struct cavm_etf_mdabx_itatbmdata0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_itatbmdata0_s cn; */
};
typedef union cavm_etf_mdabx_itatbmdata0 cavm_etf_mdabx_itatbmdata0_t;

static inline uint64_t CAVM_ETF_MDABX_ITATBMDATA0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_ITATBMDATA0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113ed0 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_ITATBMDATA0", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_ITATBMDATA0(a) cavm_etf_mdabx_itatbmdata0_t
#define bustype_CAVM_ETF_MDABX_ITATBMDATA0(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_ITATBMDATA0(a) "ETF_MDABX_ITATBMDATA0"
#define busnum_CAVM_ETF_MDABX_ITATBMDATA0(a) (a)
#define arguments_CAVM_ETF_MDABX_ITATBMDATA0(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_itctrl
{
    uint32_t u;
    struct cavm_etf_mdabx_itctrl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 31; /**< [ 31:  1](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_mdabx_itctrl_s cn; */
};
typedef union cavm_etf_mdabx_itctrl cavm_etf_mdabx_itctrl_t;

static inline uint64_t CAVM_ETF_MDABX_ITCTRL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_ITCTRL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113f00 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_ITCTRL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_ITCTRL(a) cavm_etf_mdabx_itctrl_t
#define bustype_CAVM_ETF_MDABX_ITCTRL(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_ITCTRL(a) "ETF_MDABX_ITCTRL"
#define busnum_CAVM_ETF_MDABX_ITCTRL(a) (a)
#define arguments_CAVM_ETF_MDABX_ITCTRL(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_itevtintr
{
    uint32_t u;
    struct cavm_etf_mdabx_itevtintr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 29; /**< [ 31:  3](WO) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_mdabx_itevtintr_s cn; */
};
typedef union cavm_etf_mdabx_itevtintr cavm_etf_mdabx_itevtintr_t;

static inline uint64_t CAVM_ETF_MDABX_ITEVTINTR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_ITEVTINTR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113ee0 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_ITEVTINTR", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_ITEVTINTR(a) cavm_etf_mdabx_itevtintr_t
#define bustype_CAVM_ETF_MDABX_ITEVTINTR(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_ITEVTINTR(a) "ETF_MDABX_ITEVTINTR"
#define busnum_CAVM_ETF_MDABX_ITEVTINTR(a) (a)
#define arguments_CAVM_ETF_MDABX_ITEVTINTR(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_ittrflin
{
    uint32_t u;
    struct cavm_etf_mdabx_ittrflin_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 30; /**< [ 31:  2](RO) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_mdabx_ittrflin_s cn; */
};
typedef union cavm_etf_mdabx_ittrflin cavm_etf_mdabx_ittrflin_t;

static inline uint64_t CAVM_ETF_MDABX_ITTRFLIN(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_ITTRFLIN(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113ee8 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_ITTRFLIN", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_ITTRFLIN(a) cavm_etf_mdabx_ittrflin_t
#define bustype_CAVM_ETF_MDABX_ITTRFLIN(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_ITTRFLIN(a) "ETF_MDABX_ITTRFLIN"
#define busnum_CAVM_ETF_MDABX_ITTRFLIN(a) (a)
#define arguments_CAVM_ETF_MDABX_ITTRFLIN(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_lbuflevel
{
    uint32_t u;
    struct cavm_etf_mdabx_lbuflevel_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 20; /**< [ 31: 12](RO) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_mdabx_lbuflevel_s cn; */
};
typedef union cavm_etf_mdabx_lbuflevel cavm_etf_mdabx_lbuflevel_t;

static inline uint64_t CAVM_ETF_MDABX_LBUFLEVEL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_LBUFLEVEL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e04611302c + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_LBUFLEVEL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_LBUFLEVEL(a) cavm_etf_mdabx_lbuflevel_t
#define bustype_CAVM_ETF_MDABX_LBUFLEVEL(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_LBUFLEVEL(a) "ETF_MDABX_LBUFLEVEL"
#define busnum_CAVM_ETF_MDABX_LBUFLEVEL(a) (a)
#define arguments_CAVM_ETF_MDABX_LBUFLEVEL(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_mode
{
    uint32_t u;
    struct cavm_etf_mdabx_mode_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_mode_s cn; */
};
typedef union cavm_etf_mdabx_mode cavm_etf_mdabx_mode_t;

static inline uint64_t CAVM_ETF_MDABX_MODE(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_MODE(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113028 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_MODE", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_MODE(a) cavm_etf_mdabx_mode_t
#define bustype_CAVM_ETF_MDABX_MODE(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_MODE(a) "ETF_MDABX_MODE"
#define busnum_CAVM_ETF_MDABX_MODE(a) (a)
#define arguments_CAVM_ETF_MDABX_MODE(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_pidr0
{
    uint32_t u;
    struct cavm_etf_mdabx_pidr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_mdabx_pidr0_s cn; */
};
typedef union cavm_etf_mdabx_pidr0 cavm_etf_mdabx_pidr0_t;

static inline uint64_t CAVM_ETF_MDABX_PIDR0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_PIDR0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fe0 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_PIDR0", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_PIDR0(a) cavm_etf_mdabx_pidr0_t
#define bustype_CAVM_ETF_MDABX_PIDR0(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_PIDR0(a) "ETF_MDABX_PIDR0"
#define busnum_CAVM_ETF_MDABX_PIDR0(a) (a)
#define arguments_CAVM_ETF_MDABX_PIDR0(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_pidr1
{
    uint32_t u;
    struct cavm_etf_mdabx_pidr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_mdabx_pidr1_s cn; */
};
typedef union cavm_etf_mdabx_pidr1 cavm_etf_mdabx_pidr1_t;

static inline uint64_t CAVM_ETF_MDABX_PIDR1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_PIDR1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fe4 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_PIDR1", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_PIDR1(a) cavm_etf_mdabx_pidr1_t
#define bustype_CAVM_ETF_MDABX_PIDR1(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_PIDR1(a) "ETF_MDABX_PIDR1"
#define busnum_CAVM_ETF_MDABX_PIDR1(a) (a)
#define arguments_CAVM_ETF_MDABX_PIDR1(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_pidr2
{
    uint32_t u;
    struct cavm_etf_mdabx_pidr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_mdabx_pidr2_s cn; */
};
typedef union cavm_etf_mdabx_pidr2 cavm_etf_mdabx_pidr2_t;

static inline uint64_t CAVM_ETF_MDABX_PIDR2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_PIDR2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fe8 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_PIDR2", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_PIDR2(a) cavm_etf_mdabx_pidr2_t
#define bustype_CAVM_ETF_MDABX_PIDR2(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_PIDR2(a) "ETF_MDABX_PIDR2"
#define busnum_CAVM_ETF_MDABX_PIDR2(a) (a)
#define arguments_CAVM_ETF_MDABX_PIDR2(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_pidr3
{
    uint32_t u;
    struct cavm_etf_mdabx_pidr3_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_mdabx_pidr3_s cn; */
};
typedef union cavm_etf_mdabx_pidr3 cavm_etf_mdabx_pidr3_t;

static inline uint64_t CAVM_ETF_MDABX_PIDR3(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_PIDR3(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fec + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_PIDR3", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_PIDR3(a) cavm_etf_mdabx_pidr3_t
#define bustype_CAVM_ETF_MDABX_PIDR3(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_PIDR3(a) "ETF_MDABX_PIDR3"
#define busnum_CAVM_ETF_MDABX_PIDR3(a) (a)
#define arguments_CAVM_ETF_MDABX_PIDR3(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_pidr4
{
    uint32_t u;
    struct cavm_etf_mdabx_pidr4_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_mdabx_pidr4_s cn; */
};
typedef union cavm_etf_mdabx_pidr4 cavm_etf_mdabx_pidr4_t;

static inline uint64_t CAVM_ETF_MDABX_PIDR4(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_PIDR4(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fd0 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_PIDR4", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_PIDR4(a) cavm_etf_mdabx_pidr4_t
#define bustype_CAVM_ETF_MDABX_PIDR4(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_PIDR4(a) "ETF_MDABX_PIDR4"
#define busnum_CAVM_ETF_MDABX_PIDR4(a) (a)
#define arguments_CAVM_ETF_MDABX_PIDR4(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_pidr5
{
    uint32_t u;
    struct cavm_etf_mdabx_pidr5_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_mdabx_pidr5_s cn; */
};
typedef union cavm_etf_mdabx_pidr5 cavm_etf_mdabx_pidr5_t;

static inline uint64_t CAVM_ETF_MDABX_PIDR5(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_PIDR5(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fd4 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_PIDR5", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_PIDR5(a) cavm_etf_mdabx_pidr5_t
#define bustype_CAVM_ETF_MDABX_PIDR5(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_PIDR5(a) "ETF_MDABX_PIDR5"
#define busnum_CAVM_ETF_MDABX_PIDR5(a) (a)
#define arguments_CAVM_ETF_MDABX_PIDR5(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_pidr6
{
    uint32_t u;
    struct cavm_etf_mdabx_pidr6_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_mdabx_pidr6_s cn; */
};
typedef union cavm_etf_mdabx_pidr6 cavm_etf_mdabx_pidr6_t;

static inline uint64_t CAVM_ETF_MDABX_PIDR6(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_PIDR6(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fd8 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_PIDR6", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_PIDR6(a) cavm_etf_mdabx_pidr6_t
#define bustype_CAVM_ETF_MDABX_PIDR6(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_PIDR6(a) "ETF_MDABX_PIDR6"
#define busnum_CAVM_ETF_MDABX_PIDR6(a) (a)
#define arguments_CAVM_ETF_MDABX_PIDR6(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_pidr7
{
    uint32_t u;
    struct cavm_etf_mdabx_pidr7_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_mdabx_pidr7_s cn; */
};
typedef union cavm_etf_mdabx_pidr7 cavm_etf_mdabx_pidr7_t;

static inline uint64_t CAVM_ETF_MDABX_PIDR7(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_PIDR7(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113fdc + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_PIDR7", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_PIDR7(a) cavm_etf_mdabx_pidr7_t
#define bustype_CAVM_ETF_MDABX_PIDR7(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_PIDR7(a) "ETF_MDABX_PIDR7"
#define busnum_CAVM_ETF_MDABX_PIDR7(a) (a)
#define arguments_CAVM_ETF_MDABX_PIDR7(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_pscr
{
    uint32_t u;
    struct cavm_etf_mdabx_pscr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_pscr_s cn; */
};
typedef union cavm_etf_mdabx_pscr cavm_etf_mdabx_pscr_t;

static inline uint64_t CAVM_ETF_MDABX_PSCR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_PSCR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113308 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_PSCR", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_PSCR(a) cavm_etf_mdabx_pscr_t
#define bustype_CAVM_ETF_MDABX_PSCR(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_PSCR(a) "ETF_MDABX_PSCR"
#define busnum_CAVM_ETF_MDABX_PSCR(a) (a)
#define arguments_CAVM_ETF_MDABX_PSCR(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_rrd
{
    uint32_t u;
    struct cavm_etf_mdabx_rrd_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_rrd_s cn; */
};
typedef union cavm_etf_mdabx_rrd cavm_etf_mdabx_rrd_t;

static inline uint64_t CAVM_ETF_MDABX_RRD(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_RRD(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113010 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_RRD", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_RRD(a) cavm_etf_mdabx_rrd_t
#define bustype_CAVM_ETF_MDABX_RRD(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_RRD(a) "ETF_MDABX_RRD"
#define busnum_CAVM_ETF_MDABX_RRD(a) (a)
#define arguments_CAVM_ETF_MDABX_RRD(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_rrp
{
    uint32_t u;
    struct cavm_etf_mdabx_rrp_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_rrp_s cn; */
};
typedef union cavm_etf_mdabx_rrp cavm_etf_mdabx_rrp_t;

static inline uint64_t CAVM_ETF_MDABX_RRP(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_RRP(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113014 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_RRP", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_RRP(a) cavm_etf_mdabx_rrp_t
#define bustype_CAVM_ETF_MDABX_RRP(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_RRP(a) "ETF_MDABX_RRP"
#define busnum_CAVM_ETF_MDABX_RRP(a) (a)
#define arguments_CAVM_ETF_MDABX_RRP(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_rsz
{
    uint32_t u;
    struct cavm_etf_mdabx_rsz_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_rsz_s cn; */
};
typedef union cavm_etf_mdabx_rsz cavm_etf_mdabx_rsz_t;

static inline uint64_t CAVM_ETF_MDABX_RSZ(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_RSZ(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113004 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_RSZ", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_RSZ(a) cavm_etf_mdabx_rsz_t
#define bustype_CAVM_ETF_MDABX_RSZ(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_RSZ(a) "ETF_MDABX_RSZ"
#define busnum_CAVM_ETF_MDABX_RSZ(a) (a)
#define arguments_CAVM_ETF_MDABX_RSZ(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_rwd
{
    uint32_t u;
    struct cavm_etf_mdabx_rwd_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_mdabx_rwd_s cn; */
};
typedef union cavm_etf_mdabx_rwd cavm_etf_mdabx_rwd_t;

static inline uint64_t CAVM_ETF_MDABX_RWD(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_RWD(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113024 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_RWD", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_RWD(a) cavm_etf_mdabx_rwd_t
#define bustype_CAVM_ETF_MDABX_RWD(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_RWD(a) "ETF_MDABX_RWD"
#define busnum_CAVM_ETF_MDABX_RWD(a) (a)
#define arguments_CAVM_ETF_MDABX_RWD(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_rwp
{
    uint32_t u;
    struct cavm_etf_mdabx_rwp_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 19; /**< [ 31: 13](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_mdabx_rwp_s cn; */
};
typedef union cavm_etf_mdabx_rwp cavm_etf_mdabx_rwp_t;

static inline uint64_t CAVM_ETF_MDABX_RWP(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_RWP(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e046113018 + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_RWP", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_RWP(a) cavm_etf_mdabx_rwp_t
#define bustype_CAVM_ETF_MDABX_RWP(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_RWP(a) "ETF_MDABX_RWP"
#define busnum_CAVM_ETF_MDABX_RWP(a) (a)
#define arguments_CAVM_ETF_MDABX_RWP(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_sts
{
    uint32_t u;
    struct cavm_etf_mdabx_sts_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 27; /**< [ 31:  5](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_mdabx_sts_s cn; */
};
typedef union cavm_etf_mdabx_sts cavm_etf_mdabx_sts_t;

static inline uint64_t CAVM_ETF_MDABX_STS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_STS(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e04611300c + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_STS", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_STS(a) cavm_etf_mdabx_sts_t
#define bustype_CAVM_ETF_MDABX_STS(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_STS(a) "ETF_MDABX_STS"
#define busnum_CAVM_ETF_MDABX_STS(a) (a)
#define arguments_CAVM_ETF_MDABX_STS(a) (a),-1,-1,-1
 ...
 */
union cavm_etf_mdabx_trg
{
    uint32_t u;
    struct cavm_etf_mdabx_trg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 21; /**< [ 31: 11](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_mdabx_trg_s cn; */
};
typedef union cavm_etf_mdabx_trg cavm_etf_mdabx_trg_t;

static inline uint64_t CAVM_ETF_MDABX_TRG(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_MDABX_TRG(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=15))
        return 0x87e04611301c + ((a>>2)*0x100000+(a&0x3)*0x10000);
    __cavm_csr_fatal("ETF_MDABX_TRG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_MDABX_TRG(a) cavm_etf_mdabx_trg_t
#define bustype_CAVM_ETF_MDABX_TRG(a) CSR_TYPE_RSL32b
#define basename_CAVM_ETF_MDABX_TRG(a) "ETF_MDABX_TRG"
#define busnum_CAVM_ETF_MDABX_TRG(a) (a)
#define arguments_CAVM_ETF_MDABX_TRG(a) (a),-1,-1,-1

#endif /* __CAVM_CSRS_ETF_MDAB_H__ */
