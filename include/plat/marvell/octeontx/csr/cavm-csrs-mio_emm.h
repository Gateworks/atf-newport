...
union cavm_mio_emm_buf_dat
{
    ...
    /* struct cavm_mio_emm_buf_dat_s cn8; */
    struct cavm_mio_emm_buf_dat_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
#define CAVM_MIO_EMM_CALB CAVM_MIO_EMM_CALB_FUNC()
static inline uint64_t CAVM_MIO_EMM_CALB_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_EMM_CALB_FUNC(void)
{
...
#define bustype_CAVM_MIO_EMM_CALB CSR_TYPE_RSL
#define basename_CAVM_MIO_EMM_CALB "MIO_EMM_CALB"
#define device_bar_CAVM_MIO_EMM_CALB 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_EMM_CALB 0
#define arguments_CAVM_MIO_EMM_CALB -1,-1,-1,-1
...
#define CAVM_MIO_EMM_DEBUG CAVM_MIO_EMM_DEBUG_FUNC()
static inline uint64_t CAVM_MIO_EMM_DEBUG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_EMM_DEBUG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
...
#define bustype_CAVM_MIO_EMM_DEBUG CSR_TYPE_RSL
#define basename_CAVM_MIO_EMM_DEBUG "MIO_EMM_DEBUG"
#define device_bar_CAVM_MIO_EMM_DEBUG 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_EMM_DEBUG 0
#define arguments_CAVM_MIO_EMM_DEBUG -1,-1,-1,-1
...
#define CAVM_MIO_EMM_DMA_ARG CAVM_MIO_EMM_DMA_ARG_FUNC()
static inline uint64_t CAVM_MIO_EMM_DMA_ARG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_EMM_DMA_ARG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
...
#define bustype_CAVM_MIO_EMM_DMA_ARG CSR_TYPE_RSL
#define basename_CAVM_MIO_EMM_DMA_ARG "MIO_EMM_DMA_ARG"
#define device_bar_CAVM_MIO_EMM_DMA_ARG 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_EMM_DMA_ARG 0
#define arguments_CAVM_MIO_EMM_DMA_ARG -1,-1,-1,-1
...
union cavm_mio_emm_dma_fifo_cmd
{
    ...
    /* struct cavm_mio_emm_dma_fifo_cmd_s cn; */
};
...
#define CAVM_MIO_EMM_IO_CTL CAVM_MIO_EMM_IO_CTL_FUNC()
static inline uint64_t CAVM_MIO_EMM_IO_CTL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_EMM_IO_CTL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x87e009002040ll;
...
#define bustype_CAVM_MIO_EMM_IO_CTL CSR_TYPE_RSL
#define basename_CAVM_MIO_EMM_IO_CTL "MIO_EMM_IO_CTL"
#define device_bar_CAVM_MIO_EMM_IO_CTL 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_EMM_IO_CTL 0
#define arguments_CAVM_MIO_EMM_IO_CTL -1,-1,-1,-1
...
typedef union cavm_mio_emm_tap cavm_mio_emm_tap_t;

#define CAVM_MIO_EMM_TAP CAVM_MIO_EMM_TAP_FUNC()
static inline uint64_t CAVM_MIO_EMM_TAP_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_EMM_TAP_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
...
#define bustype_CAVM_MIO_EMM_TAP CSR_TYPE_RSL
#define basename_CAVM_MIO_EMM_TAP "MIO_EMM_TAP"
#define device_bar_CAVM_MIO_EMM_TAP 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_EMM_TAP 0
#define arguments_CAVM_MIO_EMM_TAP -1,-1,-1,-1
...
typedef union cavm_mio_emm_timing cavm_mio_emm_timing_t;

#define CAVM_MIO_EMM_TIMING CAVM_MIO_EMM_TIMING_FUNC()
static inline uint64_t CAVM_MIO_EMM_TIMING_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_EMM_TIMING_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
...
#define bustype_CAVM_MIO_EMM_TIMING CSR_TYPE_RSL
#define basename_CAVM_MIO_EMM_TIMING "MIO_EMM_TIMING"
#define device_bar_CAVM_MIO_EMM_TIMING 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_EMM_TIMING 0
#define arguments_CAVM_MIO_EMM_TIMING -1,-1,-1,-1
