#ifndef __CAVM_CSRS_PBUS_H__
#define __CAVM_CSRS_PBUS_H__
 ...
 */
#define CAVM_PBUS_BAR_E_PBUS_PF_BAR0_CN8 (0x87e001000000ll)
#define CAVM_PBUS_BAR_E_PBUS_PF_BAR0_CN8_SIZE 0x800000ull
#define CAVM_PBUS_BAR_E_PBUS_PF_BAR0_CN9 (0x87e001000000ll)
#define CAVM_PBUS_BAR_E_PBUS_PF_BAR0_CN9_SIZE 0x100000ull
 ...
 */
#define CAVM_PBUS_INT_VEC_E_ADR_ERR (0)
#define CAVM_PBUS_INT_VEC_E_DMA_DONEX(a) (2 + (a))
#define CAVM_PBUS_INT_VEC_E_NCB_FLT (4)
#define CAVM_PBUS_INT_VEC_E_NCB_RAS (5)
#define CAVM_PBUS_INT_VEC_E_WAIT_ERR (1)
 ...
 * PBUS Debug Register
 */
union cavm_pbus_debug
{
    uint64_t u;
    struct cavm_pbus_debug_s
    {
    ...
    /* struct cavm_pbus_debug_s cn; */
};
typedef union cavm_pbus_debug cavm_pbus_debug_t;

#define CAVM_PBUS_DEBUG CAVM_PBUS_DEBUG_FUNC()
static inline uint64_t CAVM_PBUS_DEBUG_FUNC(void) __attribute__ ((pure, always_inline));
...
#define bustype_CAVM_PBUS_DEBUG CSR_TYPE_RSL
#define basename_CAVM_PBUS_DEBUG "PBUS_DEBUG"
#define device_bar_CAVM_PBUS_DEBUG 0x0 /* PF_BAR0 */
#define busnum_CAVM_PBUS_DEBUG 0
#define arguments_CAVM_PBUS_DEBUG -1,-1,-1,-1
 ...
 */
union cavm_pbus_dma_adrx
{
    uint64_t u;
    struct cavm_pbus_dma_adrx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_pbus_dma_adrx_s cn9; */
};
...
#define bustype_CAVM_PBUS_DMA_ADRX(a) CSR_TYPE_RSL
#define basename_CAVM_PBUS_DMA_ADRX(a) "PBUS_DMA_ADRX"
#define device_bar_CAVM_PBUS_DMA_ADRX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_PBUS_DMA_ADRX(a) (a)
#define arguments_CAVM_PBUS_DMA_ADRX(a) (a),-1,-1,-1
 ...
 */
union cavm_pbus_dma_cfgx
{
    uint64_t u;
    struct cavm_pbus_dma_cfgx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_pbus_dma_cfgx_s cn8; */
    struct cavm_pbus_dma_cfgx_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
#define bustype_CAVM_PBUS_DMA_CFGX(a) CSR_TYPE_RSL
#define basename_CAVM_PBUS_DMA_CFGX(a) "PBUS_DMA_CFGX"
#define device_bar_CAVM_PBUS_DMA_CFGX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_PBUS_DMA_CFGX(a) (a)
#define arguments_CAVM_PBUS_DMA_CFGX(a) (a),-1,-1,-1
 ...
 */
union cavm_pbus_dma_timx
{
    uint64_t u;
    struct cavm_pbus_dma_timx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_pbus_dma_timx_s cn; */
};
...
#define bustype_CAVM_PBUS_DMA_TIMX(a) CSR_TYPE_RSL
#define basename_CAVM_PBUS_DMA_TIMX(a) "PBUS_DMA_TIMX"
#define device_bar_CAVM_PBUS_DMA_TIMX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_PBUS_DMA_TIMX(a) (a)
...
union cavm_pbus_int
{
    ...
    /* struct cavm_pbus_int_s cn9; */
};
typedef union cavm_pbus_int cavm_pbus_int_t;

#define CAVM_PBUS_INT CAVM_PBUS_INT_FUNC()
static inline uint64_t CAVM_PBUS_INT_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PBUS_INT_FUNC(void)
{
    return 0x87e001000080ll;
}

#define typedef_CAVM_PBUS_INT cavm_pbus_int_t
#define bustype_CAVM_PBUS_INT CSR_TYPE_RSL
#define basename_CAVM_PBUS_INT "PBUS_INT"
#define device_bar_CAVM_PBUS_INT 0x0 /* PF_BAR0 */
#define busnum_CAVM_PBUS_INT 0
#define arguments_CAVM_PBUS_INT -1,-1,-1,-1
 ...
 */
union cavm_pbus_int_ena_w1c
{
    uint64_t u;
    struct cavm_pbus_int_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_9_63         : 55;
    ...
    struct cavm_pbus_int_ena_w1c_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_6_63         : 58;
        uint64_t dma_done              : 2;  /**< [  5:  4](R/W1C/H) Reads or clears enable for PBUS_INT[DMA_DONE]. */
    ...
    /* struct cavm_pbus_int_ena_w1c_s cn9; */
};
typedef union cavm_pbus_int_ena_w1c cavm_pbus_int_ena_w1c_t;

#define CAVM_PBUS_INT_ENA_W1C CAVM_PBUS_INT_ENA_W1C_FUNC()
static inline uint64_t CAVM_PBUS_INT_ENA_W1C_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PBUS_INT_ENA_W1C_FUNC(void)
{
    return 0x87e001000090ll;
}

#define typedef_CAVM_PBUS_INT_ENA_W1C cavm_pbus_int_ena_w1c_t
#define bustype_CAVM_PBUS_INT_ENA_W1C CSR_TYPE_RSL
#define basename_CAVM_PBUS_INT_ENA_W1C "PBUS_INT_ENA_W1C"
#define device_bar_CAVM_PBUS_INT_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_PBUS_INT_ENA_W1C 0
#define arguments_CAVM_PBUS_INT_ENA_W1C -1,-1,-1,-1
 ...
 */
union cavm_pbus_int_ena_w1s
{
    uint64_t u;
    struct cavm_pbus_int_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_9_63         : 55;
    ...
    struct cavm_pbus_int_ena_w1s_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_6_63         : 58;
        uint64_t dma_done              : 2;  /**< [  5:  4](R/W1S/H) Reads or sets enable for PBUS_INT[DMA_DONE]. */
    ...
    /* struct cavm_pbus_int_ena_w1s_s cn9; */
};
typedef union cavm_pbus_int_ena_w1s cavm_pbus_int_ena_w1s_t;

#define CAVM_PBUS_INT_ENA_W1S CAVM_PBUS_INT_ENA_W1S_FUNC()
static inline uint64_t CAVM_PBUS_INT_ENA_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PBUS_INT_ENA_W1S_FUNC(void)
{
    return 0x87e001000098ll;
}

#define typedef_CAVM_PBUS_INT_ENA_W1S cavm_pbus_int_ena_w1s_t
#define bustype_CAVM_PBUS_INT_ENA_W1S CSR_TYPE_RSL
#define basename_CAVM_PBUS_INT_ENA_W1S "PBUS_INT_ENA_W1S"
#define device_bar_CAVM_PBUS_INT_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_PBUS_INT_ENA_W1S 0
#define arguments_CAVM_PBUS_INT_ENA_W1S -1,-1,-1,-1
 ...
 */
union cavm_pbus_int_w1s
{
    uint64_t u;
    struct cavm_pbus_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_9_63         : 55;
    ...
    /* struct cavm_pbus_int_w1s_s cn9; */
};
typedef union cavm_pbus_int_w1s cavm_pbus_int_w1s_t;

#define CAVM_PBUS_INT_W1S CAVM_PBUS_INT_W1S_FUNC()
static inline uint64_t CAVM_PBUS_INT_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PBUS_INT_W1S_FUNC(void)
{
    return 0x87e001000088ll;
}

#define typedef_CAVM_PBUS_INT_W1S cavm_pbus_int_w1s_t
#define bustype_CAVM_PBUS_INT_W1S CSR_TYPE_RSL
#define basename_CAVM_PBUS_INT_W1S "PBUS_INT_W1S"
#define device_bar_CAVM_PBUS_INT_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_PBUS_INT_W1S 0
#define arguments_CAVM_PBUS_INT_W1S -1,-1,-1,-1
 ...
 * enumeration.
 */
union cavm_pbus_msix_pbax
{
    uint64_t u;
    struct cavm_pbus_msix_pbax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_pbus_msix_pbax_s cn; */
};
...
#define bustype_CAVM_PBUS_MSIX_PBAX(a) CSR_TYPE_RSL
#define basename_CAVM_PBUS_MSIX_PBAX(a) "PBUS_MSIX_PBAX"
#define device_bar_CAVM_PBUS_MSIX_PBAX(a) 0x4 /* PF_BAR4 */
#define busnum_CAVM_PBUS_MSIX_PBAX(a) (a)
#define arguments_CAVM_PBUS_MSIX_PBAX(a) (a),-1,-1,-1
 ...
 */
union cavm_pbus_msix_vecx_addr
{
    uint64_t u;
    struct cavm_pbus_msix_vecx_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
    ...
    struct cavm_pbus_msix_vecx_addr_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
    ...
    /* struct cavm_pbus_msix_vecx_addr_s cn9; */
    /* struct cavm_pbus_msix_vecx_addr_s cn96xxp1; */
    struct cavm_pbus_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
...
#define bustype_CAVM_PBUS_MSIX_VECX_ADDR(a) CSR_TYPE_RSL
#define basename_CAVM_PBUS_MSIX_VECX_ADDR(a) "PBUS_MSIX_VECX_ADDR"
#define device_bar_CAVM_PBUS_MSIX_VECX_ADDR(a) 0x4 /* PF_BAR4 */
#define busnum_CAVM_PBUS_MSIX_VECX_ADDR(a) (a)
#define arguments_CAVM_PBUS_MSIX_VECX_ADDR(a) (a),-1,-1,-1
 ...
 * This register is the MSI-X vector table, indexed by the PBUS_INT_VEC_E enumeration.
 */
union cavm_pbus_msix_vecx_ctl
{
    uint64_t u;
    struct cavm_pbus_msix_vecx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    struct cavm_pbus_msix_vecx_ctl_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_33_63        : 31;
        uint64_t mask                  : 1;  /**< [ 32: 32](R/W) When set, no MSI-X interrupts will be sent to this vector. */
    ...
    /* struct cavm_pbus_msix_vecx_ctl_s cn9; */
};
...
#define bustype_CAVM_PBUS_MSIX_VECX_CTL(a) CSR_TYPE_RSL
#define basename_CAVM_PBUS_MSIX_VECX_CTL(a) "PBUS_MSIX_VECX_CTL"
#define device_bar_CAVM_PBUS_MSIX_VECX_CTL(a) 0x4 /* PF_BAR4 */
#define busnum_CAVM_PBUS_MSIX_VECX_CTL(a) (a)
#define arguments_CAVM_PBUS_MSIX_VECX_CTL(a) (a),-1,-1,-1
 ...
 */
union cavm_pbus_regx_cfg
{
    uint64_t u;
    struct cavm_pbus_regx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_pbus_regx_cfg_s cn; */
};
...
#define bustype_CAVM_PBUS_REGX_CFG(a) CSR_TYPE_RSL
#define basename_CAVM_PBUS_REGX_CFG(a) "PBUS_REGX_CFG"
#define device_bar_CAVM_PBUS_REGX_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_PBUS_REGX_CFG(a) (a)
#define arguments_CAVM_PBUS_REGX_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_pbus_regx_tim
{
    uint64_t u;
    struct cavm_pbus_regx_tim_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_pbus_regx_tim_s cn; */
};
...
#define bustype_CAVM_PBUS_REGX_TIM(a) CSR_TYPE_RSL
#define basename_CAVM_PBUS_REGX_TIM(a) "PBUS_REGX_TIM"
#define device_bar_CAVM_PBUS_REGX_TIM(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_PBUS_REGX_TIM(a) (a)
#define arguments_CAVM_PBUS_REGX_TIM(a) (a),-1,-1,-1
...
union cavm_pbus_thr
{
    ...
    /* struct cavm_pbus_thr_s cn8; */
    struct cavm_pbus_thr_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_22_63        : 42;
...
typedef union cavm_pbus_thr cavm_pbus_thr_t;

#define CAVM_PBUS_THR CAVM_PBUS_THR_FUNC()
static inline uint64_t CAVM_PBUS_THR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_PBUS_THR_FUNC(void)
{
    return 0x87e0010000b0ll;
}

#define typedef_CAVM_PBUS_THR cavm_pbus_thr_t
#define bustype_CAVM_PBUS_THR CSR_TYPE_RSL
#define basename_CAVM_PBUS_THR "PBUS_THR"
#define device_bar_CAVM_PBUS_THR 0x0 /* PF_BAR0 */
#define busnum_CAVM_PBUS_THR 0
#define arguments_CAVM_PBUS_THR -1,-1,-1,-1

#endif /* __CAVM_CSRS_PBUS_H__ */
