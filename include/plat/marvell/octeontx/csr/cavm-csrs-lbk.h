 ...
 */
#define CAVM_LBK_BAR_E_LBKX_PF_BAR0_CN8(a) (0x87e018000000ll + 0x1000000ll * (a))
#define CAVM_LBK_BAR_E_LBKX_PF_BAR0_CN8_SIZE 0x100000ull
#define CAVM_LBK_BAR_E_LBKX_PF_BAR0_CN9(a) (0x87e018000000ll + 0x1000000ll * (a))
#define CAVM_LBK_BAR_E_LBKX_PF_BAR0_CN9_SIZE 0x10000ull
...
static inline uint64_t CAVM_LBKX_BIST_RESULT(unsigned long a)
{
    ...
    __cavm_csr_fatal("LBKX_BIST_RESULT", 1, a, 0, 0, 0, 0, 0);
}
...
union cavm_lbkx_clk_gate_ctl
{
    ...
    /* struct cavm_lbkx_clk_gate_ctl_s cn8; */
    struct cavm_lbkx_clk_gate_ctl_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
...
static inline uint64_t CAVM_LBKX_ECC_CFG(unsigned long a)
{
    ...
    __cavm_csr_fatal("LBKX_ECC_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_LBKX_ERR_INT(unsigned long a)
{
    ...
    __cavm_csr_fatal("LBKX_ERR_INT", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_LBKX_ERR_INT_ENA_W1C(unsigned long a)
{
    ...
    __cavm_csr_fatal("LBKX_ERR_INT_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_LBKX_ERR_INT_ENA_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("LBKX_ERR_INT_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_LBKX_ERR_INT_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("LBKX_ERR_INT_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_LBKX_MSIX_PBAX(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("LBKX_MSIX_PBAX", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_LBKX_MSIX_VECX_ADDR(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("LBKX_MSIX_VECX_ADDR", 2, a, b, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_LBKX_MSIX_VECX_CTL(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("LBKX_MSIX_VECX_CTL", 2, a, b, 0, 0, 0, 0);
}
