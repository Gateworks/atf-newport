#ifndef __CAVM_CSRS_CDE_H__
#define __CAVM_CSRS_CDE_H__
 ...
 */
#define CAVM_CDE_BAR_E_CDEX_PF_BAR0(a) (0x80c000000000ll + 0x1000000000ll * (a))
#define CAVM_CDE_BAR_E_CDEX_PF_BAR0_SIZE 0x10000000ull
#define CAVM_CDE_BAR_E_CDEX_PF_BAR4(a) (0x80c010000000ll + 0x1000000000ll * (a))
#define CAVM_CDE_BAR_E_CDEX_PF_BAR4_SIZE 0x100000ull
#define CAVM_CDE_BAR_E_CDEX_VFX_BAR0(a,b) (0x80c020000000ll + 0x1000000000ll * (a) + 0x100000ll * (b))
#define CAVM_CDE_BAR_E_CDEX_VFX_BAR0_SIZE 0x100000ull
#define CAVM_CDE_BAR_E_CDEX_VFX_BAR4(a,b) (0x80c030000000ll + 0x1000000000ll * (a) + 0x100000ll * (b))
#define CAVM_CDE_BAR_E_CDEX_VFX_BAR4_SIZE 0x100000ull
 ...
 */
#define CAVM_CDE_PF_INT_VEC_E_MBOXX_CN81XX(a) (2 + (a))
#define CAVM_CDE_PF_INT_VEC_E_MBOXX_CN83XX(a) (3 + (a))
 ...
 * Enumerates the MSI-X interrupt vectors.
 */
#define CAVM_CDE_VF_INT_VEC_E_DONE (2)
#define CAVM_CDE_VF_INT_VEC_E_MISC (0)
 ...
 */
union cavm_cde_inst_s
{
    uint64_t u[16];
    struct cavm_cde_inst_s_s
    {
 ...
 * is set.
 */
union cavm_cde_res_s
{
    uint64_t u[2];
    struct cavm_cde_res_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_17_63        : 47;
...
static inline uint64_t CAVM_CDEX_CQM_CORE_OBS0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_CQM_CORE_OBS0(unsigned long a)
{
...
static inline uint64_t CAVM_CDEX_CQM_CORE_OBS1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_CQM_CORE_OBS1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && (a==0))
...
static inline uint64_t CAVM_CDEX_NCBI_OBS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_NCBI_OBS(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && (a==0))
 ...
 */
union cavm_cdex_pf_active_cycles_pc
{
    uint64_t u;
...
typedef union cavm_cdex_pf_active_cycles_pc cavm_cdex_pf_active_cycles_pc_t;

static inline uint64_t CAVM_CDEX_PF_ACTIVE_CYCLES_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_ACTIVE_CYCLES_PC(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && (a==0))
        return 0x80c000010100ll + 0x1000000000ll * ((a) & 0x0);
    __cavm_csr_fatal("CDEX_PF_ACTIVE_CYCLES_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_ACTIVE_CYCLES_PC(a) cavm_cdex_pf_active_cycles_pc_t
#define bustype_CAVM_CDEX_PF_ACTIVE_CYCLES_PC(a) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_ACTIVE_CYCLES_PC(a) "CDEX_PF_ACTIVE_CYCLES_PC"
...
static inline uint64_t CAVM_CDEX_PF_BP_TEST(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_BP_TEST(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && (a==0))
 ...
 */
union cavm_cdex_pf_diag
{
    uint64_t u;
    struct cavm_cdex_pf_diag_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_diag_s cn; */
};
typedef union cavm_cdex_pf_diag cavm_cdex_pf_diag_t;

static inline uint64_t CAVM_CDEX_PF_DIAG(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_DIAG(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && (a==0))
        return 0x80c000000120ll + 0x1000000000ll * ((a) & 0x0);
    __cavm_csr_fatal("CDEX_PF_DIAG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_DIAG(a) cavm_cdex_pf_diag_t
#define bustype_CAVM_CDEX_PF_DIAG(a) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_DIAG(a) "CDEX_PF_DIAG"
...
static inline uint64_t CAVM_CDEX_PF_ECO(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_ECO(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && (a==0))
 ...
 */
union cavm_cdex_pf_inst_latency_pc
{
    uint64_t u;
    struct cavm_cdex_pf_inst_latency_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_inst_latency_pc_s cn; */
};
typedef union cavm_cdex_pf_inst_latency_pc cavm_cdex_pf_inst_latency_pc_t;

static inline uint64_t CAVM_CDEX_PF_INST_LATENCY_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_INST_LATENCY_PC(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && (a==0))
        return 0x80c000010020ll + 0x1000000000ll * ((a) & 0x0);
    __cavm_csr_fatal("CDEX_PF_INST_LATENCY_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_INST_LATENCY_PC(a) cavm_cdex_pf_inst_latency_pc_t
#define bustype_CAVM_CDEX_PF_INST_LATENCY_PC(a) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_INST_LATENCY_PC(a) "CDEX_PF_INST_LATENCY_PC"
#define device_bar_CAVM_CDEX_PF_INST_LATENCY_PC(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_CDEX_PF_INST_LATENCY_PC(a) (a)
#define arguments_CAVM_CDEX_PF_INST_LATENCY_PC(a) (a),-1,-1,-1
 ...
 */
union cavm_cdex_pf_inst_req_pc
{
    uint64_t u;
    struct cavm_cdex_pf_inst_req_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_inst_req_pc_s cn; */
};
typedef union cavm_cdex_pf_inst_req_pc cavm_cdex_pf_inst_req_pc_t;

static inline uint64_t CAVM_CDEX_PF_INST_REQ_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_INST_REQ_PC(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && (a==0))
        return 0x80c000010000ll + 0x1000000000ll * ((a) & 0x0);
    __cavm_csr_fatal("CDEX_PF_INST_REQ_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_INST_REQ_PC(a) cavm_cdex_pf_inst_req_pc_t
#define bustype_CAVM_CDEX_PF_INST_REQ_PC(a) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_INST_REQ_PC(a) "CDEX_PF_INST_REQ_PC"
#define device_bar_CAVM_CDEX_PF_INST_REQ_PC(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_CDEX_PF_INST_REQ_PC(a) (a)
#define arguments_CAVM_CDEX_PF_INST_REQ_PC(a) (a),-1,-1,-1
 ...
 */
union cavm_cdex_pf_mbox_ena_w1cx
{
    uint64_t u;
    struct cavm_cdex_pf_mbox_ena_w1cx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_mbox_ena_w1cx_s cn; */
};
typedef union cavm_cdex_pf_mbox_ena_w1cx cavm_cdex_pf_mbox_ena_w1cx_t;

static inline uint64_t CAVM_CDEX_PF_MBOX_ENA_W1CX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_MBOX_ENA_W1CX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && ((a==0) && (b==0)))
        return 0x80c000000440ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __cavm_csr_fatal("CDEX_PF_MBOX_ENA_W1CX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_MBOX_ENA_W1CX(a,b) cavm_cdex_pf_mbox_ena_w1cx_t
#define bustype_CAVM_CDEX_PF_MBOX_ENA_W1CX(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_MBOX_ENA_W1CX(a,b) "CDEX_PF_MBOX_ENA_W1CX"
#define device_bar_CAVM_CDEX_PF_MBOX_ENA_W1CX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_CDEX_PF_MBOX_ENA_W1CX(a,b) (a)
#define arguments_CAVM_CDEX_PF_MBOX_ENA_W1CX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_pf_mbox_ena_w1sx
{
    uint64_t u;
    struct cavm_cdex_pf_mbox_ena_w1sx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_mbox_ena_w1sx_s cn; */
};
typedef union cavm_cdex_pf_mbox_ena_w1sx cavm_cdex_pf_mbox_ena_w1sx_t;

static inline uint64_t CAVM_CDEX_PF_MBOX_ENA_W1SX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_MBOX_ENA_W1SX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && ((a==0) && (b==0)))
        return 0x80c000000460ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __cavm_csr_fatal("CDEX_PF_MBOX_ENA_W1SX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_MBOX_ENA_W1SX(a,b) cavm_cdex_pf_mbox_ena_w1sx_t
#define bustype_CAVM_CDEX_PF_MBOX_ENA_W1SX(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_MBOX_ENA_W1SX(a,b) "CDEX_PF_MBOX_ENA_W1SX"
#define device_bar_CAVM_CDEX_PF_MBOX_ENA_W1SX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_CDEX_PF_MBOX_ENA_W1SX(a,b) (a)
#define arguments_CAVM_CDEX_PF_MBOX_ENA_W1SX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_pf_mbox_intx
{
    uint64_t u;
    struct cavm_cdex_pf_mbox_intx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_mbox_intx_s cn; */
};
typedef union cavm_cdex_pf_mbox_intx cavm_cdex_pf_mbox_intx_t;

static inline uint64_t CAVM_CDEX_PF_MBOX_INTX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_MBOX_INTX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && ((a==0) && (b==0)))
        return 0x80c000000400ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __cavm_csr_fatal("CDEX_PF_MBOX_INTX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_MBOX_INTX(a,b) cavm_cdex_pf_mbox_intx_t
#define bustype_CAVM_CDEX_PF_MBOX_INTX(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_MBOX_INTX(a,b) "CDEX_PF_MBOX_INTX"
#define device_bar_CAVM_CDEX_PF_MBOX_INTX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_CDEX_PF_MBOX_INTX(a,b) (a)
#define arguments_CAVM_CDEX_PF_MBOX_INTX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_pf_mbox_int_w1sx
{
    uint64_t u;
    struct cavm_cdex_pf_mbox_int_w1sx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_mbox_int_w1sx_s cn; */
};
typedef union cavm_cdex_pf_mbox_int_w1sx cavm_cdex_pf_mbox_int_w1sx_t;

static inline uint64_t CAVM_CDEX_PF_MBOX_INT_W1SX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_MBOX_INT_W1SX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && ((a==0) && (b==0)))
        return 0x80c000000420ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __cavm_csr_fatal("CDEX_PF_MBOX_INT_W1SX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_MBOX_INT_W1SX(a,b) cavm_cdex_pf_mbox_int_w1sx_t
#define bustype_CAVM_CDEX_PF_MBOX_INT_W1SX(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_MBOX_INT_W1SX(a,b) "CDEX_PF_MBOX_INT_W1SX"
#define device_bar_CAVM_CDEX_PF_MBOX_INT_W1SX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_CDEX_PF_MBOX_INT_W1SX(a,b) (a)
#define arguments_CAVM_CDEX_PF_MBOX_INT_W1SX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_pf_msix_pbax
{
    uint64_t u;
    struct cavm_cdex_pf_msix_pbax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_msix_pbax_s cn; */
};
typedef union cavm_cdex_pf_msix_pbax cavm_cdex_pf_msix_pbax_t;

static inline uint64_t CAVM_CDEX_PF_MSIX_PBAX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_MSIX_PBAX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && ((a==0) && (b==0)))
        return 0x80c0100f0000ll + 0x1000000000ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __cavm_csr_fatal("CDEX_PF_MSIX_PBAX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_MSIX_PBAX(a,b) cavm_cdex_pf_msix_pbax_t
#define bustype_CAVM_CDEX_PF_MSIX_PBAX(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_MSIX_PBAX(a,b) "CDEX_PF_MSIX_PBAX"
#define device_bar_CAVM_CDEX_PF_MSIX_PBAX(a,b) 0x4 /* PF_BAR4 */
#define busnum_CAVM_CDEX_PF_MSIX_PBAX(a,b) (a)
#define arguments_CAVM_CDEX_PF_MSIX_PBAX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_pf_msix_vecx_addr
{
    uint64_t u;
    struct cavm_cdex_pf_msix_vecx_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_msix_vecx_addr_s cn; */
};
typedef union cavm_cdex_pf_msix_vecx_addr cavm_cdex_pf_msix_vecx_addr_t;

static inline uint64_t CAVM_CDEX_PF_MSIX_VECX_ADDR(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_MSIX_VECX_ADDR(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=3)))
        return 0x80c010000000ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x3);
    __cavm_csr_fatal("CDEX_PF_MSIX_VECX_ADDR", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_MSIX_VECX_ADDR(a,b) cavm_cdex_pf_msix_vecx_addr_t
#define bustype_CAVM_CDEX_PF_MSIX_VECX_ADDR(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_MSIX_VECX_ADDR(a,b) "CDEX_PF_MSIX_VECX_ADDR"
#define device_bar_CAVM_CDEX_PF_MSIX_VECX_ADDR(a,b) 0x4 /* PF_BAR4 */
#define busnum_CAVM_CDEX_PF_MSIX_VECX_ADDR(a,b) (a)
#define arguments_CAVM_CDEX_PF_MSIX_VECX_ADDR(a,b) (a),(b),-1,-1
 ...
 * This register is the MSI-X vector table, indexed by the CDE_PF_INT_VEC_E enumeration.
 */
union cavm_cdex_pf_msix_vecx_ctl
{
    uint64_t u;
    struct cavm_cdex_pf_msix_vecx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_msix_vecx_ctl_s cn; */
};
typedef union cavm_cdex_pf_msix_vecx_ctl cavm_cdex_pf_msix_vecx_ctl_t;

static inline uint64_t CAVM_CDEX_PF_MSIX_VECX_CTL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_MSIX_VECX_CTL(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=2)))
        return 0x80c010000008ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x3);
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=3)))
        return 0x80c010000008ll + 0x1000000000ll * ((a) & 0x0) + 0x10ll * ((b) & 0x3);
    __cavm_csr_fatal("CDEX_PF_MSIX_VECX_CTL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_MSIX_VECX_CTL(a,b) cavm_cdex_pf_msix_vecx_ctl_t
#define bustype_CAVM_CDEX_PF_MSIX_VECX_CTL(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_MSIX_VECX_CTL(a,b) "CDEX_PF_MSIX_VECX_CTL"
#define device_bar_CAVM_CDEX_PF_MSIX_VECX_CTL(a,b) 0x4 /* PF_BAR4 */
#define busnum_CAVM_CDEX_PF_MSIX_VECX_CTL(a,b) (a)
#define arguments_CAVM_CDEX_PF_MSIX_VECX_CTL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_pf_qx_ctl
{
    uint64_t u;
    struct cavm_cdex_pf_qx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_qx_ctl_s cn8; */
    /* struct cavm_cdex_pf_qx_ctl_s cn81xx; */
    struct cavm_cdex_pf_qx_ctl_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_60_63        : 4;
        uint64_t aura                  : 12; /**< [ 59: 48](R/W) Guest-aura for returning this queue's instruction-chunk buffers to FPA.
...
typedef union cavm_cdex_pf_qx_ctl cavm_cdex_pf_qx_ctl_t;

static inline uint64_t CAVM_CDEX_PF_QX_CTL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_QX_CTL(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_PF_QX_CTL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_QX_CTL(a,b) cavm_cdex_pf_qx_ctl_t
#define bustype_CAVM_CDEX_PF_QX_CTL(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_QX_CTL(a,b) "CDEX_PF_QX_CTL"
#define device_bar_CAVM_CDEX_PF_QX_CTL(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_CDEX_PF_QX_CTL(a,b) (a)
#define arguments_CAVM_CDEX_PF_QX_CTL(a,b) (a),(b),-1,-1
 ...
 * (see CDE()_VQ()_INPROG[INFLIGHT]).
 */
union cavm_cdex_pf_qx_gmctl
{
    uint64_t u;
    struct cavm_cdex_pf_qx_gmctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_qx_gmctl_s cn8; */
    /* struct cavm_cdex_pf_qx_gmctl_s cn81xx; */
    struct cavm_cdex_pf_qx_gmctl_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
        uint64_t strm                  : 8;  /**< [ 23: 16](R/W) Low 8 bits of the SMMU stream identifier to use when issuing requests.
...
typedef union cavm_cdex_pf_qx_gmctl cavm_cdex_pf_qx_gmctl_t;

static inline uint64_t CAVM_CDEX_PF_QX_GMCTL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_QX_GMCTL(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_PF_QX_GMCTL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_QX_GMCTL(a,b) cavm_cdex_pf_qx_gmctl_t
#define bustype_CAVM_CDEX_PF_QX_GMCTL(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_QX_GMCTL(a,b) "CDEX_PF_QX_GMCTL"
#define device_bar_CAVM_CDEX_PF_QX_GMCTL(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_CDEX_PF_QX_GMCTL(a,b) (a)
#define arguments_CAVM_CDEX_PF_QX_GMCTL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_pf_rd_latency_pc
{
    uint64_t u;
    struct cavm_cdex_pf_rd_latency_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_rd_latency_pc_s cn; */
};
typedef union cavm_cdex_pf_rd_latency_pc cavm_cdex_pf_rd_latency_pc_t;

static inline uint64_t CAVM_CDEX_PF_RD_LATENCY_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_RD_LATENCY_PC(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && (a==0))
        return 0x80c000010060ll + 0x1000000000ll * ((a) & 0x0);
    __cavm_csr_fatal("CDEX_PF_RD_LATENCY_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_RD_LATENCY_PC(a) cavm_cdex_pf_rd_latency_pc_t
#define bustype_CAVM_CDEX_PF_RD_LATENCY_PC(a) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_RD_LATENCY_PC(a) "CDEX_PF_RD_LATENCY_PC"
#define device_bar_CAVM_CDEX_PF_RD_LATENCY_PC(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_CDEX_PF_RD_LATENCY_PC(a) (a)
#define arguments_CAVM_CDEX_PF_RD_LATENCY_PC(a) (a),-1,-1,-1
 ...
 */
union cavm_cdex_pf_rd_req_pc
{
    uint64_t u;
    struct cavm_cdex_pf_rd_req_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_rd_req_pc_s cn; */
};
typedef union cavm_cdex_pf_rd_req_pc cavm_cdex_pf_rd_req_pc_t;

static inline uint64_t CAVM_CDEX_PF_RD_REQ_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_RD_REQ_PC(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && (a==0))
        return 0x80c000010040ll + 0x1000000000ll * ((a) & 0x0);
    __cavm_csr_fatal("CDEX_PF_RD_REQ_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_RD_REQ_PC(a) cavm_cdex_pf_rd_req_pc_t
#define bustype_CAVM_CDEX_PF_RD_REQ_PC(a) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_RD_REQ_PC(a) "CDEX_PF_RD_REQ_PC"
#define device_bar_CAVM_CDEX_PF_RD_REQ_PC(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_CDEX_PF_RD_REQ_PC(a) (a)
#define arguments_CAVM_CDEX_PF_RD_REQ_PC(a) (a),-1,-1,-1
 ...
 */
union cavm_cdex_pf_reset
{
    uint64_t u;
    struct cavm_cdex_pf_reset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_reset_s cn; */
};
typedef union cavm_cdex_pf_reset cavm_cdex_pf_reset_t;

static inline uint64_t CAVM_CDEX_PF_RESET(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_RESET(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && (a==0))
        return 0x80c000000100ll + 0x1000000000ll * ((a) & 0x0);
    __cavm_csr_fatal("CDEX_PF_RESET", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_RESET(a) cavm_cdex_pf_reset_t
#define bustype_CAVM_CDEX_PF_RESET(a) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_RESET(a) "CDEX_PF_RESET"
#define device_bar_CAVM_CDEX_PF_RESET(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_CDEX_PF_RESET(a) (a)
#define arguments_CAVM_CDEX_PF_RESET(a) (a),-1,-1,-1
 ...
 */
union cavm_cdex_pf_vfx_mboxx
{
    uint64_t u;
    struct cavm_cdex_pf_vfx_mboxx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_pf_vfx_mboxx_s cn; */
};
typedef union cavm_cdex_pf_vfx_mboxx cavm_cdex_pf_vfx_mboxx_t;

static inline uint64_t CAVM_CDEX_PF_VFX_MBOXX(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_PF_VFX_MBOXX(unsigned long a, unsigned long b, unsigned long c)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15) && (c<=1)))
    ...
    __cavm_csr_fatal("CDEX_PF_VFX_MBOXX", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_CDEX_PF_VFX_MBOXX(a,b,c) cavm_cdex_pf_vfx_mboxx_t
#define bustype_CAVM_CDEX_PF_VFX_MBOXX(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_CDEX_PF_VFX_MBOXX(a,b,c) "CDEX_PF_VFX_MBOXX"
#define device_bar_CAVM_CDEX_PF_VFX_MBOXX(a,b,c) 0x0 /* PF_BAR0 */
#define busnum_CAVM_CDEX_PF_VFX_MBOXX(a,b,c) (a)
#define arguments_CAVM_CDEX_PF_VFX_MBOXX(a,b,c) (a),(b),(c),-1
 ...
 * enumeration.
 */
union cavm_cdex_vfx_msix_pbax
{
    uint64_t u;
    struct cavm_cdex_vfx_msix_pbax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t pend                  : 64; /**< [ 63:  0](RO/H) Pending message for the associated CDE()_PF_MSIX_VEC()_CTL, enumerated by
                                                                 CDE_PF_INT_VEC_E. Bits that have no associated CDE_PF_INT_VEC_E are zero. */
    ...
    /* struct cavm_cdex_vfx_msix_pbax_s cn; */
};
typedef union cavm_cdex_vfx_msix_pbax cavm_cdex_vfx_msix_pbax_t;

static inline uint64_t CAVM_CDEX_VFX_MSIX_PBAX(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VFX_MSIX_PBAX(unsigned long a, unsigned long b, unsigned long c)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15) && (c==0)))
    ...
    __cavm_csr_fatal("CDEX_VFX_MSIX_PBAX", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VFX_MSIX_PBAX(a,b,c) cavm_cdex_vfx_msix_pbax_t
#define bustype_CAVM_CDEX_VFX_MSIX_PBAX(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VFX_MSIX_PBAX(a,b,c) "CDEX_VFX_MSIX_PBAX"
#define device_bar_CAVM_CDEX_VFX_MSIX_PBAX(a,b,c) 0x4 /* VF_BAR4 */
#define busnum_CAVM_CDEX_VFX_MSIX_PBAX(a,b,c) (a)
#define arguments_CAVM_CDEX_VFX_MSIX_PBAX(a,b,c) (a),(b),(c),-1
 ...
 */
union cavm_cdex_vfx_msix_vecx_addr
{
    uint64_t u;
    struct cavm_cdex_vfx_msix_vecx_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
        uint64_t addr                  : 47; /**< [ 48:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct cavm_cdex_vfx_msix_vecx_addr_s cn; */
};
typedef union cavm_cdex_vfx_msix_vecx_addr cavm_cdex_vfx_msix_vecx_addr_t;

static inline uint64_t CAVM_CDEX_VFX_MSIX_VECX_ADDR(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VFX_MSIX_VECX_ADDR(unsigned long a, unsigned long b, unsigned long c)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15) && (c<=1)))
    ...
    __cavm_csr_fatal("CDEX_VFX_MSIX_VECX_ADDR", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VFX_MSIX_VECX_ADDR(a,b,c) cavm_cdex_vfx_msix_vecx_addr_t
#define bustype_CAVM_CDEX_VFX_MSIX_VECX_ADDR(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VFX_MSIX_VECX_ADDR(a,b,c) "CDEX_VFX_MSIX_VECX_ADDR"
#define device_bar_CAVM_CDEX_VFX_MSIX_VECX_ADDR(a,b,c) 0x4 /* VF_BAR4 */
#define busnum_CAVM_CDEX_VFX_MSIX_VECX_ADDR(a,b,c) (a)
#define arguments_CAVM_CDEX_VFX_MSIX_VECX_ADDR(a,b,c) (a),(b),(c),-1
 ...
 * This register is the MSI-X vector table, indexed by the CDE_VF_INT_VEC_E enumeration.
 */
union cavm_cdex_vfx_msix_vecx_ctl
{
    uint64_t u;
    struct cavm_cdex_vfx_msix_vecx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_33_63        : 31;
        uint64_t mask                  : 1;  /**< [ 32: 32](R/W) When set, no MSI-X interrupts are sent to this vector. */
    ...
    /* struct cavm_cdex_vfx_msix_vecx_ctl_s cn; */
};
typedef union cavm_cdex_vfx_msix_vecx_ctl cavm_cdex_vfx_msix_vecx_ctl_t;

static inline uint64_t CAVM_CDEX_VFX_MSIX_VECX_CTL(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VFX_MSIX_VECX_CTL(unsigned long a, unsigned long b, unsigned long c)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15) && (c<=1)))
    ...
    __cavm_csr_fatal("CDEX_VFX_MSIX_VECX_CTL", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VFX_MSIX_VECX_CTL(a,b,c) cavm_cdex_vfx_msix_vecx_ctl_t
#define bustype_CAVM_CDEX_VFX_MSIX_VECX_CTL(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VFX_MSIX_VECX_CTL(a,b,c) "CDEX_VFX_MSIX_VECX_CTL"
#define device_bar_CAVM_CDEX_VFX_MSIX_VECX_CTL(a,b,c) 0x4 /* VF_BAR4 */
#define busnum_CAVM_CDEX_VFX_MSIX_VECX_CTL(a,b,c) (a)
#define arguments_CAVM_CDEX_VFX_MSIX_VECX_CTL(a,b,c) (a),(b),(c),-1
 ...
 */
union cavm_cdex_vfx_pf_mboxx
{
    uint64_t u;
    struct cavm_cdex_vfx_pf_mboxx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_vfx_pf_mboxx_s cn; */
};
typedef union cavm_cdex_vfx_pf_mboxx cavm_cdex_vfx_pf_mboxx_t;

static inline uint64_t CAVM_CDEX_VFX_PF_MBOXX(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VFX_PF_MBOXX(unsigned long a, unsigned long b, unsigned long c)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15) && (c<=1)))
    ...
    __cavm_csr_fatal("CDEX_VFX_PF_MBOXX", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VFX_PF_MBOXX(a,b,c) cavm_cdex_vfx_pf_mboxx_t
#define bustype_CAVM_CDEX_VFX_PF_MBOXX(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VFX_PF_MBOXX(a,b,c) "CDEX_VFX_PF_MBOXX"
#define device_bar_CAVM_CDEX_VFX_PF_MBOXX(a,b,c) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VFX_PF_MBOXX(a,b,c) (a)
#define arguments_CAVM_CDEX_VFX_PF_MBOXX(a,b,c) (a),(b),(c),-1
 ...
 */
union cavm_cdex_vqx_ctl
{
    uint64_t u;
    struct cavm_cdex_vqx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_cdex_vqx_ctl_s cn; */
};
typedef union cavm_cdex_vqx_ctl cavm_cdex_vqx_ctl_t;

static inline uint64_t CAVM_CDEX_VQX_CTL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_CTL(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_CTL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_CTL(a,b) cavm_cdex_vqx_ctl_t
#define bustype_CAVM_CDEX_VQX_CTL(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_CTL(a,b) "CDEX_VQX_CTL"
#define device_bar_CAVM_CDEX_VQX_CTL(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_CTL(a,b) (a)
#define arguments_CAVM_CDEX_VQX_CTL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_vqx_done
{
    uint64_t u;
    struct cavm_cdex_vqx_done_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_vqx_done_s cn; */
};
typedef union cavm_cdex_vqx_done cavm_cdex_vqx_done_t;

static inline uint64_t CAVM_CDEX_VQX_DONE(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_DONE(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_DONE", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_DONE(a,b) cavm_cdex_vqx_done_t
#define bustype_CAVM_CDEX_VQX_DONE(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_DONE(a,b) "CDEX_VQX_DONE"
#define device_bar_CAVM_CDEX_VQX_DONE(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_DONE(a,b) (a)
#define arguments_CAVM_CDEX_VQX_DONE(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_vqx_done_ack
{
    uint64_t u;
    struct cavm_cdex_vqx_done_ack_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_cdex_vqx_done_ack_s cn; */
};
typedef union cavm_cdex_vqx_done_ack cavm_cdex_vqx_done_ack_t;

static inline uint64_t CAVM_CDEX_VQX_DONE_ACK(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_DONE_ACK(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_DONE_ACK", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_DONE_ACK(a,b) cavm_cdex_vqx_done_ack_t
#define bustype_CAVM_CDEX_VQX_DONE_ACK(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_DONE_ACK(a,b) "CDEX_VQX_DONE_ACK"
#define device_bar_CAVM_CDEX_VQX_DONE_ACK(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_DONE_ACK(a,b) (a)
#define arguments_CAVM_CDEX_VQX_DONE_ACK(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_vqx_done_ena_w1c
{
    uint64_t u;
    struct cavm_cdex_vqx_done_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_cdex_vqx_done_ena_w1c_s cn; */
};
typedef union cavm_cdex_vqx_done_ena_w1c cavm_cdex_vqx_done_ena_w1c_t;

static inline uint64_t CAVM_CDEX_VQX_DONE_ENA_W1C(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_DONE_ENA_W1C(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_DONE_ENA_W1C", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_DONE_ENA_W1C(a,b) cavm_cdex_vqx_done_ena_w1c_t
#define bustype_CAVM_CDEX_VQX_DONE_ENA_W1C(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_DONE_ENA_W1C(a,b) "CDEX_VQX_DONE_ENA_W1C"
#define device_bar_CAVM_CDEX_VQX_DONE_ENA_W1C(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_DONE_ENA_W1C(a,b) (a)
#define arguments_CAVM_CDEX_VQX_DONE_ENA_W1C(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_vqx_done_ena_w1s
{
    uint64_t u;
    struct cavm_cdex_vqx_done_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_cdex_vqx_done_ena_w1s_s cn; */
};
typedef union cavm_cdex_vqx_done_ena_w1s cavm_cdex_vqx_done_ena_w1s_t;

static inline uint64_t CAVM_CDEX_VQX_DONE_ENA_W1S(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_DONE_ENA_W1S(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_DONE_ENA_W1S", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_DONE_ENA_W1S(a,b) cavm_cdex_vqx_done_ena_w1s_t
#define bustype_CAVM_CDEX_VQX_DONE_ENA_W1S(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_DONE_ENA_W1S(a,b) "CDEX_VQX_DONE_ENA_W1S"
#define device_bar_CAVM_CDEX_VQX_DONE_ENA_W1S(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_DONE_ENA_W1S(a,b) (a)
#define arguments_CAVM_CDEX_VQX_DONE_ENA_W1S(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_vqx_done_int_w1c
{
    uint64_t u;
    struct cavm_cdex_vqx_done_int_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_cdex_vqx_done_int_w1c_s cn; */
};
typedef union cavm_cdex_vqx_done_int_w1c cavm_cdex_vqx_done_int_w1c_t;

static inline uint64_t CAVM_CDEX_VQX_DONE_INT_W1C(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_DONE_INT_W1C(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_DONE_INT_W1C", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_DONE_INT_W1C(a,b) cavm_cdex_vqx_done_int_w1c_t
#define bustype_CAVM_CDEX_VQX_DONE_INT_W1C(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_DONE_INT_W1C(a,b) "CDEX_VQX_DONE_INT_W1C"
#define device_bar_CAVM_CDEX_VQX_DONE_INT_W1C(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_DONE_INT_W1C(a,b) (a)
#define arguments_CAVM_CDEX_VQX_DONE_INT_W1C(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_vqx_done_int_w1s
{
    uint64_t u;
    struct cavm_cdex_vqx_done_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
        uint64_t done                  : 1;  /**< [  0:  0](RO/H) Done interrupt. See CDE()_VQ()_DONE[DONE].  Note this bit is read-only, to acknowledge
    ...
    /* struct cavm_cdex_vqx_done_int_w1s_s cn; */
};
typedef union cavm_cdex_vqx_done_int_w1s cavm_cdex_vqx_done_int_w1s_t;

static inline uint64_t CAVM_CDEX_VQX_DONE_INT_W1S(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_DONE_INT_W1S(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_DONE_INT_W1S", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_DONE_INT_W1S(a,b) cavm_cdex_vqx_done_int_w1s_t
#define bustype_CAVM_CDEX_VQX_DONE_INT_W1S(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_DONE_INT_W1S(a,b) "CDEX_VQX_DONE_INT_W1S"
#define device_bar_CAVM_CDEX_VQX_DONE_INT_W1S(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_DONE_INT_W1S(a,b) (a)
#define arguments_CAVM_CDEX_VQX_DONE_INT_W1S(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_vqx_done_wait
{
    uint64_t u;
    struct cavm_cdex_vqx_done_wait_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_vqx_done_wait_s cn; */
};
typedef union cavm_cdex_vqx_done_wait cavm_cdex_vqx_done_wait_t;

static inline uint64_t CAVM_CDEX_VQX_DONE_WAIT(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_DONE_WAIT(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_DONE_WAIT", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_DONE_WAIT(a,b) cavm_cdex_vqx_done_wait_t
#define bustype_CAVM_CDEX_VQX_DONE_WAIT(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_DONE_WAIT(a,b) "CDEX_VQX_DONE_WAIT"
#define device_bar_CAVM_CDEX_VQX_DONE_WAIT(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_DONE_WAIT(a,b) (a)
#define arguments_CAVM_CDEX_VQX_DONE_WAIT(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_vqx_doorbell
{
    uint64_t u;
    struct cavm_cdex_vqx_doorbell_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_cdex_vqx_doorbell_s cn; */
};
typedef union cavm_cdex_vqx_doorbell cavm_cdex_vqx_doorbell_t;

static inline uint64_t CAVM_CDEX_VQX_DOORBELL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_DOORBELL(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_DOORBELL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_DOORBELL(a,b) cavm_cdex_vqx_doorbell_t
#define bustype_CAVM_CDEX_VQX_DOORBELL(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_DOORBELL(a,b) "CDEX_VQX_DOORBELL"
#define device_bar_CAVM_CDEX_VQX_DOORBELL(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_DOORBELL(a,b) (a)
#define arguments_CAVM_CDEX_VQX_DOORBELL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_vqx_inprog
{
    uint64_t u;
    struct cavm_cdex_vqx_inprog_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_vqx_inprog_s cn; */
};
typedef union cavm_cdex_vqx_inprog cavm_cdex_vqx_inprog_t;

static inline uint64_t CAVM_CDEX_VQX_INPROG(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_INPROG(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_INPROG", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_INPROG(a,b) cavm_cdex_vqx_inprog_t
#define bustype_CAVM_CDEX_VQX_INPROG(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_INPROG(a,b) "CDEX_VQX_INPROG"
#define device_bar_CAVM_CDEX_VQX_INPROG(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_INPROG(a,b) (a)
#define arguments_CAVM_CDEX_VQX_INPROG(a,b) (a),(b),-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_cdex_vqx_misc_ena_w1c
{
    uint64_t u;
    struct cavm_cdex_vqx_misc_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_cdex_vqx_misc_ena_w1c_s cn8; */
    struct cavm_cdex_vqx_misc_ena_w1c_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    struct cavm_cdex_vqx_misc_ena_w1c_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
        uint64_t fault                 : 1;  /**< [  6:  6](R/W1C/H) Reads or clears enable for CDE(0)_VQ(0..63)_MISC_INT[FAULT]. */
...
typedef union cavm_cdex_vqx_misc_ena_w1c cavm_cdex_vqx_misc_ena_w1c_t;

static inline uint64_t CAVM_CDEX_VQX_MISC_ENA_W1C(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_MISC_ENA_W1C(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_MISC_ENA_W1C", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_MISC_ENA_W1C(a,b) cavm_cdex_vqx_misc_ena_w1c_t
#define bustype_CAVM_CDEX_VQX_MISC_ENA_W1C(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_MISC_ENA_W1C(a,b) "CDEX_VQX_MISC_ENA_W1C"
#define device_bar_CAVM_CDEX_VQX_MISC_ENA_W1C(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_MISC_ENA_W1C(a,b) (a)
#define arguments_CAVM_CDEX_VQX_MISC_ENA_W1C(a,b) (a),(b),-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_cdex_vqx_misc_ena_w1s
{
    uint64_t u;
    struct cavm_cdex_vqx_misc_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct cavm_cdex_vqx_misc_ena_w1s_s cn8; */
    struct cavm_cdex_vqx_misc_ena_w1s_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
        uint64_t swerr                 : 1;  /**< [  4:  4](R/W1S/H) Reads or sets enable for CDE(0)_VQ(0..15)_MISC_INT[SWERR]. */
    ...
    struct cavm_cdex_vqx_misc_ena_w1s_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
        uint64_t fault                 : 1;  /**< [  6:  6](R/W1S/H) Reads or sets enable for CDE(0)_VQ(0..63)_MISC_INT[FAULT]. */
...
typedef union cavm_cdex_vqx_misc_ena_w1s cavm_cdex_vqx_misc_ena_w1s_t;

static inline uint64_t CAVM_CDEX_VQX_MISC_ENA_W1S(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_MISC_ENA_W1S(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_MISC_ENA_W1S", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_MISC_ENA_W1S(a,b) cavm_cdex_vqx_misc_ena_w1s_t
#define bustype_CAVM_CDEX_VQX_MISC_ENA_W1S(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_MISC_ENA_W1S(a,b) "CDEX_VQX_MISC_ENA_W1S"
#define device_bar_CAVM_CDEX_VQX_MISC_ENA_W1S(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_MISC_ENA_W1S(a,b) (a)
#define arguments_CAVM_CDEX_VQX_MISC_ENA_W1S(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_vqx_misc_int
{
    uint64_t u;
    struct cavm_cdex_vqx_misc_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct cavm_cdex_vqx_misc_int_s cn8; */
    struct cavm_cdex_vqx_misc_int_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
        uint64_t swerr                 : 1;  /**< [  4:  4](R/W1C/H) Software error from engines. */
    ...
    /* struct cavm_cdex_vqx_misc_int_s cn83xx; */
};
typedef union cavm_cdex_vqx_misc_int cavm_cdex_vqx_misc_int_t;

static inline uint64_t CAVM_CDEX_VQX_MISC_INT(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_MISC_INT(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_MISC_INT", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_MISC_INT(a,b) cavm_cdex_vqx_misc_int_t
#define bustype_CAVM_CDEX_VQX_MISC_INT(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_MISC_INT(a,b) "CDEX_VQX_MISC_INT"
#define device_bar_CAVM_CDEX_VQX_MISC_INT(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_MISC_INT(a,b) (a)
#define arguments_CAVM_CDEX_VQX_MISC_INT(a,b) (a),(b),-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_cdex_vqx_misc_int_w1s
{
    uint64_t u;
    struct cavm_cdex_vqx_misc_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct cavm_cdex_vqx_misc_int_w1s_s cn8; */
    struct cavm_cdex_vqx_misc_int_w1s_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
        uint64_t swerr                 : 1;  /**< [  4:  4](R/W1S/H) Reads or sets CDE(0)_VQ(0..15)_MISC_INT[SWERR]. */
    ...
    struct cavm_cdex_vqx_misc_int_w1s_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
        uint64_t fault                 : 1;  /**< [  6:  6](R/W1S/H) Reads or sets CDE(0)_VQ(0..63)_MISC_INT[FAULT]. */
...
typedef union cavm_cdex_vqx_misc_int_w1s cavm_cdex_vqx_misc_int_w1s_t;

static inline uint64_t CAVM_CDEX_VQX_MISC_INT_W1S(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_MISC_INT_W1S(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_MISC_INT_W1S", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_MISC_INT_W1S(a,b) cavm_cdex_vqx_misc_int_w1s_t
#define bustype_CAVM_CDEX_VQX_MISC_INT_W1S(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_MISC_INT_W1S(a,b) "CDEX_VQX_MISC_INT_W1S"
#define device_bar_CAVM_CDEX_VQX_MISC_INT_W1S(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_MISC_INT_W1S(a,b) (a)
#define arguments_CAVM_CDEX_VQX_MISC_INT_W1S(a,b) (a),(b),-1,-1
 ...
 */
union cavm_cdex_vqx_saddr
{
    uint64_t u;
    struct cavm_cdex_vqx_saddr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
    ...
    /* struct cavm_cdex_vqx_saddr_s cn; */
};
typedef union cavm_cdex_vqx_saddr cavm_cdex_vqx_saddr_t;

static inline uint64_t CAVM_CDEX_VQX_SADDR(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_CDEX_VQX_SADDR(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b<=15)))
    ...
    __cavm_csr_fatal("CDEX_VQX_SADDR", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_CDEX_VQX_SADDR(a,b) cavm_cdex_vqx_saddr_t
#define bustype_CAVM_CDEX_VQX_SADDR(a,b) CSR_TYPE_NCB
#define basename_CAVM_CDEX_VQX_SADDR(a,b) "CDEX_VQX_SADDR"
#define device_bar_CAVM_CDEX_VQX_SADDR(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_CDEX_VQX_SADDR(a,b) (a)
#define arguments_CAVM_CDEX_VQX_SADDR(a,b) (a),(b),-1,-1

#endif /* __CAVM_CSRS_CDE_H__ */
