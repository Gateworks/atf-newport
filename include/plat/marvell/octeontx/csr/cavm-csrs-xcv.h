#ifndef __CAVM_CSRS_XCV_H__
#define __CAVM_CSRS_XCV_H__
 ...
 */
#define CAVM_XCV_BAR_E_XCVX_PF_BAR0(a) (0x87e0db000000ll + 0ll * (a))
#define CAVM_XCV_BAR_E_XCVX_PF_BAR0_SIZE 0x100000ull
#define CAVM_XCV_BAR_E_XCVX_PF_BAR4(a) (0x87e0dbf00000ll + 0ll * (a))
#define CAVM_XCV_BAR_E_XCVX_PF_BAR4_SIZE 0x100000ull
 ...
 */
#define CAVM_XCV_INT_VEC_E_INT (0)
...
static inline uint64_t CAVM_XCVX_BATCH_CRD_RET(unsigned long a)
{
    ...
    __cavm_csr_fatal("XCVX_BATCH_CRD_RET", 1, a, 0, 0, 0, 0, 0);
}
 ...
 */
union cavm_xcvx_comp_ctl
{
    uint64_t u;
    struct cavm_xcvx_comp_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_xcvx_comp_ctl_s cn; */
};
typedef union cavm_xcvx_comp_ctl cavm_xcvx_comp_ctl_t;

static inline uint64_t CAVM_XCVX_COMP_CTL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_XCVX_COMP_CTL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && (a==0))
        return 0x87e0db000020ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("XCVX_COMP_CTL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_XCVX_COMP_CTL(a) cavm_xcvx_comp_ctl_t
#define bustype_CAVM_XCVX_COMP_CTL(a) CSR_TYPE_RSL
#define basename_CAVM_XCVX_COMP_CTL(a) "XCVX_COMP_CTL"
#define device_bar_CAVM_XCVX_COMP_CTL(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_XCVX_COMP_CTL(a) (a)
#define arguments_CAVM_XCVX_COMP_CTL(a) (a),-1,-1,-1
...
static inline uint64_t CAVM_XCVX_CTL(unsigned long a)
{
    ...
    __cavm_csr_fatal("XCVX_CTL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_XCVX_CTL(a) cavm_xcvx_ctl_t
#define bustype_CAVM_XCVX_CTL(a) CSR_TYPE_RSL
#define basename_CAVM_XCVX_CTL(a) "XCVX_CTL"
#define device_bar_CAVM_XCVX_CTL(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_XCVX_CTL(a) (a)
#define arguments_CAVM_XCVX_CTL(a) (a),-1,-1,-1
...
static inline uint64_t CAVM_XCVX_DLL_CTL(unsigned long a)
{
    ...
    __cavm_csr_fatal("XCVX_DLL_CTL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_XCVX_DLL_CTL(a) cavm_xcvx_dll_ctl_t
#define bustype_CAVM_XCVX_DLL_CTL(a) CSR_TYPE_RSL
#define basename_CAVM_XCVX_DLL_CTL(a) "XCVX_DLL_CTL"
...
static inline uint64_t CAVM_XCVX_ECO(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_XCVX_ECO(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && (a==0))
 ...
 */
union cavm_xcvx_inbnd_status
{
    uint64_t u;
    struct cavm_xcvx_inbnd_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
    ...
    /* struct cavm_xcvx_inbnd_status_s cn; */
};
typedef union cavm_xcvx_inbnd_status cavm_xcvx_inbnd_status_t;

static inline uint64_t CAVM_XCVX_INBND_STATUS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_XCVX_INBND_STATUS(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && (a==0))
        return 0x87e0db000080ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("XCVX_INBND_STATUS", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_XCVX_INBND_STATUS(a) cavm_xcvx_inbnd_status_t
#define bustype_CAVM_XCVX_INBND_STATUS(a) CSR_TYPE_RSL
#define basename_CAVM_XCVX_INBND_STATUS(a) "XCVX_INBND_STATUS"
#define device_bar_CAVM_XCVX_INBND_STATUS(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_XCVX_INBND_STATUS(a) (a)
#define arguments_CAVM_XCVX_INBND_STATUS(a) (a),-1,-1,-1
...
union cavm_xcvx_int
{
    ...
    /* struct cavm_xcvx_int_s cn; */
};
typedef union cavm_xcvx_int cavm_xcvx_int_t;

static inline uint64_t CAVM_XCVX_INT(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_XCVX_INT(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && (a==0))
        return 0x87e0db000040ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("XCVX_INT", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_XCVX_INT(a) cavm_xcvx_int_t
#define bustype_CAVM_XCVX_INT(a) CSR_TYPE_RSL
#define basename_CAVM_XCVX_INT(a) "XCVX_INT"
#define device_bar_CAVM_XCVX_INT(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_XCVX_INT(a) (a)
#define arguments_CAVM_XCVX_INT(a) (a),-1,-1,-1
 ...
 */
union cavm_xcvx_int_ena_w1c
{
    uint64_t u;
    struct cavm_xcvx_int_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct cavm_xcvx_int_ena_w1c_s cn; */
};
typedef union cavm_xcvx_int_ena_w1c cavm_xcvx_int_ena_w1c_t;

static inline uint64_t CAVM_XCVX_INT_ENA_W1C(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_XCVX_INT_ENA_W1C(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && (a==0))
        return 0x87e0db000050ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("XCVX_INT_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_XCVX_INT_ENA_W1C(a) cavm_xcvx_int_ena_w1c_t
#define bustype_CAVM_XCVX_INT_ENA_W1C(a) CSR_TYPE_RSL
#define basename_CAVM_XCVX_INT_ENA_W1C(a) "XCVX_INT_ENA_W1C"
#define device_bar_CAVM_XCVX_INT_ENA_W1C(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_XCVX_INT_ENA_W1C(a) (a)
#define arguments_CAVM_XCVX_INT_ENA_W1C(a) (a),-1,-1,-1
 ...
 */
union cavm_xcvx_int_ena_w1s
{
    uint64_t u;
    struct cavm_xcvx_int_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct cavm_xcvx_int_ena_w1s_s cn; */
};
typedef union cavm_xcvx_int_ena_w1s cavm_xcvx_int_ena_w1s_t;

static inline uint64_t CAVM_XCVX_INT_ENA_W1S(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_XCVX_INT_ENA_W1S(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && (a==0))
        return 0x87e0db000058ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("XCVX_INT_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_XCVX_INT_ENA_W1S(a) cavm_xcvx_int_ena_w1s_t
#define bustype_CAVM_XCVX_INT_ENA_W1S(a) CSR_TYPE_RSL
#define basename_CAVM_XCVX_INT_ENA_W1S(a) "XCVX_INT_ENA_W1S"
#define device_bar_CAVM_XCVX_INT_ENA_W1S(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_XCVX_INT_ENA_W1S(a) (a)
#define arguments_CAVM_XCVX_INT_ENA_W1S(a) (a),-1,-1,-1
 ...
 */
union cavm_xcvx_int_w1s
{
    uint64_t u;
    struct cavm_xcvx_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct cavm_xcvx_int_w1s_s cn; */
};
typedef union cavm_xcvx_int_w1s cavm_xcvx_int_w1s_t;

static inline uint64_t CAVM_XCVX_INT_W1S(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_XCVX_INT_W1S(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && (a==0))
        return 0x87e0db000048ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("XCVX_INT_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_XCVX_INT_W1S(a) cavm_xcvx_int_w1s_t
#define bustype_CAVM_XCVX_INT_W1S(a) CSR_TYPE_RSL
#define basename_CAVM_XCVX_INT_W1S(a) "XCVX_INT_W1S"
#define device_bar_CAVM_XCVX_INT_W1S(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_XCVX_INT_W1S(a) (a)
#define arguments_CAVM_XCVX_INT_W1S(a) (a),-1,-1,-1
 ...
 */
union cavm_xcvx_msix_pbax
{
    uint64_t u;
    struct cavm_xcvx_msix_pbax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_xcvx_msix_pbax_s cn; */
};
typedef union cavm_xcvx_msix_pbax cavm_xcvx_msix_pbax_t;

static inline uint64_t CAVM_XCVX_MSIX_PBAX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_XCVX_MSIX_PBAX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b==0)))
        return 0x87e0dbff0000ll + 0ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __cavm_csr_fatal("XCVX_MSIX_PBAX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_XCVX_MSIX_PBAX(a,b) cavm_xcvx_msix_pbax_t
#define bustype_CAVM_XCVX_MSIX_PBAX(a,b) CSR_TYPE_RSL
#define basename_CAVM_XCVX_MSIX_PBAX(a,b) "XCVX_MSIX_PBAX"
#define device_bar_CAVM_XCVX_MSIX_PBAX(a,b) 0x4 /* PF_BAR4 */
#define busnum_CAVM_XCVX_MSIX_PBAX(a,b) (a)
#define arguments_CAVM_XCVX_MSIX_PBAX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_xcvx_msix_vecx_addr
{
    uint64_t u;
    struct cavm_xcvx_msix_vecx_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_xcvx_msix_vecx_addr_s cn; */
};
typedef union cavm_xcvx_msix_vecx_addr cavm_xcvx_msix_vecx_addr_t;

static inline uint64_t CAVM_XCVX_MSIX_VECX_ADDR(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_XCVX_MSIX_VECX_ADDR(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b==0)))
        return 0x87e0dbf00000ll + 0ll * ((a) & 0x0) + 0x10ll * ((b) & 0x0);
    __cavm_csr_fatal("XCVX_MSIX_VECX_ADDR", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_XCVX_MSIX_VECX_ADDR(a,b) cavm_xcvx_msix_vecx_addr_t
#define bustype_CAVM_XCVX_MSIX_VECX_ADDR(a,b) CSR_TYPE_RSL
#define basename_CAVM_XCVX_MSIX_VECX_ADDR(a,b) "XCVX_MSIX_VECX_ADDR"
#define device_bar_CAVM_XCVX_MSIX_VECX_ADDR(a,b) 0x4 /* PF_BAR4 */
#define busnum_CAVM_XCVX_MSIX_VECX_ADDR(a,b) (a)
#define arguments_CAVM_XCVX_MSIX_VECX_ADDR(a,b) (a),(b),-1,-1
 ...
 * This register is the MSI-X vector table, indexed by the XCV_INT_VEC_E enumeration.
 */
union cavm_xcvx_msix_vecx_ctl
{
    uint64_t u;
    struct cavm_xcvx_msix_vecx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_xcvx_msix_vecx_ctl_s cn; */
};
typedef union cavm_xcvx_msix_vecx_ctl cavm_xcvx_msix_vecx_ctl_t;

static inline uint64_t CAVM_XCVX_MSIX_VECX_CTL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_XCVX_MSIX_VECX_CTL(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a==0) && (b==0)))
        return 0x87e0dbf00008ll + 0ll * ((a) & 0x0) + 0x10ll * ((b) & 0x0);
    __cavm_csr_fatal("XCVX_MSIX_VECX_CTL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_XCVX_MSIX_VECX_CTL(a,b) cavm_xcvx_msix_vecx_ctl_t
#define bustype_CAVM_XCVX_MSIX_VECX_CTL(a,b) CSR_TYPE_RSL
#define basename_CAVM_XCVX_MSIX_VECX_CTL(a,b) "XCVX_MSIX_VECX_CTL"
#define device_bar_CAVM_XCVX_MSIX_VECX_CTL(a,b) 0x4 /* PF_BAR4 */
#define busnum_CAVM_XCVX_MSIX_VECX_CTL(a,b) (a)
#define arguments_CAVM_XCVX_MSIX_VECX_CTL(a,b) (a),(b),-1,-1
...
static inline uint64_t CAVM_XCVX_RESET(unsigned long a)
{
    ...
    __cavm_csr_fatal("XCVX_RESET", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_XCVX_RESET(a) cavm_xcvx_reset_t
#define bustype_CAVM_XCVX_RESET(a) CSR_TYPE_RSL
#define basename_CAVM_XCVX_RESET(a) "XCVX_RESET"
#define device_bar_CAVM_XCVX_RESET(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_XCVX_RESET(a) (a)
#define arguments_CAVM_XCVX_RESET(a) (a),-1,-1,-1

#endif /* __CAVM_CSRS_XCV_H__ */
