#ifndef __CAVM_CSRS_DAB_ETR_H__
#define __CAVM_CSRS_DAB_ETR_H__
 ...
 * Read only register
 */
union cavm_etrx_authstatus
{
    uint32_t u;
    struct cavm_etrx_authstatus_s
    {
    ...
    /* struct cavm_etrx_authstatus_s cn; */
};
typedef union cavm_etrx_authstatus cavm_etrx_authstatus_t;

static inline uint64_t CAVM_ETRX_AUTHSTATUS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_AUTHSTATUS(unsigned long a)
{
    ...
    __cavm_csr_fatal("ETRX_AUTHSTATUS", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_AUTHSTATUS(a) cavm_etrx_authstatus_t
#define bustype_CAVM_ETRX_AUTHSTATUS(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_AUTHSTATUS(a) "ETRX_AUTHSTATUS"
#define busnum_CAVM_ETRX_AUTHSTATUS(a) (a)
#define arguments_CAVM_ETRX_AUTHSTATUS(a) (a),-1,-1,-1
 ...
 * attributes.
 */
union cavm_etrx_busctl
{
    uint32_t u;
    struct cavm_etrx_busctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_busctl_s cn; */
};
typedef union cavm_etrx_busctl cavm_etrx_busctl_t;

static inline uint64_t CAVM_ETRX_BUSCTL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_BUSCTL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040110ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040110ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_BUSCTL", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_BUSCTL(a) cavm_etrx_busctl_t
#define bustype_CAVM_ETRX_BUSCTL(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_BUSCTL(a) "ETRX_BUSCTL"
#define busnum_CAVM_ETRX_BUSCTL(a) (a)
#define arguments_CAVM_ETRX_BUSCTL(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_cidr0
{
    uint32_t u;
    struct cavm_etrx_cidr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_cidr0_s cn; */
};
typedef union cavm_etrx_cidr0 cavm_etrx_cidr0_t;

static inline uint64_t CAVM_ETRX_CIDR0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_CIDR0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040ff0ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040ff0ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_CIDR0", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_CIDR0(a) cavm_etrx_cidr0_t
#define bustype_CAVM_ETRX_CIDR0(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_CIDR0(a) "ETRX_CIDR0"
#define busnum_CAVM_ETRX_CIDR0(a) (a)
#define arguments_CAVM_ETRX_CIDR0(a) (a),-1,-1,-1
 ...
 * This register provides information to identify a debug component.
 */
union cavm_etrx_cidr1
{
    uint32_t u;
    struct cavm_etrx_cidr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_cidr1_s cn; */
};
typedef union cavm_etrx_cidr1 cavm_etrx_cidr1_t;

static inline uint64_t CAVM_ETRX_CIDR1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_CIDR1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040ff4ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040ff4ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_CIDR1", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_CIDR1(a) cavm_etrx_cidr1_t
#define bustype_CAVM_ETRX_CIDR1(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_CIDR1(a) "ETRX_CIDR1"
#define busnum_CAVM_ETRX_CIDR1(a) (a)
#define arguments_CAVM_ETRX_CIDR1(a) (a),-1,-1,-1
 ...
 * This register provides information to identify a debug component.
 */
union cavm_etrx_cidr2
{
    uint32_t u;
    struct cavm_etrx_cidr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_cidr2_s cn; */
};
typedef union cavm_etrx_cidr2 cavm_etrx_cidr2_t;

static inline uint64_t CAVM_ETRX_CIDR2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_CIDR2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040ff8ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040ff8ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_CIDR2", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_CIDR2(a) cavm_etrx_cidr2_t
#define bustype_CAVM_ETRX_CIDR2(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_CIDR2(a) "ETRX_CIDR2"
#define busnum_CAVM_ETRX_CIDR2(a) (a)
#define arguments_CAVM_ETRX_CIDR2(a) (a),-1,-1,-1
 ...
 * This register provides information to identify a debug component.
 */
union cavm_etrx_cidr3
{
    uint32_t u;
    struct cavm_etrx_cidr3_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_cidr3_s cn; */
};
typedef union cavm_etrx_cidr3 cavm_etrx_cidr3_t;

static inline uint64_t CAVM_ETRX_CIDR3(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_CIDR3(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040ffcll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040ffcll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_CIDR3", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_CIDR3(a) cavm_etrx_cidr3_t
#define bustype_CAVM_ETRX_CIDR3(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_CIDR3(a) "ETRX_CIDR3"
#define busnum_CAVM_ETRX_CIDR3(a) (a)
#define arguments_CAVM_ETRX_CIDR3(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_claimclr
{
    uint32_t u;
    struct cavm_etrx_claimclr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_claimclr_s cn; */
};
typedef union cavm_etrx_claimclr cavm_etrx_claimclr_t;

static inline uint64_t CAVM_ETRX_CLAIMCLR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_CLAIMCLR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fa4ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fa4ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_CLAIMCLR", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_CLAIMCLR(a) cavm_etrx_claimclr_t
#define bustype_CAVM_ETRX_CLAIMCLR(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_CLAIMCLR(a) "ETRX_CLAIMCLR"
#define busnum_CAVM_ETRX_CLAIMCLR(a) (a)
#define arguments_CAVM_ETRX_CLAIMCLR(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_control
{
    uint32_t u;
    struct cavm_etrx_control_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_control_s cn; */
};
typedef union cavm_etrx_control cavm_etrx_control_t;

static inline uint64_t CAVM_ETRX_CONTROL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_CONTROL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040020ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040020ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_CONTROL", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_CONTROL(a) cavm_etrx_control_t
#define bustype_CAVM_ETRX_CONTROL(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_CONTROL(a) "ETRX_CONTROL"
#define busnum_CAVM_ETRX_CONTROL(a) (a)
#define arguments_CAVM_ETRX_CONTROL(a) (a),-1,-1,-1
...
union cavm_etrx_dba
{
    ...
    /* struct cavm_etrx_dba_s cn; */
};
typedef union cavm_etrx_dba cavm_etrx_dba_t;

static inline uint64_t CAVM_ETRX_DBA(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_DBA(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040118ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040118ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_DBA", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_DBA(a) cavm_etrx_dba_t
#define bustype_CAVM_ETRX_DBA(a) CSR_TYPE_DAB
#define basename_CAVM_ETRX_DBA(a) "ETRX_DBA"
#define busnum_CAVM_ETRX_DBA(a) (a)
#define arguments_CAVM_ETRX_DBA(a) (a),-1,-1,-1
 ...
 *     ETR component.
 */
union cavm_etrx_devarch
{
    uint32_t u;
    struct cavm_etrx_devarch_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_devarch_s cn; */
};
typedef union cavm_etrx_devarch cavm_etrx_devarch_t;

static inline uint64_t CAVM_ETRX_DEVARCH(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_DEVARCH(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fbcll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fbcll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_DEVARCH", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_DEVARCH(a) cavm_etrx_devarch_t
#define bustype_CAVM_ETRX_DEVARCH(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_DEVARCH(a) "ETRX_DEVARCH"
#define busnum_CAVM_ETRX_DEVARCH(a) (a)
#define arguments_CAVM_ETRX_DEVARCH(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_devid
{
    uint32_t u;
    struct cavm_etrx_devid_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_devid_s cn; */
};
typedef union cavm_etrx_devid cavm_etrx_devid_t;

static inline uint64_t CAVM_ETRX_DEVID(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_DEVID(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fc8ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fc8ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_DEVID", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_DEVID(a) cavm_etrx_devid_t
#define bustype_CAVM_ETRX_DEVID(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_DEVID(a) "ETRX_DEVID"
#define busnum_CAVM_ETRX_DEVID(a) (a)
#define arguments_CAVM_ETRX_DEVID(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_devtype
{
    uint32_t u;
    struct cavm_etrx_devtype_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_devtype_s cn; */
};
typedef union cavm_etrx_devtype cavm_etrx_devtype_t;

static inline uint64_t CAVM_ETRX_DEVTYPE(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_DEVTYPE(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fccll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fccll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_DEVTYPE", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_DEVTYPE(a) cavm_etrx_devtype_t
#define bustype_CAVM_ETRX_DEVTYPE(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_DEVTYPE(a) "ETRX_DEVTYPE"
#define busnum_CAVM_ETRX_DEVTYPE(a) (a)
#define arguments_CAVM_ETRX_DEVTYPE(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_ffcr
{
    uint32_t u;
    struct cavm_etrx_ffcr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_ffcr_s cn; */
};
typedef union cavm_etrx_ffcr cavm_etrx_ffcr_t;

static inline uint64_t CAVM_ETRX_FFCR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_FFCR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040304ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040304ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_FFCR", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_FFCR(a) cavm_etrx_ffcr_t
#define bustype_CAVM_ETRX_FFCR(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_FFCR(a) "ETRX_FFCR"
#define busnum_CAVM_ETRX_FFCR(a) (a)
#define arguments_CAVM_ETRX_FFCR(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_ffsr
{
    uint32_t u;
    struct cavm_etrx_ffsr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_ffsr_s cn; */
};
typedef union cavm_etrx_ffsr cavm_etrx_ffsr_t;

static inline uint64_t CAVM_ETRX_FFSR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_FFSR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040300ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040300ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_FFSR", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_FFSR(a) cavm_etrx_ffsr_t
#define bustype_CAVM_ETRX_FFSR(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_FFSR(a) "ETRX_FFSR"
#define busnum_CAVM_ETRX_FFSR(a) (a)
#define arguments_CAVM_ETRX_FFSR(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_irqcr0
{
    uint64_t u;
    struct cavm_etrx_irqcr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_irqcr0_s cn; */
};
typedef union cavm_etrx_irqcr0 cavm_etrx_irqcr0_t;

static inline uint64_t CAVM_ETRX_IRQCR0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_IRQCR0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040e80ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040e80ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_IRQCR0", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_IRQCR0(a) cavm_etrx_irqcr0_t
#define bustype_CAVM_ETRX_IRQCR0(a) CSR_TYPE_DAB
#define basename_CAVM_ETRX_IRQCR0(a) "ETRX_IRQCR0"
#define busnum_CAVM_ETRX_IRQCR0(a) (a)
#define arguments_CAVM_ETRX_IRQCR0(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_irqcr1
{
    uint32_t u;
    struct cavm_etrx_irqcr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_irqcr1_s cn; */
};
typedef union cavm_etrx_irqcr1 cavm_etrx_irqcr1_t;

static inline uint64_t CAVM_ETRX_IRQCR1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_IRQCR1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040e88ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040e88ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_IRQCR1", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_IRQCR1(a) cavm_etrx_irqcr1_t
#define bustype_CAVM_ETRX_IRQCR1(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_IRQCR1(a) "ETRX_IRQCR1"
#define busnum_CAVM_ETRX_IRQCR1(a) (a)
#define arguments_CAVM_ETRX_IRQCR1(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_irqcr2
{
    uint32_t u;
    struct cavm_etrx_irqcr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_irqcr2_s cn; */
};
typedef union cavm_etrx_irqcr2 cavm_etrx_irqcr2_t;

static inline uint64_t CAVM_ETRX_IRQCR2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_IRQCR2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040e8cll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040e8cll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_IRQCR2", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_IRQCR2(a) cavm_etrx_irqcr2_t
#define bustype_CAVM_ETRX_IRQCR2(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_IRQCR2(a) "ETRX_IRQCR2"
#define busnum_CAVM_ETRX_IRQCR2(a) (a)
#define arguments_CAVM_ETRX_IRQCR2(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_itctrl
{
    uint32_t u;
    struct cavm_etrx_itctrl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_1_31         : 31;
    ...
    /* struct cavm_etrx_itctrl_s cn; */
};
typedef union cavm_etrx_itctrl cavm_etrx_itctrl_t;

static inline uint64_t CAVM_ETRX_ITCTRL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_ITCTRL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040f00ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040f00ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_ITCTRL", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_ITCTRL(a) cavm_etrx_itctrl_t
#define bustype_CAVM_ETRX_ITCTRL(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_ITCTRL(a) "ETRX_ITCTRL"
#define busnum_CAVM_ETRX_ITCTRL(a) (a)
#define arguments_CAVM_ETRX_ITCTRL(a) (a),-1,-1,-1
...
union cavm_etrx_lar
{
    ...
    /* struct cavm_etrx_lar_s cn; */
};
typedef union cavm_etrx_lar cavm_etrx_lar_t;

static inline uint64_t CAVM_ETRX_LAR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_LAR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fb0ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fb0ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_LAR", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_LAR(a) cavm_etrx_lar_t
#define bustype_CAVM_ETRX_LAR(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_LAR(a) "ETRX_LAR"
#define busnum_CAVM_ETRX_LAR(a) (a)
#define arguments_CAVM_ETRX_LAR(a) (a),-1,-1,-1
...
union cavm_etrx_lsr
{
    ...
    /* struct cavm_etrx_lsr_s cn; */
};
typedef union cavm_etrx_lsr cavm_etrx_lsr_t;

static inline uint64_t CAVM_ETRX_LSR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_LSR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fb4ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fb4ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_LSR", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_LSR(a) cavm_etrx_lsr_t
#define bustype_CAVM_ETRX_LSR(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_LSR(a) "ETRX_LSR"
#define busnum_CAVM_ETRX_LSR(a) (a)
#define arguments_CAVM_ETRX_LSR(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_mode
{
    uint32_t u;
    struct cavm_etrx_mode_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_mode_s cn; */
};
typedef union cavm_etrx_mode cavm_etrx_mode_t;

static inline uint64_t CAVM_ETRX_MODE(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_MODE(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040028ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040028ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_MODE", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_MODE(a) cavm_etrx_mode_t
#define bustype_CAVM_ETRX_MODE(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_MODE(a) "ETRX_MODE"
#define busnum_CAVM_ETRX_MODE(a) (a)
#define arguments_CAVM_ETRX_MODE(a) (a),-1,-1,-1
 ...
 * This register provides information to identify a debug component.
 */
union cavm_etrx_pidr0
{
    uint32_t u;
    struct cavm_etrx_pidr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_pidr0_s cn; */
};
typedef union cavm_etrx_pidr0 cavm_etrx_pidr0_t;

static inline uint64_t CAVM_ETRX_PIDR0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_PIDR0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fe0ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fe0ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_PIDR0", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_PIDR0(a) cavm_etrx_pidr0_t
#define bustype_CAVM_ETRX_PIDR0(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_PIDR0(a) "ETRX_PIDR0"
#define busnum_CAVM_ETRX_PIDR0(a) (a)
#define arguments_CAVM_ETRX_PIDR0(a) (a),-1,-1,-1
 ...
 * This register provides information to identify a debug component.
 */
union cavm_etrx_pidr1
{
    uint32_t u;
    struct cavm_etrx_pidr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_pidr1_s cn; */
};
typedef union cavm_etrx_pidr1 cavm_etrx_pidr1_t;

static inline uint64_t CAVM_ETRX_PIDR1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_PIDR1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fe4ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fe4ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_PIDR1", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_PIDR1(a) cavm_etrx_pidr1_t
#define bustype_CAVM_ETRX_PIDR1(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_PIDR1(a) "ETRX_PIDR1"
#define busnum_CAVM_ETRX_PIDR1(a) (a)
#define arguments_CAVM_ETRX_PIDR1(a) (a),-1,-1,-1
 ...
 * This register provides information to identify a debug component.
 */
union cavm_etrx_pidr2
{
    uint32_t u;
    struct cavm_etrx_pidr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_pidr2_s cn96xx; */
    struct cavm_etrx_pidr2_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by Arm. */
...
typedef union cavm_etrx_pidr2 cavm_etrx_pidr2_t;

static inline uint64_t CAVM_ETRX_PIDR2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_PIDR2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fe8ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fe8ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_PIDR2", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_PIDR2(a) cavm_etrx_pidr2_t
#define bustype_CAVM_ETRX_PIDR2(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_PIDR2(a) "ETRX_PIDR2"
#define busnum_CAVM_ETRX_PIDR2(a) (a)
#define arguments_CAVM_ETRX_PIDR2(a) (a),-1,-1,-1
 ...
 * This register provides information to identify a debug component.
 */
union cavm_etrx_pidr3
{
    uint32_t u;
    struct cavm_etrx_pidr3_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_pidr3_s cn; */
};
typedef union cavm_etrx_pidr3 cavm_etrx_pidr3_t;

static inline uint64_t CAVM_ETRX_PIDR3(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_PIDR3(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fecll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fecll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_PIDR3", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_PIDR3(a) cavm_etrx_pidr3_t
#define bustype_CAVM_ETRX_PIDR3(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_PIDR3(a) "ETRX_PIDR3"
#define busnum_CAVM_ETRX_PIDR3(a) (a)
#define arguments_CAVM_ETRX_PIDR3(a) (a),-1,-1,-1
 ...
 * This register provides information to identify a debug component.
 */
union cavm_etrx_pidr4
{
    uint32_t u;
    struct cavm_etrx_pidr4_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_pidr4_s cn96xx; */
    struct cavm_etrx_pidr4_cnf95xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t fourkbcount           : 4;  /**< [  7:  4](RO) Size of the component. Log\<sub\>2\</sub\> of the number of 4KB pages from the
...
typedef union cavm_etrx_pidr4 cavm_etrx_pidr4_t;

static inline uint64_t CAVM_ETRX_PIDR4(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_PIDR4(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fd0ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fd0ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_PIDR4", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_PIDR4(a) cavm_etrx_pidr4_t
#define bustype_CAVM_ETRX_PIDR4(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_PIDR4(a) "ETRX_PIDR4"
#define busnum_CAVM_ETRX_PIDR4(a) (a)
#define arguments_CAVM_ETRX_PIDR4(a) (a),-1,-1,-1
 ...
 * This register provides information to identify a debug component.
 */
union cavm_etrx_pidr5
{
    uint32_t u;
    struct cavm_etrx_pidr5_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_pidr5_s cn; */
};
typedef union cavm_etrx_pidr5 cavm_etrx_pidr5_t;

static inline uint64_t CAVM_ETRX_PIDR5(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_PIDR5(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fd4ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fd4ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_PIDR5", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_PIDR5(a) cavm_etrx_pidr5_t
#define bustype_CAVM_ETRX_PIDR5(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_PIDR5(a) "ETRX_PIDR5"
#define busnum_CAVM_ETRX_PIDR5(a) (a)
#define arguments_CAVM_ETRX_PIDR5(a) (a),-1,-1,-1
 ...
 * This register provides information to identify a debug component.
 */
union cavm_etrx_pidr6
{
    uint32_t u;
    struct cavm_etrx_pidr6_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_0_31         : 32;
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_etrx_pidr6_s cn; */
};
typedef union cavm_etrx_pidr6 cavm_etrx_pidr6_t;

static inline uint64_t CAVM_ETRX_PIDR6(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_PIDR6(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fd8ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fd8ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_PIDR6", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_PIDR6(a) cavm_etrx_pidr6_t
#define bustype_CAVM_ETRX_PIDR6(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_PIDR6(a) "ETRX_PIDR6"
#define busnum_CAVM_ETRX_PIDR6(a) (a)
#define arguments_CAVM_ETRX_PIDR6(a) (a),-1,-1,-1
 ...
 * This register provides information to identify a debug component.
 */
union cavm_etrx_pidr7
{
    uint32_t u;
    struct cavm_etrx_pidr7_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_0_31         : 32;
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_etrx_pidr7_s cn; */
};
typedef union cavm_etrx_pidr7 cavm_etrx_pidr7_t;

static inline uint64_t CAVM_ETRX_PIDR7(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_PIDR7(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fdcll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fdcll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_PIDR7", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_PIDR7(a) cavm_etrx_pidr7_t
#define bustype_CAVM_ETRX_PIDR7(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_PIDR7(a) "ETRX_PIDR7"
#define busnum_CAVM_ETRX_PIDR7(a) (a)
#define arguments_CAVM_ETRX_PIDR7(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_pscr
{
    uint32_t u;
    struct cavm_etrx_pscr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_pscr_s cn; */
};
typedef union cavm_etrx_pscr cavm_etrx_pscr_t;

static inline uint64_t CAVM_ETRX_PSCR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_PSCR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040308ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040308ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_PSCR", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_PSCR(a) cavm_etrx_pscr_t
#define bustype_CAVM_ETRX_PSCR(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_PSCR(a) "ETRX_PSCR"
#define busnum_CAVM_ETRX_PSCR(a) (a)
#define arguments_CAVM_ETRX_PSCR(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_pwrcontrol
{
    uint32_t u;
    struct cavm_etrx_pwrcontrol_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_1_31         : 31;
    ...
    /* struct cavm_etrx_pwrcontrol_s cn; */
};
typedef union cavm_etrx_pwrcontrol cavm_etrx_pwrcontrol_t;

static inline uint64_t CAVM_ETRX_PWRCONTROL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_PWRCONTROL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a0080400f0ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a0080400f0ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_PWRCONTROL", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_PWRCONTROL(a) cavm_etrx_pwrcontrol_t
#define bustype_CAVM_ETRX_PWRCONTROL(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_PWRCONTROL(a) "ETRX_PWRCONTROL"
#define busnum_CAVM_ETRX_PWRCONTROL(a) (a)
#define arguments_CAVM_ETRX_PWRCONTROL(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_ramsize
{
    uint32_t u;
    struct cavm_etrx_ramsize_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_ETRX_RAMSIZE(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_RAMSIZE(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040004ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040004ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_RAMSIZE", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_RAMSIZE(a) cavm_etrx_ramsize_t
#define bustype_CAVM_ETRX_RAMSIZE(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_RAMSIZE(a) "ETRX_RAMSIZE"
#define busnum_CAVM_ETRX_RAMSIZE(a) (a)
#define arguments_CAVM_ETRX_RAMSIZE(a) (a),-1,-1,-1
 ...
 * ETR Status Register
 */
union cavm_etrx_status
{
    uint32_t u;
    struct cavm_etrx_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_7_31         : 25;
...
static inline uint64_t CAVM_ETRX_STATUS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_STATUS(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a00804000cll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a00804000cll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_STATUS", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_STATUS(a) cavm_etrx_status_t
#define bustype_CAVM_ETRX_STATUS(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_STATUS(a) "ETRX_STATUS"
#define busnum_CAVM_ETRX_STATUS(a) (a)
#define arguments_CAVM_ETRX_STATUS(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_trcclaimset
{
    uint32_t u;
    struct cavm_etrx_trcclaimset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    /* struct cavm_etrx_trcclaimset_s cn; */
};
typedef union cavm_etrx_trcclaimset cavm_etrx_trcclaimset_t;

static inline uint64_t CAVM_ETRX_TRCCLAIMSET(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_TRCCLAIMSET(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fa0ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fa0ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_TRCCLAIMSET", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_TRCCLAIMSET(a) cavm_etrx_trcclaimset_t
#define bustype_CAVM_ETRX_TRCCLAIMSET(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_TRCCLAIMSET(a) "ETRX_TRCCLAIMSET"
#define busnum_CAVM_ETRX_TRCCLAIMSET(a) (a)
#define arguments_CAVM_ETRX_TRCCLAIMSET(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_trigcntr
{
    uint32_t u;
    struct cavm_etrx_trigcntr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_trigcntr_s cn; */
};
typedef union cavm_etrx_trigcntr cavm_etrx_trigcntr_t;

static inline uint64_t CAVM_ETRX_TRIGCNTR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_TRIGCNTR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a00804001cll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a00804001cll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_TRIGCNTR", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_TRIGCNTR(a) cavm_etrx_trigcntr_t
#define bustype_CAVM_ETRX_TRIGCNTR(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_TRIGCNTR(a) "ETRX_TRIGCNTR"
#define busnum_CAVM_ETRX_TRIGCNTR(a) (a)
#define arguments_CAVM_ETRX_TRIGCNTR(a) (a),-1,-1,-1
 ...
 */
union cavm_etrx_wtrpointer
{
    uint32_t u;
    struct cavm_etrx_wtrpointer_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_wtrpointer_s cn; */
};
typedef union cavm_etrx_wtrpointer cavm_etrx_wtrpointer_t;

static inline uint64_t CAVM_ETRX_WTRPOINTER(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_WTRPOINTER(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040018ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040018ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_WTRPOINTER", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_WTRPOINTER(a) cavm_etrx_wtrpointer_t
#define bustype_CAVM_ETRX_WTRPOINTER(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_WTRPOINTER(a) "ETRX_WTRPOINTER"
#define busnum_CAVM_ETRX_WTRPOINTER(a) (a)
#define arguments_CAVM_ETRX_WTRPOINTER(a) (a),-1,-1,-1
...
{
    uint32_t u;
    struct cavm_etrx_wtrpointerhi_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrx_wtrpointerhi_s cn; */
};
typedef union cavm_etrx_wtrpointerhi cavm_etrx_wtrpointerhi_t;

static inline uint64_t CAVM_ETRX_WTRPOINTERHI(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRX_WTRPOINTERHI(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a00804003cll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a00804003cll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRX_WTRPOINTERHI", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRX_WTRPOINTERHI(a) cavm_etrx_wtrpointerhi_t
#define bustype_CAVM_ETRX_WTRPOINTERHI(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRX_WTRPOINTERHI(a) "ETRX_WTRPOINTERHI"
#define busnum_CAVM_ETRX_WTRPOINTERHI(a) (a)
#define arguments_CAVM_ETRX_WTRPOINTERHI(a) (a),-1,-1,-1
 ...
 */
union cavm_etrcx_devaff0
{
    uint32_t u;
    struct cavm_etrcx_devaff0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etrcx_devaff0_s cn; */
};
typedef union cavm_etrcx_devaff0 cavm_etrcx_devaff0_t;

static inline uint64_t CAVM_ETRCX_DEVAFF0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRCX_DEVAFF0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040fa8ll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040fa8ll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRCX_DEVAFF0", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRCX_DEVAFF0(a) cavm_etrcx_devaff0_t
#define bustype_CAVM_ETRCX_DEVAFF0(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRCX_DEVAFF0(a) "ETRCX_DEVAFF0"
#define busnum_CAVM_ETRCX_DEVAFF0(a) (a)
#define arguments_CAVM_ETRCX_DEVAFF0(a) (a),-1,-1,-1
 ...
 */
union cavm_etrcx_devaff1
{
    uint32_t u;
    struct cavm_etrcx_devaff1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_0_31         : 32;
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_etrcx_devaff1_s cn; */
};
typedef union cavm_etrcx_devaff1 cavm_etrcx_devaff1_t;

static inline uint64_t CAVM_ETRCX_DEVAFF1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETRCX_DEVAFF1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=23))
        return 0x87a008040facll + 0x80000ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=5))
        return 0x87a008040facll + 0x80000ll * ((a) & 0x7);
    __cavm_csr_fatal("ETRCX_DEVAFF1", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ETRCX_DEVAFF1(a) cavm_etrcx_devaff1_t
#define bustype_CAVM_ETRCX_DEVAFF1(a) CSR_TYPE_DAB32b
#define basename_CAVM_ETRCX_DEVAFF1(a) "ETRCX_DEVAFF1"
#define busnum_CAVM_ETRCX_DEVAFF1(a) (a)
#define arguments_CAVM_ETRCX_DEVAFF1(a) (a),-1,-1,-1

#endif /* __CAVM_CSRS_DAB_ETR_H__ */
