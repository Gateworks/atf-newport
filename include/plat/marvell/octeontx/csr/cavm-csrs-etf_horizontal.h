#ifndef __CAVM_CSRS_ETF_HORIZONTAL_H__
#define __CAVM_CSRS_ETF_HORIZONTAL_H__
 ...
 */
union cavm_etf_horizontal_authstatus
{
    uint32_t u;
    struct cavm_etf_horizontal_authstatus_s
    {
    ...
    /* struct cavm_etf_horizontal_authstatus_s cn; */
};
typedef union cavm_etf_horizontal_authstatus cavm_etf_horizontal_authstatus_t;

#define CAVM_ETF_HORIZONTAL_AUTHSTATUS CAVM_ETF_HORIZONTAL_AUTHSTATUS_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_AUTHSTATUS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_AUTHSTATUS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fb8ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_AUTHSTATUS", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_AUTHSTATUS cavm_etf_horizontal_authstatus_t
#define bustype_CAVM_ETF_HORIZONTAL_AUTHSTATUS CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_AUTHSTATUS "ETF_HORIZONTAL_AUTHSTATUS"
#define busnum_CAVM_ETF_HORIZONTAL_AUTHSTATUS 0
#define arguments_CAVM_ETF_HORIZONTAL_AUTHSTATUS -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_bufwm
{
    uint32_t u;
    struct cavm_etf_horizontal_bufwm_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_bufwm_s cn; */
};
typedef union cavm_etf_horizontal_bufwm cavm_etf_horizontal_bufwm_t;

#define CAVM_ETF_HORIZONTAL_BUFWM CAVM_ETF_HORIZONTAL_BUFWM_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_BUFWM_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_BUFWM_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003034ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_BUFWM", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_BUFWM cavm_etf_horizontal_bufwm_t
#define bustype_CAVM_ETF_HORIZONTAL_BUFWM CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_BUFWM "ETF_HORIZONTAL_BUFWM"
#define busnum_CAVM_ETF_HORIZONTAL_BUFWM 0
#define arguments_CAVM_ETF_HORIZONTAL_BUFWM -1,-1,-1,-1
 ...
 * RRD reads.
 */
union cavm_etf_horizontal_cbuflevel
{
    uint32_t u;
    struct cavm_etf_horizontal_cbuflevel_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_cbuflevel_s cn; */
};
typedef union cavm_etf_horizontal_cbuflevel cavm_etf_horizontal_cbuflevel_t;

#define CAVM_ETF_HORIZONTAL_CBUFLEVEL CAVM_ETF_HORIZONTAL_CBUFLEVEL_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_CBUFLEVEL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_CBUFLEVEL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003030ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_CBUFLEVEL", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_CBUFLEVEL cavm_etf_horizontal_cbuflevel_t
#define bustype_CAVM_ETF_HORIZONTAL_CBUFLEVEL CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_CBUFLEVEL "ETF_HORIZONTAL_CBUFLEVEL"
#define busnum_CAVM_ETF_HORIZONTAL_CBUFLEVEL 0
#define arguments_CAVM_ETF_HORIZONTAL_CBUFLEVEL -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_cidr0
{
    uint32_t u;
    struct cavm_etf_horizontal_cidr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_cidr0_s cn; */
};
typedef union cavm_etf_horizontal_cidr0 cavm_etf_horizontal_cidr0_t;

#define CAVM_ETF_HORIZONTAL_CIDR0 CAVM_ETF_HORIZONTAL_CIDR0_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_CIDR0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_CIDR0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003ff0ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_CIDR0", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_CIDR0 cavm_etf_horizontal_cidr0_t
#define bustype_CAVM_ETF_HORIZONTAL_CIDR0 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_CIDR0 "ETF_HORIZONTAL_CIDR0"
#define busnum_CAVM_ETF_HORIZONTAL_CIDR0 0
#define arguments_CAVM_ETF_HORIZONTAL_CIDR0 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_cidr1
{
    uint32_t u;
    struct cavm_etf_horizontal_cidr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_horizontal_cidr1_s cn; */
};
typedef union cavm_etf_horizontal_cidr1 cavm_etf_horizontal_cidr1_t;

#define CAVM_ETF_HORIZONTAL_CIDR1 CAVM_ETF_HORIZONTAL_CIDR1_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_CIDR1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_CIDR1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003ff4ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_CIDR1", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_CIDR1 cavm_etf_horizontal_cidr1_t
#define bustype_CAVM_ETF_HORIZONTAL_CIDR1 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_CIDR1 "ETF_HORIZONTAL_CIDR1"
#define busnum_CAVM_ETF_HORIZONTAL_CIDR1 0
#define arguments_CAVM_ETF_HORIZONTAL_CIDR1 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_cidr2
{
    uint32_t u;
    struct cavm_etf_horizontal_cidr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_horizontal_cidr2_s cn; */
};
typedef union cavm_etf_horizontal_cidr2 cavm_etf_horizontal_cidr2_t;

#define CAVM_ETF_HORIZONTAL_CIDR2 CAVM_ETF_HORIZONTAL_CIDR2_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_CIDR2_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_CIDR2_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003ff8ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_CIDR2", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_CIDR2 cavm_etf_horizontal_cidr2_t
#define bustype_CAVM_ETF_HORIZONTAL_CIDR2 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_CIDR2 "ETF_HORIZONTAL_CIDR2"
#define busnum_CAVM_ETF_HORIZONTAL_CIDR2 0
#define arguments_CAVM_ETF_HORIZONTAL_CIDR2 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_cidr3
{
    uint32_t u;
    struct cavm_etf_horizontal_cidr3_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_horizontal_cidr3_s cn; */
};
typedef union cavm_etf_horizontal_cidr3 cavm_etf_horizontal_cidr3_t;

#define CAVM_ETF_HORIZONTAL_CIDR3 CAVM_ETF_HORIZONTAL_CIDR3_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_CIDR3_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_CIDR3_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003ffcll;
    __cavm_csr_fatal("ETF_HORIZONTAL_CIDR3", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_CIDR3 cavm_etf_horizontal_cidr3_t
#define bustype_CAVM_ETF_HORIZONTAL_CIDR3 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_CIDR3 "ETF_HORIZONTAL_CIDR3"
#define busnum_CAVM_ETF_HORIZONTAL_CIDR3 0
#define arguments_CAVM_ETF_HORIZONTAL_CIDR3 -1,-1,-1,-1
 ...
 * value.
 */
union cavm_etf_horizontal_claimclr
{
    uint32_t u;
    struct cavm_etf_horizontal_claimclr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_claimclr_s cn; */
};
typedef union cavm_etf_horizontal_claimclr cavm_etf_horizontal_claimclr_t;

#define CAVM_ETF_HORIZONTAL_CLAIMCLR CAVM_ETF_HORIZONTAL_CLAIMCLR_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_CLAIMCLR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_CLAIMCLR_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fa4ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_CLAIMCLR", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_CLAIMCLR cavm_etf_horizontal_claimclr_t
#define bustype_CAVM_ETF_HORIZONTAL_CLAIMCLR CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_CLAIMCLR "ETF_HORIZONTAL_CLAIMCLR"
#define busnum_CAVM_ETF_HORIZONTAL_CLAIMCLR 0
#define arguments_CAVM_ETF_HORIZONTAL_CLAIMCLR -1,-1,-1,-1
 ...
 * be set.
 */
union cavm_etf_horizontal_claimset
{
    uint32_t u;
    struct cavm_etf_horizontal_claimset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 28; /**< [ 31:  4](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_horizontal_claimset_s cn; */
};
typedef union cavm_etf_horizontal_claimset cavm_etf_horizontal_claimset_t;

#define CAVM_ETF_HORIZONTAL_CLAIMSET CAVM_ETF_HORIZONTAL_CLAIMSET_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_CLAIMSET_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_CLAIMSET_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fa0ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_CLAIMSET", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_CLAIMSET cavm_etf_horizontal_claimset_t
#define bustype_CAVM_ETF_HORIZONTAL_CLAIMSET CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_CLAIMSET "ETF_HORIZONTAL_CLAIMSET"
#define busnum_CAVM_ETF_HORIZONTAL_CLAIMSET 0
#define arguments_CAVM_ETF_HORIZONTAL_CLAIMSET -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_ctl
{
    uint32_t u;
    struct cavm_etf_horizontal_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_ctl_s cn; */
};
typedef union cavm_etf_horizontal_ctl cavm_etf_horizontal_ctl_t;

#define CAVM_ETF_HORIZONTAL_CTL CAVM_ETF_HORIZONTAL_CTL_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_CTL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_CTL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003020ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_CTL", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_CTL cavm_etf_horizontal_ctl_t
#define bustype_CAVM_ETF_HORIZONTAL_CTL CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_CTL "ETF_HORIZONTAL_CTL"
#define busnum_CAVM_ETF_HORIZONTAL_CTL 0
#define arguments_CAVM_ETF_HORIZONTAL_CTL -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_devid
{
    uint32_t u;
    struct cavm_etf_horizontal_devid_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_devid_s cn; */
};
typedef union cavm_etf_horizontal_devid cavm_etf_horizontal_devid_t;

#define CAVM_ETF_HORIZONTAL_DEVID CAVM_ETF_HORIZONTAL_DEVID_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_DEVID_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_DEVID_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fc8ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_DEVID", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_DEVID cavm_etf_horizontal_devid_t
#define bustype_CAVM_ETF_HORIZONTAL_DEVID CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_DEVID "ETF_HORIZONTAL_DEVID"
#define busnum_CAVM_ETF_HORIZONTAL_DEVID 0
#define arguments_CAVM_ETF_HORIZONTAL_DEVID -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_devid1
{
    uint32_t u;
    struct cavm_etf_horizontal_devid1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_devid1_s cn; */
};
typedef union cavm_etf_horizontal_devid1 cavm_etf_horizontal_devid1_t;

#define CAVM_ETF_HORIZONTAL_DEVID1 CAVM_ETF_HORIZONTAL_DEVID1_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_DEVID1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_DEVID1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fc4ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_DEVID1", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_DEVID1 cavm_etf_horizontal_devid1_t
#define bustype_CAVM_ETF_HORIZONTAL_DEVID1 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_DEVID1 "ETF_HORIZONTAL_DEVID1"
#define busnum_CAVM_ETF_HORIZONTAL_DEVID1 0
#define arguments_CAVM_ETF_HORIZONTAL_DEVID1 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_devtype
{
    uint32_t u;
    struct cavm_etf_horizontal_devtype_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_horizontal_devtype_s cn; */
};
typedef union cavm_etf_horizontal_devtype cavm_etf_horizontal_devtype_t;

#define CAVM_ETF_HORIZONTAL_DEVTYPE CAVM_ETF_HORIZONTAL_DEVTYPE_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_DEVTYPE_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_DEVTYPE_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fccll;
    __cavm_csr_fatal("ETF_HORIZONTAL_DEVTYPE", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_DEVTYPE cavm_etf_horizontal_devtype_t
#define bustype_CAVM_ETF_HORIZONTAL_DEVTYPE CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_DEVTYPE "ETF_HORIZONTAL_DEVTYPE"
#define busnum_CAVM_ETF_HORIZONTAL_DEVTYPE 0
#define arguments_CAVM_ETF_HORIZONTAL_DEVTYPE -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_ffcr
{
    uint32_t u;
    struct cavm_etf_horizontal_ffcr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_ffcr_s cn; */
};
typedef union cavm_etf_horizontal_ffcr cavm_etf_horizontal_ffcr_t;

#define CAVM_ETF_HORIZONTAL_FFCR CAVM_ETF_HORIZONTAL_FFCR_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_FFCR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_FFCR_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003304ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_FFCR", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_FFCR cavm_etf_horizontal_ffcr_t
#define bustype_CAVM_ETF_HORIZONTAL_FFCR CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_FFCR "ETF_HORIZONTAL_FFCR"
#define busnum_CAVM_ETF_HORIZONTAL_FFCR 0
#define arguments_CAVM_ETF_HORIZONTAL_FFCR -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_ffsr
{
    uint32_t u;
    struct cavm_etf_horizontal_ffsr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_ffsr_s cn; */
};
typedef union cavm_etf_horizontal_ffsr cavm_etf_horizontal_ffsr_t;

#define CAVM_ETF_HORIZONTAL_FFSR CAVM_ETF_HORIZONTAL_FFSR_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_FFSR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_FFSR_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003300ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_FFSR", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_FFSR cavm_etf_horizontal_ffsr_t
#define bustype_CAVM_ETF_HORIZONTAL_FFSR CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_FFSR "ETF_HORIZONTAL_FFSR"
#define busnum_CAVM_ETF_HORIZONTAL_FFSR 0
#define arguments_CAVM_ETF_HORIZONTAL_FFSR -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_itatbctr0
{
    uint32_t u;
    struct cavm_etf_horizontal_itatbctr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_itatbctr0_s cn; */
};
typedef union cavm_etf_horizontal_itatbctr0 cavm_etf_horizontal_itatbctr0_t;

#define CAVM_ETF_HORIZONTAL_ITATBCTR0 CAVM_ETF_HORIZONTAL_ITATBCTR0_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBCTR0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBCTR0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003ef8ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_ITATBCTR0", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_ITATBCTR0 cavm_etf_horizontal_itatbctr0_t
#define bustype_CAVM_ETF_HORIZONTAL_ITATBCTR0 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_ITATBCTR0 "ETF_HORIZONTAL_ITATBCTR0"
#define busnum_CAVM_ETF_HORIZONTAL_ITATBCTR0 0
#define arguments_CAVM_ETF_HORIZONTAL_ITATBCTR0 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_itatbctr1
{
    uint32_t u;
    struct cavm_etf_horizontal_itatbctr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_itatbctr1_s cn; */
};
typedef union cavm_etf_horizontal_itatbctr1 cavm_etf_horizontal_itatbctr1_t;

#define CAVM_ETF_HORIZONTAL_ITATBCTR1 CAVM_ETF_HORIZONTAL_ITATBCTR1_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBCTR1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBCTR1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003ef4ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_ITATBCTR1", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_ITATBCTR1 cavm_etf_horizontal_itatbctr1_t
#define bustype_CAVM_ETF_HORIZONTAL_ITATBCTR1 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_ITATBCTR1 "ETF_HORIZONTAL_ITATBCTR1"
#define busnum_CAVM_ETF_HORIZONTAL_ITATBCTR1 0
#define arguments_CAVM_ETF_HORIZONTAL_ITATBCTR1 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_itatbctr2
{
    uint32_t u;
    struct cavm_etf_horizontal_itatbctr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_itatbctr2_s cn; */
};
typedef union cavm_etf_horizontal_itatbctr2 cavm_etf_horizontal_itatbctr2_t;

#define CAVM_ETF_HORIZONTAL_ITATBCTR2 CAVM_ETF_HORIZONTAL_ITATBCTR2_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBCTR2_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBCTR2_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003ef0ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_ITATBCTR2", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_ITATBCTR2 cavm_etf_horizontal_itatbctr2_t
#define bustype_CAVM_ETF_HORIZONTAL_ITATBCTR2 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_ITATBCTR2 "ETF_HORIZONTAL_ITATBCTR2"
#define busnum_CAVM_ETF_HORIZONTAL_ITATBCTR2 0
#define arguments_CAVM_ETF_HORIZONTAL_ITATBCTR2 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_itatbdata0
{
    uint32_t u;
    struct cavm_etf_horizontal_itatbdata0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_itatbdata0_s cn; */
};
typedef union cavm_etf_horizontal_itatbdata0 cavm_etf_horizontal_itatbdata0_t;

#define CAVM_ETF_HORIZONTAL_ITATBDATA0 CAVM_ETF_HORIZONTAL_ITATBDATA0_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBDATA0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBDATA0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003eecll;
    __cavm_csr_fatal("ETF_HORIZONTAL_ITATBDATA0", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_ITATBDATA0 cavm_etf_horizontal_itatbdata0_t
#define bustype_CAVM_ETF_HORIZONTAL_ITATBDATA0 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_ITATBDATA0 "ETF_HORIZONTAL_ITATBDATA0"
#define busnum_CAVM_ETF_HORIZONTAL_ITATBDATA0 0
#define arguments_CAVM_ETF_HORIZONTAL_ITATBDATA0 -1,-1,-1,-1
 ...
 * 0x0.
 */
union cavm_etf_horizontal_itatbmctr1
{
    uint32_t u;
    struct cavm_etf_horizontal_itatbmctr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_itatbmctr1_s cn; */
};
typedef union cavm_etf_horizontal_itatbmctr1 cavm_etf_horizontal_itatbmctr1_t;

#define CAVM_ETF_HORIZONTAL_ITATBMCTR1 CAVM_ETF_HORIZONTAL_ITATBMCTR1_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBMCTR1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBMCTR1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003ed8ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_ITATBMCTR1", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_ITATBMCTR1 cavm_etf_horizontal_itatbmctr1_t
#define bustype_CAVM_ETF_HORIZONTAL_ITATBMCTR1 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_ITATBMCTR1 "ETF_HORIZONTAL_ITATBMCTR1"
#define busnum_CAVM_ETF_HORIZONTAL_ITATBMCTR1 0
#define arguments_CAVM_ETF_HORIZONTAL_ITATBMCTR1 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_itatbmctr2
{
    uint32_t u;
    struct cavm_etf_horizontal_itatbmctr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_itatbmctr2_s cn; */
};
typedef union cavm_etf_horizontal_itatbmctr2 cavm_etf_horizontal_itatbmctr2_t;

#define CAVM_ETF_HORIZONTAL_ITATBMCTR2 CAVM_ETF_HORIZONTAL_ITATBMCTR2_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBMCTR2_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBMCTR2_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003ed4ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_ITATBMCTR2", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_ITATBMCTR2 cavm_etf_horizontal_itatbmctr2_t
#define bustype_CAVM_ETF_HORIZONTAL_ITATBMCTR2 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_ITATBMCTR2 "ETF_HORIZONTAL_ITATBMCTR2"
#define busnum_CAVM_ETF_HORIZONTAL_ITATBMCTR2 0
#define arguments_CAVM_ETF_HORIZONTAL_ITATBMCTR2 -1,-1,-1,-1
 ...
 * DATA WIDTH)/8.
 */
union cavm_etf_horizontal_itatbmdata0
{
    uint32_t u;
    struct cavm_etf_horizontal_itatbmdata0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_itatbmdata0_s cn; */
};
typedef union cavm_etf_horizontal_itatbmdata0 cavm_etf_horizontal_itatbmdata0_t;

#define CAVM_ETF_HORIZONTAL_ITATBMDATA0 CAVM_ETF_HORIZONTAL_ITATBMDATA0_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBMDATA0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_ITATBMDATA0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003ed0ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_ITATBMDATA0", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_ITATBMDATA0 cavm_etf_horizontal_itatbmdata0_t
#define bustype_CAVM_ETF_HORIZONTAL_ITATBMDATA0 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_ITATBMDATA0 "ETF_HORIZONTAL_ITATBMDATA0"
#define busnum_CAVM_ETF_HORIZONTAL_ITATBMDATA0 0
#define arguments_CAVM_ETF_HORIZONTAL_ITATBMDATA0 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_itctrl
{
    uint32_t u;
    struct cavm_etf_horizontal_itctrl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 31; /**< [ 31:  1](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_horizontal_itctrl_s cn; */
};
typedef union cavm_etf_horizontal_itctrl cavm_etf_horizontal_itctrl_t;

#define CAVM_ETF_HORIZONTAL_ITCTRL CAVM_ETF_HORIZONTAL_ITCTRL_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_ITCTRL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_ITCTRL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003f00ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_ITCTRL", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_ITCTRL cavm_etf_horizontal_itctrl_t
#define bustype_CAVM_ETF_HORIZONTAL_ITCTRL CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_ITCTRL "ETF_HORIZONTAL_ITCTRL"
#define busnum_CAVM_ETF_HORIZONTAL_ITCTRL 0
#define arguments_CAVM_ETF_HORIZONTAL_ITCTRL -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_itevtintr
{
    uint32_t u;
    struct cavm_etf_horizontal_itevtintr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 29; /**< [ 31:  3](WO) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_horizontal_itevtintr_s cn; */
};
typedef union cavm_etf_horizontal_itevtintr cavm_etf_horizontal_itevtintr_t;

#define CAVM_ETF_HORIZONTAL_ITEVTINTR CAVM_ETF_HORIZONTAL_ITEVTINTR_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_ITEVTINTR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_ITEVTINTR_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003ee0ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_ITEVTINTR", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_ITEVTINTR cavm_etf_horizontal_itevtintr_t
#define bustype_CAVM_ETF_HORIZONTAL_ITEVTINTR CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_ITEVTINTR "ETF_HORIZONTAL_ITEVTINTR"
#define busnum_CAVM_ETF_HORIZONTAL_ITEVTINTR 0
#define arguments_CAVM_ETF_HORIZONTAL_ITEVTINTR -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_ittrflin
{
    uint32_t u;
    struct cavm_etf_horizontal_ittrflin_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 30; /**< [ 31:  2](RO) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_horizontal_ittrflin_s cn; */
};
typedef union cavm_etf_horizontal_ittrflin cavm_etf_horizontal_ittrflin_t;

#define CAVM_ETF_HORIZONTAL_ITTRFLIN CAVM_ETF_HORIZONTAL_ITTRFLIN_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_ITTRFLIN_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_ITTRFLIN_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003ee8ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_ITTRFLIN", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_ITTRFLIN cavm_etf_horizontal_ittrflin_t
#define bustype_CAVM_ETF_HORIZONTAL_ITTRFLIN CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_ITTRFLIN "ETF_HORIZONTAL_ITTRFLIN"
#define busnum_CAVM_ETF_HORIZONTAL_ITTRFLIN 0
#define arguments_CAVM_ETF_HORIZONTAL_ITTRFLIN -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_lbuflevel
{
    uint32_t u;
    struct cavm_etf_horizontal_lbuflevel_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 19; /**< [ 31: 13](RO) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_horizontal_lbuflevel_s cn; */
};
typedef union cavm_etf_horizontal_lbuflevel cavm_etf_horizontal_lbuflevel_t;

#define CAVM_ETF_HORIZONTAL_LBUFLEVEL CAVM_ETF_HORIZONTAL_LBUFLEVEL_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_LBUFLEVEL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_LBUFLEVEL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e04600302cll;
    __cavm_csr_fatal("ETF_HORIZONTAL_LBUFLEVEL", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_LBUFLEVEL cavm_etf_horizontal_lbuflevel_t
#define bustype_CAVM_ETF_HORIZONTAL_LBUFLEVEL CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_LBUFLEVEL "ETF_HORIZONTAL_LBUFLEVEL"
#define busnum_CAVM_ETF_HORIZONTAL_LBUFLEVEL 0
#define arguments_CAVM_ETF_HORIZONTAL_LBUFLEVEL -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_mode
{
    uint32_t u;
    struct cavm_etf_horizontal_mode_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_mode_s cn; */
};
typedef union cavm_etf_horizontal_mode cavm_etf_horizontal_mode_t;

#define CAVM_ETF_HORIZONTAL_MODE CAVM_ETF_HORIZONTAL_MODE_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_MODE_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_MODE_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003028ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_MODE", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_MODE cavm_etf_horizontal_mode_t
#define bustype_CAVM_ETF_HORIZONTAL_MODE CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_MODE "ETF_HORIZONTAL_MODE"
#define busnum_CAVM_ETF_HORIZONTAL_MODE 0
#define arguments_CAVM_ETF_HORIZONTAL_MODE -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_pidr0
{
    uint32_t u;
    struct cavm_etf_horizontal_pidr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_horizontal_pidr0_s cn; */
};
typedef union cavm_etf_horizontal_pidr0 cavm_etf_horizontal_pidr0_t;

#define CAVM_ETF_HORIZONTAL_PIDR0 CAVM_ETF_HORIZONTAL_PIDR0_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fe0ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_PIDR0", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_PIDR0 cavm_etf_horizontal_pidr0_t
#define bustype_CAVM_ETF_HORIZONTAL_PIDR0 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_PIDR0 "ETF_HORIZONTAL_PIDR0"
#define busnum_CAVM_ETF_HORIZONTAL_PIDR0 0
#define arguments_CAVM_ETF_HORIZONTAL_PIDR0 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_pidr1
{
    uint32_t u;
    struct cavm_etf_horizontal_pidr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_horizontal_pidr1_s cn; */
};
typedef union cavm_etf_horizontal_pidr1 cavm_etf_horizontal_pidr1_t;

#define CAVM_ETF_HORIZONTAL_PIDR1 CAVM_ETF_HORIZONTAL_PIDR1_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fe4ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_PIDR1", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_PIDR1 cavm_etf_horizontal_pidr1_t
#define bustype_CAVM_ETF_HORIZONTAL_PIDR1 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_PIDR1 "ETF_HORIZONTAL_PIDR1"
#define busnum_CAVM_ETF_HORIZONTAL_PIDR1 0
#define arguments_CAVM_ETF_HORIZONTAL_PIDR1 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_pidr2
{
    uint32_t u;
    struct cavm_etf_horizontal_pidr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_horizontal_pidr2_s cn; */
};
typedef union cavm_etf_horizontal_pidr2 cavm_etf_horizontal_pidr2_t;

#define CAVM_ETF_HORIZONTAL_PIDR2 CAVM_ETF_HORIZONTAL_PIDR2_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR2_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR2_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fe8ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_PIDR2", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_PIDR2 cavm_etf_horizontal_pidr2_t
#define bustype_CAVM_ETF_HORIZONTAL_PIDR2 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_PIDR2 "ETF_HORIZONTAL_PIDR2"
#define busnum_CAVM_ETF_HORIZONTAL_PIDR2 0
#define arguments_CAVM_ETF_HORIZONTAL_PIDR2 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_pidr3
{
    uint32_t u;
    struct cavm_etf_horizontal_pidr3_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_horizontal_pidr3_s cn; */
};
typedef union cavm_etf_horizontal_pidr3 cavm_etf_horizontal_pidr3_t;

#define CAVM_ETF_HORIZONTAL_PIDR3 CAVM_ETF_HORIZONTAL_PIDR3_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR3_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR3_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fecll;
    __cavm_csr_fatal("ETF_HORIZONTAL_PIDR3", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_PIDR3 cavm_etf_horizontal_pidr3_t
#define bustype_CAVM_ETF_HORIZONTAL_PIDR3 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_PIDR3 "ETF_HORIZONTAL_PIDR3"
#define busnum_CAVM_ETF_HORIZONTAL_PIDR3 0
#define arguments_CAVM_ETF_HORIZONTAL_PIDR3 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_pidr4
{
    uint32_t u;
    struct cavm_etf_horizontal_pidr4_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_horizontal_pidr4_s cn; */
};
typedef union cavm_etf_horizontal_pidr4 cavm_etf_horizontal_pidr4_t;

#define CAVM_ETF_HORIZONTAL_PIDR4 CAVM_ETF_HORIZONTAL_PIDR4_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR4_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR4_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fd0ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_PIDR4", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_PIDR4 cavm_etf_horizontal_pidr4_t
#define bustype_CAVM_ETF_HORIZONTAL_PIDR4 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_PIDR4 "ETF_HORIZONTAL_PIDR4"
#define busnum_CAVM_ETF_HORIZONTAL_PIDR4 0
#define arguments_CAVM_ETF_HORIZONTAL_PIDR4 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_pidr5
{
    uint32_t u;
    struct cavm_etf_horizontal_pidr5_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_horizontal_pidr5_s cn; */
};
typedef union cavm_etf_horizontal_pidr5 cavm_etf_horizontal_pidr5_t;

#define CAVM_ETF_HORIZONTAL_PIDR5 CAVM_ETF_HORIZONTAL_PIDR5_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR5_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR5_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fd4ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_PIDR5", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_PIDR5 cavm_etf_horizontal_pidr5_t
#define bustype_CAVM_ETF_HORIZONTAL_PIDR5 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_PIDR5 "ETF_HORIZONTAL_PIDR5"
#define busnum_CAVM_ETF_HORIZONTAL_PIDR5 0
#define arguments_CAVM_ETF_HORIZONTAL_PIDR5 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_pidr6
{
    uint32_t u;
    struct cavm_etf_horizontal_pidr6_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_horizontal_pidr6_s cn; */
};
typedef union cavm_etf_horizontal_pidr6 cavm_etf_horizontal_pidr6_t;

#define CAVM_ETF_HORIZONTAL_PIDR6 CAVM_ETF_HORIZONTAL_PIDR6_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR6_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR6_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fd8ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_PIDR6", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_PIDR6 cavm_etf_horizontal_pidr6_t
#define bustype_CAVM_ETF_HORIZONTAL_PIDR6 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_PIDR6 "ETF_HORIZONTAL_PIDR6"
#define busnum_CAVM_ETF_HORIZONTAL_PIDR6 0
#define arguments_CAVM_ETF_HORIZONTAL_PIDR6 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_pidr7
{
    uint32_t u;
    struct cavm_etf_horizontal_pidr7_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etf_horizontal_pidr7_s cn; */
};
typedef union cavm_etf_horizontal_pidr7 cavm_etf_horizontal_pidr7_t;

#define CAVM_ETF_HORIZONTAL_PIDR7 CAVM_ETF_HORIZONTAL_PIDR7_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR7_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_PIDR7_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003fdcll;
    __cavm_csr_fatal("ETF_HORIZONTAL_PIDR7", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_PIDR7 cavm_etf_horizontal_pidr7_t
#define bustype_CAVM_ETF_HORIZONTAL_PIDR7 CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_PIDR7 "ETF_HORIZONTAL_PIDR7"
#define busnum_CAVM_ETF_HORIZONTAL_PIDR7 0
#define arguments_CAVM_ETF_HORIZONTAL_PIDR7 -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_pscr
{
    uint32_t u;
    struct cavm_etf_horizontal_pscr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_pscr_s cn; */
};
typedef union cavm_etf_horizontal_pscr cavm_etf_horizontal_pscr_t;

#define CAVM_ETF_HORIZONTAL_PSCR CAVM_ETF_HORIZONTAL_PSCR_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_PSCR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_PSCR_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003308ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_PSCR", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_PSCR cavm_etf_horizontal_pscr_t
#define bustype_CAVM_ETF_HORIZONTAL_PSCR CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_PSCR "ETF_HORIZONTAL_PSCR"
#define busnum_CAVM_ETF_HORIZONTAL_PSCR 0
#define arguments_CAVM_ETF_HORIZONTAL_PSCR -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_rrd
{
    uint32_t u;
    struct cavm_etf_horizontal_rrd_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_rrd_s cn; */
};
typedef union cavm_etf_horizontal_rrd cavm_etf_horizontal_rrd_t;

#define CAVM_ETF_HORIZONTAL_RRD CAVM_ETF_HORIZONTAL_RRD_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_RRD_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_RRD_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003010ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_RRD", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_RRD cavm_etf_horizontal_rrd_t
#define bustype_CAVM_ETF_HORIZONTAL_RRD CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_RRD "ETF_HORIZONTAL_RRD"
#define busnum_CAVM_ETF_HORIZONTAL_RRD 0
#define arguments_CAVM_ETF_HORIZONTAL_RRD -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_rrp
{
    uint32_t u;
    struct cavm_etf_horizontal_rrp_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_rrp_s cn; */
};
typedef union cavm_etf_horizontal_rrp cavm_etf_horizontal_rrp_t;

#define CAVM_ETF_HORIZONTAL_RRP CAVM_ETF_HORIZONTAL_RRP_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_RRP_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_RRP_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003014ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_RRP", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_RRP cavm_etf_horizontal_rrp_t
#define bustype_CAVM_ETF_HORIZONTAL_RRP CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_RRP "ETF_HORIZONTAL_RRP"
#define busnum_CAVM_ETF_HORIZONTAL_RRP 0
#define arguments_CAVM_ETF_HORIZONTAL_RRP -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_rsz
{
    uint32_t u;
    struct cavm_etf_horizontal_rsz_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_rsz_s cn; */
};
typedef union cavm_etf_horizontal_rsz cavm_etf_horizontal_rsz_t;

#define CAVM_ETF_HORIZONTAL_RSZ CAVM_ETF_HORIZONTAL_RSZ_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_RSZ_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_RSZ_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003004ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_RSZ", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_RSZ cavm_etf_horizontal_rsz_t
#define bustype_CAVM_ETF_HORIZONTAL_RSZ CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_RSZ "ETF_HORIZONTAL_RSZ"
#define busnum_CAVM_ETF_HORIZONTAL_RSZ 0
#define arguments_CAVM_ETF_HORIZONTAL_RSZ -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_rwd
{
    uint32_t u;
    struct cavm_etf_horizontal_rwd_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etf_horizontal_rwd_s cn; */
};
typedef union cavm_etf_horizontal_rwd cavm_etf_horizontal_rwd_t;

#define CAVM_ETF_HORIZONTAL_RWD CAVM_ETF_HORIZONTAL_RWD_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_RWD_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_RWD_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003024ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_RWD", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_RWD cavm_etf_horizontal_rwd_t
#define bustype_CAVM_ETF_HORIZONTAL_RWD CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_RWD "ETF_HORIZONTAL_RWD"
#define busnum_CAVM_ETF_HORIZONTAL_RWD 0
#define arguments_CAVM_ETF_HORIZONTAL_RWD -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_rwp
{
    uint32_t u;
    struct cavm_etf_horizontal_rwp_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 18; /**< [ 31: 14](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_horizontal_rwp_s cn; */
};
typedef union cavm_etf_horizontal_rwp cavm_etf_horizontal_rwp_t;

#define CAVM_ETF_HORIZONTAL_RWP CAVM_ETF_HORIZONTAL_RWP_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_RWP_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_RWP_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046003018ll;
    __cavm_csr_fatal("ETF_HORIZONTAL_RWP", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_RWP cavm_etf_horizontal_rwp_t
#define bustype_CAVM_ETF_HORIZONTAL_RWP CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_RWP "ETF_HORIZONTAL_RWP"
#define busnum_CAVM_ETF_HORIZONTAL_RWP 0
#define arguments_CAVM_ETF_HORIZONTAL_RWP -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_sts
{
    uint32_t u;
    struct cavm_etf_horizontal_sts_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 27; /**< [ 31:  5](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_horizontal_sts_s cn; */
};
typedef union cavm_etf_horizontal_sts cavm_etf_horizontal_sts_t;

#define CAVM_ETF_HORIZONTAL_STS CAVM_ETF_HORIZONTAL_STS_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_STS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_STS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e04600300cll;
    __cavm_csr_fatal("ETF_HORIZONTAL_STS", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_STS cavm_etf_horizontal_sts_t
#define bustype_CAVM_ETF_HORIZONTAL_STS CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_STS "ETF_HORIZONTAL_STS"
#define busnum_CAVM_ETF_HORIZONTAL_STS 0
#define arguments_CAVM_ETF_HORIZONTAL_STS -1,-1,-1,-1
 ...
 */
union cavm_etf_horizontal_trg
{
    uint32_t u;
    struct cavm_etf_horizontal_trg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 20; /**< [ 31: 12](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etf_horizontal_trg_s cn; */
};
typedef union cavm_etf_horizontal_trg cavm_etf_horizontal_trg_t;

#define CAVM_ETF_HORIZONTAL_TRG CAVM_ETF_HORIZONTAL_TRG_FUNC()
static inline uint64_t CAVM_ETF_HORIZONTAL_TRG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETF_HORIZONTAL_TRG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e04600301cll;
    __cavm_csr_fatal("ETF_HORIZONTAL_TRG", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETF_HORIZONTAL_TRG cavm_etf_horizontal_trg_t
#define bustype_CAVM_ETF_HORIZONTAL_TRG CSR_TYPE_RSL32b
#define basename_CAVM_ETF_HORIZONTAL_TRG "ETF_HORIZONTAL_TRG"
#define busnum_CAVM_ETF_HORIZONTAL_TRG 0
#define arguments_CAVM_ETF_HORIZONTAL_TRG -1,-1,-1,-1

#endif /* __CAVM_CSRS_ETF_HORIZONTAL_H__ */
