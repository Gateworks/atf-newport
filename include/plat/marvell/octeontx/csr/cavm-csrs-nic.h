#ifndef __CAVM_CSRS_NIC_H__
#define __CAVM_CSRS_NIC_H__
 ...
 */
#define CAVM_NIC_BAR_E_NIC_PF_BAR0 (0x843000000000ll)
#define CAVM_NIC_BAR_E_NIC_PF_BAR0_SIZE 0x40000000ull
#define CAVM_NIC_BAR_E_NIC_PF_BAR4 (0x843060000000ll)
#define CAVM_NIC_BAR_E_NIC_PF_BAR4_SIZE 0x100000ull
#define CAVM_NIC_BAR_E_NIC_VFX_BAR0(a) (0x8430a0000000ll + 0x200000ll * (a))
#define CAVM_NIC_BAR_E_NIC_VFX_BAR0_SIZE 0x200000ull
#define CAVM_NIC_BAR_E_NIC_VFX_BAR4(a) (0x8430e0000000ll + 0x200000ll * (a))
#define CAVM_NIC_BAR_E_NIC_VFX_BAR4_SIZE 0x200000ull
 ...
 */
#define CAVM_NIC_CHAN_E_BGXX_LMACX_CHX(a,b,c) (0x800 + 0x100 * (a) + 0x10 * (b) + (c))
#define CAVM_NIC_CHAN_E_DPI_CHX(a) (0x400 + (a))
#define CAVM_NIC_CHAN_E_LBKX_CHX(a,b) (0 + 0x100 * (a) + (b))
#define CAVM_NIC_CHAN_E_PKO_NULL (0xfff)
#define CAVM_NIC_CHAN_E_RX(a) (0 + 0x100 * (a))
 ...
 */
#define CAVM_NIC_CHAN_IDX_E_BGXX_LMACX_CHX(a,b,c) (0 + 0x20 * (a) + 8 * (b) + (c))
#define CAVM_NIC_CHAN_IDX_E_LBKX_CHX_CN81XX(a,b) (0x48 + 0x40 * (a) + (b))
#define CAVM_NIC_CHAN_IDX_E_LBKX_CHX_CN83XX(a,b) (0x80 + 0x40 * (a) + (b))
#define CAVM_NIC_CHAN_IDX_E_RGXX_LMACX_CHX(a,b,c) (0x40 + 0x20 * (a) + 8 * (b) + (c))
 ...
 */
#define CAVM_NIC_CPI_ALG_E_DIFF (3)
#define CAVM_NIC_CPI_ALG_E_NONE (0)
#define CAVM_NIC_CPI_ALG_E_VLAN (1)
#define CAVM_NIC_CPI_ALG_E_VLAN16 (2)
 ...
 */
#define CAVM_NIC_CQE_SEND_STATUS_E_CK_DERR (0x8a)
#define CAVM_NIC_CQE_SEND_STATUS_E_CK_PERR (0x8b)
#define CAVM_NIC_CQE_SEND_STATUS_E_DATA_FAULT (0x84)
#define CAVM_NIC_CQE_SEND_STATUS_E_DESC_FAULT (0x10)
#define CAVM_NIC_CQE_SEND_STATUS_E_DESC_SEQUENCE_ERR (0x8c)
#define CAVM_NIC_CQE_SEND_STATUS_E_GOOD (0)
#define CAVM_NIC_CQE_SEND_STATUS_E_HDR_CONS_ERR (0x11)
#define CAVM_NIC_CQE_SEND_STATUS_E_IMM_SIZE_OFLOW (0x80)
#define CAVM_NIC_CQE_SEND_STATUS_E_LOCK_VIOL (0x83)
#define CAVM_NIC_CQE_SEND_STATUS_E_MAX_SIZE_VIOL (0x13)
#define CAVM_NIC_CQE_SEND_STATUS_E_MEM_FAULT (0x87)
#define CAVM_NIC_CQE_SEND_STATUS_E_SUBDC_ERR (0x12)
#define CAVM_NIC_CQE_SEND_STATUS_E_TSTMP_CONFLICT (0x85)
#define CAVM_NIC_CQE_SEND_STATUS_E_TSTMP_TIMEOUT (0x86)
 ...
 */
#define CAVM_NIC_CQE_TYPE_E_INVALID (0)
#define CAVM_NIC_CQE_TYPE_E_RX (2)
#define CAVM_NIC_CQE_TYPE_E_RX_SPLT (3)
#define CAVM_NIC_CQE_TYPE_E_SEND (8)
#define CAVM_NIC_CQE_TYPE_E_SEND_PTP (9)
 ...
 */
#define CAVM_NIC_ERRLEV_E_L2 (1)
#define CAVM_NIC_ERRLEV_E_L3 (2)
#define CAVM_NIC_ERRLEV_E_L4 (3)
#define CAVM_NIC_ERRLEV_E_LE (4)
#define CAVM_NIC_ERRLEV_E_LF (5)
#define CAVM_NIC_ERRLEV_E_RE (0)
 ...
 */
#define CAVM_NIC_ERROP_E_IP_CHK (0x42)
#define CAVM_NIC_ERROP_E_IP_HOP (0x45)
#define CAVM_NIC_ERROP_E_IP_MAL (0x43)
#define CAVM_NIC_ERROP_E_IP_MALD (0x44)
#define CAVM_NIC_ERROP_E_IP_NOT (0x41)
#define CAVM_NIC_ERROP_E_L2_LENMISM (0x27)
#define CAVM_NIC_ERROP_E_L2_MAL (0x24)
#define CAVM_NIC_ERROP_E_L2_OVERSIZE (0x25)
#define CAVM_NIC_ERROP_E_L2_PCLP (0x28)
#define CAVM_NIC_ERROP_E_L2_UNDERSIZE (0x26)
#define CAVM_NIC_ERROP_E_L3_ICRC (0x46)
#define CAVM_NIC_ERROP_E_L3_PCLP (0x47)
#define CAVM_NIC_ERROP_E_L4_CHK (0x62)
#define CAVM_NIC_ERROP_E_L4_MAL (0x61)
#define CAVM_NIC_ERROP_E_L4_PCLP (0x67)
#define CAVM_NIC_ERROP_E_L4_PORT (0x64)
#define CAVM_NIC_ERROP_E_PREL2_ERR (0x1f)
#define CAVM_NIC_ERROP_E_RBDR_TRUNC (0x70)
#define CAVM_NIC_ERROP_E_RE_FCS (7)
#define CAVM_NIC_ERROP_E_RE_JABBER (2)
#define CAVM_NIC_ERROP_E_RE_NONE (0)
#define CAVM_NIC_ERROP_E_RE_PARTIAL (1)
#define CAVM_NIC_ERROP_E_RE_RX_CTL (0xb)
#define CAVM_NIC_ERROP_E_RE_TERMINATE (9)
#define CAVM_NIC_ERROP_E_TCP_FLAG (0x65)
#define CAVM_NIC_ERROP_E_TCP_OFFSET (0x66)
#define CAVM_NIC_ERROP_E_TUN_MAL (0x1d)
#define CAVM_NIC_ERROP_E_TUN_PCLP (0x1e)
#define CAVM_NIC_ERROP_E_UDP_LEN (0x63)
 ...
 */
#define CAVM_NIC_ETHERTYPE_E_ARP (0x806)
#define CAVM_NIC_ETHERTYPE_E_CNM (0x22e9)
#define CAVM_NIC_ETHERTYPE_E_IP (0x800)
#define CAVM_NIC_ETHERTYPE_E_IP6 (0x86dd)
#define CAVM_NIC_ETHERTYPE_E_MPLS_8847 (0x8847)
#define CAVM_NIC_ETHERTYPE_E_MPLS_8848 (0x8848)
#define CAVM_NIC_ETHERTYPE_E_REVARP (0x8035)
#define CAVM_NIC_ETHERTYPE_E_ROCE (0x8915)
#define CAVM_NIC_ETHERTYPE_E_VLAN (0x8100)
#define CAVM_NIC_ETHERTYPE_E_VLAN_88A8 (0x88a8)
#define CAVM_NIC_ETHERTYPE_E_VLAN_9100 (0x9100)
#define CAVM_NIC_ETHERTYPE_E_VLAN_9200 (0x9200)
#define CAVM_NIC_ETHERTYPE_E_VLAN_9300 (0x9300)
 ...
 */
#define CAVM_NIC_ETYPE_ALG_E_ENDPARSE (2)
#define CAVM_NIC_ETYPE_ALG_E_NONE (0)
#define CAVM_NIC_ETYPE_ALG_E_SKIP (1)
#define CAVM_NIC_ETYPE_ALG_E_VLAN (3)
#define CAVM_NIC_ETYPE_ALG_E_VLAN_STRIP (4)
 ...
 */
#define CAVM_NIC_INTF_BLOCK_E_BGXX(a) (8 + (a))
#define CAVM_NIC_INTF_BLOCK_E_DPI (4)
#define CAVM_NIC_INTF_BLOCK_E_LBKX(a) (0 + (a))
#define CAVM_NIC_INTF_BLOCK_E_RX(a) (0 + (a))
 ...
 * NIC_PF_INTF()_BP_CFG.
 */
#define CAVM_NIC_INTF_E_BGXX(a) (0 + (a))
#define CAVM_NIC_INTF_E_LBKX_CN81XX(a) (3 + (a))
#define CAVM_NIC_INTF_E_LBKX_CN83XX(a) (4 + (a))
#define CAVM_NIC_INTF_E_RGXX(a) (2 + (a))
 ...
 */
#define CAVM_NIC_IPPROTO_E_AH (0x33)
#define CAVM_NIC_IPPROTO_E_DEST (0x3c)
#define CAVM_NIC_IPPROTO_E_ESP (0x32)
#define CAVM_NIC_IPPROTO_E_FRAG (0x2c)
#define CAVM_NIC_IPPROTO_E_GRE (0x2f)
#define CAVM_NIC_IPPROTO_E_HOP_BY_HOP (0)
#define CAVM_NIC_IPPROTO_E_IP4 (4)
#define CAVM_NIC_IPPROTO_E_IP6 (0x29)
#define CAVM_NIC_IPPROTO_E_IPCOMP (0x6c)
#define CAVM_NIC_IPPROTO_E_ROUTING (0x2b)
#define CAVM_NIC_IPPROTO_E_TCP (6)
#define CAVM_NIC_IPPROTO_E_UDP (0x11)
 ...
 */
#define CAVM_NIC_L3TYPE_E_ET_STOP (0xd)
#define CAVM_NIC_L3TYPE_E_GRH (1)
#define CAVM_NIC_L3TYPE_E_IP4 (4)
#define CAVM_NIC_L3TYPE_E_IP4_OPT (5)
#define CAVM_NIC_L3TYPE_E_IP6 (6)
#define CAVM_NIC_L3TYPE_E_IP6_OPT (7)
#define CAVM_NIC_L3TYPE_E_NONE (0)
#define CAVM_NIC_L3TYPE_E_OTHER (0xe)
 ...
 */
#define CAVM_NIC_L4TYPE_E_BTH (5)
#define CAVM_NIC_L4TYPE_E_GRE (7)
#define CAVM_NIC_L4TYPE_E_IPCOMP (3)
#define CAVM_NIC_L4TYPE_E_IPFRAG (2)
#define CAVM_NIC_L4TYPE_E_IPSEC_ESP (1)
#define CAVM_NIC_L4TYPE_E_NONE (0)
#define CAVM_NIC_L4TYPE_E_NVGRE (0xc)
#define CAVM_NIC_L4TYPE_E_OTHER (0xe)
#define CAVM_NIC_L4TYPE_E_SCTP (6)
#define CAVM_NIC_L4TYPE_E_TCP (4)
#define CAVM_NIC_L4TYPE_E_UDP (8)
#define CAVM_NIC_L4TYPE_E_UDP_BTH (0xb)
#define CAVM_NIC_L4TYPE_E_UDP_GENEVE (9)
#define CAVM_NIC_L4TYPE_E_UDP_VXLAN (0xa)
 ...
 */
#define CAVM_NIC_LBK_RX_CONN_E_LBKX_CN81XX(a) (0 + (a))
#define CAVM_NIC_LBK_RX_CONN_E_LBKX_CN83XX(a) (2 + (a))
 ...
 */
#define CAVM_NIC_LBK_TX_CONN_E_LBKX_CN81XX(a) (0 + (a))
#define CAVM_NIC_LBK_TX_CONN_E_LBKX_CN83XX(a) (1 + 2 * (a))
 ...
 */
#define CAVM_NIC_LMAC_E_BGXX_LMACX(a,b) (0 + 4 * (a) + (b))
#define CAVM_NIC_LMAC_E_LBKX_CN81XX(a) (9 + (a))
#define CAVM_NIC_LMAC_E_LBKX_CN83XX(a) (0x10 + (a))
#define CAVM_NIC_LMAC_E_RGXX_LMACX(a,b) (8 + 4 * (a) + (b))
 ...
 */
#define CAVM_NIC_PF_INT_VEC_E_ECC0_DBE (1)
#define CAVM_NIC_PF_INT_VEC_E_ECC0_SBE (0)
#define CAVM_NIC_PF_INT_VEC_E_ECC1_DBE (3)
#define CAVM_NIC_PF_INT_VEC_E_ECC1_SBE (2)
#define CAVM_NIC_PF_INT_VEC_E_ECC2_DBE (5)
#define CAVM_NIC_PF_INT_VEC_E_ECC2_SBE (4)
#define CAVM_NIC_PF_INT_VEC_E_ECC3_DBE (7)
#define CAVM_NIC_PF_INT_VEC_E_ECC3_SBE (6)
#define CAVM_NIC_PF_INT_VEC_E_MBOXX(a) (8 + (a))
 ...
 */
#define CAVM_NIC_RSS_ALG_E_GRE_IP (6)
#define CAVM_NIC_RSS_ALG_E_INNER_GRE_IP (0xc)
#define CAVM_NIC_RSS_ALG_E_INNER_IP (8)
#define CAVM_NIC_RSS_ALG_E_INNER_ROCE (0xd)
#define CAVM_NIC_RSS_ALG_E_INNER_SCTP_IP (0xb)
#define CAVM_NIC_RSS_ALG_E_INNER_TCP_IP (9)
#define CAVM_NIC_RSS_ALG_E_INNER_UDP_IP (0xa)
#define CAVM_NIC_RSS_ALG_E_IP (2)
#define CAVM_NIC_RSS_ALG_E_NONE (0)
#define CAVM_NIC_RSS_ALG_E_PORT (1)
#define CAVM_NIC_RSS_ALG_E_ROCE (7)
#define CAVM_NIC_RSS_ALG_E_SCTP_IP (5)
#define CAVM_NIC_RSS_ALG_E_TCP_IP (3)
#define CAVM_NIC_RSS_ALG_E_UDP_IP (4)
 ...
 */
#define CAVM_NIC_SEND_CKL4_E_NONE (0)
#define CAVM_NIC_SEND_CKL4_E_TCP (2)
#define CAVM_NIC_SEND_CKL4_E_UDP (1)
 ...
 */
#define CAVM_NIC_SEND_CRCALG_E_CKSUM (3)
#define CAVM_NIC_SEND_CRCALG_E_CRC32 (0)
#define CAVM_NIC_SEND_CRCALG_E_CRC32C (1)
#define CAVM_NIC_SEND_CRCALG_E_ICRC (2)
 ...
 */
#define CAVM_NIC_SEND_LD_TYPE_E_LDD (0)
#define CAVM_NIC_SEND_LD_TYPE_E_LDT (1)
#define CAVM_NIC_SEND_LD_TYPE_E_LDWB (2)
 ...
 */
#define CAVM_NIC_SEND_MEMALG_E_ADD (8)
#define CAVM_NIC_SEND_MEMALG_E_ADDLEN (0xa)
#define CAVM_NIC_SEND_MEMALG_E_SET (0)
#define CAVM_NIC_SEND_MEMALG_E_SUB (9)
#define CAVM_NIC_SEND_MEMALG_E_SUBLEN (0xb)
 ...
 */
#define CAVM_NIC_SEND_MEMDSZ_E_B16 (2)
#define CAVM_NIC_SEND_MEMDSZ_E_B32 (1)
#define CAVM_NIC_SEND_MEMDSZ_E_B64 (0)
#define CAVM_NIC_SEND_MEMDSZ_E_B8 (3)
 ...
 */
#define CAVM_NIC_SEND_SUBDC_E_CRC (2)
#define CAVM_NIC_SEND_SUBDC_E_EOD (0xf)
#define CAVM_NIC_SEND_SUBDC_E_GATHER (4)
#define CAVM_NIC_SEND_SUBDC_E_HDR (1)
#define CAVM_NIC_SEND_SUBDC_E_IMM (3)
#define CAVM_NIC_SEND_SUBDC_E_INVALID (0)
#define CAVM_NIC_SEND_SUBDC_E_MEM (5)
#define CAVM_NIC_SEND_SUBDC_E_SOD (0xe)
 ...
 */
#define CAVM_NIC_STAT_RQ_E_OCTS (0)
#define CAVM_NIC_STAT_RQ_E_PKTS (1)
 ...
 */
#define CAVM_NIC_STAT_SQ_E_OCTS (0)
#define CAVM_NIC_STAT_SQ_E_PKTS (1)
 ...
 */
#define CAVM_NIC_STAT_VNIC_RX_E_RX_BCAST (2)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_DRP_BCAST (0xa)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_DRP_L3BCAST (0xc)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_DRP_L3MCAST (0xd)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_DRP_MCAST (0xb)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_FCS (8)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_L2ERR (9)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_MCAST (3)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_OCTS (0)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_ORUN (6)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_ORUN_OCTS (7)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_RED (4)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_RED_OCTS (5)
#define CAVM_NIC_STAT_VNIC_RX_E_RX_UCAST (1)
 ...
 */
#define CAVM_NIC_STAT_VNIC_TX_E_TX_BCAST (2)
#define CAVM_NIC_STAT_VNIC_TX_E_TX_DROP (4)
#define CAVM_NIC_STAT_VNIC_TX_E_TX_MCAST (3)
#define CAVM_NIC_STAT_VNIC_TX_E_TX_OCTS (0)
#define CAVM_NIC_STAT_VNIC_TX_E_TX_UCAST (1)
 ...
 * Enumerates the MSI-X interrupt vectors.
 */
#define CAVM_NIC_VF_INT_VEC_E_CQX(a) (0 + (a))
#define CAVM_NIC_VF_INT_VEC_E_MISC (0x12)
#define CAVM_NIC_VF_INT_VEC_E_QS_ERR (0x13)
#define CAVM_NIC_VF_INT_VEC_E_RBDRX(a) (0x10 + (a))
#define CAVM_NIC_VF_INT_VEC_E_SQX(a) (8 + (a))
 ...
 */
union cavm_nic_cqe_rx2_s
{
    uint64_t u;
    struct cavm_nic_cqe_rx2_s_s
    {
    ...
    /* struct cavm_nic_cqe_rx2_s_s cn; */
};
 ...
 */
union cavm_nic_cqe_rx_s
{
    uint64_t u[6];
    struct cavm_nic_cqe_rx_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
 ...
 */
union cavm_nic_cqe_send_s
{
    uint64_t u[2];
    struct cavm_nic_cqe_send_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
 ...
 */
union cavm_nic_rbdr_entry_s
{
    uint64_t u;
    struct cavm_nic_rbdr_entry_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_rbdr_entry_s_s cn; */
};
 ...
 */
union cavm_nic_send_crc_s
{
    uint64_t u[2];
    struct cavm_nic_send_crc_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_send_crc_s_s cn; */
};
 ...
 */
union cavm_nic_send_gather_s
{
    uint64_t u[2];
    struct cavm_nic_send_gather_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_send_gather_s_s cn; */
};
 ...
 */
union cavm_nic_send_hdr_s
{
    uint64_t u[2];
    struct cavm_nic_send_hdr_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_send_hdr_s_s cn; */
};
 ...
 */
union cavm_nic_send_imm_s
{
    uint64_t u[2];
    struct cavm_nic_send_imm_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_send_imm_s_s cn; */
};
 ...
 */
union cavm_nic_send_mem_s
{
    uint64_t u[2];
    struct cavm_nic_send_mem_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_send_mem_s_s cn; */
};
 ...
 */
union cavm_nic_pf_bist0_status
{
    uint64_t u;
    struct cavm_nic_pf_bist0_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_bist0_status_s cn; */
};
typedef union cavm_nic_pf_bist0_status cavm_nic_pf_bist0_status_t;

#define CAVM_NIC_PF_BIST0_STATUS CAVM_NIC_PF_BIST0_STATUS_FUNC()
static inline uint64_t CAVM_NIC_PF_BIST0_STATUS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_BIST0_STATUS_FUNC(void)
{
...
#define bustype_CAVM_NIC_PF_BIST0_STATUS CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_BIST0_STATUS "NIC_PF_BIST0_STATUS"
#define device_bar_CAVM_NIC_PF_BIST0_STATUS 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_BIST0_STATUS 0
#define arguments_CAVM_NIC_PF_BIST0_STATUS -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_bist1_status
{
    uint64_t u;
    struct cavm_nic_pf_bist1_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_bist1_status_s cn; */
};
typedef union cavm_nic_pf_bist1_status cavm_nic_pf_bist1_status_t;

#define CAVM_NIC_PF_BIST1_STATUS CAVM_NIC_PF_BIST1_STATUS_FUNC()
static inline uint64_t CAVM_NIC_PF_BIST1_STATUS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_BIST1_STATUS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_BIST1_STATUS CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_BIST1_STATUS "NIC_PF_BIST1_STATUS"
#define device_bar_CAVM_NIC_PF_BIST1_STATUS 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_BIST1_STATUS 0
#define arguments_CAVM_NIC_PF_BIST1_STATUS -1,-1,-1,-1
 ...
 * See NIC_PF_BIST0_STATUS.
 */
union cavm_nic_pf_bist2_status
{
    uint64_t u;
    struct cavm_nic_pf_bist2_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_bist2_status_s cn; */
};
typedef union cavm_nic_pf_bist2_status cavm_nic_pf_bist2_status_t;

#define CAVM_NIC_PF_BIST2_STATUS CAVM_NIC_PF_BIST2_STATUS_FUNC()
static inline uint64_t CAVM_NIC_PF_BIST2_STATUS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_BIST2_STATUS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_BIST2_STATUS CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_BIST2_STATUS "NIC_PF_BIST2_STATUS"
#define device_bar_CAVM_NIC_PF_BIST2_STATUS 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_BIST2_STATUS 0
#define arguments_CAVM_NIC_PF_BIST2_STATUS -1,-1,-1,-1
 ...
 * See NIC_PF_BIST0_STATUS.
 */
union cavm_nic_pf_bist3_status
{
    uint64_t u;
    struct cavm_nic_pf_bist3_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_bist3_status_s cn; */
};
typedef union cavm_nic_pf_bist3_status cavm_nic_pf_bist3_status_t;

#define CAVM_NIC_PF_BIST3_STATUS CAVM_NIC_PF_BIST3_STATUS_FUNC()
static inline uint64_t CAVM_NIC_PF_BIST3_STATUS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_BIST3_STATUS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_BIST3_STATUS CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_BIST3_STATUS "NIC_PF_BIST3_STATUS"
#define device_bar_CAVM_NIC_PF_BIST3_STATUS 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_BIST3_STATUS 0
#define arguments_CAVM_NIC_PF_BIST3_STATUS -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_bist4_status
{
    uint64_t u;
    struct cavm_nic_pf_bist4_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_bist4_status_s cn; */
};
typedef union cavm_nic_pf_bist4_status cavm_nic_pf_bist4_status_t;

#define CAVM_NIC_PF_BIST4_STATUS CAVM_NIC_PF_BIST4_STATUS_FUNC()
static inline uint64_t CAVM_NIC_PF_BIST4_STATUS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_BIST4_STATUS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_BIST4_STATUS CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_BIST4_STATUS "NIC_PF_BIST4_STATUS"
#define device_bar_CAVM_NIC_PF_BIST4_STATUS 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_BIST4_STATUS 0
#define arguments_CAVM_NIC_PF_BIST4_STATUS -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_bp_cfg
{
    uint64_t u;
    struct cavm_nic_pf_bp_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_bp_cfg_s cn; */
};
typedef union cavm_nic_pf_bp_cfg cavm_nic_pf_bp_cfg_t;

#define CAVM_NIC_PF_BP_CFG CAVM_NIC_PF_BP_CFG_FUNC()
static inline uint64_t CAVM_NIC_PF_BP_CFG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_BP_CFG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_BP_CFG CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_BP_CFG "NIC_PF_BP_CFG"
#define device_bar_CAVM_NIC_PF_BP_CFG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_BP_CFG 0
#define arguments_CAVM_NIC_PF_BP_CFG -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_cfg
{
    uint64_t u;
    struct cavm_nic_pf_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_cfg_s cn; */
};
typedef union cavm_nic_pf_cfg cavm_nic_pf_cfg_t;

#define CAVM_NIC_PF_CFG CAVM_NIC_PF_CFG_FUNC()
static inline uint64_t CAVM_NIC_PF_CFG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_CFG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_CFG CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CFG "NIC_PF_CFG"
#define device_bar_CAVM_NIC_PF_CFG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CFG 0
#define arguments_CAVM_NIC_PF_CFG -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_chanx_credit
{
    uint64_t u;
    struct cavm_nic_pf_chanx_credit_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_chanx_credit_s cn8; */
    /* struct cavm_nic_pf_chanx_credit_s cn81xx; */
    struct cavm_nic_pf_chanx_credit_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t cc_unit_cnt           : 20; /**< [ 31: 12](R/W/H) Channel-credit unit count. This value, plus 1 MTU, represents the maximum outstanding
...
#define bustype_CAVM_NIC_PF_CHANX_CREDIT(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CHANX_CREDIT(a) "NIC_PF_CHANX_CREDIT"
#define device_bar_CAVM_NIC_PF_CHANX_CREDIT(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CHANX_CREDIT(a) (a)
#define arguments_CAVM_NIC_PF_CHANX_CREDIT(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_chanx_rx_bp_cfg
{
    uint64_t u;
    struct cavm_nic_pf_chanx_rx_bp_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_chanx_rx_bp_cfg_s cn8; */
    struct cavm_nic_pf_chanx_rx_bp_cfg_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ena                   : 1;  /**< [ 63: 63](R/W) This bit is set to enable backpressure for this channel. */
        uint64_t reserved_8_62         : 55;
    ...
    /* struct cavm_nic_pf_chanx_rx_bp_cfg_s cn83xx; */
};
...
#define bustype_CAVM_NIC_PF_CHANX_RX_BP_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CHANX_RX_BP_CFG(a) "NIC_PF_CHANX_RX_BP_CFG"
#define device_bar_CAVM_NIC_PF_CHANX_RX_BP_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CHANX_RX_BP_CFG(a) (a)
#define arguments_CAVM_NIC_PF_CHANX_RX_BP_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_chanx_rx_cfg
{
    uint64_t u;
    struct cavm_nic_pf_chanx_rx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_chanx_rx_cfg_s cn8; */
    struct cavm_nic_pf_chanx_rx_cfg_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cpi_alg               : 2;  /**< [ 63: 62](R/W) Algorithm used in CPI calculation. Enumerated by NIC_CPI_ALG_E. */
        uint64_t reserved_59_61        : 3;
    ...
    /* struct cavm_nic_pf_chanx_rx_cfg_s cn83xx; */
};
...
#define bustype_CAVM_NIC_PF_CHANX_RX_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CHANX_RX_CFG(a) "NIC_PF_CHANX_RX_CFG"
#define device_bar_CAVM_NIC_PF_CHANX_RX_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CHANX_RX_CFG(a) (a)
#define arguments_CAVM_NIC_PF_CHANX_RX_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_chanx_sw_xoff
{
    uint64_t u;
    struct cavm_nic_pf_chanx_sw_xoff_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
    ...
    /* struct cavm_nic_pf_chanx_sw_xoff_s cn; */
};
...
#define bustype_CAVM_NIC_PF_CHANX_SW_XOFF(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CHANX_SW_XOFF(a) "NIC_PF_CHANX_SW_XOFF"
#define device_bar_CAVM_NIC_PF_CHANX_SW_XOFF(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CHANX_SW_XOFF(a) (a)
#define arguments_CAVM_NIC_PF_CHANX_SW_XOFF(a) (a),-1,-1,-1
 ...
 * Index enumerated by NIC_CHAN_IDX_E.
 */
union cavm_nic_pf_chanx_tx_cfg
{
    uint64_t u;
    struct cavm_nic_pf_chanx_tx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_chanx_tx_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_PF_CHANX_TX_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CHANX_TX_CFG(a) "NIC_PF_CHANX_TX_CFG"
#define device_bar_CAVM_NIC_PF_CHANX_TX_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CHANX_TX_CFG(a) (a)
#define arguments_CAVM_NIC_PF_CHANX_TX_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_const
{
    uint64_t u;
    struct cavm_nic_pf_const_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_const_s cn; */
};
typedef union cavm_nic_pf_const cavm_nic_pf_const_t;

#define CAVM_NIC_PF_CONST CAVM_NIC_PF_CONST_FUNC()
static inline uint64_t CAVM_NIC_PF_CONST_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_CONST_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_CONST CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CONST "NIC_PF_CONST"
#define device_bar_CAVM_NIC_PF_CONST 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CONST 0
#define arguments_CAVM_NIC_PF_CONST -1,-1,-1,-1
 ...
 * This register contains constants for software discovery.
 */
union cavm_nic_pf_const1
{
    uint64_t u;
    struct cavm_nic_pf_const1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_const1_s cn; */
};
typedef union cavm_nic_pf_const1 cavm_nic_pf_const1_t;

#define CAVM_NIC_PF_CONST1 CAVM_NIC_PF_CONST1_FUNC()
static inline uint64_t CAVM_NIC_PF_CONST1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_CONST1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_CONST1 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CONST1 "NIC_PF_CONST1"
#define device_bar_CAVM_NIC_PF_CONST1 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CONST1 0
#define arguments_CAVM_NIC_PF_CONST1 -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_cpix_cfg
{
    uint64_t u;
    struct cavm_nic_pf_cpix_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_cpix_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_PF_CPIX_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CPIX_CFG(a) "NIC_PF_CPIX_CFG"
#define device_bar_CAVM_NIC_PF_CPIX_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CPIX_CFG(a) (a)
#define arguments_CAVM_NIC_PF_CPIX_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_cq_avg_cfg
{
    uint64_t u;
    struct cavm_nic_pf_cq_avg_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_cq_avg_cfg_s cn; */
};
typedef union cavm_nic_pf_cq_avg_cfg cavm_nic_pf_cq_avg_cfg_t;

#define CAVM_NIC_PF_CQ_AVG_CFG CAVM_NIC_PF_CQ_AVG_CFG_FUNC()
static inline uint64_t CAVM_NIC_PF_CQ_AVG_CFG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_CQ_AVG_CFG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_CQ_AVG_CFG CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CQ_AVG_CFG "NIC_PF_CQ_AVG_CFG"
#define device_bar_CAVM_NIC_PF_CQ_AVG_CFG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CQ_AVG_CFG 0
#define arguments_CAVM_NIC_PF_CQ_AVG_CFG -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_cqm_cfg
{
    uint64_t u;
    struct cavm_nic_pf_cqm_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_cqm_cfg_s cn; */
};
typedef union cavm_nic_pf_cqm_cfg cavm_nic_pf_cqm_cfg_t;

#define CAVM_NIC_PF_CQM_CFG CAVM_NIC_PF_CQM_CFG_FUNC()
static inline uint64_t CAVM_NIC_PF_CQM_CFG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_CQM_CFG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_CQM_CFG CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CQM_CFG "NIC_PF_CQM_CFG"
#define device_bar_CAVM_NIC_PF_CQM_CFG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CQM_CFG 0
#define arguments_CAVM_NIC_PF_CQM_CFG -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_cqm_test
{
    uint64_t u;
    struct cavm_nic_pf_cqm_test_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_cqm_test_s cn; */
};
typedef union cavm_nic_pf_cqm_test cavm_nic_pf_cqm_test_t;

#define CAVM_NIC_PF_CQM_TEST CAVM_NIC_PF_CQM_TEST_FUNC()
static inline uint64_t CAVM_NIC_PF_CQM_TEST_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_CQM_TEST_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_CQM_TEST CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CQM_TEST "NIC_PF_CQM_TEST"
#define device_bar_CAVM_NIC_PF_CQM_TEST 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CQM_TEST 0
#define arguments_CAVM_NIC_PF_CQM_TEST -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_csi_test
{
    uint64_t u;
    struct cavm_nic_pf_csi_test_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t enable                : 4;  /**< [ 63: 60](R/W) Enable test mode. For diagnostic use only.
                                                                 Internal:
    ...
    /* struct cavm_nic_pf_csi_test_s cn; */
};
typedef union cavm_nic_pf_csi_test cavm_nic_pf_csi_test_t;

#define CAVM_NIC_PF_CSI_TEST CAVM_NIC_PF_CSI_TEST_FUNC()
static inline uint64_t CAVM_NIC_PF_CSI_TEST_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_CSI_TEST_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_CSI_TEST CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_CSI_TEST "NIC_PF_CSI_TEST"
#define device_bar_CAVM_NIC_PF_CSI_TEST 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_CSI_TEST 0
#define arguments_CAVM_NIC_PF_CSI_TEST -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_ecc0_cdis
{
    uint64_t u;
    struct cavm_nic_pf_ecc0_cdis_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_ecc0_cdis_s cn8; */
    /* struct cavm_nic_pf_ecc0_cdis_s cn81xx; */
    struct cavm_nic_pf_ecc0_cdis_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t blk3                  : 32; /**< [ 63: 32](R/W) Syndrome flip for group 0 block 3 memories.
                                                                 Internal:
...
typedef union cavm_nic_pf_ecc0_cdis cavm_nic_pf_ecc0_cdis_t;

#define CAVM_NIC_PF_ECC0_CDIS CAVM_NIC_PF_ECC0_CDIS_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC0_CDIS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC0_CDIS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC0_CDIS CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC0_CDIS "NIC_PF_ECC0_CDIS"
#define device_bar_CAVM_NIC_PF_ECC0_CDIS 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC0_CDIS 0
#define arguments_CAVM_NIC_PF_ECC0_CDIS -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_ecc0_dbe_ena_w1c
{
    uint64_t u;
    struct cavm_nic_pf_ecc0_dbe_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_ecc0_dbe_ena_w1c_s cn; */
};
typedef union cavm_nic_pf_ecc0_dbe_ena_w1c cavm_nic_pf_ecc0_dbe_ena_w1c_t;

#define CAVM_NIC_PF_ECC0_DBE_ENA_W1C CAVM_NIC_PF_ECC0_DBE_ENA_W1C_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC0_DBE_ENA_W1C_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC0_DBE_ENA_W1C_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC0_DBE_ENA_W1C CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC0_DBE_ENA_W1C "NIC_PF_ECC0_DBE_ENA_W1C"
#define device_bar_CAVM_NIC_PF_ECC0_DBE_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC0_DBE_ENA_W1C 0
#define arguments_CAVM_NIC_PF_ECC0_DBE_ENA_W1C -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_ecc0_dbe_ena_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc0_dbe_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_ecc0_dbe_ena_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc0_dbe_ena_w1s cavm_nic_pf_ecc0_dbe_ena_w1s_t;

#define CAVM_NIC_PF_ECC0_DBE_ENA_W1S CAVM_NIC_PF_ECC0_DBE_ENA_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC0_DBE_ENA_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC0_DBE_ENA_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC0_DBE_ENA_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC0_DBE_ENA_W1S "NIC_PF_ECC0_DBE_ENA_W1S"
#define device_bar_CAVM_NIC_PF_ECC0_DBE_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC0_DBE_ENA_W1S 0
#define arguments_CAVM_NIC_PF_ECC0_DBE_ENA_W1S -1,-1,-1,-1
 ...
 * Bits in each field are enumerated by NIC_PF_ECC0_FLIP0.
 */
union cavm_nic_pf_ecc0_dbe_int
{
    uint64_t u;
    struct cavm_nic_pf_ecc0_dbe_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_ecc0_dbe_int_s cn; */
};
typedef union cavm_nic_pf_ecc0_dbe_int cavm_nic_pf_ecc0_dbe_int_t;

#define CAVM_NIC_PF_ECC0_DBE_INT CAVM_NIC_PF_ECC0_DBE_INT_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC0_DBE_INT_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC0_DBE_INT_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC0_DBE_INT CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC0_DBE_INT "NIC_PF_ECC0_DBE_INT"
#define device_bar_CAVM_NIC_PF_ECC0_DBE_INT 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC0_DBE_INT 0
#define arguments_CAVM_NIC_PF_ECC0_DBE_INT -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_ecc0_dbe_int_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc0_dbe_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_ecc0_dbe_int_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc0_dbe_int_w1s cavm_nic_pf_ecc0_dbe_int_w1s_t;

#define CAVM_NIC_PF_ECC0_DBE_INT_W1S CAVM_NIC_PF_ECC0_DBE_INT_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC0_DBE_INT_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC0_DBE_INT_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC0_DBE_INT_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC0_DBE_INT_W1S "NIC_PF_ECC0_DBE_INT_W1S"
#define device_bar_CAVM_NIC_PF_ECC0_DBE_INT_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC0_DBE_INT_W1S 0
#define arguments_CAVM_NIC_PF_ECC0_DBE_INT_W1S -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_ecc0_flip0
{
    uint64_t u;
    struct cavm_nic_pf_ecc0_flip0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t blk3                  : 32; /**< [ 63: 32](R/W) Syndrome flip for group 0 block 3 memories.
                                                                 Internal:
    ...
    /* struct cavm_nic_pf_ecc0_flip0_s cn8; */
    /* struct cavm_nic_pf_ecc0_flip0_s cn81xx; */
    struct cavm_nic_pf_ecc0_flip0_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t blk3                  : 32; /**< [ 63: 32](R/W) Syndrome flip for group 0 block 3 memories.
                                                                 Internal:
...
typedef union cavm_nic_pf_ecc0_flip0 cavm_nic_pf_ecc0_flip0_t;

#define CAVM_NIC_PF_ECC0_FLIP0 CAVM_NIC_PF_ECC0_FLIP0_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC0_FLIP0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC0_FLIP0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC0_FLIP0 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC0_FLIP0 "NIC_PF_ECC0_FLIP0"
#define device_bar_CAVM_NIC_PF_ECC0_FLIP0 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC0_FLIP0 0
#define arguments_CAVM_NIC_PF_ECC0_FLIP0 -1,-1,-1,-1
 ...
 * writes to a corresponding RAM to test single-bit or double-bit error handling.
 */
union cavm_nic_pf_ecc0_flip1
{
    uint64_t u;
    struct cavm_nic_pf_ecc0_flip1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t blk3                  : 32; /**< [ 63: 32](R/W) Syndrome flip for group 0 block 3 memories.
                                                                 Internal:
    ...
    /* struct cavm_nic_pf_ecc0_flip1_s cn8; */
    /* struct cavm_nic_pf_ecc0_flip1_s cn81xx; */
    struct cavm_nic_pf_ecc0_flip1_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t blk3                  : 32; /**< [ 63: 32](R/W) Syndrome flip for group 0 block 3 memories.
                                                                 Internal:
...
typedef union cavm_nic_pf_ecc0_flip1 cavm_nic_pf_ecc0_flip1_t;

#define CAVM_NIC_PF_ECC0_FLIP1 CAVM_NIC_PF_ECC0_FLIP1_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC0_FLIP1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC0_FLIP1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC0_FLIP1 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC0_FLIP1 "NIC_PF_ECC0_FLIP1"
#define device_bar_CAVM_NIC_PF_ECC0_FLIP1 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC0_FLIP1 0
#define arguments_CAVM_NIC_PF_ECC0_FLIP1 -1,-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_nic_pf_ecc0_sbe_ena_w1c
{
    uint64_t u;
    struct cavm_nic_pf_ecc0_sbe_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_ecc0_sbe_ena_w1c_s cn; */
};
typedef union cavm_nic_pf_ecc0_sbe_ena_w1c cavm_nic_pf_ecc0_sbe_ena_w1c_t;

#define CAVM_NIC_PF_ECC0_SBE_ENA_W1C CAVM_NIC_PF_ECC0_SBE_ENA_W1C_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC0_SBE_ENA_W1C_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC0_SBE_ENA_W1C_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC0_SBE_ENA_W1C CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC0_SBE_ENA_W1C "NIC_PF_ECC0_SBE_ENA_W1C"
#define device_bar_CAVM_NIC_PF_ECC0_SBE_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC0_SBE_ENA_W1C 0
#define arguments_CAVM_NIC_PF_ECC0_SBE_ENA_W1C -1,-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_nic_pf_ecc0_sbe_ena_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc0_sbe_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_ecc0_sbe_ena_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc0_sbe_ena_w1s cavm_nic_pf_ecc0_sbe_ena_w1s_t;

#define CAVM_NIC_PF_ECC0_SBE_ENA_W1S CAVM_NIC_PF_ECC0_SBE_ENA_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC0_SBE_ENA_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC0_SBE_ENA_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC0_SBE_ENA_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC0_SBE_ENA_W1S "NIC_PF_ECC0_SBE_ENA_W1S"
#define device_bar_CAVM_NIC_PF_ECC0_SBE_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC0_SBE_ENA_W1S 0
#define arguments_CAVM_NIC_PF_ECC0_SBE_ENA_W1S -1,-1,-1,-1
 ...
 * Bits in each field are enumerated by NIC_PF_ECC0_FLIP0.
 */
union cavm_nic_pf_ecc0_sbe_int
{
    uint64_t u;
    struct cavm_nic_pf_ecc0_sbe_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t blk3                  : 32; /**< [ 63: 32](R/W1C/H) RAM error on group 0 block 3 memories. */
        uint64_t blk2                  : 16; /**< [ 31: 16](R/W1C/H) RAM error on group 0 block 2 memories. */
    ...
    /* struct cavm_nic_pf_ecc0_sbe_int_s cn; */
};
typedef union cavm_nic_pf_ecc0_sbe_int cavm_nic_pf_ecc0_sbe_int_t;

#define CAVM_NIC_PF_ECC0_SBE_INT CAVM_NIC_PF_ECC0_SBE_INT_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC0_SBE_INT_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC0_SBE_INT_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC0_SBE_INT CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC0_SBE_INT "NIC_PF_ECC0_SBE_INT"
#define device_bar_CAVM_NIC_PF_ECC0_SBE_INT 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC0_SBE_INT 0
#define arguments_CAVM_NIC_PF_ECC0_SBE_INT -1,-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_nic_pf_ecc0_sbe_int_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc0_sbe_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_ecc0_sbe_int_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc0_sbe_int_w1s cavm_nic_pf_ecc0_sbe_int_w1s_t;

#define CAVM_NIC_PF_ECC0_SBE_INT_W1S CAVM_NIC_PF_ECC0_SBE_INT_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC0_SBE_INT_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC0_SBE_INT_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC0_SBE_INT_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC0_SBE_INT_W1S "NIC_PF_ECC0_SBE_INT_W1S"
#define device_bar_CAVM_NIC_PF_ECC0_SBE_INT_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC0_SBE_INT_W1S 0
#define arguments_CAVM_NIC_PF_ECC0_SBE_INT_W1S -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_ecc1_cdis
{
    uint64_t u;
    struct cavm_nic_pf_ecc1_cdis_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc1_cdis_s cn8; */
    /* struct cavm_nic_pf_ecc1_cdis_s cn81xx; */
    struct cavm_nic_pf_ecc1_cdis_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t blk1                  : 16; /**< [ 39: 24](R/W) Syndrome flip for group 1 block 1 memories.
...
typedef union cavm_nic_pf_ecc1_cdis cavm_nic_pf_ecc1_cdis_t;

#define CAVM_NIC_PF_ECC1_CDIS CAVM_NIC_PF_ECC1_CDIS_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC1_CDIS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC1_CDIS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC1_CDIS CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC1_CDIS "NIC_PF_ECC1_CDIS"
#define device_bar_CAVM_NIC_PF_ECC1_CDIS 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC1_CDIS 0
#define arguments_CAVM_NIC_PF_ECC1_CDIS -1,-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_nic_pf_ecc1_dbe_ena_w1c
{
    uint64_t u;
    struct cavm_nic_pf_ecc1_dbe_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc1_dbe_ena_w1c_s cn; */
};
typedef union cavm_nic_pf_ecc1_dbe_ena_w1c cavm_nic_pf_ecc1_dbe_ena_w1c_t;

#define CAVM_NIC_PF_ECC1_DBE_ENA_W1C CAVM_NIC_PF_ECC1_DBE_ENA_W1C_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC1_DBE_ENA_W1C_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC1_DBE_ENA_W1C_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC1_DBE_ENA_W1C CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC1_DBE_ENA_W1C "NIC_PF_ECC1_DBE_ENA_W1C"
#define device_bar_CAVM_NIC_PF_ECC1_DBE_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC1_DBE_ENA_W1C 0
#define arguments_CAVM_NIC_PF_ECC1_DBE_ENA_W1C -1,-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_nic_pf_ecc1_dbe_ena_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc1_dbe_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc1_dbe_ena_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc1_dbe_ena_w1s cavm_nic_pf_ecc1_dbe_ena_w1s_t;

#define CAVM_NIC_PF_ECC1_DBE_ENA_W1S CAVM_NIC_PF_ECC1_DBE_ENA_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC1_DBE_ENA_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC1_DBE_ENA_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC1_DBE_ENA_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC1_DBE_ENA_W1S "NIC_PF_ECC1_DBE_ENA_W1S"
#define device_bar_CAVM_NIC_PF_ECC1_DBE_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC1_DBE_ENA_W1S 0
#define arguments_CAVM_NIC_PF_ECC1_DBE_ENA_W1S -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_ecc1_dbe_int
{
    uint64_t u;
    struct cavm_nic_pf_ecc1_dbe_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc1_dbe_int_s cn; */
};
typedef union cavm_nic_pf_ecc1_dbe_int cavm_nic_pf_ecc1_dbe_int_t;

#define CAVM_NIC_PF_ECC1_DBE_INT CAVM_NIC_PF_ECC1_DBE_INT_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC1_DBE_INT_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC1_DBE_INT_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC1_DBE_INT CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC1_DBE_INT "NIC_PF_ECC1_DBE_INT"
#define device_bar_CAVM_NIC_PF_ECC1_DBE_INT 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC1_DBE_INT 0
#define arguments_CAVM_NIC_PF_ECC1_DBE_INT -1,-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_nic_pf_ecc1_dbe_int_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc1_dbe_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc1_dbe_int_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc1_dbe_int_w1s cavm_nic_pf_ecc1_dbe_int_w1s_t;

#define CAVM_NIC_PF_ECC1_DBE_INT_W1S CAVM_NIC_PF_ECC1_DBE_INT_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC1_DBE_INT_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC1_DBE_INT_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC1_DBE_INT_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC1_DBE_INT_W1S "NIC_PF_ECC1_DBE_INT_W1S"
#define device_bar_CAVM_NIC_PF_ECC1_DBE_INT_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC1_DBE_INT_W1S 0
#define arguments_CAVM_NIC_PF_ECC1_DBE_INT_W1S -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_ecc1_flip0
{
    uint64_t u;
    struct cavm_nic_pf_ecc1_flip0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t blk1                  : 16; /**< [ 39: 24](R/W) Syndrome flip for group 1 block 1 memories.
    ...
    /* struct cavm_nic_pf_ecc1_flip0_s cn8; */
    /* struct cavm_nic_pf_ecc1_flip0_s cn81xx; */
    struct cavm_nic_pf_ecc1_flip0_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t blk1                  : 16; /**< [ 39: 24](R/W) Syndrome flip for group 1 block 1 memories.
...
typedef union cavm_nic_pf_ecc1_flip0 cavm_nic_pf_ecc1_flip0_t;

#define CAVM_NIC_PF_ECC1_FLIP0 CAVM_NIC_PF_ECC1_FLIP0_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC1_FLIP0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC1_FLIP0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC1_FLIP0 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC1_FLIP0 "NIC_PF_ECC1_FLIP0"
#define device_bar_CAVM_NIC_PF_ECC1_FLIP0 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC1_FLIP0 0
#define arguments_CAVM_NIC_PF_ECC1_FLIP0 -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_ecc1_flip1
{
    uint64_t u;
    struct cavm_nic_pf_ecc1_flip1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t blk1                  : 16; /**< [ 39: 24](R/W) Syndrome flip for group 1 block 1 memories.
    ...
    /* struct cavm_nic_pf_ecc1_flip1_s cn8; */
    /* struct cavm_nic_pf_ecc1_flip1_s cn81xx; */
    struct cavm_nic_pf_ecc1_flip1_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t blk1                  : 16; /**< [ 39: 24](R/W) Syndrome flip for group 1 block 1 memories.
...
typedef union cavm_nic_pf_ecc1_flip1 cavm_nic_pf_ecc1_flip1_t;

#define CAVM_NIC_PF_ECC1_FLIP1 CAVM_NIC_PF_ECC1_FLIP1_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC1_FLIP1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC1_FLIP1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC1_FLIP1 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC1_FLIP1 "NIC_PF_ECC1_FLIP1"
#define device_bar_CAVM_NIC_PF_ECC1_FLIP1 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC1_FLIP1 0
#define arguments_CAVM_NIC_PF_ECC1_FLIP1 -1,-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_nic_pf_ecc1_sbe_ena_w1c
{
    uint64_t u;
    struct cavm_nic_pf_ecc1_sbe_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc1_sbe_ena_w1c_s cn; */
};
typedef union cavm_nic_pf_ecc1_sbe_ena_w1c cavm_nic_pf_ecc1_sbe_ena_w1c_t;

#define CAVM_NIC_PF_ECC1_SBE_ENA_W1C CAVM_NIC_PF_ECC1_SBE_ENA_W1C_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC1_SBE_ENA_W1C_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC1_SBE_ENA_W1C_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC1_SBE_ENA_W1C CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC1_SBE_ENA_W1C "NIC_PF_ECC1_SBE_ENA_W1C"
#define device_bar_CAVM_NIC_PF_ECC1_SBE_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC1_SBE_ENA_W1C 0
#define arguments_CAVM_NIC_PF_ECC1_SBE_ENA_W1C -1,-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_nic_pf_ecc1_sbe_ena_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc1_sbe_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc1_sbe_ena_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc1_sbe_ena_w1s cavm_nic_pf_ecc1_sbe_ena_w1s_t;

#define CAVM_NIC_PF_ECC1_SBE_ENA_W1S CAVM_NIC_PF_ECC1_SBE_ENA_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC1_SBE_ENA_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC1_SBE_ENA_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC1_SBE_ENA_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC1_SBE_ENA_W1S "NIC_PF_ECC1_SBE_ENA_W1S"
#define device_bar_CAVM_NIC_PF_ECC1_SBE_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC1_SBE_ENA_W1S 0
#define arguments_CAVM_NIC_PF_ECC1_SBE_ENA_W1S -1,-1,-1,-1
 ...
 * Bits in each field are enumerated by NIC_PF_ECC1_FLIP0.
 */
union cavm_nic_pf_ecc1_sbe_int
{
    uint64_t u;
    struct cavm_nic_pf_ecc1_sbe_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t blk1                  : 16; /**< [ 39: 24](R/W1C/H) RAM error on group 1 block 1 memories. */
    ...
    /* struct cavm_nic_pf_ecc1_sbe_int_s cn; */
};
typedef union cavm_nic_pf_ecc1_sbe_int cavm_nic_pf_ecc1_sbe_int_t;

#define CAVM_NIC_PF_ECC1_SBE_INT CAVM_NIC_PF_ECC1_SBE_INT_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC1_SBE_INT_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC1_SBE_INT_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC1_SBE_INT CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC1_SBE_INT "NIC_PF_ECC1_SBE_INT"
#define device_bar_CAVM_NIC_PF_ECC1_SBE_INT 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC1_SBE_INT 0
#define arguments_CAVM_NIC_PF_ECC1_SBE_INT -1,-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_nic_pf_ecc1_sbe_int_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc1_sbe_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc1_sbe_int_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc1_sbe_int_w1s cavm_nic_pf_ecc1_sbe_int_w1s_t;

#define CAVM_NIC_PF_ECC1_SBE_INT_W1S CAVM_NIC_PF_ECC1_SBE_INT_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC1_SBE_INT_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC1_SBE_INT_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC1_SBE_INT_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC1_SBE_INT_W1S "NIC_PF_ECC1_SBE_INT_W1S"
#define device_bar_CAVM_NIC_PF_ECC1_SBE_INT_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC1_SBE_INT_W1S 0
#define arguments_CAVM_NIC_PF_ECC1_SBE_INT_W1S -1,-1,-1,-1
 ...
 * See NIC_PF_ECC0_CDIS.
 */
union cavm_nic_pf_ecc2_cdis
{
    uint64_t u;
    struct cavm_nic_pf_ecc2_cdis_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_50_63        : 14;
    ...
    /* struct cavm_nic_pf_ecc2_cdis_s cn; */
};
typedef union cavm_nic_pf_ecc2_cdis cavm_nic_pf_ecc2_cdis_t;

#define CAVM_NIC_PF_ECC2_CDIS CAVM_NIC_PF_ECC2_CDIS_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC2_CDIS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC2_CDIS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC2_CDIS CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC2_CDIS "NIC_PF_ECC2_CDIS"
#define device_bar_CAVM_NIC_PF_ECC2_CDIS 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC2_CDIS 0
#define arguments_CAVM_NIC_PF_ECC2_CDIS -1,-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_nic_pf_ecc2_dbe_ena_w1c
{
    uint64_t u;
    struct cavm_nic_pf_ecc2_dbe_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_50_63        : 14;
    ...
    /* struct cavm_nic_pf_ecc2_dbe_ena_w1c_s cn; */
};
typedef union cavm_nic_pf_ecc2_dbe_ena_w1c cavm_nic_pf_ecc2_dbe_ena_w1c_t;

#define CAVM_NIC_PF_ECC2_DBE_ENA_W1C CAVM_NIC_PF_ECC2_DBE_ENA_W1C_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC2_DBE_ENA_W1C_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC2_DBE_ENA_W1C_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC2_DBE_ENA_W1C CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC2_DBE_ENA_W1C "NIC_PF_ECC2_DBE_ENA_W1C"
#define device_bar_CAVM_NIC_PF_ECC2_DBE_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC2_DBE_ENA_W1C 0
#define arguments_CAVM_NIC_PF_ECC2_DBE_ENA_W1C -1,-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_nic_pf_ecc2_dbe_ena_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc2_dbe_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_50_63        : 14;
    ...
    /* struct cavm_nic_pf_ecc2_dbe_ena_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc2_dbe_ena_w1s cavm_nic_pf_ecc2_dbe_ena_w1s_t;

#define CAVM_NIC_PF_ECC2_DBE_ENA_W1S CAVM_NIC_PF_ECC2_DBE_ENA_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC2_DBE_ENA_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC2_DBE_ENA_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC2_DBE_ENA_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC2_DBE_ENA_W1S "NIC_PF_ECC2_DBE_ENA_W1S"
#define device_bar_CAVM_NIC_PF_ECC2_DBE_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC2_DBE_ENA_W1S 0
#define arguments_CAVM_NIC_PF_ECC2_DBE_ENA_W1S -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_ecc2_dbe_int
{
    uint64_t u;
    struct cavm_nic_pf_ecc2_dbe_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_50_63        : 14;
    ...
    /* struct cavm_nic_pf_ecc2_dbe_int_s cn; */
};
typedef union cavm_nic_pf_ecc2_dbe_int cavm_nic_pf_ecc2_dbe_int_t;

#define CAVM_NIC_PF_ECC2_DBE_INT CAVM_NIC_PF_ECC2_DBE_INT_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC2_DBE_INT_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC2_DBE_INT_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC2_DBE_INT CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC2_DBE_INT "NIC_PF_ECC2_DBE_INT"
#define device_bar_CAVM_NIC_PF_ECC2_DBE_INT 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC2_DBE_INT 0
#define arguments_CAVM_NIC_PF_ECC2_DBE_INT -1,-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_nic_pf_ecc2_dbe_int_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc2_dbe_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_50_63        : 14;
    ...
    /* struct cavm_nic_pf_ecc2_dbe_int_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc2_dbe_int_w1s cavm_nic_pf_ecc2_dbe_int_w1s_t;

#define CAVM_NIC_PF_ECC2_DBE_INT_W1S CAVM_NIC_PF_ECC2_DBE_INT_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC2_DBE_INT_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC2_DBE_INT_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC2_DBE_INT_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC2_DBE_INT_W1S "NIC_PF_ECC2_DBE_INT_W1S"
#define device_bar_CAVM_NIC_PF_ECC2_DBE_INT_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC2_DBE_INT_W1S 0
#define arguments_CAVM_NIC_PF_ECC2_DBE_INT_W1S -1,-1,-1,-1
 ...
 * See NIC_PF_ECC0_FLIP0.
 */
union cavm_nic_pf_ecc2_flip0
{
    uint64_t u;
    struct cavm_nic_pf_ecc2_flip0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_50_63        : 14;
        uint64_t blk0                  : 50; /**< [ 49:  0](R/W) Syndrome flip for group 2 block 0 memories.
    ...
    /* struct cavm_nic_pf_ecc2_flip0_s cn; */
};
typedef union cavm_nic_pf_ecc2_flip0 cavm_nic_pf_ecc2_flip0_t;

#define CAVM_NIC_PF_ECC2_FLIP0 CAVM_NIC_PF_ECC2_FLIP0_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC2_FLIP0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC2_FLIP0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC2_FLIP0 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC2_FLIP0 "NIC_PF_ECC2_FLIP0"
#define device_bar_CAVM_NIC_PF_ECC2_FLIP0 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC2_FLIP0 0
#define arguments_CAVM_NIC_PF_ECC2_FLIP0 -1,-1,-1,-1
 ...
 * See NIC_PF_ECC0_FLIP1.
 */
union cavm_nic_pf_ecc2_flip1
{
    uint64_t u;
    struct cavm_nic_pf_ecc2_flip1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_50_63        : 14;
        uint64_t blk0                  : 50; /**< [ 49:  0](R/W) Syndrome flip for group 2 block 0 memories.
    ...
    /* struct cavm_nic_pf_ecc2_flip1_s cn; */
};
typedef union cavm_nic_pf_ecc2_flip1 cavm_nic_pf_ecc2_flip1_t;

#define CAVM_NIC_PF_ECC2_FLIP1 CAVM_NIC_PF_ECC2_FLIP1_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC2_FLIP1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC2_FLIP1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC2_FLIP1 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC2_FLIP1 "NIC_PF_ECC2_FLIP1"
#define device_bar_CAVM_NIC_PF_ECC2_FLIP1 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC2_FLIP1 0
#define arguments_CAVM_NIC_PF_ECC2_FLIP1 -1,-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_nic_pf_ecc2_sbe_ena_w1c
{
    uint64_t u;
    struct cavm_nic_pf_ecc2_sbe_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_50_63        : 14;
    ...
    /* struct cavm_nic_pf_ecc2_sbe_ena_w1c_s cn; */
};
typedef union cavm_nic_pf_ecc2_sbe_ena_w1c cavm_nic_pf_ecc2_sbe_ena_w1c_t;

#define CAVM_NIC_PF_ECC2_SBE_ENA_W1C CAVM_NIC_PF_ECC2_SBE_ENA_W1C_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC2_SBE_ENA_W1C_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC2_SBE_ENA_W1C_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC2_SBE_ENA_W1C CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC2_SBE_ENA_W1C "NIC_PF_ECC2_SBE_ENA_W1C"
#define device_bar_CAVM_NIC_PF_ECC2_SBE_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC2_SBE_ENA_W1C 0
#define arguments_CAVM_NIC_PF_ECC2_SBE_ENA_W1C -1,-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_nic_pf_ecc2_sbe_ena_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc2_sbe_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_50_63        : 14;
    ...
    /* struct cavm_nic_pf_ecc2_sbe_ena_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc2_sbe_ena_w1s cavm_nic_pf_ecc2_sbe_ena_w1s_t;

#define CAVM_NIC_PF_ECC2_SBE_ENA_W1S CAVM_NIC_PF_ECC2_SBE_ENA_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC2_SBE_ENA_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC2_SBE_ENA_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC2_SBE_ENA_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC2_SBE_ENA_W1S "NIC_PF_ECC2_SBE_ENA_W1S"
#define device_bar_CAVM_NIC_PF_ECC2_SBE_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC2_SBE_ENA_W1S 0
#define arguments_CAVM_NIC_PF_ECC2_SBE_ENA_W1S -1,-1,-1,-1
 ...
 * Bits in each field are enumerated by NIC_PF_ECC2_FLIP0.
 */
union cavm_nic_pf_ecc2_sbe_int
{
    uint64_t u;
    struct cavm_nic_pf_ecc2_sbe_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_50_63        : 14;
        uint64_t blk0                  : 50; /**< [ 49:  0](R/W1C/H) RAM error on group 2 block 0 memories. */
    ...
    /* struct cavm_nic_pf_ecc2_sbe_int_s cn; */
};
typedef union cavm_nic_pf_ecc2_sbe_int cavm_nic_pf_ecc2_sbe_int_t;

#define CAVM_NIC_PF_ECC2_SBE_INT CAVM_NIC_PF_ECC2_SBE_INT_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC2_SBE_INT_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC2_SBE_INT_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC2_SBE_INT CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC2_SBE_INT "NIC_PF_ECC2_SBE_INT"
#define device_bar_CAVM_NIC_PF_ECC2_SBE_INT 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC2_SBE_INT 0
#define arguments_CAVM_NIC_PF_ECC2_SBE_INT -1,-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_nic_pf_ecc2_sbe_int_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc2_sbe_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_50_63        : 14;
    ...
    /* struct cavm_nic_pf_ecc2_sbe_int_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc2_sbe_int_w1s cavm_nic_pf_ecc2_sbe_int_w1s_t;

#define CAVM_NIC_PF_ECC2_SBE_INT_W1S CAVM_NIC_PF_ECC2_SBE_INT_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC2_SBE_INT_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC2_SBE_INT_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC2_SBE_INT_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC2_SBE_INT_W1S "NIC_PF_ECC2_SBE_INT_W1S"
#define device_bar_CAVM_NIC_PF_ECC2_SBE_INT_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC2_SBE_INT_W1S 0
#define arguments_CAVM_NIC_PF_ECC2_SBE_INT_W1S -1,-1,-1,-1
 ...
 * See NIC_PF_ECC0_CDIS.
 */
union cavm_nic_pf_ecc3_cdis
{
    uint64_t u;
    struct cavm_nic_pf_ecc3_cdis_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc3_cdis_s cn8; */
    /* struct cavm_nic_pf_ecc3_cdis_s cn81xx; */
    struct cavm_nic_pf_ecc3_cdis_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t blk1                  : 16; /**< [ 39: 24](R/W) Syndrome flip for group 3 block 1 memories.
...
typedef union cavm_nic_pf_ecc3_cdis cavm_nic_pf_ecc3_cdis_t;

#define CAVM_NIC_PF_ECC3_CDIS CAVM_NIC_PF_ECC3_CDIS_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC3_CDIS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC3_CDIS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC3_CDIS CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC3_CDIS "NIC_PF_ECC3_CDIS"
#define device_bar_CAVM_NIC_PF_ECC3_CDIS 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC3_CDIS 0
#define arguments_CAVM_NIC_PF_ECC3_CDIS -1,-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_nic_pf_ecc3_dbe_ena_w1c
{
    uint64_t u;
    struct cavm_nic_pf_ecc3_dbe_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc3_dbe_ena_w1c_s cn; */
};
typedef union cavm_nic_pf_ecc3_dbe_ena_w1c cavm_nic_pf_ecc3_dbe_ena_w1c_t;

#define CAVM_NIC_PF_ECC3_DBE_ENA_W1C CAVM_NIC_PF_ECC3_DBE_ENA_W1C_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC3_DBE_ENA_W1C_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC3_DBE_ENA_W1C_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC3_DBE_ENA_W1C CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC3_DBE_ENA_W1C "NIC_PF_ECC3_DBE_ENA_W1C"
#define device_bar_CAVM_NIC_PF_ECC3_DBE_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC3_DBE_ENA_W1C 0
#define arguments_CAVM_NIC_PF_ECC3_DBE_ENA_W1C -1,-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_nic_pf_ecc3_dbe_ena_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc3_dbe_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc3_dbe_ena_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc3_dbe_ena_w1s cavm_nic_pf_ecc3_dbe_ena_w1s_t;

#define CAVM_NIC_PF_ECC3_DBE_ENA_W1S CAVM_NIC_PF_ECC3_DBE_ENA_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC3_DBE_ENA_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC3_DBE_ENA_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC3_DBE_ENA_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC3_DBE_ENA_W1S "NIC_PF_ECC3_DBE_ENA_W1S"
#define device_bar_CAVM_NIC_PF_ECC3_DBE_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC3_DBE_ENA_W1S 0
#define arguments_CAVM_NIC_PF_ECC3_DBE_ENA_W1S -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_ecc3_dbe_int
{
    uint64_t u;
    struct cavm_nic_pf_ecc3_dbe_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc3_dbe_int_s cn; */
};
typedef union cavm_nic_pf_ecc3_dbe_int cavm_nic_pf_ecc3_dbe_int_t;

#define CAVM_NIC_PF_ECC3_DBE_INT CAVM_NIC_PF_ECC3_DBE_INT_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC3_DBE_INT_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC3_DBE_INT_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC3_DBE_INT CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC3_DBE_INT "NIC_PF_ECC3_DBE_INT"
#define device_bar_CAVM_NIC_PF_ECC3_DBE_INT 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC3_DBE_INT 0
#define arguments_CAVM_NIC_PF_ECC3_DBE_INT -1,-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_nic_pf_ecc3_dbe_int_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc3_dbe_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc3_dbe_int_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc3_dbe_int_w1s cavm_nic_pf_ecc3_dbe_int_w1s_t;

#define CAVM_NIC_PF_ECC3_DBE_INT_W1S CAVM_NIC_PF_ECC3_DBE_INT_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC3_DBE_INT_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC3_DBE_INT_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC3_DBE_INT_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC3_DBE_INT_W1S "NIC_PF_ECC3_DBE_INT_W1S"
#define device_bar_CAVM_NIC_PF_ECC3_DBE_INT_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC3_DBE_INT_W1S 0
#define arguments_CAVM_NIC_PF_ECC3_DBE_INT_W1S -1,-1,-1,-1
 ...
 * See NIC_PF_ECC0_FLIP0.
 */
union cavm_nic_pf_ecc3_flip0
{
    uint64_t u;
    struct cavm_nic_pf_ecc3_flip0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t blk1                  : 16; /**< [ 39: 24](R/W) Syndrome flip for group 3 block 1 memories.
    ...
    /* struct cavm_nic_pf_ecc3_flip0_s cn8; */
    /* struct cavm_nic_pf_ecc3_flip0_s cn81xx; */
    struct cavm_nic_pf_ecc3_flip0_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t blk1                  : 16; /**< [ 39: 24](R/W) Syndrome flip for group 3 block 1 memories.
...
typedef union cavm_nic_pf_ecc3_flip0 cavm_nic_pf_ecc3_flip0_t;

#define CAVM_NIC_PF_ECC3_FLIP0 CAVM_NIC_PF_ECC3_FLIP0_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC3_FLIP0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC3_FLIP0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC3_FLIP0 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC3_FLIP0 "NIC_PF_ECC3_FLIP0"
#define device_bar_CAVM_NIC_PF_ECC3_FLIP0 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC3_FLIP0 0
#define arguments_CAVM_NIC_PF_ECC3_FLIP0 -1,-1,-1,-1
 ...
 * See NIC_PF_ECC0_FLIP1.
 */
union cavm_nic_pf_ecc3_flip1
{
    uint64_t u;
    struct cavm_nic_pf_ecc3_flip1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t blk1                  : 16; /**< [ 39: 24](R/W) Syndrome flip for group 3 block 1 memories.
    ...
    /* struct cavm_nic_pf_ecc3_flip1_s cn8; */
    /* struct cavm_nic_pf_ecc3_flip1_s cn81xx; */
    struct cavm_nic_pf_ecc3_flip1_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t blk1                  : 16; /**< [ 39: 24](R/W) Syndrome flip for group 3 block 1 memories.
...
typedef union cavm_nic_pf_ecc3_flip1 cavm_nic_pf_ecc3_flip1_t;

#define CAVM_NIC_PF_ECC3_FLIP1 CAVM_NIC_PF_ECC3_FLIP1_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC3_FLIP1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC3_FLIP1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC3_FLIP1 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC3_FLIP1 "NIC_PF_ECC3_FLIP1"
#define device_bar_CAVM_NIC_PF_ECC3_FLIP1 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC3_FLIP1 0
#define arguments_CAVM_NIC_PF_ECC3_FLIP1 -1,-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_nic_pf_ecc3_sbe_ena_w1c
{
    uint64_t u;
    struct cavm_nic_pf_ecc3_sbe_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc3_sbe_ena_w1c_s cn; */
};
typedef union cavm_nic_pf_ecc3_sbe_ena_w1c cavm_nic_pf_ecc3_sbe_ena_w1c_t;

#define CAVM_NIC_PF_ECC3_SBE_ENA_W1C CAVM_NIC_PF_ECC3_SBE_ENA_W1C_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC3_SBE_ENA_W1C_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC3_SBE_ENA_W1C_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC3_SBE_ENA_W1C CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC3_SBE_ENA_W1C "NIC_PF_ECC3_SBE_ENA_W1C"
#define device_bar_CAVM_NIC_PF_ECC3_SBE_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC3_SBE_ENA_W1C 0
#define arguments_CAVM_NIC_PF_ECC3_SBE_ENA_W1C -1,-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_nic_pf_ecc3_sbe_ena_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc3_sbe_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc3_sbe_ena_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc3_sbe_ena_w1s cavm_nic_pf_ecc3_sbe_ena_w1s_t;

#define CAVM_NIC_PF_ECC3_SBE_ENA_W1S CAVM_NIC_PF_ECC3_SBE_ENA_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC3_SBE_ENA_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC3_SBE_ENA_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC3_SBE_ENA_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC3_SBE_ENA_W1S "NIC_PF_ECC3_SBE_ENA_W1S"
#define device_bar_CAVM_NIC_PF_ECC3_SBE_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC3_SBE_ENA_W1S 0
#define arguments_CAVM_NIC_PF_ECC3_SBE_ENA_W1S -1,-1,-1,-1
 ...
 * Bits in each field are enumerated by NIC_PF_ECC3_FLIP0.
 */
union cavm_nic_pf_ecc3_sbe_int
{
    uint64_t u;
    struct cavm_nic_pf_ecc3_sbe_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
        uint64_t blk1                  : 16; /**< [ 39: 24](R/W1C/H) RAM error on group 3 block 1 memories. */
    ...
    /* struct cavm_nic_pf_ecc3_sbe_int_s cn; */
};
typedef union cavm_nic_pf_ecc3_sbe_int cavm_nic_pf_ecc3_sbe_int_t;

#define CAVM_NIC_PF_ECC3_SBE_INT CAVM_NIC_PF_ECC3_SBE_INT_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC3_SBE_INT_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC3_SBE_INT_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC3_SBE_INT CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC3_SBE_INT "NIC_PF_ECC3_SBE_INT"
#define device_bar_CAVM_NIC_PF_ECC3_SBE_INT 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC3_SBE_INT 0
#define arguments_CAVM_NIC_PF_ECC3_SBE_INT -1,-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_nic_pf_ecc3_sbe_int_w1s
{
    uint64_t u;
    struct cavm_nic_pf_ecc3_sbe_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_ecc3_sbe_int_w1s_s cn; */
};
typedef union cavm_nic_pf_ecc3_sbe_int_w1s cavm_nic_pf_ecc3_sbe_int_w1s_t;

#define CAVM_NIC_PF_ECC3_SBE_INT_W1S CAVM_NIC_PF_ECC3_SBE_INT_W1S_FUNC()
static inline uint64_t CAVM_NIC_PF_ECC3_SBE_INT_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECC3_SBE_INT_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECC3_SBE_INT_W1S CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECC3_SBE_INT_W1S "NIC_PF_ECC3_SBE_INT_W1S"
#define device_bar_CAVM_NIC_PF_ECC3_SBE_INT_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECC3_SBE_INT_W1S 0
#define arguments_CAVM_NIC_PF_ECC3_SBE_INT_W1S -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_eco0
{
    uint64_t u;
    struct cavm_nic_pf_eco0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_nic_pf_eco0_s cn; */
};
typedef union cavm_nic_pf_eco0 cavm_nic_pf_eco0_t;

#define CAVM_NIC_PF_ECO0 CAVM_NIC_PF_ECO0_FUNC()
static inline uint64_t CAVM_NIC_PF_ECO0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECO0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECO0 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECO0 "NIC_PF_ECO0"
#define device_bar_CAVM_NIC_PF_ECO0 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECO0 0
#define arguments_CAVM_NIC_PF_ECO0 -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_eco1
{
    uint64_t u;
    struct cavm_nic_pf_eco1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t eco_rw                : 32; /**< [ 31:  0](R/W) Internal:
    ...
    /* struct cavm_nic_pf_eco1_s cn; */
};
typedef union cavm_nic_pf_eco1 cavm_nic_pf_eco1_t;

#define CAVM_NIC_PF_ECO1 CAVM_NIC_PF_ECO1_FUNC()
static inline uint64_t CAVM_NIC_PF_ECO1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECO1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECO1 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECO1 "NIC_PF_ECO1"
#define device_bar_CAVM_NIC_PF_ECO1 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECO1 0
#define arguments_CAVM_NIC_PF_ECO1 -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_eco2
{
    uint64_t u;
    struct cavm_nic_pf_eco2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t eco_rw                : 32; /**< [ 31:  0](R/W) Internal:
    ...
    /* struct cavm_nic_pf_eco2_s cn; */
};
typedef union cavm_nic_pf_eco2 cavm_nic_pf_eco2_t;

#define CAVM_NIC_PF_ECO2 CAVM_NIC_PF_ECO2_FUNC()
static inline uint64_t CAVM_NIC_PF_ECO2_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECO2_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECO2 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECO2 "NIC_PF_ECO2"
#define device_bar_CAVM_NIC_PF_ECO2 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECO2 0
#define arguments_CAVM_NIC_PF_ECO2 -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_eco3
{
    uint64_t u;
    struct cavm_nic_pf_eco3_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t eco_rw                : 32; /**< [ 31:  0](R/W) Internal:
    ...
    /* struct cavm_nic_pf_eco3_s cn; */
};
typedef union cavm_nic_pf_eco3 cavm_nic_pf_eco3_t;

#define CAVM_NIC_PF_ECO3 CAVM_NIC_PF_ECO3_FUNC()
static inline uint64_t CAVM_NIC_PF_ECO3_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECO3_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECO3 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECO3 "NIC_PF_ECO3"
#define device_bar_CAVM_NIC_PF_ECO3 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECO3 0
#define arguments_CAVM_NIC_PF_ECO3 -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_eco4
{
    uint64_t u;
    struct cavm_nic_pf_eco4_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t eco_rw                : 32; /**< [ 31:  0](R/W) Internal:
    ...
    /* struct cavm_nic_pf_eco4_s cn; */
};
typedef union cavm_nic_pf_eco4 cavm_nic_pf_eco4_t;

#define CAVM_NIC_PF_ECO4 CAVM_NIC_PF_ECO4_FUNC()
static inline uint64_t CAVM_NIC_PF_ECO4_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECO4_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECO4 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECO4 "NIC_PF_ECO4"
#define device_bar_CAVM_NIC_PF_ECO4 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECO4 0
#define arguments_CAVM_NIC_PF_ECO4 -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_eco5
{
    uint64_t u;
    struct cavm_nic_pf_eco5_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t eco_rw                : 32; /**< [ 31:  0](R/W) Internal:
    ...
    /* struct cavm_nic_pf_eco5_s cn; */
};
typedef union cavm_nic_pf_eco5 cavm_nic_pf_eco5_t;

#define CAVM_NIC_PF_ECO5 CAVM_NIC_PF_ECO5_FUNC()
static inline uint64_t CAVM_NIC_PF_ECO5_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_ECO5_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_ECO5 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_ECO5 "NIC_PF_ECO5"
#define device_bar_CAVM_NIC_PF_ECO5 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_ECO5 0
#define arguments_CAVM_NIC_PF_ECO5 -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_int_timer_cfg
{
    uint64_t u;
    struct cavm_nic_pf_int_timer_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
    ...
    /* struct cavm_nic_pf_int_timer_cfg_s cn; */
};
typedef union cavm_nic_pf_int_timer_cfg cavm_nic_pf_int_timer_cfg_t;

#define CAVM_NIC_PF_INT_TIMER_CFG CAVM_NIC_PF_INT_TIMER_CFG_FUNC()
static inline uint64_t CAVM_NIC_PF_INT_TIMER_CFG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_INT_TIMER_CFG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_INT_TIMER_CFG CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_INT_TIMER_CFG "NIC_PF_INT_TIMER_CFG"
#define device_bar_CAVM_NIC_PF_INT_TIMER_CFG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_INT_TIMER_CFG 0
#define arguments_CAVM_NIC_PF_INT_TIMER_CFG -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_intfx_bp_cfg
{
    uint64_t u;
    struct cavm_nic_pf_intfx_bp_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_intfx_bp_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_PF_INTFX_BP_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_INTFX_BP_CFG(a) "NIC_PF_INTFX_BP_CFG"
#define device_bar_CAVM_NIC_PF_INTFX_BP_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_INTFX_BP_CFG(a) (a)
#define arguments_CAVM_NIC_PF_INTFX_BP_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_intfx_send_cfg
{
    uint64_t u;
    struct cavm_nic_pf_intfx_send_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_intfx_send_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_PF_INTFX_SEND_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_INTFX_SEND_CFG(a) "NIC_PF_INTFX_SEND_CFG"
#define device_bar_CAVM_NIC_PF_INTFX_SEND_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_INTFX_SEND_CFG(a) (a)
#define arguments_CAVM_NIC_PF_INTFX_SEND_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_lmacx_cfg
{
    uint64_t u;
    struct cavm_nic_pf_lmacx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_lmacx_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_PF_LMACX_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_LMACX_CFG(a) "NIC_PF_LMACX_CFG"
#define device_bar_CAVM_NIC_PF_LMACX_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_LMACX_CFG(a) (a)
#define arguments_CAVM_NIC_PF_LMACX_CFG(a) (a),-1,-1,-1
 ...
 * Index enumerated by NIC_LMAC_E.
 */
union cavm_nic_pf_lmacx_cfg2
{
    uint64_t u;
    struct cavm_nic_pf_lmacx_cfg2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_lmacx_cfg2_s cn; */
};
...
#define bustype_CAVM_NIC_PF_LMACX_CFG2(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_LMACX_CFG2(a) "NIC_PF_LMACX_CFG2"
#define device_bar_CAVM_NIC_PF_LMACX_CFG2(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_LMACX_CFG2(a) (a)
#define arguments_CAVM_NIC_PF_LMACX_CFG2(a) (a),-1,-1,-1
 ...
 * Index enumerated by NIC_LMAC_E.
 */
union cavm_nic_pf_lmacx_credit
{
    uint64_t u;
    struct cavm_nic_pf_lmacx_credit_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t cc_unit_cnt           : 20; /**< [ 31: 12](R/W/H) Channel-credit unit count. This value, plus 1 MTU, represents the maximum outstanding
    ...
    /* struct cavm_nic_pf_lmacx_credit_s cn8; */
    /* struct cavm_nic_pf_lmacx_credit_s cn81xx; */
    struct cavm_nic_pf_lmacx_credit_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t cc_unit_cnt           : 20; /**< [ 31: 12](R/W/H) Channel-credit unit count. This value, plus 1 MTU, represents the maximum outstanding
...
#define bustype_CAVM_NIC_PF_LMACX_CREDIT(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_LMACX_CREDIT(a) "NIC_PF_LMACX_CREDIT"
#define device_bar_CAVM_NIC_PF_LMACX_CREDIT(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_LMACX_CREDIT(a) (a)
#define arguments_CAVM_NIC_PF_LMACX_CREDIT(a) (a),-1,-1,-1
 ...
 * Index enumerated by NIC_LMAC_E.
 */
union cavm_nic_pf_lmacx_sw_xoff
{
    uint64_t u;
    struct cavm_nic_pf_lmacx_sw_xoff_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_nic_pf_lmacx_sw_xoff_s cn; */
};
...
#define bustype_CAVM_NIC_PF_LMACX_SW_XOFF(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_LMACX_SW_XOFF(a) "NIC_PF_LMACX_SW_XOFF"
#define device_bar_CAVM_NIC_PF_LMACX_SW_XOFF(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_LMACX_SW_XOFF(a) (a)
#define arguments_CAVM_NIC_PF_LMACX_SW_XOFF(a) (a),-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_nic_pf_mbox_ena_w1cx
{
    uint64_t u;
    struct cavm_nic_pf_mbox_ena_w1cx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_mbox_ena_w1cx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_MBOX_ENA_W1CX(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_MBOX_ENA_W1CX(a) "NIC_PF_MBOX_ENA_W1CX"
#define device_bar_CAVM_NIC_PF_MBOX_ENA_W1CX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_MBOX_ENA_W1CX(a) (a)
#define arguments_CAVM_NIC_PF_MBOX_ENA_W1CX(a) (a),-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_nic_pf_mbox_ena_w1sx
{
    uint64_t u;
    struct cavm_nic_pf_mbox_ena_w1sx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_mbox_ena_w1sx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_MBOX_ENA_W1SX(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_MBOX_ENA_W1SX(a) "NIC_PF_MBOX_ENA_W1SX"
#define device_bar_CAVM_NIC_PF_MBOX_ENA_W1SX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_MBOX_ENA_W1SX(a) (a)
#define arguments_CAVM_NIC_PF_MBOX_ENA_W1SX(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_mbox_intx
{
    uint64_t u;
    struct cavm_nic_pf_mbox_intx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_mbox_intx_s cn8; */
    /* struct cavm_nic_pf_mbox_intx_s cn81xx; */
    struct cavm_nic_pf_mbox_intx_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t mbox                  : 64; /**< [ 63:  0](R/W1C/H) One interrupt bit per VF, e.g. NIC_PF_MBOX_INT(0)[MBOX\<5\>] for VF 5.
                                                                 Each bit is set when the associated NIC_VF()_PF_MBOX(1) register is written.
...
#define bustype_CAVM_NIC_PF_MBOX_INTX(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_MBOX_INTX(a) "NIC_PF_MBOX_INTX"
#define device_bar_CAVM_NIC_PF_MBOX_INTX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_MBOX_INTX(a) (a)
#define arguments_CAVM_NIC_PF_MBOX_INTX(a) (a),-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_nic_pf_mbox_int_w1sx
{
    uint64_t u;
    struct cavm_nic_pf_mbox_int_w1sx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_mbox_int_w1sx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_MBOX_INT_W1SX(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_MBOX_INT_W1SX(a) "NIC_PF_MBOX_INT_W1SX"
#define device_bar_CAVM_NIC_PF_MBOX_INT_W1SX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_MBOX_INT_W1SX(a) (a)
#define arguments_CAVM_NIC_PF_MBOX_INT_W1SX(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_mcamx_ena
{
    uint64_t u;
    struct cavm_nic_pf_mcamx_ena_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_mcamx_ena_s cn; */
};
...
#define bustype_CAVM_NIC_PF_MCAMX_ENA(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_MCAMX_ENA(a) "NIC_PF_MCAMX_ENA"
#define device_bar_CAVM_NIC_PF_MCAMX_ENA(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_MCAMX_ENA(a) (a)
#define arguments_CAVM_NIC_PF_MCAMX_ENA(a) (a),-1,-1,-1
 ...
 * number.
 */
union cavm_nic_pf_mcamx_mx_data
{
    uint64_t u;
    struct cavm_nic_pf_mcamx_mx_data_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_mcamx_mx_data_s cn; */
};
...
#define bustype_CAVM_NIC_PF_MCAMX_MX_DATA(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_MCAMX_MX_DATA(a,b) "NIC_PF_MCAMX_MX_DATA"
#define device_bar_CAVM_NIC_PF_MCAMX_MX_DATA(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_MCAMX_MX_DATA(a,b) (a)
#define arguments_CAVM_NIC_PF_MCAMX_MX_DATA(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_pf_mcam_ctrl
{
    uint64_t u;
    struct cavm_nic_pf_mcam_ctrl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_nic_pf_mcam_ctrl_s cn; */
};
typedef union cavm_nic_pf_mcam_ctrl cavm_nic_pf_mcam_ctrl_t;

#define CAVM_NIC_PF_MCAM_CTRL CAVM_NIC_PF_MCAM_CTRL_FUNC()
static inline uint64_t CAVM_NIC_PF_MCAM_CTRL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_MCAM_CTRL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_MCAM_CTRL CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_MCAM_CTRL "NIC_PF_MCAM_CTRL"
#define device_bar_CAVM_NIC_PF_MCAM_CTRL 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_MCAM_CTRL 0
#define arguments_CAVM_NIC_PF_MCAM_CTRL -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_mpix_cfg
{
    uint64_t u;
    struct cavm_nic_pf_mpix_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_mpix_cfg_s cn8; */
    struct cavm_nic_pf_mpix_cfg_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    struct cavm_nic_pf_mpix_cfg_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_31_63        : 33;
...
#define bustype_CAVM_NIC_PF_MPIX_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_MPIX_CFG(a) "NIC_PF_MPIX_CFG"
#define device_bar_CAVM_NIC_PF_MPIX_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_MPIX_CFG(a) (a)
#define arguments_CAVM_NIC_PF_MPIX_CFG(a) (a),-1,-1,-1
 ...
 * enumeration.
 */
union cavm_nic_pf_msix_pbax
{
    uint64_t u;
    struct cavm_nic_pf_msix_pbax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_msix_pbax_s cn; */
};
...
#define bustype_CAVM_NIC_PF_MSIX_PBAX(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_MSIX_PBAX(a) "NIC_PF_MSIX_PBAX"
#define device_bar_CAVM_NIC_PF_MSIX_PBAX(a) 0x4 /* PF_BAR4 */
#define busnum_CAVM_NIC_PF_MSIX_PBAX(a) (a)
#define arguments_CAVM_NIC_PF_MSIX_PBAX(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_msix_vecx_addr
{
    uint64_t u;
    struct cavm_nic_pf_msix_vecx_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
    ...
    /* struct cavm_nic_pf_msix_vecx_addr_s cn; */
};
...
#define bustype_CAVM_NIC_PF_MSIX_VECX_ADDR(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_MSIX_VECX_ADDR(a) "NIC_PF_MSIX_VECX_ADDR"
#define device_bar_CAVM_NIC_PF_MSIX_VECX_ADDR(a) 0x4 /* PF_BAR4 */
#define busnum_CAVM_NIC_PF_MSIX_VECX_ADDR(a) (a)
#define arguments_CAVM_NIC_PF_MSIX_VECX_ADDR(a) (a),-1,-1,-1
 ...
 * This register is the MSI-X vector table, indexed by the NIC_PF_INT_VEC_E enumeration.
 */
union cavm_nic_pf_msix_vecx_ctl
{
    uint64_t u;
    struct cavm_nic_pf_msix_vecx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_msix_vecx_ctl_s cn; */
};
...
#define bustype_CAVM_NIC_PF_MSIX_VECX_CTL(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_MSIX_VECX_CTL(a) "NIC_PF_MSIX_VECX_CTL"
#define device_bar_CAVM_NIC_PF_MSIX_VECX_CTL(a) 0x4 /* PF_BAR4 */
#define busnum_CAVM_NIC_PF_MSIX_VECX_CTL(a) (a)
#define arguments_CAVM_NIC_PF_MSIX_VECX_CTL(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_pir_cfg
{
    uint64_t u;
    struct cavm_nic_pf_pir_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_pir_cfg_s cn8; */
    /* struct cavm_nic_pf_pir_cfg_s cn81xx; */
    struct cavm_nic_pf_pir_cfg_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_12_63        : 52;
        uint64_t tick_rate             : 12; /**< [ 11:  0](R/W) Number of coprocessor clocks between replenishing TL3 shaper tokens. Zero disables the
...
typedef union cavm_nic_pf_pir_cfg cavm_nic_pf_pir_cfg_t;

#define CAVM_NIC_PF_PIR_CFG CAVM_NIC_PF_PIR_CFG_FUNC()
static inline uint64_t CAVM_NIC_PF_PIR_CFG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_PIR_CFG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_PIR_CFG CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_PIR_CFG "NIC_PF_PIR_CFG"
#define device_bar_CAVM_NIC_PF_PIR_CFG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_PIR_CFG 0
#define arguments_CAVM_NIC_PF_PIR_CFG -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_pkindx_cfg
{
    uint64_t u;
    struct cavm_nic_pf_pkindx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_pkindx_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_PF_PKINDX_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_PKINDX_CFG(a) "NIC_PF_PKINDX_CFG"
#define device_bar_CAVM_NIC_PF_PKINDX_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_PKINDX_CFG(a) (a)
#define arguments_CAVM_NIC_PF_PKINDX_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_qsx_cfg
{
    uint64_t u;
    struct cavm_nic_pf_qsx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_nic_pf_qsx_cfg_s cn8; */
    struct cavm_nic_pf_qsx_cfg_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t ena                   : 1;  /**< [ 31: 31](R/W) Enable QS. */
    ...
    struct cavm_nic_pf_qsx_cfg_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
        uint64_t ena                   : 1;  /**< [ 31: 31](R/W) Enable QS. */
...
#define bustype_CAVM_NIC_PF_QSX_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_QSX_CFG(a) "NIC_PF_QSX_CFG"
#define device_bar_CAVM_NIC_PF_QSX_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_QSX_CFG(a) (a)
#define arguments_CAVM_NIC_PF_QSX_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_qsx_lockx
{
    uint64_t u;
    struct cavm_nic_pf_qsx_lockx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_qsx_lockx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_QSX_LOCKX(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_QSX_LOCKX(a,b) "NIC_PF_QSX_LOCKX"
#define device_bar_CAVM_NIC_PF_QSX_LOCKX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_QSX_LOCKX(a,b) (a)
#define arguments_CAVM_NIC_PF_QSX_LOCKX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_pf_qsx_rqx_bp_cfg
{
    uint64_t u;
    struct cavm_nic_pf_qsx_rqx_bp_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_qsx_rqx_bp_cfg_s cn8; */
    struct cavm_nic_pf_qsx_rqx_bp_cfg_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t rbdr_bp_ena           : 1;  /**< [ 63: 63](R/W) Enables BP based off the RBDR levels of the Start and Continue Rings. */
        uint64_t cq_bp_ena             : 1;  /**< [ 62: 62](R/W) Enables BP based off the CQ level. */
    ...
    /* struct cavm_nic_pf_qsx_rqx_bp_cfg_s cn83xx; */
};
...
#define bustype_CAVM_NIC_PF_QSX_RQX_BP_CFG(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_QSX_RQX_BP_CFG(a,b) "NIC_PF_QSX_RQX_BP_CFG"
#define device_bar_CAVM_NIC_PF_QSX_RQX_BP_CFG(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_QSX_RQX_BP_CFG(a,b) (a)
#define arguments_CAVM_NIC_PF_QSX_RQX_BP_CFG(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_pf_qsx_rqx_cfg
{
    uint64_t u;
    struct cavm_nic_pf_qsx_rqx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_qsx_rqx_cfg_s cn8; */
    struct cavm_nic_pf_qsx_rqx_cfg_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t tcp_off               : 1;  /**< [ 63: 63](R/W) Reserved.
                                                                 Internal:
    ...
    /* struct cavm_nic_pf_qsx_rqx_cfg_s cn83xx; */
};
...
#define bustype_CAVM_NIC_PF_QSX_RQX_CFG(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_QSX_RQX_CFG(a,b) "NIC_PF_QSX_RQX_CFG"
#define device_bar_CAVM_NIC_PF_QSX_RQX_CFG(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_QSX_RQX_CFG(a,b) (a)
#define arguments_CAVM_NIC_PF_QSX_RQX_CFG(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_pf_qsx_rqx_drop_cfg
{
    uint64_t u;
    struct cavm_nic_pf_qsx_rqx_drop_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_qsx_rqx_drop_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_PF_QSX_RQX_DROP_CFG(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_QSX_RQX_DROP_CFG(a,b) "NIC_PF_QSX_RQX_DROP_CFG"
#define device_bar_CAVM_NIC_PF_QSX_RQX_DROP_CFG(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_QSX_RQX_DROP_CFG(a,b) (a)
#define arguments_CAVM_NIC_PF_QSX_RQX_DROP_CFG(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_pf_qsx_rqx_statx
{
    uint64_t u;
    struct cavm_nic_pf_qsx_rqx_statx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
    ...
    /* struct cavm_nic_pf_qsx_rqx_statx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_QSX_RQX_STATX(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_QSX_RQX_STATX(a,b,c) "NIC_PF_QSX_RQX_STATX"
#define device_bar_CAVM_NIC_PF_QSX_RQX_STATX(a,b,c) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_QSX_RQX_STATX(a,b,c) (a)
#define arguments_CAVM_NIC_PF_QSX_RQX_STATX(a,b,c) (a),(b),(c),-1
 ...
 */
union cavm_nic_pf_qsx_sqx_cfg
{
    uint64_t u;
    struct cavm_nic_pf_qsx_sqx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
    ...
    /* struct cavm_nic_pf_qsx_sqx_cfg_s cn8; */
    struct cavm_nic_pf_qsx_sqx_cfg_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
        uint64_t sq_ins_data           : 16; /**< [ 47: 32](R/W) SQ insertion data.If NIC_PF_QS()_CFG[SQ_INS_ENA] is set, this is the data inserted
    ...
    struct cavm_nic_pf_qsx_sqx_cfg_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
        uint64_t sq_ins_data           : 16; /**< [ 47: 32](R/W) SQ insertion data.If NIC_PF_QS()_CFG[SQ_INS_ENA] is set, this is the data inserted
...
#define bustype_CAVM_NIC_PF_QSX_SQX_CFG(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_QSX_SQX_CFG(a,b) "NIC_PF_QSX_SQX_CFG"
#define device_bar_CAVM_NIC_PF_QSX_SQX_CFG(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_QSX_SQX_CFG(a,b) (a)
#define arguments_CAVM_NIC_PF_QSX_SQX_CFG(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_pf_qsx_sqx_cfg2
{
    uint64_t u;
    struct cavm_nic_pf_qsx_sqx_cfg2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_qsx_sqx_cfg2_s cn8; */
    struct cavm_nic_pf_qsx_sqx_cfg2_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
        uint64_t reserved_6_7          : 2;
    ...
    struct cavm_nic_pf_qsx_sqx_cfg2_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
        uint64_t tl4                   : 8;  /**< [  7:  0](R/W) TL4 index. Must point to the unique TL4 that will service this traffic, and
...
#define bustype_CAVM_NIC_PF_QSX_SQX_CFG2(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_QSX_SQX_CFG2(a,b) "NIC_PF_QSX_SQX_CFG2"
#define device_bar_CAVM_NIC_PF_QSX_SQX_CFG2(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_QSX_SQX_CFG2(a,b) (a)
#define arguments_CAVM_NIC_PF_QSX_SQX_CFG2(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_pf_qsx_sqx_statx
{
    uint64_t u;
    struct cavm_nic_pf_qsx_sqx_statx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
    ...
    /* struct cavm_nic_pf_qsx_sqx_statx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_QSX_SQX_STATX(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_QSX_SQX_STATX(a,b,c) "NIC_PF_QSX_SQX_STATX"
#define device_bar_CAVM_NIC_PF_QSX_SQX_STATX(a,b,c) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_QSX_SQX_STATX(a,b,c) (a)
#define arguments_CAVM_NIC_PF_QSX_SQX_STATX(a,b,c) (a),(b),(c),-1
 ...
 */
union cavm_nic_pf_rqm_test
{
    uint64_t u;
    struct cavm_nic_pf_rqm_test_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t enable                : 4;  /**< [ 63: 60](R/W) Enable test mode. For diagnostic use only.
                                                                 Internal:
    ...
    /* struct cavm_nic_pf_rqm_test_s cn; */
};
typedef union cavm_nic_pf_rqm_test cavm_nic_pf_rqm_test_t;

#define CAVM_NIC_PF_RQM_TEST CAVM_NIC_PF_RQM_TEST_FUNC()
static inline uint64_t CAVM_NIC_PF_RQM_TEST_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_RQM_TEST_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_RQM_TEST CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RQM_TEST "NIC_PF_RQM_TEST"
#define device_bar_CAVM_NIC_PF_RQM_TEST 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RQM_TEST 0
#define arguments_CAVM_NIC_PF_RQM_TEST -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_rrm_avg_cfg
{
    uint64_t u;
    struct cavm_nic_pf_rrm_avg_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_21_63        : 43;
        uint64_t avg_en                : 1;  /**< [ 20: 20](R/W) QoS averaging enable. When set, compute average buffer levels. When clear, do not compute
    ...
    /* struct cavm_nic_pf_rrm_avg_cfg_s cn; */
};
typedef union cavm_nic_pf_rrm_avg_cfg cavm_nic_pf_rrm_avg_cfg_t;

#define CAVM_NIC_PF_RRM_AVG_CFG CAVM_NIC_PF_RRM_AVG_CFG_FUNC()
static inline uint64_t CAVM_NIC_PF_RRM_AVG_CFG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_RRM_AVG_CFG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_RRM_AVG_CFG CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RRM_AVG_CFG "NIC_PF_RRM_AVG_CFG"
#define device_bar_CAVM_NIC_PF_RRM_AVG_CFG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RRM_AVG_CFG 0
#define arguments_CAVM_NIC_PF_RRM_AVG_CFG -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_rrm_cfg
{
    uint64_t u;
    struct cavm_nic_pf_rrm_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_rrm_cfg_s cn; */
};
typedef union cavm_nic_pf_rrm_cfg cavm_nic_pf_rrm_cfg_t;

#define CAVM_NIC_PF_RRM_CFG CAVM_NIC_PF_RRM_CFG_FUNC()
static inline uint64_t CAVM_NIC_PF_RRM_CFG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_RRM_CFG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_RRM_CFG CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RRM_CFG "NIC_PF_RRM_CFG"
#define device_bar_CAVM_NIC_PF_RRM_CFG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RRM_CFG 0
#define arguments_CAVM_NIC_PF_RRM_CFG -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_rrm_test
{
    uint64_t u;
    struct cavm_nic_pf_rrm_test_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t enable                : 4;  /**< [ 63: 60](R/W) Enable test mode. For diagnostic use only.
                                                                 Internal:
    ...
    /* struct cavm_nic_pf_rrm_test_s cn; */
};
typedef union cavm_nic_pf_rrm_test cavm_nic_pf_rrm_test_t;

#define CAVM_NIC_PF_RRM_TEST CAVM_NIC_PF_RRM_TEST_FUNC()
static inline uint64_t CAVM_NIC_PF_RRM_TEST_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_RRM_TEST_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_RRM_TEST CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RRM_TEST "NIC_PF_RRM_TEST"
#define device_bar_CAVM_NIC_PF_RRM_TEST 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RRM_TEST 0
#define arguments_CAVM_NIC_PF_RRM_TEST -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_rssix_rq
{
    uint64_t u;
    struct cavm_nic_pf_rssix_rq_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
    ...
    /* struct cavm_nic_pf_rssix_rq_s cn8; */
    struct cavm_nic_pf_rssix_rq_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    struct cavm_nic_pf_rssix_rq_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_10_63        : 54;
...
#define bustype_CAVM_NIC_PF_RSSIX_RQ(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RSSIX_RQ(a) "NIC_PF_RSSIX_RQ"
#define device_bar_CAVM_NIC_PF_RSSIX_RQ(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RSSIX_RQ(a) (a)
#define arguments_CAVM_NIC_PF_RSSIX_RQ(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_rx_bp_statex
{
    uint64_t u;
    struct cavm_nic_pf_rx_bp_statex_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_rx_bp_statex_s cn; */
};
...
#define bustype_CAVM_NIC_PF_RX_BP_STATEX(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_BP_STATEX(a) "NIC_PF_RX_BP_STATEX"
#define device_bar_CAVM_NIC_PF_RX_BP_STATEX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_BP_STATEX(a) (a)
#define arguments_CAVM_NIC_PF_RX_BP_STATEX(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_rx_bpid_statex
{
    uint64_t u;
    struct cavm_nic_pf_rx_bpid_statex_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_rx_bpid_statex_s cn; */
};
...
#define bustype_CAVM_NIC_PF_RX_BPID_STATEX(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_BPID_STATEX(a) "NIC_PF_RX_BPID_STATEX"
#define device_bar_CAVM_NIC_PF_RX_BPID_STATEX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_BPID_STATEX(a) (a)
#define arguments_CAVM_NIC_PF_RX_BPID_STATEX(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_rx_cfg
{
    uint64_t u;
    struct cavm_nic_pf_rx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_nic_pf_rx_cfg_s cn; */
};
typedef union cavm_nic_pf_rx_cfg cavm_nic_pf_rx_cfg_t;

#define CAVM_NIC_PF_RX_CFG CAVM_NIC_PF_RX_CFG_FUNC()
static inline uint64_t CAVM_NIC_PF_RX_CFG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_RX_CFG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_RX_CFG CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_CFG "NIC_PF_RX_CFG"
#define device_bar_CAVM_NIC_PF_RX_CFG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_CFG 0
#define arguments_CAVM_NIC_PF_RX_CFG -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_rx_chan_bp_disx
{
    uint64_t u;
    struct cavm_nic_pf_rx_chan_bp_disx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_rx_chan_bp_disx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_RX_CHAN_BP_DISX(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_CHAN_BP_DISX(a) "NIC_PF_RX_CHAN_BP_DISX"
#define device_bar_CAVM_NIC_PF_RX_CHAN_BP_DISX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_CHAN_BP_DISX(a) (a)
#define arguments_CAVM_NIC_PF_RX_CHAN_BP_DISX(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_rx_chan_bp_swx
{
    uint64_t u;
    struct cavm_nic_pf_rx_chan_bp_swx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_rx_chan_bp_swx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_RX_CHAN_BP_SWX(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_CHAN_BP_SWX(a) "NIC_PF_RX_CHAN_BP_SWX"
#define device_bar_CAVM_NIC_PF_RX_CHAN_BP_SWX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_CHAN_BP_SWX(a) (a)
#define arguments_CAVM_NIC_PF_RX_CHAN_BP_SWX(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_rx_etypex
{
    uint64_t u;
    struct cavm_nic_pf_rx_etypex_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_rx_etypex_s cn; */
};
...
#define bustype_CAVM_NIC_PF_RX_ETYPEX(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_ETYPEX(a) "NIC_PF_RX_ETYPEX"
#define device_bar_CAVM_NIC_PF_RX_ETYPEX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_ETYPEX(a) (a)
#define arguments_CAVM_NIC_PF_RX_ETYPEX(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_rx_geneve_def
{
    uint64_t u;
    struct cavm_nic_pf_rx_geneve_def_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_rx_geneve_def_s cn; */
};
typedef union cavm_nic_pf_rx_geneve_def cavm_nic_pf_rx_geneve_def_t;

#define CAVM_NIC_PF_RX_GENEVE_DEF CAVM_NIC_PF_RX_GENEVE_DEF_FUNC()
static inline uint64_t CAVM_NIC_PF_RX_GENEVE_DEF_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_RX_GENEVE_DEF_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_RX_GENEVE_DEF CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_GENEVE_DEF "NIC_PF_RX_GENEVE_DEF"
#define device_bar_CAVM_NIC_PF_RX_GENEVE_DEF 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_GENEVE_DEF 0
#define arguments_CAVM_NIC_PF_RX_GENEVE_DEF -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_rx_geneve_prot_def
{
    uint64_t u;
    struct cavm_nic_pf_rx_geneve_prot_def_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_rx_geneve_prot_def_s cn; */
};
typedef union cavm_nic_pf_rx_geneve_prot_def cavm_nic_pf_rx_geneve_prot_def_t;

#define CAVM_NIC_PF_RX_GENEVE_PROT_DEF CAVM_NIC_PF_RX_GENEVE_PROT_DEF_FUNC()
static inline uint64_t CAVM_NIC_PF_RX_GENEVE_PROT_DEF_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_RX_GENEVE_PROT_DEF_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_RX_GENEVE_PROT_DEF CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_GENEVE_PROT_DEF "NIC_PF_RX_GENEVE_PROT_DEF"
#define device_bar_CAVM_NIC_PF_RX_GENEVE_PROT_DEF 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_GENEVE_PROT_DEF 0
#define arguments_CAVM_NIC_PF_RX_GENEVE_PROT_DEF -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_rx_nvgre_prot_def
{
    uint64_t u;
    struct cavm_nic_pf_rx_nvgre_prot_def_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ena_ipv6              : 1;  /**< [ 63: 63](R/W) Enables the [IPV6_PROT] value. */
        uint64_t ena_ipv4              : 1;  /**< [ 62: 62](R/W) Enables the [IPV4_PROT] value. */
    ...
    /* struct cavm_nic_pf_rx_nvgre_prot_def_s cn; */
};
typedef union cavm_nic_pf_rx_nvgre_prot_def cavm_nic_pf_rx_nvgre_prot_def_t;

#define CAVM_NIC_PF_RX_NVGRE_PROT_DEF CAVM_NIC_PF_RX_NVGRE_PROT_DEF_FUNC()
static inline uint64_t CAVM_NIC_PF_RX_NVGRE_PROT_DEF_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_RX_NVGRE_PROT_DEF_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_RX_NVGRE_PROT_DEF CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_NVGRE_PROT_DEF "NIC_PF_RX_NVGRE_PROT_DEF"
#define device_bar_CAVM_NIC_PF_RX_NVGRE_PROT_DEF 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_NVGRE_PROT_DEF 0
#define arguments_CAVM_NIC_PF_RX_NVGRE_PROT_DEF -1,-1,-1,-1
 ...
 * Unused register.
 */
union cavm_nic_pf_rx_rocev2_def
{
    uint64_t u;
    struct cavm_nic_pf_rx_rocev2_def_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_rx_rocev2_def_s cn; */
};
typedef union cavm_nic_pf_rx_rocev2_def cavm_nic_pf_rx_rocev2_def_t;

#define CAVM_NIC_PF_RX_ROCEV2_DEF CAVM_NIC_PF_RX_ROCEV2_DEF_FUNC()
static inline uint64_t CAVM_NIC_PF_RX_ROCEV2_DEF_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_RX_ROCEV2_DEF_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_RX_ROCEV2_DEF CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_ROCEV2_DEF "NIC_PF_RX_ROCEV2_DEF"
#define device_bar_CAVM_NIC_PF_RX_ROCEV2_DEF 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_ROCEV2_DEF 0
#define arguments_CAVM_NIC_PF_RX_ROCEV2_DEF -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_rx_vxlan_defx
{
    uint64_t u;
    struct cavm_nic_pf_rx_vxlan_defx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_rx_vxlan_defx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_RX_VXLAN_DEFX(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_VXLAN_DEFX(a) "NIC_PF_RX_VXLAN_DEFX"
#define device_bar_CAVM_NIC_PF_RX_VXLAN_DEFX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_VXLAN_DEFX(a) (a)
#define arguments_CAVM_NIC_PF_RX_VXLAN_DEFX(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_rx_vxlan_prot_def
{
    uint64_t u;
    struct cavm_nic_pf_rx_vxlan_prot_def_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_rx_vxlan_prot_def_s cn; */
};
typedef union cavm_nic_pf_rx_vxlan_prot_def cavm_nic_pf_rx_vxlan_prot_def_t;

#define CAVM_NIC_PF_RX_VXLAN_PROT_DEF CAVM_NIC_PF_RX_VXLAN_PROT_DEF_FUNC()
static inline uint64_t CAVM_NIC_PF_RX_VXLAN_PROT_DEF_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_RX_VXLAN_PROT_DEF_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_RX_VXLAN_PROT_DEF CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_VXLAN_PROT_DEF "NIC_PF_RX_VXLAN_PROT_DEF"
#define device_bar_CAVM_NIC_PF_RX_VXLAN_PROT_DEF 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_VXLAN_PROT_DEF 0
#define arguments_CAVM_NIC_PF_RX_VXLAN_PROT_DEF -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_rx_wrr_cfgx
{
    uint64_t u;
    struct cavm_nic_pf_rx_wrr_cfgx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_rx_wrr_cfgx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_RX_WRR_CFGX(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_RX_WRR_CFGX(a) "NIC_PF_RX_WRR_CFGX"
#define device_bar_CAVM_NIC_PF_RX_WRR_CFGX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_RX_WRR_CFGX(a) (a)
#define arguments_CAVM_NIC_PF_RX_WRR_CFGX(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_seb_test
{
    uint64_t u;
    struct cavm_nic_pf_seb_test_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t enable                : 4;  /**< [ 63: 60](R/W) Enable test mode. For diagnostic use only.
                                                                 Internal:
    ...
    /* struct cavm_nic_pf_seb_test_s cn; */
};
typedef union cavm_nic_pf_seb_test cavm_nic_pf_seb_test_t;

#define CAVM_NIC_PF_SEB_TEST CAVM_NIC_PF_SEB_TEST_FUNC()
static inline uint64_t CAVM_NIC_PF_SEB_TEST_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_SEB_TEST_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_SEB_TEST CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_SEB_TEST "NIC_PF_SEB_TEST"
#define device_bar_CAVM_NIC_PF_SEB_TEST 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_SEB_TEST 0
#define arguments_CAVM_NIC_PF_SEB_TEST -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_send_cfg
{
    uint64_t u;
    struct cavm_nic_pf_send_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_nic_pf_send_cfg_s cn; */
};
typedef union cavm_nic_pf_send_cfg cavm_nic_pf_send_cfg_t;

#define CAVM_NIC_PF_SEND_CFG CAVM_NIC_PF_SEND_CFG_FUNC()
static inline uint64_t CAVM_NIC_PF_SEND_CFG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_SEND_CFG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_SEND_CFG CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_SEND_CFG "NIC_PF_SEND_CFG"
#define device_bar_CAVM_NIC_PF_SEND_CFG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_SEND_CFG 0
#define arguments_CAVM_NIC_PF_SEND_CFG -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_soft_reset
{
    uint64_t u;
    struct cavm_nic_pf_soft_reset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_nic_pf_soft_reset_s cn; */
};
typedef union cavm_nic_pf_soft_reset cavm_nic_pf_soft_reset_t;

#define CAVM_NIC_PF_SOFT_RESET CAVM_NIC_PF_SOFT_RESET_FUNC()
static inline uint64_t CAVM_NIC_PF_SOFT_RESET_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_SOFT_RESET_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_SOFT_RESET CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_SOFT_RESET "NIC_PF_SOFT_RESET"
#define device_bar_CAVM_NIC_PF_SOFT_RESET 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_SOFT_RESET 0
#define arguments_CAVM_NIC_PF_SOFT_RESET -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_sqm_test1
{
    uint64_t u;
    struct cavm_nic_pf_sqm_test1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t enable                : 4;  /**< [ 63: 60](R/W) Enable test mode. For diagnostic use only.
                                                                 Internal:
    ...
    /* struct cavm_nic_pf_sqm_test1_s cn; */
};
typedef union cavm_nic_pf_sqm_test1 cavm_nic_pf_sqm_test1_t;

#define CAVM_NIC_PF_SQM_TEST1 CAVM_NIC_PF_SQM_TEST1_FUNC()
static inline uint64_t CAVM_NIC_PF_SQM_TEST1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_SQM_TEST1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_SQM_TEST1 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_SQM_TEST1 "NIC_PF_SQM_TEST1"
#define device_bar_CAVM_NIC_PF_SQM_TEST1 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_SQM_TEST1 0
#define arguments_CAVM_NIC_PF_SQM_TEST1 -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_sqm_test2
{
    uint64_t u;
    struct cavm_nic_pf_sqm_test2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t enable                : 4;  /**< [ 63: 60](R/W) Enable test mode. For diagnostic use only.
                                                                 Internal:
    ...
    /* struct cavm_nic_pf_sqm_test2_s cn; */
};
typedef union cavm_nic_pf_sqm_test2 cavm_nic_pf_sqm_test2_t;

#define CAVM_NIC_PF_SQM_TEST2 CAVM_NIC_PF_SQM_TEST2_FUNC()
static inline uint64_t CAVM_NIC_PF_SQM_TEST2_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_SQM_TEST2_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_SQM_TEST2 CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_SQM_TEST2 "NIC_PF_SQM_TEST2"
#define device_bar_CAVM_NIC_PF_SQM_TEST2 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_SQM_TEST2 0
#define arguments_CAVM_NIC_PF_SQM_TEST2 -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_status
{
    uint64_t u;
    struct cavm_nic_pf_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_10_63        : 54;
    ...
    /* struct cavm_nic_pf_status_s cn; */
};
typedef union cavm_nic_pf_status cavm_nic_pf_status_t;

#define CAVM_NIC_PF_STATUS CAVM_NIC_PF_STATUS_FUNC()
static inline uint64_t CAVM_NIC_PF_STATUS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_STATUS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_STATUS CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_STATUS "NIC_PF_STATUS"
#define device_bar_CAVM_NIC_PF_STATUS 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_STATUS 0
#define arguments_CAVM_NIC_PF_STATUS -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_sw_sync_pipex_cq_cnts
{
    uint64_t u;
    struct cavm_nic_pf_sw_sync_pipex_cq_cnts_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_sw_sync_pipex_cq_cnts_s cn; */
};
...
#define bustype_CAVM_NIC_PF_SW_SYNC_PIPEX_CQ_CNTS(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_SW_SYNC_PIPEX_CQ_CNTS(a) "NIC_PF_SW_SYNC_PIPEX_CQ_CNTS"
#define device_bar_CAVM_NIC_PF_SW_SYNC_PIPEX_CQ_CNTS(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_SW_SYNC_PIPEX_CQ_CNTS(a) (a)
#define arguments_CAVM_NIC_PF_SW_SYNC_PIPEX_CQ_CNTS(a) (a),-1,-1,-1
 ...
 * enumerated by NIC_LMAC_E.
 */
union cavm_nic_pf_sw_sync_pipex_pkt_cnts
{
    uint64_t u;
    struct cavm_nic_pf_sw_sync_pipex_pkt_cnts_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t out_cnt               : 32; /**< [ 63: 32](RO/H) Running count at output of machine. */
        uint64_t in_cnt                : 32; /**< [ 31:  0](RO/H) Running count at input of machine. */
    ...
    /* struct cavm_nic_pf_sw_sync_pipex_pkt_cnts_s cn; */
};
...
#define bustype_CAVM_NIC_PF_SW_SYNC_PIPEX_PKT_CNTS(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_SW_SYNC_PIPEX_PKT_CNTS(a) "NIC_PF_SW_SYNC_PIPEX_PKT_CNTS"
#define device_bar_CAVM_NIC_PF_SW_SYNC_PIPEX_PKT_CNTS(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_SW_SYNC_PIPEX_PKT_CNTS(a) (a)
#define arguments_CAVM_NIC_PF_SW_SYNC_PIPEX_PKT_CNTS(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_sw_sync_rx
{
    uint64_t u;
    struct cavm_nic_pf_sw_sync_rx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_nic_pf_sw_sync_rx_s cn; */
};
typedef union cavm_nic_pf_sw_sync_rx cavm_nic_pf_sw_sync_rx_t;

#define CAVM_NIC_PF_SW_SYNC_RX CAVM_NIC_PF_SW_SYNC_RX_FUNC()
static inline uint64_t CAVM_NIC_PF_SW_SYNC_RX_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_SW_SYNC_RX_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_SW_SYNC_RX CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_SW_SYNC_RX "NIC_PF_SW_SYNC_RX"
#define device_bar_CAVM_NIC_PF_SW_SYNC_RX 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_SW_SYNC_RX 0
#define arguments_CAVM_NIC_PF_SW_SYNC_RX -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_sw_sync_rx_done
{
    uint64_t u;
    struct cavm_nic_pf_sw_sync_rx_done_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_nic_pf_sw_sync_rx_done_s cn; */
};
typedef union cavm_nic_pf_sw_sync_rx_done cavm_nic_pf_sw_sync_rx_done_t;

#define CAVM_NIC_PF_SW_SYNC_RX_DONE CAVM_NIC_PF_SW_SYNC_RX_DONE_FUNC()
static inline uint64_t CAVM_NIC_PF_SW_SYNC_RX_DONE_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_SW_SYNC_RX_DONE_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_SW_SYNC_RX_DONE CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_SW_SYNC_RX_DONE "NIC_PF_SW_SYNC_RX_DONE"
#define device_bar_CAVM_NIC_PF_SW_SYNC_RX_DONE 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_SW_SYNC_RX_DONE 0
#define arguments_CAVM_NIC_PF_SW_SYNC_RX_DONE -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_tcp_timer
{
    uint64_t u;
    struct cavm_nic_pf_tcp_timer_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_tcp_timer_s cn; */
};
typedef union cavm_nic_pf_tcp_timer cavm_nic_pf_tcp_timer_t;

#define CAVM_NIC_PF_TCP_TIMER CAVM_NIC_PF_TCP_TIMER_FUNC()
static inline uint64_t CAVM_NIC_PF_TCP_TIMER_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_TCP_TIMER_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_TCP_TIMER CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TCP_TIMER "NIC_PF_TCP_TIMER"
#define device_bar_CAVM_NIC_PF_TCP_TIMER 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TCP_TIMER 0
#define arguments_CAVM_NIC_PF_TCP_TIMER -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_tl2x_cfg
{
    uint64_t u;
    struct cavm_nic_pf_tl2x_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
    ...
    /* struct cavm_nic_pf_tl2x_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_PF_TL2X_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TL2X_CFG(a) "NIC_PF_TL2X_CFG"
#define device_bar_CAVM_NIC_PF_TL2X_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TL2X_CFG(a) (a)
#define arguments_CAVM_NIC_PF_TL2X_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_tl2x_lmac
{
    uint64_t u;
    struct cavm_nic_pf_tl2x_lmac_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_tl2x_lmac_s cn; */
};
...
#define bustype_CAVM_NIC_PF_TL2X_LMAC(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TL2X_LMAC(a) "NIC_PF_TL2X_LMAC"
#define device_bar_CAVM_NIC_PF_TL2X_LMAC(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TL2X_LMAC(a) (a)
#define arguments_CAVM_NIC_PF_TL2X_LMAC(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_tl2x_pri
{
    uint64_t u;
    struct cavm_nic_pf_tl2x_pri_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_tl2x_pri_s cn; */
};
...
#define bustype_CAVM_NIC_PF_TL2X_PRI(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TL2X_PRI(a) "NIC_PF_TL2X_PRI"
#define device_bar_CAVM_NIC_PF_TL2X_PRI(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TL2X_PRI(a) (a)
#define arguments_CAVM_NIC_PF_TL2X_PRI(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_tl2x_sh_status
{
    uint64_t u;
    struct cavm_nic_pf_tl2x_sh_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_tl2x_sh_status_s cn; */
};
...
#define bustype_CAVM_NIC_PF_TL2X_SH_STATUS(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TL2X_SH_STATUS(a) "NIC_PF_TL2X_SH_STATUS"
#define device_bar_CAVM_NIC_PF_TL2X_SH_STATUS(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TL2X_SH_STATUS(a) (a)
#define arguments_CAVM_NIC_PF_TL2X_SH_STATUS(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_tl3x_cfg
{
    uint64_t u;
    struct cavm_nic_pf_tl3x_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
        uint64_t rr_quantum            : 24; /**< [ 23:  0](R/W) Round-robin (DWRR) quantum. The weighted deficit round-robin quantum (24-bit unsigned
    ...
    /* struct cavm_nic_pf_tl3x_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_PF_TL3X_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TL3X_CFG(a) "NIC_PF_TL3X_CFG"
#define device_bar_CAVM_NIC_PF_TL3X_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TL3X_CFG(a) (a)
#define arguments_CAVM_NIC_PF_TL3X_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_tl3x_chan
{
    uint64_t u;
    struct cavm_nic_pf_tl3x_chan_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct cavm_nic_pf_tl3x_chan_s cn8; */
    /* struct cavm_nic_pf_tl3x_chan_s cn81xx; */
    struct cavm_nic_pf_tl3x_chan_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
        uint64_t chan                  : 7;  /**< [  6:  0](R/W) The channel-within-LMAC sending backpressure to this TL3. The LMAC is selected by
...
#define bustype_CAVM_NIC_PF_TL3X_CHAN(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TL3X_CHAN(a) "NIC_PF_TL3X_CHAN"
#define device_bar_CAVM_NIC_PF_TL3X_CHAN(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TL3X_CHAN(a) (a)
#define arguments_CAVM_NIC_PF_TL3X_CHAN(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_tl3x_pir
{
    uint64_t u;
    struct cavm_nic_pf_tl3x_pir_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_nic_pf_tl3x_pir_s cn; */
};
...
#define bustype_CAVM_NIC_PF_TL3X_PIR(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TL3X_PIR(a) "NIC_PF_TL3X_PIR"
#define device_bar_CAVM_NIC_PF_TL3X_PIR(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TL3X_PIR(a) (a)
#define arguments_CAVM_NIC_PF_TL3X_PIR(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_tl3x_sh_status
{
    uint64_t u;
    struct cavm_nic_pf_tl3x_sh_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_tl3x_sh_status_s cn; */
};
...
#define bustype_CAVM_NIC_PF_TL3X_SH_STATUS(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TL3X_SH_STATUS(a) "NIC_PF_TL3X_SH_STATUS"
#define device_bar_CAVM_NIC_PF_TL3X_SH_STATUS(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TL3X_SH_STATUS(a) (a)
#define arguments_CAVM_NIC_PF_TL3X_SH_STATUS(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_tl3x_sw_xoff
{
    uint64_t u;
    struct cavm_nic_pf_tl3x_sw_xoff_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
    ...
    /* struct cavm_nic_pf_tl3x_sw_xoff_s cn; */
};
...
#define bustype_CAVM_NIC_PF_TL3X_SW_XOFF(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TL3X_SW_XOFF(a) "NIC_PF_TL3X_SW_XOFF"
#define device_bar_CAVM_NIC_PF_TL3X_SW_XOFF(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TL3X_SW_XOFF(a) (a)
#define arguments_CAVM_NIC_PF_TL3X_SW_XOFF(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_tl3ax_cfg
{
    uint64_t u;
    struct cavm_nic_pf_tl3ax_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_tl3ax_cfg_s cn8; */
    struct cavm_nic_pf_tl3ax_cfg_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_6_63         : 58;
    ...
    /* struct cavm_nic_pf_tl3ax_cfg_s cn83xx; */
};
...
#define bustype_CAVM_NIC_PF_TL3AX_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TL3AX_CFG(a) "NIC_PF_TL3AX_CFG"
#define device_bar_CAVM_NIC_PF_TL3AX_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TL3AX_CFG(a) (a)
#define arguments_CAVM_NIC_PF_TL3AX_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_tl4x_cfg
{
    uint64_t u;
    struct cavm_nic_pf_tl4x_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_nic_pf_tl4x_cfg_s cn8; */
    struct cavm_nic_pf_tl4x_cfg_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    struct cavm_nic_pf_tl4x_cfg_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
...
#define bustype_CAVM_NIC_PF_TL4X_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TL4X_CFG(a) "NIC_PF_TL4X_CFG"
#define device_bar_CAVM_NIC_PF_TL4X_CFG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TL4X_CFG(a) (a)
#define arguments_CAVM_NIC_PF_TL4X_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_tl4x_sw_xoff
{
    uint64_t u;
    struct cavm_nic_pf_tl4x_sw_xoff_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_nic_pf_tl4x_sw_xoff_s cn; */
};
...
#define bustype_CAVM_NIC_PF_TL4X_SW_XOFF(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TL4X_SW_XOFF(a) "NIC_PF_TL4X_SW_XOFF"
#define device_bar_CAVM_NIC_PF_TL4X_SW_XOFF(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TL4X_SW_XOFF(a) (a)
#define arguments_CAVM_NIC_PF_TL4X_SW_XOFF(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_tso_cfg
{
    uint64_t u;
    struct cavm_nic_pf_tso_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_tso_cfg_s cn; */
};
typedef union cavm_nic_pf_tso_cfg cavm_nic_pf_tso_cfg_t;

#define CAVM_NIC_PF_TSO_CFG CAVM_NIC_PF_TSO_CFG_FUNC()
static inline uint64_t CAVM_NIC_PF_TSO_CFG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_TSO_CFG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_TSO_CFG CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TSO_CFG "NIC_PF_TSO_CFG"
#define device_bar_CAVM_NIC_PF_TSO_CFG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TSO_CFG 0
#define arguments_CAVM_NIC_PF_TSO_CFG -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_tx_fifo_status
{
    uint64_t u;
    struct cavm_nic_pf_tx_fifo_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_tx_fifo_status_s cn; */
};
typedef union cavm_nic_pf_tx_fifo_status cavm_nic_pf_tx_fifo_status_t;

#define CAVM_NIC_PF_TX_FIFO_STATUS CAVM_NIC_PF_TX_FIFO_STATUS_FUNC()
static inline uint64_t CAVM_NIC_PF_TX_FIFO_STATUS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NIC_PF_TX_FIFO_STATUS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
...
#define bustype_CAVM_NIC_PF_TX_FIFO_STATUS CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TX_FIFO_STATUS "NIC_PF_TX_FIFO_STATUS"
#define device_bar_CAVM_NIC_PF_TX_FIFO_STATUS 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TX_FIFO_STATUS 0
#define arguments_CAVM_NIC_PF_TX_FIFO_STATUS -1,-1,-1,-1
 ...
 */
union cavm_nic_pf_tx_lbkx_fifo_credit
{
    uint64_t u;
    struct cavm_nic_pf_tx_lbkx_fifo_credit_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_10_63        : 54;
    ...
    /* struct cavm_nic_pf_tx_lbkx_fifo_credit_s cn; */
};
...
#define bustype_CAVM_NIC_PF_TX_LBKX_FIFO_CREDIT(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_TX_LBKX_FIFO_CREDIT(a) "NIC_PF_TX_LBKX_FIFO_CREDIT"
#define device_bar_CAVM_NIC_PF_TX_LBKX_FIFO_CREDIT(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_TX_LBKX_FIFO_CREDIT(a) (a)
#define arguments_CAVM_NIC_PF_TX_LBKX_FIFO_CREDIT(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_pf_vfx_mboxx
{
    uint64_t u;
    struct cavm_nic_pf_vfx_mboxx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_pf_vfx_mboxx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_VFX_MBOXX(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_VFX_MBOXX(a,b) "NIC_PF_VFX_MBOXX"
#define device_bar_CAVM_NIC_PF_VFX_MBOXX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_VFX_MBOXX(a,b) (a)
#define arguments_CAVM_NIC_PF_VFX_MBOXX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_pf_vnicx_rx_statx
{
    uint64_t u;
    struct cavm_nic_pf_vnicx_rx_statx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
    ...
    /* struct cavm_nic_pf_vnicx_rx_statx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_VNICX_RX_STATX(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_VNICX_RX_STATX(a,b) "NIC_PF_VNICX_RX_STATX"
#define device_bar_CAVM_NIC_PF_VNICX_RX_STATX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_VNICX_RX_STATX(a,b) (a)
#define arguments_CAVM_NIC_PF_VNICX_RX_STATX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_pf_vnicx_tx_statx
{
    uint64_t u;
    struct cavm_nic_pf_vnicx_tx_statx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
    ...
    /* struct cavm_nic_pf_vnicx_tx_statx_s cn; */
};
...
#define bustype_CAVM_NIC_PF_VNICX_TX_STATX(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_PF_VNICX_TX_STATX(a,b) "NIC_PF_VNICX_TX_STATX"
#define device_bar_CAVM_NIC_PF_VNICX_TX_STATX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NIC_PF_VNICX_TX_STATX(a,b) (a)
#define arguments_CAVM_NIC_PF_VNICX_TX_STATX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_cqx_base
{
    uint64_t u;
    struct cavm_nic_qsx_cqx_base_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
    ...
    /* struct cavm_nic_qsx_cqx_base_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_CQX_BASE(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_CQX_BASE(a,b) "NIC_QSX_CQX_BASE"
#define device_bar_CAVM_NIC_QSX_CQX_BASE(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_CQX_BASE(a,b) (a)
#define arguments_CAVM_NIC_QSX_CQX_BASE(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_cqx_cfg
{
    uint64_t u;
    struct cavm_nic_qsx_cqx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_qsx_cqx_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_CQX_CFG(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_CQX_CFG(a,b) "NIC_QSX_CQX_CFG"
#define device_bar_CAVM_NIC_QSX_CQX_CFG(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_CQX_CFG(a,b) (a)
#define arguments_CAVM_NIC_QSX_CQX_CFG(a,b) (a),(b),-1,-1
 ...
 * NIC Completion-Queue Configuration Registers
 */
union cavm_nic_qsx_cqx_cfg2
{
    uint64_t u;
    struct cavm_nic_qsx_cqx_cfg2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
    ...
    /* struct cavm_nic_qsx_cqx_cfg2_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_CQX_CFG2(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_CQX_CFG2(a,b) "NIC_QSX_CQX_CFG2"
#define device_bar_CAVM_NIC_QSX_CQX_CFG2(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_CQX_CFG2(a,b) (a)
#define arguments_CAVM_NIC_QSX_CQX_CFG2(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_cqx_debug
{
    uint64_t u;
    struct cavm_nic_qsx_cqx_debug_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct cavm_nic_qsx_cqx_debug_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_CQX_DEBUG(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_CQX_DEBUG(a,b) "NIC_QSX_CQX_DEBUG"
#define device_bar_CAVM_NIC_QSX_CQX_DEBUG(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_CQX_DEBUG(a,b) (a)
#define arguments_CAVM_NIC_QSX_CQX_DEBUG(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_cqx_door
{
    uint64_t u;
    struct cavm_nic_qsx_cqx_door_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct cavm_nic_qsx_cqx_door_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_CQX_DOOR(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_CQX_DOOR(a,b) "NIC_QSX_CQX_DOOR"
#define device_bar_CAVM_NIC_QSX_CQX_DOOR(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_CQX_DOOR(a,b) (a)
#define arguments_CAVM_NIC_QSX_CQX_DOOR(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_cqx_head
{
    uint64_t u;
    struct cavm_nic_qsx_cqx_head_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_25_63        : 39;
    ...
    /* struct cavm_nic_qsx_cqx_head_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_CQX_HEAD(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_CQX_HEAD(a,b) "NIC_QSX_CQX_HEAD"
#define device_bar_CAVM_NIC_QSX_CQX_HEAD(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_CQX_HEAD(a,b) (a)
#define arguments_CAVM_NIC_QSX_CQX_HEAD(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_cqx_status
{
    uint64_t u;
    struct cavm_nic_qsx_cqx_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_qsx_cqx_status_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_CQX_STATUS(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_CQX_STATUS(a,b) "NIC_QSX_CQX_STATUS"
#define device_bar_CAVM_NIC_QSX_CQX_STATUS(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_CQX_STATUS(a,b) (a)
#define arguments_CAVM_NIC_QSX_CQX_STATUS(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_cqx_status2
{
    uint64_t u;
    struct cavm_nic_qsx_cqx_status2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_nic_qsx_cqx_status2_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_CQX_STATUS2(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_CQX_STATUS2(a,b) "NIC_QSX_CQX_STATUS2"
#define device_bar_CAVM_NIC_QSX_CQX_STATUS2(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_CQX_STATUS2(a,b) (a)
#define arguments_CAVM_NIC_QSX_CQX_STATUS2(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_cqx_tail
{
    uint64_t u;
    struct cavm_nic_qsx_cqx_tail_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_25_63        : 39;
    ...
    /* struct cavm_nic_qsx_cqx_tail_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_CQX_TAIL(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_CQX_TAIL(a,b) "NIC_QSX_CQX_TAIL"
#define device_bar_CAVM_NIC_QSX_CQX_TAIL(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_CQX_TAIL(a,b) (a)
#define arguments_CAVM_NIC_QSX_CQX_TAIL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_cqx_thresh
{
    uint64_t u;
    struct cavm_nic_qsx_cqx_thresh_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct cavm_nic_qsx_cqx_thresh_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_CQX_THRESH(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_CQX_THRESH(a,b) "NIC_QSX_CQX_THRESH"
#define device_bar_CAVM_NIC_QSX_CQX_THRESH(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_CQX_THRESH(a,b) (a)
#define arguments_CAVM_NIC_QSX_CQX_THRESH(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_rbdrx_base
{
    uint64_t u;
    struct cavm_nic_qsx_rbdrx_base_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
    ...
    /* struct cavm_nic_qsx_rbdrx_base_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_RBDRX_BASE(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_RBDRX_BASE(a,b) "NIC_QSX_RBDRX_BASE"
#define device_bar_CAVM_NIC_QSX_RBDRX_BASE(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_RBDRX_BASE(a,b) (a)
#define arguments_CAVM_NIC_QSX_RBDRX_BASE(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_rbdrx_cfg
{
    uint64_t u;
    struct cavm_nic_qsx_rbdrx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_qsx_rbdrx_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_RBDRX_CFG(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_RBDRX_CFG(a,b) "NIC_QSX_RBDRX_CFG"
#define device_bar_CAVM_NIC_QSX_RBDRX_CFG(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_RBDRX_CFG(a,b) (a)
#define arguments_CAVM_NIC_QSX_RBDRX_CFG(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_rbdrx_door
{
    uint64_t u;
    struct cavm_nic_qsx_rbdrx_door_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
    ...
    /* struct cavm_nic_qsx_rbdrx_door_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_RBDRX_DOOR(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_RBDRX_DOOR(a,b) "NIC_QSX_RBDRX_DOOR"
#define device_bar_CAVM_NIC_QSX_RBDRX_DOOR(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_RBDRX_DOOR(a,b) (a)
#define arguments_CAVM_NIC_QSX_RBDRX_DOOR(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_rbdrx_head
{
    uint64_t u;
    struct cavm_nic_qsx_rbdrx_head_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_22_63        : 42;
    ...
    /* struct cavm_nic_qsx_rbdrx_head_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_RBDRX_HEAD(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_RBDRX_HEAD(a,b) "NIC_QSX_RBDRX_HEAD"
#define device_bar_CAVM_NIC_QSX_RBDRX_HEAD(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_RBDRX_HEAD(a,b) (a)
#define arguments_CAVM_NIC_QSX_RBDRX_HEAD(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_rbdrx_prefetch_status
{
    uint64_t u;
    struct cavm_nic_qsx_rbdrx_prefetch_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_qsx_rbdrx_prefetch_status_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_RBDRX_PREFETCH_STATUS(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_RBDRX_PREFETCH_STATUS(a,b) "NIC_QSX_RBDRX_PREFETCH_STATUS"
#define device_bar_CAVM_NIC_QSX_RBDRX_PREFETCH_STATUS(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_RBDRX_PREFETCH_STATUS(a,b) (a)
#define arguments_CAVM_NIC_QSX_RBDRX_PREFETCH_STATUS(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_rbdrx_status0
{
    uint64_t u;
    struct cavm_nic_qsx_rbdrx_status0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_qsx_rbdrx_status0_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_RBDRX_STATUS0(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_RBDRX_STATUS0(a,b) "NIC_QSX_RBDRX_STATUS0"
#define device_bar_CAVM_NIC_QSX_RBDRX_STATUS0(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_RBDRX_STATUS0(a,b) (a)
#define arguments_CAVM_NIC_QSX_RBDRX_STATUS0(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_rbdrx_status1
{
    uint64_t u;
    struct cavm_nic_qsx_rbdrx_status1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
    ...
    /* struct cavm_nic_qsx_rbdrx_status1_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_RBDRX_STATUS1(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_RBDRX_STATUS1(a,b) "NIC_QSX_RBDRX_STATUS1"
#define device_bar_CAVM_NIC_QSX_RBDRX_STATUS1(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_RBDRX_STATUS1(a,b) (a)
#define arguments_CAVM_NIC_QSX_RBDRX_STATUS1(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_rbdrx_tail
{
    uint64_t u;
    struct cavm_nic_qsx_rbdrx_tail_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_22_63        : 42;
    ...
    /* struct cavm_nic_qsx_rbdrx_tail_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_RBDRX_TAIL(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_RBDRX_TAIL(a,b) "NIC_QSX_RBDRX_TAIL"
#define device_bar_CAVM_NIC_QSX_RBDRX_TAIL(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_RBDRX_TAIL(a,b) (a)
#define arguments_CAVM_NIC_QSX_RBDRX_TAIL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_rbdrx_thresh
{
    uint64_t u;
    struct cavm_nic_qsx_rbdrx_thresh_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_19_63        : 45;
    ...
    /* struct cavm_nic_qsx_rbdrx_thresh_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_RBDRX_THRESH(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_RBDRX_THRESH(a,b) "NIC_QSX_RBDRX_THRESH"
#define device_bar_CAVM_NIC_QSX_RBDRX_THRESH(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_RBDRX_THRESH(a,b) (a)
#define arguments_CAVM_NIC_QSX_RBDRX_THRESH(a,b) (a),(b),-1,-1
 ...
 * NIC Receive-Queue Configuration Registers
 */
union cavm_nic_qsx_rqx_cfg
{
    uint64_t u;
    struct cavm_nic_qsx_rqx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
    ...
    /* struct cavm_nic_qsx_rqx_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_RQX_CFG(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_RQX_CFG(a,b) "NIC_QSX_RQX_CFG"
#define device_bar_CAVM_NIC_QSX_RQX_CFG(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_RQX_CFG(a,b) (a)
#define arguments_CAVM_NIC_QSX_RQX_CFG(a,b) (a),(b),-1,-1
 ...
 * The third dimension indicates which statistic, and is enumerated by NIC_STAT_RQ_E.
 */
union cavm_nic_qsx_rqx_statx
{
    uint64_t u;
    struct cavm_nic_qsx_rqx_statx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
    ...
    /* struct cavm_nic_qsx_rqx_statx_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_RQX_STATX(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_RQX_STATX(a,b,c) "NIC_QSX_RQX_STATX"
#define device_bar_CAVM_NIC_QSX_RQX_STATX(a,b,c) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_RQX_STATX(a,b,c) (a)
#define arguments_CAVM_NIC_QSX_RQX_STATX(a,b,c) (a),(b),(c),-1
 ...
 */
union cavm_nic_qsx_rq_gen_cfg
{
    uint64_t u;
    struct cavm_nic_qsx_rq_gen_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_27_63        : 37;
    ...
    /* struct cavm_nic_qsx_rq_gen_cfg_s cn8; */
    struct cavm_nic_qsx_rq_gen_cfg_cn81xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_27_63        : 37;
        uint64_t vlan_strip            : 2;  /**< [ 26: 25](R/W) Controls the stripping of any VLAN tags:
    ...
    /* struct cavm_nic_qsx_rq_gen_cfg_s cn83xx; */
};
...
#define bustype_CAVM_NIC_QSX_RQ_GEN_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_RQ_GEN_CFG(a) "NIC_QSX_RQ_GEN_CFG"
#define device_bar_CAVM_NIC_QSX_RQ_GEN_CFG(a) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_RQ_GEN_CFG(a) (a)
#define arguments_CAVM_NIC_QSX_RQ_GEN_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_qsx_sqx_base
{
    uint64_t u;
    struct cavm_nic_qsx_sqx_base_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
    ...
    /* struct cavm_nic_qsx_sqx_base_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_SQX_BASE(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_SQX_BASE(a,b) "NIC_QSX_SQX_BASE"
#define device_bar_CAVM_NIC_QSX_SQX_BASE(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_SQX_BASE(a,b) (a)
#define arguments_CAVM_NIC_QSX_SQX_BASE(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_sqx_cfg
{
    uint64_t u;
    struct cavm_nic_qsx_sqx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_nic_qsx_sqx_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_SQX_CFG(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_SQX_CFG(a,b) "NIC_QSX_SQX_CFG"
#define device_bar_CAVM_NIC_QSX_SQX_CFG(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_SQX_CFG(a,b) (a)
#define arguments_CAVM_NIC_QSX_SQX_CFG(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_sqx_debug
{
    uint64_t u;
    struct cavm_nic_qsx_sqx_debug_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_nic_qsx_sqx_debug_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_SQX_DEBUG(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_SQX_DEBUG(a,b) "NIC_QSX_SQX_DEBUG"
#define device_bar_CAVM_NIC_QSX_SQX_DEBUG(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_SQX_DEBUG(a,b) (a)
#define arguments_CAVM_NIC_QSX_SQX_DEBUG(a,b) (a),(b),-1,-1
 ...
 * to the SQ ring.
 */
union cavm_nic_qsx_sqx_door
{
    uint64_t u;
    struct cavm_nic_qsx_sqx_door_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct cavm_nic_qsx_sqx_door_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_SQX_DOOR(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_SQX_DOOR(a,b) "NIC_QSX_SQX_DOOR"
#define device_bar_CAVM_NIC_QSX_SQX_DOOR(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_SQX_DOOR(a,b) (a)
#define arguments_CAVM_NIC_QSX_SQX_DOOR(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_sqx_head
{
    uint64_t u;
    struct cavm_nic_qsx_sqx_head_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_nic_qsx_sqx_head_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_SQX_HEAD(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_SQX_HEAD(a,b) "NIC_QSX_SQX_HEAD"
#define device_bar_CAVM_NIC_QSX_SQX_HEAD(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_SQX_HEAD(a,b) (a)
#define arguments_CAVM_NIC_QSX_SQX_HEAD(a,b) (a),(b),-1,-1
 ...
 * The third dimension indicates which statistic, and is enumerated by NIC_STAT_SQ_E.
 */
union cavm_nic_qsx_sqx_statx
{
    uint64_t u;
    struct cavm_nic_qsx_sqx_statx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
    ...
    /* struct cavm_nic_qsx_sqx_statx_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_SQX_STATX(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_SQX_STATX(a,b,c) "NIC_QSX_SQX_STATX"
#define device_bar_CAVM_NIC_QSX_SQX_STATX(a,b,c) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_SQX_STATX(a,b,c) (a)
#define arguments_CAVM_NIC_QSX_SQX_STATX(a,b,c) (a),(b),(c),-1
 ...
 */
union cavm_nic_qsx_sqx_status
{
    uint64_t u;
    struct cavm_nic_qsx_sqx_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_22_63        : 42;
    ...
    /* struct cavm_nic_qsx_sqx_status_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_SQX_STATUS(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_SQX_STATUS(a,b) "NIC_QSX_SQX_STATUS"
#define device_bar_CAVM_NIC_QSX_SQX_STATUS(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_SQX_STATUS(a,b) (a)
#define arguments_CAVM_NIC_QSX_SQX_STATUS(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_sqx_tail
{
    uint64_t u;
    struct cavm_nic_qsx_sqx_tail_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_nic_qsx_sqx_tail_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_SQX_TAIL(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_SQX_TAIL(a,b) "NIC_QSX_SQX_TAIL"
#define device_bar_CAVM_NIC_QSX_SQX_TAIL(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_SQX_TAIL(a,b) (a)
#define arguments_CAVM_NIC_QSX_SQX_TAIL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_qsx_sqx_thresh
{
    uint64_t u;
    struct cavm_nic_qsx_sqx_thresh_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct cavm_nic_qsx_sqx_thresh_s cn; */
};
...
#define bustype_CAVM_NIC_QSX_SQX_THRESH(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_QSX_SQX_THRESH(a,b) "NIC_QSX_SQX_THRESH"
#define device_bar_CAVM_NIC_QSX_SQX_THRESH(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_QSX_SQX_THRESH(a,b) (a)
#define arguments_CAVM_NIC_QSX_SQX_THRESH(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_vfx_cfg
{
    uint64_t u;
    struct cavm_nic_vfx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
...
#define bustype_CAVM_NIC_VFX_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_VFX_CFG(a) "NIC_VFX_CFG"
#define device_bar_CAVM_NIC_VFX_CFG(a) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_VFX_CFG(a) (a)
#define arguments_CAVM_NIC_VFX_CFG(a) (a),-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_nic_vfx_ena_w1c
{
    uint64_t u;
    struct cavm_nic_vfx_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
    ...
    /* struct cavm_nic_vfx_ena_w1c_s cn8; */
    /* struct cavm_nic_vfx_ena_w1c_s cn81xx; */
    struct cavm_nic_vfx_ena_w1c_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
...
#define bustype_CAVM_NIC_VFX_ENA_W1C(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_VFX_ENA_W1C(a) "NIC_VFX_ENA_W1C"
#define device_bar_CAVM_NIC_VFX_ENA_W1C(a) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_VFX_ENA_W1C(a) (a)
#define arguments_CAVM_NIC_VFX_ENA_W1C(a) (a),-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_nic_vfx_ena_w1s
{
    uint64_t u;
    struct cavm_nic_vfx_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
    ...
    /* struct cavm_nic_vfx_ena_w1s_s cn8; */
    /* struct cavm_nic_vfx_ena_w1s_s cn81xx; */
    struct cavm_nic_vfx_ena_w1s_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
...
#define bustype_CAVM_NIC_VFX_ENA_W1S(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_VFX_ENA_W1S(a) "NIC_VFX_ENA_W1S"
#define device_bar_CAVM_NIC_VFX_ENA_W1S(a) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_VFX_ENA_W1S(a) (a)
#define arguments_CAVM_NIC_VFX_ENA_W1S(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_vfx_int
{
    uint64_t u;
    struct cavm_nic_vfx_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
    ...
    /* struct cavm_nic_vfx_int_s cn8; */
    /* struct cavm_nic_vfx_int_s cn81xx; */
    struct cavm_nic_vfx_int_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
        uint64_t qs_err                : 1;  /**< [ 23: 23](R/W1C/H) Queue set error. Set when a CQ, SQ or RBDR in the QS has an error, as follows:
...
#define bustype_CAVM_NIC_VFX_INT(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_VFX_INT(a) "NIC_VFX_INT"
#define device_bar_CAVM_NIC_VFX_INT(a) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_VFX_INT(a) (a)
#define arguments_CAVM_NIC_VFX_INT(a) (a),-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_nic_vfx_int_w1s
{
    uint64_t u;
    struct cavm_nic_vfx_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
    ...
    /* struct cavm_nic_vfx_int_w1s_s cn8; */
    /* struct cavm_nic_vfx_int_w1s_s cn81xx; */
    struct cavm_nic_vfx_int_w1s_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_24_63        : 40;
...
#define bustype_CAVM_NIC_VFX_INT_W1S(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_VFX_INT_W1S(a) "NIC_VFX_INT_W1S"
#define device_bar_CAVM_NIC_VFX_INT_W1S(a) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_VFX_INT_W1S(a) (a)
#define arguments_CAVM_NIC_VFX_INT_W1S(a) (a),-1,-1,-1
 ...
 * enumeration.
 */
union cavm_nic_vfx_msix_pbax
{
    uint64_t u;
    struct cavm_nic_vfx_msix_pbax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_vfx_msix_pbax_s cn; */
};
...
#define bustype_CAVM_NIC_VFX_MSIX_PBAX(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_VFX_MSIX_PBAX(a,b) "NIC_VFX_MSIX_PBAX"
#define device_bar_CAVM_NIC_VFX_MSIX_PBAX(a,b) 0x4 /* VF_BAR4 */
#define busnum_CAVM_NIC_VFX_MSIX_PBAX(a,b) (a)
#define arguments_CAVM_NIC_VFX_MSIX_PBAX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_vfx_msix_vecx_addr
{
    uint64_t u;
    struct cavm_nic_vfx_msix_vecx_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
        uint64_t addr                  : 47; /**< [ 48:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct cavm_nic_vfx_msix_vecx_addr_s cn; */
};
...
#define bustype_CAVM_NIC_VFX_MSIX_VECX_ADDR(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_VFX_MSIX_VECX_ADDR(a,b) "NIC_VFX_MSIX_VECX_ADDR"
#define device_bar_CAVM_NIC_VFX_MSIX_VECX_ADDR(a,b) 0x4 /* VF_BAR4 */
#define busnum_CAVM_NIC_VFX_MSIX_VECX_ADDR(a,b) (a)
#define arguments_CAVM_NIC_VFX_MSIX_VECX_ADDR(a,b) (a),(b),-1,-1
 ...
 * This register is the MSI-X vector table, indexed by the NIC_VF_INT_VEC_E enumeration.
 */
union cavm_nic_vfx_msix_vecx_ctl
{
    uint64_t u;
    struct cavm_nic_vfx_msix_vecx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_33_63        : 31;
        uint64_t mask                  : 1;  /**< [ 32: 32](R/W) When set, no MSI-X interrupts are sent to this vector. */
    ...
    /* struct cavm_nic_vfx_msix_vecx_ctl_s cn; */
};
...
#define bustype_CAVM_NIC_VFX_MSIX_VECX_CTL(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_VFX_MSIX_VECX_CTL(a,b) "NIC_VFX_MSIX_VECX_CTL"
#define device_bar_CAVM_NIC_VFX_MSIX_VECX_CTL(a,b) 0x4 /* VF_BAR4 */
#define busnum_CAVM_NIC_VFX_MSIX_VECX_CTL(a,b) (a)
#define arguments_CAVM_NIC_VFX_MSIX_VECX_CTL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_vfx_pf_mboxx
{
    uint64_t u;
    struct cavm_nic_vfx_pf_mboxx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_vfx_pf_mboxx_s cn; */
};
...
#define bustype_CAVM_NIC_VFX_PF_MBOXX(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_VFX_PF_MBOXX(a,b) "NIC_VFX_PF_MBOXX"
#define device_bar_CAVM_NIC_VFX_PF_MBOXX(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_VFX_PF_MBOXX(a,b) (a)
#define arguments_CAVM_NIC_VFX_PF_MBOXX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_nic_vnicx_rss_cfg
{
    uint64_t u;
    struct cavm_nic_vnicx_rss_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_12_63        : 52;
    ...
    /* struct cavm_nic_vnicx_rss_cfg_s cn; */
};
...
#define bustype_CAVM_NIC_VNICX_RSS_CFG(a) CSR_TYPE_NCB
#define basename_CAVM_NIC_VNICX_RSS_CFG(a) "NIC_VNICX_RSS_CFG"
#define device_bar_CAVM_NIC_VNICX_RSS_CFG(a) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_VNICX_RSS_CFG(a) (a)
#define arguments_CAVM_NIC_VNICX_RSS_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_nic_vnicx_rss_keyx
{
    uint64_t u;
    struct cavm_nic_vnicx_rss_keyx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_nic_vnicx_rss_keyx_s cn; */
};
...
#define bustype_CAVM_NIC_VNICX_RSS_KEYX(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_VNICX_RSS_KEYX(a,b) "NIC_VNICX_RSS_KEYX"
#define device_bar_CAVM_NIC_VNICX_RSS_KEYX(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_VNICX_RSS_KEYX(a,b) (a)
#define arguments_CAVM_NIC_VNICX_RSS_KEYX(a,b) (a),(b),-1,-1
 ...
 * The second dimension indicates which statistic, and is enumerated by NIC_STAT_VNIC_RX_E.
 */
union cavm_nic_vnicx_rx_statx
{
    uint64_t u;
    struct cavm_nic_vnicx_rx_statx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
    ...
    /* struct cavm_nic_vnicx_rx_statx_s cn; */
};
...
#define bustype_CAVM_NIC_VNICX_RX_STATX(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_VNICX_RX_STATX(a,b) "NIC_VNICX_RX_STATX"
#define device_bar_CAVM_NIC_VNICX_RX_STATX(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_VNICX_RX_STATX(a,b) (a)
#define arguments_CAVM_NIC_VNICX_RX_STATX(a,b) (a),(b),-1,-1
 ...
 * The second dimension indicates which statistic, and is enumerated by NIC_STAT_VNIC_TX_E.
 */
union cavm_nic_vnicx_tx_statx
{
    uint64_t u;
    struct cavm_nic_vnicx_tx_statx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
    ...
    /* struct cavm_nic_vnicx_tx_statx_s cn; */
};
...
#define bustype_CAVM_NIC_VNICX_TX_STATX(a,b) CSR_TYPE_NCB
#define basename_CAVM_NIC_VNICX_TX_STATX(a,b) "NIC_VNICX_TX_STATX"
#define device_bar_CAVM_NIC_VNICX_TX_STATX(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_NIC_VNICX_TX_STATX(a,b) (a)
#define arguments_CAVM_NIC_VNICX_TX_STATX(a,b) (a),(b),-1,-1

#endif /* __CAVM_CSRS_NIC_H__ */
