...
static inline uint64_t CAVM_TRCX_TRCACATR4(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCACATR4", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TRCX_TRCACATR5(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCACATR5", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TRCX_TRCACATR6(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCACATR6", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TRCX_TRCACATR7(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCACATR7", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TRCX_TRCACVR4(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCACVR4", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TRCX_TRCACVR5(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCACVR5", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TRCX_TRCACVR6(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCACVR6", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TRCX_TRCACVR7(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCACVR7", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TRCX_TRCCLAIMCLR(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCCLAIMCLR", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TRCX_TRCCLAIMSET(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCCLAIMSET", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TRCX_TRCIMSPEC0(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCIMSPEC0", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TRCX_TRCIMSPEC1(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCIMSPEC1", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TRCX_TRCIMSPEC2(unsigned long a)
{
    ...
    __cavm_csr_fatal("TRCX_TRCIMSPEC2", 1, a, 0, 0, 0);
}
...
union cavm_trcx_trcpidr2
{
    ...
    struct cavm_trcx_trcpidr2_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t revision              : 4;  /**< [  7:  4](RO) Architectural revision, as assigned by Arm. */
    ...
    /* struct cavm_trcx_trcpidr2_s cnf95xx; */
};
...
union cavm_trcx_trcpidr4
{
    ...
    struct cavm_trcx_trcpidr4_cn96xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t size                  : 4;  /**< [  7:  4](RO) Size of the component. Log\<sub\>2\</sub\> of the number of 4KB pages from the
    ...
    /* struct cavm_trcx_trcpidr4_s cnf95xx; */
};
...
union cavm_trcx_trcvmidcctlr0
{
    ...
    struct cavm_trcx_trcvmidcctlr0_cn83xx
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_4_31         : 28;
