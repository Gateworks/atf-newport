...
union cavm_tim_mem_bucket_s
{
    ...
    /* struct cavm_tim_mem_bucket_s_s cn8; */
    struct cavm_tim_mem_bucket_s_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_tim_mem_entry_s
{
    ...
    /* struct cavm_tim_mem_entry_s_s cn8; */
    struct cavm_tim_mem_entry_s_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_44_63        : 20;
        uint64_t grp                   : 10; /**< [ 43: 34] SSO guest group.
...
static inline uint64_t CAVM_TIM_AF_ACTIVE_PC_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_ACTIVE_PC", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_BAR2_ALIASX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_BAR2_ALIASX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=131071))
        return 0x840099100000ll + 8ll * ((a) & 0x1ffff);
    __cavm_csr_fatal("TIM_AF_BAR2_ALIASX", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_BAR2_SEL_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_BAR2_SEL", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_BKT_SKIPX_INT_STATUS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_BKT_SKIPX_INT_STATUS(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=255))
        return 0x840090044000ll + 8ll * ((a) & 0xff);
    __cavm_csr_fatal("TIM_AF_BKT_SKIPX_INT_STATUS", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_BKT_SKIP_INTX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_BKT_SKIP_INTX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=3))
        return 0x840090010000ll + 0x20ll * ((a) & 0x3);
    __cavm_csr_fatal("TIM_AF_BKT_SKIP_INTX", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_BKT_SKIP_INT_ENA_W1CX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_BKT_SKIP_INT_ENA_W1CX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=3))
        return 0x840090010018ll + 0x20ll * ((a) & 0x3);
    __cavm_csr_fatal("TIM_AF_BKT_SKIP_INT_ENA_W1CX", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_BKT_SKIP_INT_ENA_W1SX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_BKT_SKIP_INT_ENA_W1SX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=3))
        return 0x840090010010ll + 0x20ll * ((a) & 0x3);
    __cavm_csr_fatal("TIM_AF_BKT_SKIP_INT_ENA_W1SX", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_BKT_SKIP_INT_W1SX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_BKT_SKIP_INT_W1SX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=3))
        return 0x840090010008ll + 0x20ll * ((a) & 0x3);
    __cavm_csr_fatal("TIM_AF_BKT_SKIP_INT_W1SX", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_BLK_RST_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_BLK_RST", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_BP_TESTX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_BP_TESTX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=8))
        return 0x840090034000ll + 8ll * ((a) & 0xf);
    __cavm_csr_fatal("TIM_AF_BP_TESTX", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_CONST_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_CONST", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_DBG_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_DBG", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_ECO_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_ECO", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_ENGX_ACTIVE(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_ENGX_ACTIVE(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=15))
        return 0x840090038000ll + 8ll * ((a) & 0xf);
    __cavm_csr_fatal("TIM_AF_ENGX_ACTIVE", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_FR_RN_CYCLES_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_FR_RN_CYCLES", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_FR_RN_GPIOS_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_FR_RN_GPIOS", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_FR_RN_GTI_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_FR_RN_GTI", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_FR_RN_PTP_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_FR_RN_PTP", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_FR_RN_TENNS_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_FR_RN_TENNS", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_LF_RST_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_LF_RST", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_NXT_MIN_GPIOS_EXPIRE_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_NXT_MIN_GPIOS_EXPIRE", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_NXT_MIN_GTI_EXPIRE_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_NXT_MIN_GTI_EXPIRE", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_NXT_MIN_PTP_EXPIRE_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_NXT_MIN_PTP_EXPIRE", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_NXT_MIN_TENNS_EXPIRE_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_NXT_MIN_TENNS_EXPIRE", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_REG_FLAGS_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_REG_FLAGS", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_RINGX_CTL0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_RINGX_CTL0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=255))
        return 0x840090004000ll + 8ll * ((a) & 0xff);
    __cavm_csr_fatal("TIM_AF_RINGX_CTL0", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_RINGX_CTL1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_RINGX_CTL1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=255))
        return 0x840090006000ll + 8ll * ((a) & 0xff);
    __cavm_csr_fatal("TIM_AF_RINGX_CTL1", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_RINGX_CTL2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_RINGX_CTL2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=255))
        return 0x840090008000ll + 8ll * ((a) & 0xff);
    __cavm_csr_fatal("TIM_AF_RINGX_CTL2", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_RINGX_GMCTL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_RINGX_GMCTL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=255))
        return 0x840090002000ll + 8ll * ((a) & 0xff);
    __cavm_csr_fatal("TIM_AF_RINGX_GMCTL", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_RINGX_LATE(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_RINGX_LATE(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=255))
        return 0x840090046000ll + 8ll * ((a) & 0xff);
    __cavm_csr_fatal("TIM_AF_RINGX_LATE", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_RING_ACTIVE_VECX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_RING_ACTIVE_VECX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=3))
        return 0x840090040000ll + 8ll * ((a) & 0x3);
    __cavm_csr_fatal("TIM_AF_RING_ACTIVE_VECX", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_RING_PENDING_VECX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_AF_RING_PENDING_VECX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=3))
        return 0x840090042000ll + 8ll * ((a) & 0x3);
    __cavm_csr_fatal("TIM_AF_RING_PENDING_VECX", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_RVU_INT_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_RVU_INT", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_RVU_INT_ENA_W1C_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_RVU_INT_ENA_W1C", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_RVU_INT_ENA_W1S_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_RVU_INT_ENA_W1S", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_RVU_INT_W1S_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_RVU_INT_W1S", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_AF_RVU_LF_CFG_DEBUG_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_AF_RVU_LF_CFG_DEBUG", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_FR_RN_CYCLES_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_FR_RN_CYCLES", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_FR_RN_GPIOS_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_FR_RN_GPIOS", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_FR_RN_GTI_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_FR_RN_GTI", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_FR_RN_PTP_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_FR_RN_PTP", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_FR_RN_TENNS_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_FR_RN_TENNS", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_NRSPERR_INT_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_NRSPERR_INT", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_NRSPERR_INT_ENA_W1C_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_NRSPERR_INT_ENA_W1C", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_NRSPERR_INT_ENA_W1S_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_NRSPERR_INT_ENA_W1S", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_NRSPERR_INT_W1S_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_NRSPERR_INT_W1S", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_RAS_INT_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_RAS_INT", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_RAS_INT_ENA_W1C_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_RAS_INT_ENA_W1C", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_RAS_INT_ENA_W1S_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_RAS_INT_ENA_W1S", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_RAS_INT_W1S_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_RAS_INT_W1S", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_RING_AURA_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_RING_AURA", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_RING_BASE_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_RING_BASE", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_RING_CTL0_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_RING_CTL0", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_RING_CTL1_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_RING_CTL1", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_RING_CTL2_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_RING_CTL2", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_LF_RING_REL_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_LF_RING_REL", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_PRIV_AF_INT_CFG_FUNC(void)
{
    ...
    __cavm_csr_fatal("TIM_PRIV_AF_INT_CFG", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_PRIV_LFX_CFG(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_PRIV_LFX_CFG(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=255))
        return 0x840090020000ll + 8ll * ((a) & 0xff);
    __cavm_csr_fatal("TIM_PRIV_LFX_CFG", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_TIM_PRIV_LFX_INT_CFG(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_TIM_PRIV_LFX_INT_CFG(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=255))
        return 0x840090024000ll + 8ll * ((a) & 0xff);
    __cavm_csr_fatal("TIM_PRIV_LFX_INT_CFG", 1, a, 0, 0, 0);
}
...
#define device_bar_CAVM_TIM_VFX_MSIX_PBAX(a,b) 0x4 /* VF_BAR4 */
...
#define device_bar_CAVM_TIM_VFX_MSIX_VECX_ADDR(a,b) 0x4 /* VF_BAR4 */
...
#define device_bar_CAVM_TIM_VFX_MSIX_VECX_CTL(a,b) 0x4 /* VF_BAR4 */
...
#define device_bar_CAVM_TIM_VFX_NRSPERR_ENA_W1C(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VFX_NRSPERR_ENA_W1S(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VFX_NRSPERR_INT(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VFX_NRSPERR_INT_W1S(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VRINGX_AURA(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VRINGX_BASE(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VRINGX_CTL0(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VRINGX_CTL1(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VRINGX_CTL2(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VRINGX_FR_RN_CYCLES(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VRINGX_FR_RN_GPIOS(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VRINGX_FR_RN_GTI(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VRINGX_FR_RN_PTP(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_TIM_VRINGX_REL(a) 0x0 /* VF_BAR0 */
