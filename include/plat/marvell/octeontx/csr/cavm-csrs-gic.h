...
static inline uint64_t CAVM_GIC_BIST_STATUSR_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_BIST_STATUSR", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_BP_TEST0_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_BP_TEST0", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_BP_TEST1_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_BP_TEST1", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_CLOCK_CTLR_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_CLOCK_CTLR", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_CONST_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_CONST", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_CSCLK_ACTIVE_PC_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_CSCLK_ACTIVE_PC", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_ECC_INT_STATUSR_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_ECC_INT_STATUSR", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_INT_REQX_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_GIC_INT_REQX_PC(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=6))
        return 0x801000010100ll + 8ll * ((a) & 0x7);
    __cavm_csr_fatal("GIC_INT_REQX_PC", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_PF_MSIX_PBAX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_GIC_PF_MSIX_PBAX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a==0))
        return 0x8010800f0000ll + 8ll * ((a) & 0x0);
    __cavm_csr_fatal("GIC_PF_MSIX_PBAX", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_PF_MSIX_VECX_ADDR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_GIC_PF_MSIX_VECX_ADDR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a==0))
        return 0x801080000000ll + 0x10ll * ((a) & 0x0);
    __cavm_csr_fatal("GIC_PF_MSIX_VECX_ADDR", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_PF_MSIX_VECX_CTL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_GIC_PF_MSIX_VECX_CTL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a==0))
        return 0x801080000008ll + 0x10ll * ((a) & 0x0);
    __cavm_csr_fatal("GIC_PF_MSIX_VECX_CTL", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_RAS_CTL_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_RAS_CTL", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_RAS_ERR_SIG_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_RAS_ERR_SIG", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_RAS_INT_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_RAS_INT", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_RAS_INT_ENA_W1C_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_RAS_INT_ENA_W1C", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_RAS_INT_ENA_W1S_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_RAS_INT_ENA_W1S", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_GIC_RAS_INT_W1S_FUNC(void)
{
    ...
    __cavm_csr_fatal("GIC_RAS_INT_W1S", 0, 0, 0, 0, 0);
}
