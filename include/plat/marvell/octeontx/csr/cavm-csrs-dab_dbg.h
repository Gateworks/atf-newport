...
union cavm_dbgx_dbgauthstatus_el1
{
    ...
    /* struct cavm_dbgx_dbgauthstatus_el1_s cn8; */
    struct cavm_dbgx_dbgauthstatus_el1_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
        uint32_t snid                  : 2;  /**< [  7:  6](RO/H) Secure noninvasive debug.
...
union cavm_dbgx_dbgbcrx_el1
{
    ...
    /* struct cavm_dbgx_dbgbcrx_el1_s cn8; */
    struct cavm_dbgx_dbgbcrx_el1_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_24_31        : 8;
        uint32_t bt                    : 4;  /**< [ 23: 20](R/W) Breakpoint type.
...
{
    if (cavm_is_model(OCTEONTX_CN81XX) && ((a<=3) && (b<=5)))
        return 0x87a008000408ll + 0x80000ll * ((a) & 0x3) + 0x10ll * ((b) & 0x7);
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a<=23) && (b<=5)))
...
union cavm_dbgx_dbgclaimclr_el1
{
    ...
    struct cavm_dbgx_dbgclaimclr_el1_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    struct cavm_dbgx_dbgclaimclr_el1_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
...
union cavm_dbgx_dbgclaimset_el1
{
    ...
    struct cavm_dbgx_dbgclaimset_el1_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
    ...
    struct cavm_dbgx_dbgclaimset_el1_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_8_31         : 24;
...
union cavm_dbgx_dbgwcrx_el1
{
    ...
    /* struct cavm_dbgx_dbgwcrx_el1_s cn8; */
    struct cavm_dbgx_dbgwcrx_el1_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_29_31        : 3;
...
union cavm_dbgx_eddevarch
{
    ...
    /* struct cavm_dbgx_eddevarch_s cn8; */
    struct cavm_dbgx_eddevarch_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t architect             : 11; /**< [ 31: 21](RO) Defines the architecture of the component. For debug, this is
                                                                     Arm Limited.
...
union cavm_dbgx_eddevid
{
    ...
    /* struct cavm_dbgx_eddevid_s cn8; */
    struct cavm_dbgx_eddevid_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_28_31        : 4;
        uint32_t auxregs               : 4;  /**< [ 27: 24](RO) Indicates support for auxiliary registers. Permitted values
...
union cavm_dbgx_eddevid1
{
    ...
    /* struct cavm_dbgx_eddevid1_s cn8; */
    struct cavm_dbgx_eddevid1_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_4_31         : 28;
        uint32_t pcsroffset            : 4;  /**< [  3:  0](RO) PCSROffset field.
...
union cavm_dbgx_midr_el1
{
    ...
    /* struct cavm_dbgx_midr_el1_s cn8; */
