...
static inline uint64_t CAVM_SSOW_AF_BAR2_ALIASX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SSOW_AF_BAR2_ALIASX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=131071))
        return 0x840089100000ll + 8ll * ((a) & 0x1ffff);
    __cavm_csr_fatal("SSOW_AF_BAR2_ALIASX", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_AF_BAR2_SEL_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_AF_BAR2_SEL", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_AF_LF_HWS_RST_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_AF_LF_HWS_RST", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_AF_RVU_LF_HWS_CFG_DEBUG_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_AF_RVU_LF_HWS_CFG_DEBUG", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_AF_SCRATCH_AW_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_AF_SCRATCH_AW", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_AF_SCRATCH_GW_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_AF_SCRATCH_GW", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_AF_SCRATCH_WS_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_AF_SCRATCH_WS", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_GRPMSK_CHG_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_GRPMSK_CHG", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_INT_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_INT", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_INT_ENA_W1C_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_INT_ENA_W1C", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_INT_ENA_W1S_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_INT_ENA_W1S", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_INT_W1S_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_INT_W1S", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_LINKS_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_LINKS", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_NW_TIM_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_NW_TIM", 0, 0, 0, 0, 0);
}
 ...
 */
union cavm_ssow_lf_gws_op_alloc_we
{
    uint64_t u;
    struct cavm_ssow_lf_gws_op_alloc_we_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ssow_lf_gws_op_alloc_we_s cn; */
};
typedef union cavm_ssow_lf_gws_op_alloc_we cavm_ssow_lf_gws_op_alloc_we_t;

#define CAVM_SSOW_LF_GWS_OP_ALLOC_WE CAVM_SSOW_LF_GWS_OP_ALLOC_WE_FUNC()
static inline uint64_t CAVM_SSOW_LF_GWS_OP_ALLOC_WE_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SSOW_LF_GWS_OP_ALLOC_WE_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x840200800400ll;
    __cavm_csr_fatal("SSOW_LF_GWS_OP_ALLOC_WE", 0, 0, 0, 0, 0);
}

#define typedef_CAVM_SSOW_LF_GWS_OP_ALLOC_WE cavm_ssow_lf_gws_op_alloc_we_t
#define bustype_CAVM_SSOW_LF_GWS_OP_ALLOC_WE CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_SSOW_LF_GWS_OP_ALLOC_WE "SSOW_LF_GWS_OP_ALLOC_WE"
#define device_bar_CAVM_SSOW_LF_GWS_OP_ALLOC_WE 0x2 /* RVU_BAR2 */
#define busnum_CAVM_SSOW_LF_GWS_OP_ALLOC_WE 0
#define arguments_CAVM_SSOW_LF_GWS_OP_ALLOC_WE -1,-1,-1,-1
 ...
 */
union cavm_ssow_lf_gws_op_clr_nsched0
{
    uint64_t u;
    struct cavm_ssow_lf_gws_op_clr_nsched0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ssow_lf_gws_op_clr_nsched0_s cn; */
};
typedef union cavm_ssow_lf_gws_op_clr_nsched0 cavm_ssow_lf_gws_op_clr_nsched0_t;

#define CAVM_SSOW_LF_GWS_OP_CLR_NSCHED0 CAVM_SSOW_LF_GWS_OP_CLR_NSCHED0_FUNC()
static inline uint64_t CAVM_SSOW_LF_GWS_OP_CLR_NSCHED0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SSOW_LF_GWS_OP_CLR_NSCHED0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x840200800a00ll;
    __cavm_csr_fatal("SSOW_LF_GWS_OP_CLR_NSCHED0", 0, 0, 0, 0, 0);
}

#define typedef_CAVM_SSOW_LF_GWS_OP_CLR_NSCHED0 cavm_ssow_lf_gws_op_clr_nsched0_t
#define bustype_CAVM_SSOW_LF_GWS_OP_CLR_NSCHED0 CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_SSOW_LF_GWS_OP_CLR_NSCHED0 "SSOW_LF_GWS_OP_CLR_NSCHED0"
#define device_bar_CAVM_SSOW_LF_GWS_OP_CLR_NSCHED0 0x2 /* RVU_BAR2 */
#define busnum_CAVM_SSOW_LF_GWS_OP_CLR_NSCHED0 0
#define arguments_CAVM_SSOW_LF_GWS_OP_CLR_NSCHED0 -1,-1,-1,-1
 ...
 */
union cavm_ssow_lf_gws_op_clr_nsched1
{
    uint64_t u;
    struct cavm_ssow_lf_gws_op_clr_nsched1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ssow_lf_gws_op_clr_nsched1_s cn; */
};
typedef union cavm_ssow_lf_gws_op_clr_nsched1 cavm_ssow_lf_gws_op_clr_nsched1_t;

#define CAVM_SSOW_LF_GWS_OP_CLR_NSCHED1 CAVM_SSOW_LF_GWS_OP_CLR_NSCHED1_FUNC()
static inline uint64_t CAVM_SSOW_LF_GWS_OP_CLR_NSCHED1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SSOW_LF_GWS_OP_CLR_NSCHED1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x840200800a08ll;
    __cavm_csr_fatal("SSOW_LF_GWS_OP_CLR_NSCHED1", 0, 0, 0, 0, 0);
}

#define typedef_CAVM_SSOW_LF_GWS_OP_CLR_NSCHED1 cavm_ssow_lf_gws_op_clr_nsched1_t
#define bustype_CAVM_SSOW_LF_GWS_OP_CLR_NSCHED1 CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_SSOW_LF_GWS_OP_CLR_NSCHED1 "SSOW_LF_GWS_OP_CLR_NSCHED1"
#define device_bar_CAVM_SSOW_LF_GWS_OP_CLR_NSCHED1 0x2 /* RVU_BAR2 */
#define busnum_CAVM_SSOW_LF_GWS_OP_CLR_NSCHED1 0
#define arguments_CAVM_SSOW_LF_GWS_OP_CLR_NSCHED1 -1,-1,-1,-1
...
static inline uint64_t CAVM_SSOW_LF_GWS_OP_DESCHED_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_OP_DESCHED", 0, 0, 0, 0, 0);
}
 ...
 */
union cavm_ssow_lf_gws_op_desched_nosch
{
    uint64_t u;
    struct cavm_ssow_lf_gws_op_desched_nosch_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_0_63         : 64;
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_ssow_lf_gws_op_desched_nosch_s cn; */
};
typedef union cavm_ssow_lf_gws_op_desched_nosch cavm_ssow_lf_gws_op_desched_nosch_t;

#define CAVM_SSOW_LF_GWS_OP_DESCHED_NOSCH CAVM_SSOW_LF_GWS_OP_DESCHED_NOSCH_FUNC()
static inline uint64_t CAVM_SSOW_LF_GWS_OP_DESCHED_NOSCH_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SSOW_LF_GWS_OP_DESCHED_NOSCH_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x8402008008c0ll;
    __cavm_csr_fatal("SSOW_LF_GWS_OP_DESCHED_NOSCH", 0, 0, 0, 0, 0);
}

#define typedef_CAVM_SSOW_LF_GWS_OP_DESCHED_NOSCH cavm_ssow_lf_gws_op_desched_nosch_t
#define bustype_CAVM_SSOW_LF_GWS_OP_DESCHED_NOSCH CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_SSOW_LF_GWS_OP_DESCHED_NOSCH "SSOW_LF_GWS_OP_DESCHED_NOSCH"
#define device_bar_CAVM_SSOW_LF_GWS_OP_DESCHED_NOSCH 0x2 /* RVU_BAR2 */
#define busnum_CAVM_SSOW_LF_GWS_OP_DESCHED_NOSCH 0
#define arguments_CAVM_SSOW_LF_GWS_OP_DESCHED_NOSCH -1,-1,-1,-1
 ...
 */
union cavm_ssow_lf_gws_op_get_work
{
    uint64_t u;
    struct cavm_ssow_lf_gws_op_get_work_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ssow_lf_gws_op_get_work_s cn; */
};
typedef union cavm_ssow_lf_gws_op_get_work cavm_ssow_lf_gws_op_get_work_t;

#define CAVM_SSOW_LF_GWS_OP_GET_WORK CAVM_SSOW_LF_GWS_OP_GET_WORK_FUNC()
static inline uint64_t CAVM_SSOW_LF_GWS_OP_GET_WORK_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SSOW_LF_GWS_OP_GET_WORK_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x840200800600ll;
    __cavm_csr_fatal("SSOW_LF_GWS_OP_GET_WORK", 0, 0, 0, 0, 0);
}

#define typedef_CAVM_SSOW_LF_GWS_OP_GET_WORK cavm_ssow_lf_gws_op_get_work_t
#define bustype_CAVM_SSOW_LF_GWS_OP_GET_WORK CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_SSOW_LF_GWS_OP_GET_WORK "SSOW_LF_GWS_OP_GET_WORK"
#define device_bar_CAVM_SSOW_LF_GWS_OP_GET_WORK 0x2 /* RVU_BAR2 */
#define busnum_CAVM_SSOW_LF_GWS_OP_GET_WORK 0
#define arguments_CAVM_SSOW_LF_GWS_OP_GET_WORK -1,-1,-1,-1
...
static inline uint64_t CAVM_SSOW_LF_GWS_OP_GWC_INVAL_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_OP_GWC_INVAL", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_OP_SWTAG_DESCHED_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_OP_SWTAG_DESCHED", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_OP_SWTAG_FLUSH_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_OP_SWTAG_FLUSH", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_OP_SWTAG_FULL0_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_OP_SWTAG_FULL0", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_OP_SWTAG_FULL1_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_OP_SWTAG_FULL1", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_OP_SWTAG_NORM_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_OP_SWTAG_NORM", 0, 0, 0, 0, 0);
}
 ...
 */
union cavm_ssow_lf_gws_op_swtag_nosched
{
    uint64_t u;
    struct cavm_ssow_lf_gws_op_swtag_nosched_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_44_63        : 20;
        uint64_t ggrp                  : 10; /**< [ 43: 34](WO) Guest group that the work-queue entry will switch to. Translated as described
    ...
    /* struct cavm_ssow_lf_gws_op_swtag_nosched_s cn; */
};
typedef union cavm_ssow_lf_gws_op_swtag_nosched cavm_ssow_lf_gws_op_swtag_nosched_t;

#define CAVM_SSOW_LF_GWS_OP_SWTAG_NOSCHED CAVM_SSOW_LF_GWS_OP_SWTAG_NOSCHED_FUNC()
static inline uint64_t CAVM_SSOW_LF_GWS_OP_SWTAG_NOSCHED_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SSOW_LF_GWS_OP_SWTAG_NOSCHED_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x8402008009c0ll;
    __cavm_csr_fatal("SSOW_LF_GWS_OP_SWTAG_NOSCHED", 0, 0, 0, 0, 0);
}

#define typedef_CAVM_SSOW_LF_GWS_OP_SWTAG_NOSCHED cavm_ssow_lf_gws_op_swtag_nosched_t
#define bustype_CAVM_SSOW_LF_GWS_OP_SWTAG_NOSCHED CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_SSOW_LF_GWS_OP_SWTAG_NOSCHED "SSOW_LF_GWS_OP_SWTAG_NOSCHED"
#define device_bar_CAVM_SSOW_LF_GWS_OP_SWTAG_NOSCHED 0x2 /* RVU_BAR2 */
#define busnum_CAVM_SSOW_LF_GWS_OP_SWTAG_NOSCHED 0
#define arguments_CAVM_SSOW_LF_GWS_OP_SWTAG_NOSCHED -1,-1,-1,-1
...
static inline uint64_t CAVM_SSOW_LF_GWS_OP_SWTAG_UNTAG_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_OP_SWTAG_UNTAG", 0, 0, 0, 0, 0);
}
 ...
 * ignored.
 */
union cavm_ssow_lf_gws_op_swtp_clr
{
    uint64_t u;
    struct cavm_ssow_lf_gws_op_swtp_clr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_0_63         : 64;
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_ssow_lf_gws_op_swtp_clr_s cn; */
};
typedef union cavm_ssow_lf_gws_op_swtp_clr cavm_ssow_lf_gws_op_swtp_clr_t;

#define CAVM_SSOW_LF_GWS_OP_SWTP_CLR CAVM_SSOW_LF_GWS_OP_SWTP_CLR_FUNC()
static inline uint64_t CAVM_SSOW_LF_GWS_OP_SWTP_CLR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SSOW_LF_GWS_OP_SWTP_CLR_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x840200800820ll;
    __cavm_csr_fatal("SSOW_LF_GWS_OP_SWTP_CLR", 0, 0, 0, 0, 0);
}

#define typedef_CAVM_SSOW_LF_GWS_OP_SWTP_CLR cavm_ssow_lf_gws_op_swtp_clr_t
#define bustype_CAVM_SSOW_LF_GWS_OP_SWTP_CLR CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_SSOW_LF_GWS_OP_SWTP_CLR "SSOW_LF_GWS_OP_SWTP_CLR"
#define device_bar_CAVM_SSOW_LF_GWS_OP_SWTP_CLR 0x2 /* RVU_BAR2 */
#define busnum_CAVM_SSOW_LF_GWS_OP_SWTP_CLR 0
#define arguments_CAVM_SSOW_LF_GWS_OP_SWTP_CLR -1,-1,-1,-1
 ...
 * ignored.
 */
union cavm_ssow_lf_gws_op_swtp_set
{
    uint64_t u;
    struct cavm_ssow_lf_gws_op_swtp_set_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_0_63         : 64;
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_ssow_lf_gws_op_swtp_set_s cn; */
};
typedef union cavm_ssow_lf_gws_op_swtp_set cavm_ssow_lf_gws_op_swtp_set_t;

#define CAVM_SSOW_LF_GWS_OP_SWTP_SET CAVM_SSOW_LF_GWS_OP_SWTP_SET_FUNC()
static inline uint64_t CAVM_SSOW_LF_GWS_OP_SWTP_SET_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SSOW_LF_GWS_OP_SWTP_SET_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x840200800c00ll;
    __cavm_csr_fatal("SSOW_LF_GWS_OP_SWTP_SET", 0, 0, 0, 0, 0);
}

#define typedef_CAVM_SSOW_LF_GWS_OP_SWTP_SET cavm_ssow_lf_gws_op_swtp_set_t
#define bustype_CAVM_SSOW_LF_GWS_OP_SWTP_SET CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_SSOW_LF_GWS_OP_SWTP_SET "SSOW_LF_GWS_OP_SWTP_SET"
#define device_bar_CAVM_SSOW_LF_GWS_OP_SWTP_SET 0x2 /* RVU_BAR2 */
#define busnum_CAVM_SSOW_LF_GWS_OP_SWTP_SET 0
#define arguments_CAVM_SSOW_LF_GWS_OP_SWTP_SET -1,-1,-1,-1
...
static inline uint64_t CAVM_SSOW_LF_GWS_OP_UPD_WQP_GRP0_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_OP_UPD_WQP_GRP0", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_OP_UPD_WQP_GRP1_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_OP_UPD_WQP_GRP1", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_PENDSTATE_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_PENDSTATE", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_PENDTAG_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_PENDTAG", 0, 0, 0, 0, 0);
}
 ...
 * Returns status of each HWS.
 */
union cavm_ssow_lf_gws_pendwqp
{
    uint64_t u;
    struct cavm_ssow_lf_gws_pendwqp_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ssow_lf_gws_pendwqp_s cn; */
};
typedef union cavm_ssow_lf_gws_pendwqp cavm_ssow_lf_gws_pendwqp_t;

#define CAVM_SSOW_LF_GWS_PENDWQP CAVM_SSOW_LF_GWS_PENDWQP_FUNC()
static inline uint64_t CAVM_SSOW_LF_GWS_PENDWQP_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_SSOW_LF_GWS_PENDWQP_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x840200800040ll;
    __cavm_csr_fatal("SSOW_LF_GWS_PENDWQP", 0, 0, 0, 0, 0);
}

#define typedef_CAVM_SSOW_LF_GWS_PENDWQP cavm_ssow_lf_gws_pendwqp_t
#define bustype_CAVM_SSOW_LF_GWS_PENDWQP CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_SSOW_LF_GWS_PENDWQP "SSOW_LF_GWS_PENDWQP"
#define device_bar_CAVM_SSOW_LF_GWS_PENDWQP 0x2 /* RVU_BAR2 */
#define busnum_CAVM_SSOW_LF_GWS_PENDWQP 0
#define arguments_CAVM_SSOW_LF_GWS_PENDWQP -1,-1,-1,-1
...
static inline uint64_t CAVM_SSOW_LF_GWS_SWTP_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_SWTP", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_TAG_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_TAG", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_LF_GWS_WQP_FUNC(void)
{
    ...
    __cavm_csr_fatal("SSOW_LF_GWS_WQP", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_PRIV_LFX_HWS_CFG(unsigned long a)
{
    ...
    __cavm_csr_fatal("SSOW_PRIV_LFX_HWS_CFG", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_SSOW_PRIV_LFX_HWS_INT_CFG(unsigned long a)
{
    ...
    __cavm_csr_fatal("SSOW_PRIV_LFX_HWS_INT_CFG", 1, a, 0, 0, 0);
}
...
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a<=31) && (b<=3)))
...
#define device_bar_CAVM_SSOW_VHWSX_GRPMSK_CHGX(a,b) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_LINKS(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_ALLOC_WE(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_CLR_NSCHED(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_DESCHED(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_DESCHED_NOSCH(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_GET_WORK0(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_GET_WORK1(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_SWTAG_DESCHED(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_SWTAG_FULL0(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_SWTAG_FULL1(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_SWTAG_NORM(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_SWTAG_NOSCHED(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_SWTAG_UNTAG(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_SWTP_CLR(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_SWTP_SET(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_UPD_WQP_GRP0(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_OP_UPD_WQP_GRP1(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_PENDTAG(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_PENDWQP(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_SWTP(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_TAG(a) 0x0 /* VF_BAR0 */
...
#define device_bar_CAVM_SSOW_VHWSX_WQP(a) 0x0 /* VF_BAR0 */
