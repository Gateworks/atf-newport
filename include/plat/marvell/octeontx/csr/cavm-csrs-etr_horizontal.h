#ifndef __CAVM_CSRS_ETR_HORIZONTAL_H__
#define __CAVM_CSRS_ETR_HORIZONTAL_H__
 ...
 */
union cavm_etr_horizontal_authstatus
{
    uint32_t u;
    struct cavm_etr_horizontal_authstatus_s
    {
    ...
    /* struct cavm_etr_horizontal_authstatus_s cn; */
};
typedef union cavm_etr_horizontal_authstatus cavm_etr_horizontal_authstatus_t;

#define CAVM_ETR_HORIZONTAL_AUTHSTATUS CAVM_ETR_HORIZONTAL_AUTHSTATUS_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_AUTHSTATUS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_AUTHSTATUS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fb8ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_AUTHSTATUS", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_AUTHSTATUS cavm_etr_horizontal_authstatus_t
#define bustype_CAVM_ETR_HORIZONTAL_AUTHSTATUS CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_AUTHSTATUS "ETR_HORIZONTAL_AUTHSTATUS"
#define busnum_CAVM_ETR_HORIZONTAL_AUTHSTATUS 0
#define arguments_CAVM_ETR_HORIZONTAL_AUTHSTATUS -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_axictl
{
    uint32_t u;
    struct cavm_etr_horizontal_axictl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_axictl_s cn; */
};
typedef union cavm_etr_horizontal_axictl cavm_etr_horizontal_axictl_t;

#define CAVM_ETR_HORIZONTAL_AXICTL CAVM_ETR_HORIZONTAL_AXICTL_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_AXICTL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_AXICTL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004110ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_AXICTL", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_AXICTL cavm_etr_horizontal_axictl_t
#define bustype_CAVM_ETR_HORIZONTAL_AXICTL CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_AXICTL "ETR_HORIZONTAL_AXICTL"
#define busnum_CAVM_ETR_HORIZONTAL_AXICTL 0
#define arguments_CAVM_ETR_HORIZONTAL_AXICTL -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_bufwm
{
    uint32_t u;
    struct cavm_etr_horizontal_bufwm_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_bufwm_s cn; */
};
typedef union cavm_etr_horizontal_bufwm cavm_etr_horizontal_bufwm_t;

#define CAVM_ETR_HORIZONTAL_BUFWM CAVM_ETR_HORIZONTAL_BUFWM_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_BUFWM_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_BUFWM_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004034ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_BUFWM", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_BUFWM cavm_etr_horizontal_bufwm_t
#define bustype_CAVM_ETR_HORIZONTAL_BUFWM CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_BUFWM "ETR_HORIZONTAL_BUFWM"
#define busnum_CAVM_ETR_HORIZONTAL_BUFWM 0
#define arguments_CAVM_ETR_HORIZONTAL_BUFWM -1,-1,-1,-1
 ...
 * RRD reads.
 */
union cavm_etr_horizontal_cbuflevel
{
    uint32_t u;
    struct cavm_etr_horizontal_cbuflevel_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_cbuflevel_s cn; */
};
typedef union cavm_etr_horizontal_cbuflevel cavm_etr_horizontal_cbuflevel_t;

#define CAVM_ETR_HORIZONTAL_CBUFLEVEL CAVM_ETR_HORIZONTAL_CBUFLEVEL_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_CBUFLEVEL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_CBUFLEVEL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004030ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_CBUFLEVEL", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_CBUFLEVEL cavm_etr_horizontal_cbuflevel_t
#define bustype_CAVM_ETR_HORIZONTAL_CBUFLEVEL CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_CBUFLEVEL "ETR_HORIZONTAL_CBUFLEVEL"
#define busnum_CAVM_ETR_HORIZONTAL_CBUFLEVEL 0
#define arguments_CAVM_ETR_HORIZONTAL_CBUFLEVEL -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_cidr0
{
    uint32_t u;
    struct cavm_etr_horizontal_cidr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_cidr0_s cn; */
};
typedef union cavm_etr_horizontal_cidr0 cavm_etr_horizontal_cidr0_t;

#define CAVM_ETR_HORIZONTAL_CIDR0 CAVM_ETR_HORIZONTAL_CIDR0_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_CIDR0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_CIDR0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004ff0ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_CIDR0", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_CIDR0 cavm_etr_horizontal_cidr0_t
#define bustype_CAVM_ETR_HORIZONTAL_CIDR0 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_CIDR0 "ETR_HORIZONTAL_CIDR0"
#define busnum_CAVM_ETR_HORIZONTAL_CIDR0 0
#define arguments_CAVM_ETR_HORIZONTAL_CIDR0 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_cidr1
{
    uint32_t u;
    struct cavm_etr_horizontal_cidr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etr_horizontal_cidr1_s cn; */
};
typedef union cavm_etr_horizontal_cidr1 cavm_etr_horizontal_cidr1_t;

#define CAVM_ETR_HORIZONTAL_CIDR1 CAVM_ETR_HORIZONTAL_CIDR1_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_CIDR1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_CIDR1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004ff4ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_CIDR1", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_CIDR1 cavm_etr_horizontal_cidr1_t
#define bustype_CAVM_ETR_HORIZONTAL_CIDR1 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_CIDR1 "ETR_HORIZONTAL_CIDR1"
#define busnum_CAVM_ETR_HORIZONTAL_CIDR1 0
#define arguments_CAVM_ETR_HORIZONTAL_CIDR1 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_cidr2
{
    uint32_t u;
    struct cavm_etr_horizontal_cidr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etr_horizontal_cidr2_s cn; */
};
typedef union cavm_etr_horizontal_cidr2 cavm_etr_horizontal_cidr2_t;

#define CAVM_ETR_HORIZONTAL_CIDR2 CAVM_ETR_HORIZONTAL_CIDR2_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_CIDR2_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_CIDR2_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004ff8ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_CIDR2", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_CIDR2 cavm_etr_horizontal_cidr2_t
#define bustype_CAVM_ETR_HORIZONTAL_CIDR2 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_CIDR2 "ETR_HORIZONTAL_CIDR2"
#define busnum_CAVM_ETR_HORIZONTAL_CIDR2 0
#define arguments_CAVM_ETR_HORIZONTAL_CIDR2 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_cidr3
{
    uint32_t u;
    struct cavm_etr_horizontal_cidr3_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etr_horizontal_cidr3_s cn; */
};
typedef union cavm_etr_horizontal_cidr3 cavm_etr_horizontal_cidr3_t;

#define CAVM_ETR_HORIZONTAL_CIDR3 CAVM_ETR_HORIZONTAL_CIDR3_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_CIDR3_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_CIDR3_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004ffcll;
    __cavm_csr_fatal("ETR_HORIZONTAL_CIDR3", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_CIDR3 cavm_etr_horizontal_cidr3_t
#define bustype_CAVM_ETR_HORIZONTAL_CIDR3 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_CIDR3 "ETR_HORIZONTAL_CIDR3"
#define busnum_CAVM_ETR_HORIZONTAL_CIDR3 0
#define arguments_CAVM_ETR_HORIZONTAL_CIDR3 -1,-1,-1,-1
 ...
 * value.
 */
union cavm_etr_horizontal_claimclr
{
    uint32_t u;
    struct cavm_etr_horizontal_claimclr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_claimclr_s cn; */
};
typedef union cavm_etr_horizontal_claimclr cavm_etr_horizontal_claimclr_t;

#define CAVM_ETR_HORIZONTAL_CLAIMCLR CAVM_ETR_HORIZONTAL_CLAIMCLR_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_CLAIMCLR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_CLAIMCLR_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fa4ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_CLAIMCLR", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_CLAIMCLR cavm_etr_horizontal_claimclr_t
#define bustype_CAVM_ETR_HORIZONTAL_CLAIMCLR CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_CLAIMCLR "ETR_HORIZONTAL_CLAIMCLR"
#define busnum_CAVM_ETR_HORIZONTAL_CLAIMCLR 0
#define arguments_CAVM_ETR_HORIZONTAL_CLAIMCLR -1,-1,-1,-1
 ...
 * be set.
 */
union cavm_etr_horizontal_claimset
{
    uint32_t u;
    struct cavm_etr_horizontal_claimset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 28; /**< [ 31:  4](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etr_horizontal_claimset_s cn; */
};
typedef union cavm_etr_horizontal_claimset cavm_etr_horizontal_claimset_t;

#define CAVM_ETR_HORIZONTAL_CLAIMSET CAVM_ETR_HORIZONTAL_CLAIMSET_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_CLAIMSET_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_CLAIMSET_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fa0ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_CLAIMSET", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_CLAIMSET cavm_etr_horizontal_claimset_t
#define bustype_CAVM_ETR_HORIZONTAL_CLAIMSET CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_CLAIMSET "ETR_HORIZONTAL_CLAIMSET"
#define busnum_CAVM_ETR_HORIZONTAL_CLAIMSET 0
#define arguments_CAVM_ETR_HORIZONTAL_CLAIMSET -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_ctl
{
    uint32_t u;
    struct cavm_etr_horizontal_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_ctl_s cn; */
};
typedef union cavm_etr_horizontal_ctl cavm_etr_horizontal_ctl_t;

#define CAVM_ETR_HORIZONTAL_CTL CAVM_ETR_HORIZONTAL_CTL_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_CTL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_CTL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004020ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_CTL", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_CTL cavm_etr_horizontal_ctl_t
#define bustype_CAVM_ETR_HORIZONTAL_CTL CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_CTL "ETR_HORIZONTAL_CTL"
#define busnum_CAVM_ETR_HORIZONTAL_CTL 0
#define arguments_CAVM_ETR_HORIZONTAL_CTL -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_dbahi
{
    uint32_t u;
    struct cavm_etr_horizontal_dbahi_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_dbahi_s cn; */
};
typedef union cavm_etr_horizontal_dbahi cavm_etr_horizontal_dbahi_t;

#define CAVM_ETR_HORIZONTAL_DBAHI CAVM_ETR_HORIZONTAL_DBAHI_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_DBAHI_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_DBAHI_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e04600411cll;
    __cavm_csr_fatal("ETR_HORIZONTAL_DBAHI", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_DBAHI cavm_etr_horizontal_dbahi_t
#define bustype_CAVM_ETR_HORIZONTAL_DBAHI CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_DBAHI "ETR_HORIZONTAL_DBAHI"
#define busnum_CAVM_ETR_HORIZONTAL_DBAHI 0
#define arguments_CAVM_ETR_HORIZONTAL_DBAHI -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_dbalo
{
    uint32_t u;
    struct cavm_etr_horizontal_dbalo_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_dbalo_s cn; */
};
typedef union cavm_etr_horizontal_dbalo cavm_etr_horizontal_dbalo_t;

#define CAVM_ETR_HORIZONTAL_DBALO CAVM_ETR_HORIZONTAL_DBALO_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_DBALO_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_DBALO_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004118ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_DBALO", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_DBALO cavm_etr_horizontal_dbalo_t
#define bustype_CAVM_ETR_HORIZONTAL_DBALO CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_DBALO "ETR_HORIZONTAL_DBALO"
#define busnum_CAVM_ETR_HORIZONTAL_DBALO 0
#define arguments_CAVM_ETR_HORIZONTAL_DBALO -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_devid
{
    uint32_t u;
    struct cavm_etr_horizontal_devid_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_devid_s cn; */
};
typedef union cavm_etr_horizontal_devid cavm_etr_horizontal_devid_t;

#define CAVM_ETR_HORIZONTAL_DEVID CAVM_ETR_HORIZONTAL_DEVID_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_DEVID_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_DEVID_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fc8ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_DEVID", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_DEVID cavm_etr_horizontal_devid_t
#define bustype_CAVM_ETR_HORIZONTAL_DEVID CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_DEVID "ETR_HORIZONTAL_DEVID"
#define busnum_CAVM_ETR_HORIZONTAL_DEVID 0
#define arguments_CAVM_ETR_HORIZONTAL_DEVID -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_devid1
{
    uint32_t u;
    struct cavm_etr_horizontal_devid1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_devid1_s cn; */
};
typedef union cavm_etr_horizontal_devid1 cavm_etr_horizontal_devid1_t;

#define CAVM_ETR_HORIZONTAL_DEVID1 CAVM_ETR_HORIZONTAL_DEVID1_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_DEVID1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_DEVID1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fc4ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_DEVID1", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_DEVID1 cavm_etr_horizontal_devid1_t
#define bustype_CAVM_ETR_HORIZONTAL_DEVID1 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_DEVID1 "ETR_HORIZONTAL_DEVID1"
#define busnum_CAVM_ETR_HORIZONTAL_DEVID1 0
#define arguments_CAVM_ETR_HORIZONTAL_DEVID1 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_devtype
{
    uint32_t u;
    struct cavm_etr_horizontal_devtype_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etr_horizontal_devtype_s cn; */
};
typedef union cavm_etr_horizontal_devtype cavm_etr_horizontal_devtype_t;

#define CAVM_ETR_HORIZONTAL_DEVTYPE CAVM_ETR_HORIZONTAL_DEVTYPE_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_DEVTYPE_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_DEVTYPE_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fccll;
    __cavm_csr_fatal("ETR_HORIZONTAL_DEVTYPE", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_DEVTYPE cavm_etr_horizontal_devtype_t
#define bustype_CAVM_ETR_HORIZONTAL_DEVTYPE CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_DEVTYPE "ETR_HORIZONTAL_DEVTYPE"
#define busnum_CAVM_ETR_HORIZONTAL_DEVTYPE 0
#define arguments_CAVM_ETR_HORIZONTAL_DEVTYPE -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_ffcr
{
    uint32_t u;
    struct cavm_etr_horizontal_ffcr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_ffcr_s cn; */
};
typedef union cavm_etr_horizontal_ffcr cavm_etr_horizontal_ffcr_t;

#define CAVM_ETR_HORIZONTAL_FFCR CAVM_ETR_HORIZONTAL_FFCR_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_FFCR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_FFCR_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004304ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_FFCR", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_FFCR cavm_etr_horizontal_ffcr_t
#define bustype_CAVM_ETR_HORIZONTAL_FFCR CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_FFCR "ETR_HORIZONTAL_FFCR"
#define busnum_CAVM_ETR_HORIZONTAL_FFCR 0
#define arguments_CAVM_ETR_HORIZONTAL_FFCR -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_ffsr
{
    uint32_t u;
    struct cavm_etr_horizontal_ffsr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_ffsr_s cn; */
};
typedef union cavm_etr_horizontal_ffsr cavm_etr_horizontal_ffsr_t;

#define CAVM_ETR_HORIZONTAL_FFSR CAVM_ETR_HORIZONTAL_FFSR_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_FFSR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_FFSR_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004300ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_FFSR", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_FFSR cavm_etr_horizontal_ffsr_t
#define bustype_CAVM_ETR_HORIZONTAL_FFSR CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_FFSR "ETR_HORIZONTAL_FFSR"
#define busnum_CAVM_ETR_HORIZONTAL_FFSR 0
#define arguments_CAVM_ETR_HORIZONTAL_FFSR -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_itatbctr0
{
    uint32_t u;
    struct cavm_etr_horizontal_itatbctr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_itatbctr0_s cn; */
};
typedef union cavm_etr_horizontal_itatbctr0 cavm_etr_horizontal_itatbctr0_t;

#define CAVM_ETR_HORIZONTAL_ITATBCTR0 CAVM_ETR_HORIZONTAL_ITATBCTR0_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_ITATBCTR0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_ITATBCTR0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004ef8ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_ITATBCTR0", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_ITATBCTR0 cavm_etr_horizontal_itatbctr0_t
#define bustype_CAVM_ETR_HORIZONTAL_ITATBCTR0 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_ITATBCTR0 "ETR_HORIZONTAL_ITATBCTR0"
#define busnum_CAVM_ETR_HORIZONTAL_ITATBCTR0 0
#define arguments_CAVM_ETR_HORIZONTAL_ITATBCTR0 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_itatbctr1
{
    uint32_t u;
    struct cavm_etr_horizontal_itatbctr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_itatbctr1_s cn; */
};
typedef union cavm_etr_horizontal_itatbctr1 cavm_etr_horizontal_itatbctr1_t;

#define CAVM_ETR_HORIZONTAL_ITATBCTR1 CAVM_ETR_HORIZONTAL_ITATBCTR1_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_ITATBCTR1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_ITATBCTR1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004ef4ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_ITATBCTR1", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_ITATBCTR1 cavm_etr_horizontal_itatbctr1_t
#define bustype_CAVM_ETR_HORIZONTAL_ITATBCTR1 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_ITATBCTR1 "ETR_HORIZONTAL_ITATBCTR1"
#define busnum_CAVM_ETR_HORIZONTAL_ITATBCTR1 0
#define arguments_CAVM_ETR_HORIZONTAL_ITATBCTR1 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_itatbctr2
{
    uint32_t u;
    struct cavm_etr_horizontal_itatbctr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_itatbctr2_s cn; */
};
typedef union cavm_etr_horizontal_itatbctr2 cavm_etr_horizontal_itatbctr2_t;

#define CAVM_ETR_HORIZONTAL_ITATBCTR2 CAVM_ETR_HORIZONTAL_ITATBCTR2_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_ITATBCTR2_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_ITATBCTR2_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004ef0ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_ITATBCTR2", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_ITATBCTR2 cavm_etr_horizontal_itatbctr2_t
#define bustype_CAVM_ETR_HORIZONTAL_ITATBCTR2 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_ITATBCTR2 "ETR_HORIZONTAL_ITATBCTR2"
#define busnum_CAVM_ETR_HORIZONTAL_ITATBCTR2 0
#define arguments_CAVM_ETR_HORIZONTAL_ITATBCTR2 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_itatbdata0
{
    uint32_t u;
    struct cavm_etr_horizontal_itatbdata0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_itatbdata0_s cn; */
};
typedef union cavm_etr_horizontal_itatbdata0 cavm_etr_horizontal_itatbdata0_t;

#define CAVM_ETR_HORIZONTAL_ITATBDATA0 CAVM_ETR_HORIZONTAL_ITATBDATA0_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_ITATBDATA0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_ITATBDATA0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004eecll;
    __cavm_csr_fatal("ETR_HORIZONTAL_ITATBDATA0", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_ITATBDATA0 cavm_etr_horizontal_itatbdata0_t
#define bustype_CAVM_ETR_HORIZONTAL_ITATBDATA0 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_ITATBDATA0 "ETR_HORIZONTAL_ITATBDATA0"
#define busnum_CAVM_ETR_HORIZONTAL_ITATBDATA0 0
#define arguments_CAVM_ETR_HORIZONTAL_ITATBDATA0 -1,-1,-1,-1
 ...
 * return 0x0.
 */
union cavm_etr_horizontal_itatbmctr0
{
    uint32_t u;
    struct cavm_etr_horizontal_itatbmctr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_itatbmctr0_s cn; */
};
typedef union cavm_etr_horizontal_itatbmctr0 cavm_etr_horizontal_itatbmctr0_t;

#define CAVM_ETR_HORIZONTAL_ITATBMCTR0 CAVM_ETR_HORIZONTAL_ITATBMCTR0_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_ITATBMCTR0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_ITATBMCTR0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004edcll;
    __cavm_csr_fatal("ETR_HORIZONTAL_ITATBMCTR0", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_ITATBMCTR0 cavm_etr_horizontal_itatbmctr0_t
#define bustype_CAVM_ETR_HORIZONTAL_ITATBMCTR0 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_ITATBMCTR0 "ETR_HORIZONTAL_ITATBMCTR0"
#define busnum_CAVM_ETR_HORIZONTAL_ITATBMCTR0 0
#define arguments_CAVM_ETR_HORIZONTAL_ITATBMCTR0 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_itctrl
{
    uint32_t u;
    struct cavm_etr_horizontal_itctrl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 31; /**< [ 31:  1](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etr_horizontal_itctrl_s cn; */
};
typedef union cavm_etr_horizontal_itctrl cavm_etr_horizontal_itctrl_t;

#define CAVM_ETR_HORIZONTAL_ITCTRL CAVM_ETR_HORIZONTAL_ITCTRL_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_ITCTRL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_ITCTRL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004f00ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_ITCTRL", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_ITCTRL cavm_etr_horizontal_itctrl_t
#define bustype_CAVM_ETR_HORIZONTAL_ITCTRL CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_ITCTRL "ETR_HORIZONTAL_ITCTRL"
#define busnum_CAVM_ETR_HORIZONTAL_ITCTRL 0
#define arguments_CAVM_ETR_HORIZONTAL_ITCTRL -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_itevtintr
{
    uint32_t u;
    struct cavm_etr_horizontal_itevtintr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_itevtintr_s cn; */
};
typedef union cavm_etr_horizontal_itevtintr cavm_etr_horizontal_itevtintr_t;

#define CAVM_ETR_HORIZONTAL_ITEVTINTR CAVM_ETR_HORIZONTAL_ITEVTINTR_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_ITEVTINTR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_ITEVTINTR_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004ee0ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_ITEVTINTR", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_ITEVTINTR cavm_etr_horizontal_itevtintr_t
#define bustype_CAVM_ETR_HORIZONTAL_ITEVTINTR CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_ITEVTINTR "ETR_HORIZONTAL_ITEVTINTR"
#define busnum_CAVM_ETR_HORIZONTAL_ITEVTINTR 0
#define arguments_CAVM_ETR_HORIZONTAL_ITEVTINTR -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_ittrflin
{
    uint32_t u;
    struct cavm_etr_horizontal_ittrflin_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 30; /**< [ 31:  2](RO) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etr_horizontal_ittrflin_s cn; */
};
typedef union cavm_etr_horizontal_ittrflin cavm_etr_horizontal_ittrflin_t;

#define CAVM_ETR_HORIZONTAL_ITTRFLIN CAVM_ETR_HORIZONTAL_ITTRFLIN_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_ITTRFLIN_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_ITTRFLIN_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004ee8ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_ITTRFLIN", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_ITTRFLIN cavm_etr_horizontal_ittrflin_t
#define bustype_CAVM_ETR_HORIZONTAL_ITTRFLIN CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_ITTRFLIN "ETR_HORIZONTAL_ITTRFLIN"
#define busnum_CAVM_ETR_HORIZONTAL_ITTRFLIN 0
#define arguments_CAVM_ETR_HORIZONTAL_ITTRFLIN -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_lbuflevel
{
    uint32_t u;
    struct cavm_etr_horizontal_lbuflevel_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 1;  /**< [ 31: 31](RO) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etr_horizontal_lbuflevel_s cn; */
};
typedef union cavm_etr_horizontal_lbuflevel cavm_etr_horizontal_lbuflevel_t;

#define CAVM_ETR_HORIZONTAL_LBUFLEVEL CAVM_ETR_HORIZONTAL_LBUFLEVEL_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_LBUFLEVEL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_LBUFLEVEL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e04600402cll;
    __cavm_csr_fatal("ETR_HORIZONTAL_LBUFLEVEL", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_LBUFLEVEL cavm_etr_horizontal_lbuflevel_t
#define bustype_CAVM_ETR_HORIZONTAL_LBUFLEVEL CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_LBUFLEVEL "ETR_HORIZONTAL_LBUFLEVEL"
#define busnum_CAVM_ETR_HORIZONTAL_LBUFLEVEL 0
#define arguments_CAVM_ETR_HORIZONTAL_LBUFLEVEL -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_mode
{
    uint32_t u;
    struct cavm_etr_horizontal_mode_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_mode_s cn; */
};
typedef union cavm_etr_horizontal_mode cavm_etr_horizontal_mode_t;

#define CAVM_ETR_HORIZONTAL_MODE CAVM_ETR_HORIZONTAL_MODE_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_MODE_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_MODE_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004028ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_MODE", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_MODE cavm_etr_horizontal_mode_t
#define bustype_CAVM_ETR_HORIZONTAL_MODE CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_MODE "ETR_HORIZONTAL_MODE"
#define busnum_CAVM_ETR_HORIZONTAL_MODE 0
#define arguments_CAVM_ETR_HORIZONTAL_MODE -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_pidr0
{
    uint32_t u;
    struct cavm_etr_horizontal_pidr0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etr_horizontal_pidr0_s cn; */
};
typedef union cavm_etr_horizontal_pidr0 cavm_etr_horizontal_pidr0_t;

#define CAVM_ETR_HORIZONTAL_PIDR0 CAVM_ETR_HORIZONTAL_PIDR0_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR0_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR0_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fe0ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_PIDR0", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_PIDR0 cavm_etr_horizontal_pidr0_t
#define bustype_CAVM_ETR_HORIZONTAL_PIDR0 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_PIDR0 "ETR_HORIZONTAL_PIDR0"
#define busnum_CAVM_ETR_HORIZONTAL_PIDR0 0
#define arguments_CAVM_ETR_HORIZONTAL_PIDR0 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_pidr1
{
    uint32_t u;
    struct cavm_etr_horizontal_pidr1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etr_horizontal_pidr1_s cn; */
};
typedef union cavm_etr_horizontal_pidr1 cavm_etr_horizontal_pidr1_t;

#define CAVM_ETR_HORIZONTAL_PIDR1 CAVM_ETR_HORIZONTAL_PIDR1_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR1_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR1_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fe4ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_PIDR1", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_PIDR1 cavm_etr_horizontal_pidr1_t
#define bustype_CAVM_ETR_HORIZONTAL_PIDR1 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_PIDR1 "ETR_HORIZONTAL_PIDR1"
#define busnum_CAVM_ETR_HORIZONTAL_PIDR1 0
#define arguments_CAVM_ETR_HORIZONTAL_PIDR1 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_pidr2
{
    uint32_t u;
    struct cavm_etr_horizontal_pidr2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etr_horizontal_pidr2_s cn; */
};
typedef union cavm_etr_horizontal_pidr2 cavm_etr_horizontal_pidr2_t;

#define CAVM_ETR_HORIZONTAL_PIDR2 CAVM_ETR_HORIZONTAL_PIDR2_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR2_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR2_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fe8ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_PIDR2", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_PIDR2 cavm_etr_horizontal_pidr2_t
#define bustype_CAVM_ETR_HORIZONTAL_PIDR2 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_PIDR2 "ETR_HORIZONTAL_PIDR2"
#define busnum_CAVM_ETR_HORIZONTAL_PIDR2 0
#define arguments_CAVM_ETR_HORIZONTAL_PIDR2 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_pidr3
{
    uint32_t u;
    struct cavm_etr_horizontal_pidr3_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etr_horizontal_pidr3_s cn; */
};
typedef union cavm_etr_horizontal_pidr3 cavm_etr_horizontal_pidr3_t;

#define CAVM_ETR_HORIZONTAL_PIDR3 CAVM_ETR_HORIZONTAL_PIDR3_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR3_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR3_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fecll;
    __cavm_csr_fatal("ETR_HORIZONTAL_PIDR3", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_PIDR3 cavm_etr_horizontal_pidr3_t
#define bustype_CAVM_ETR_HORIZONTAL_PIDR3 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_PIDR3 "ETR_HORIZONTAL_PIDR3"
#define busnum_CAVM_ETR_HORIZONTAL_PIDR3 0
#define arguments_CAVM_ETR_HORIZONTAL_PIDR3 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_pidr4
{
    uint32_t u;
    struct cavm_etr_horizontal_pidr4_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etr_horizontal_pidr4_s cn; */
};
typedef union cavm_etr_horizontal_pidr4 cavm_etr_horizontal_pidr4_t;

#define CAVM_ETR_HORIZONTAL_PIDR4 CAVM_ETR_HORIZONTAL_PIDR4_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR4_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR4_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fd0ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_PIDR4", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_PIDR4 cavm_etr_horizontal_pidr4_t
#define bustype_CAVM_ETR_HORIZONTAL_PIDR4 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_PIDR4 "ETR_HORIZONTAL_PIDR4"
#define busnum_CAVM_ETR_HORIZONTAL_PIDR4 0
#define arguments_CAVM_ETR_HORIZONTAL_PIDR4 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_pidr5
{
    uint32_t u;
    struct cavm_etr_horizontal_pidr5_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etr_horizontal_pidr5_s cn; */
};
typedef union cavm_etr_horizontal_pidr5 cavm_etr_horizontal_pidr5_t;

#define CAVM_ETR_HORIZONTAL_PIDR5 CAVM_ETR_HORIZONTAL_PIDR5_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR5_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR5_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fd4ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_PIDR5", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_PIDR5 cavm_etr_horizontal_pidr5_t
#define bustype_CAVM_ETR_HORIZONTAL_PIDR5 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_PIDR5 "ETR_HORIZONTAL_PIDR5"
#define busnum_CAVM_ETR_HORIZONTAL_PIDR5 0
#define arguments_CAVM_ETR_HORIZONTAL_PIDR5 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_pidr6
{
    uint32_t u;
    struct cavm_etr_horizontal_pidr6_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etr_horizontal_pidr6_s cn; */
};
typedef union cavm_etr_horizontal_pidr6 cavm_etr_horizontal_pidr6_t;

#define CAVM_ETR_HORIZONTAL_PIDR6 CAVM_ETR_HORIZONTAL_PIDR6_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR6_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR6_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fd8ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_PIDR6", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_PIDR6 cavm_etr_horizontal_pidr6_t
#define bustype_CAVM_ETR_HORIZONTAL_PIDR6 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_PIDR6 "ETR_HORIZONTAL_PIDR6"
#define busnum_CAVM_ETR_HORIZONTAL_PIDR6 0
#define arguments_CAVM_ETR_HORIZONTAL_PIDR6 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_pidr7
{
    uint32_t u;
    struct cavm_etr_horizontal_pidr7_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t res0_0                : 24; /**< [ 31:  8](RO) Reserved bit or field with Should-Be-Zero-or-Preserved (SBZP) behavior. */
    ...
    /* struct cavm_etr_horizontal_pidr7_s cn; */
};
typedef union cavm_etr_horizontal_pidr7 cavm_etr_horizontal_pidr7_t;

#define CAVM_ETR_HORIZONTAL_PIDR7 CAVM_ETR_HORIZONTAL_PIDR7_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR7_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_PIDR7_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004fdcll;
    __cavm_csr_fatal("ETR_HORIZONTAL_PIDR7", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_PIDR7 cavm_etr_horizontal_pidr7_t
#define bustype_CAVM_ETR_HORIZONTAL_PIDR7 CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_PIDR7 "ETR_HORIZONTAL_PIDR7"
#define busnum_CAVM_ETR_HORIZONTAL_PIDR7 0
#define arguments_CAVM_ETR_HORIZONTAL_PIDR7 -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_pscr
{
    uint32_t u;
    struct cavm_etr_horizontal_pscr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_pscr_s cn; */
};
typedef union cavm_etr_horizontal_pscr cavm_etr_horizontal_pscr_t;

#define CAVM_ETR_HORIZONTAL_PSCR CAVM_ETR_HORIZONTAL_PSCR_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_PSCR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_PSCR_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004308ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_PSCR", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_PSCR cavm_etr_horizontal_pscr_t
#define bustype_CAVM_ETR_HORIZONTAL_PSCR CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_PSCR "ETR_HORIZONTAL_PSCR"
#define busnum_CAVM_ETR_HORIZONTAL_PSCR 0
#define arguments_CAVM_ETR_HORIZONTAL_PSCR -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_rrd
{
    uint32_t u;
    struct cavm_etr_horizontal_rrd_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_rrd_s cn; */
};
typedef union cavm_etr_horizontal_rrd cavm_etr_horizontal_rrd_t;

#define CAVM_ETR_HORIZONTAL_RRD CAVM_ETR_HORIZONTAL_RRD_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_RRD_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_RRD_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004010ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_RRD", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_RRD cavm_etr_horizontal_rrd_t
#define bustype_CAVM_ETR_HORIZONTAL_RRD CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_RRD "ETR_HORIZONTAL_RRD"
#define busnum_CAVM_ETR_HORIZONTAL_RRD 0
#define arguments_CAVM_ETR_HORIZONTAL_RRD -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_rrp
{
    uint32_t u;
    struct cavm_etr_horizontal_rrp_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_rrp_s cn; */
};
typedef union cavm_etr_horizontal_rrp cavm_etr_horizontal_rrp_t;

#define CAVM_ETR_HORIZONTAL_RRP CAVM_ETR_HORIZONTAL_RRP_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_RRP_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_RRP_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004014ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_RRP", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_RRP cavm_etr_horizontal_rrp_t
#define bustype_CAVM_ETR_HORIZONTAL_RRP CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_RRP "ETR_HORIZONTAL_RRP"
#define busnum_CAVM_ETR_HORIZONTAL_RRP 0
#define arguments_CAVM_ETR_HORIZONTAL_RRP -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_rrphi
{
    uint32_t u;
    struct cavm_etr_horizontal_rrphi_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 12; /**< [ 31: 20](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etr_horizontal_rrphi_s cn; */
};
typedef union cavm_etr_horizontal_rrphi cavm_etr_horizontal_rrphi_t;

#define CAVM_ETR_HORIZONTAL_RRPHI CAVM_ETR_HORIZONTAL_RRPHI_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_RRPHI_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_RRPHI_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004038ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_RRPHI", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_RRPHI cavm_etr_horizontal_rrphi_t
#define bustype_CAVM_ETR_HORIZONTAL_RRPHI CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_RRPHI "ETR_HORIZONTAL_RRPHI"
#define busnum_CAVM_ETR_HORIZONTAL_RRPHI 0
#define arguments_CAVM_ETR_HORIZONTAL_RRPHI -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_rsz
{
    uint32_t u;
    struct cavm_etr_horizontal_rsz_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_rsz_s cn; */
};
typedef union cavm_etr_horizontal_rsz cavm_etr_horizontal_rsz_t;

#define CAVM_ETR_HORIZONTAL_RSZ CAVM_ETR_HORIZONTAL_RSZ_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_RSZ_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_RSZ_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004004ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_RSZ", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_RSZ cavm_etr_horizontal_rsz_t
#define bustype_CAVM_ETR_HORIZONTAL_RSZ CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_RSZ "ETR_HORIZONTAL_RSZ"
#define busnum_CAVM_ETR_HORIZONTAL_RSZ 0
#define arguments_CAVM_ETR_HORIZONTAL_RSZ -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_rurp
{
    uint32_t u;
    struct cavm_etr_horizontal_rurp_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_rurp_s cn; */
};
typedef union cavm_etr_horizontal_rurp cavm_etr_horizontal_rurp_t;

#define CAVM_ETR_HORIZONTAL_RURP CAVM_ETR_HORIZONTAL_RURP_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_RURP_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_RURP_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004120ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_RURP", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_RURP cavm_etr_horizontal_rurp_t
#define bustype_CAVM_ETR_HORIZONTAL_RURP CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_RURP "ETR_HORIZONTAL_RURP"
#define busnum_CAVM_ETR_HORIZONTAL_RURP 0
#define arguments_CAVM_ETR_HORIZONTAL_RURP -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_rwd
{
    uint32_t u;
    struct cavm_etr_horizontal_rwd_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_rwd_s cn; */
};
typedef union cavm_etr_horizontal_rwd cavm_etr_horizontal_rwd_t;

#define CAVM_ETR_HORIZONTAL_RWD CAVM_ETR_HORIZONTAL_RWD_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_RWD_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_RWD_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004024ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_RWD", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_RWD cavm_etr_horizontal_rwd_t
#define bustype_CAVM_ETR_HORIZONTAL_RWD CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_RWD "ETR_HORIZONTAL_RWD"
#define busnum_CAVM_ETR_HORIZONTAL_RWD 0
#define arguments_CAVM_ETR_HORIZONTAL_RWD -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_rwp
{
    uint32_t u;
    struct cavm_etr_horizontal_rwp_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_rwp_s cn; */
};
typedef union cavm_etr_horizontal_rwp cavm_etr_horizontal_rwp_t;

#define CAVM_ETR_HORIZONTAL_RWP CAVM_ETR_HORIZONTAL_RWP_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_RWP_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_RWP_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e046004018ll;
    __cavm_csr_fatal("ETR_HORIZONTAL_RWP", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_RWP cavm_etr_horizontal_rwp_t
#define bustype_CAVM_ETR_HORIZONTAL_RWP CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_RWP "ETR_HORIZONTAL_RWP"
#define busnum_CAVM_ETR_HORIZONTAL_RWP 0
#define arguments_CAVM_ETR_HORIZONTAL_RWP -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_rwphi
{
    uint32_t u;
    struct cavm_etr_horizontal_rwphi_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 12; /**< [ 31: 20](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etr_horizontal_rwphi_s cn; */
};
typedef union cavm_etr_horizontal_rwphi cavm_etr_horizontal_rwphi_t;

#define CAVM_ETR_HORIZONTAL_RWPHI CAVM_ETR_HORIZONTAL_RWPHI_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_RWPHI_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_RWPHI_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e04600403cll;
    __cavm_csr_fatal("ETR_HORIZONTAL_RWPHI", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_RWPHI cavm_etr_horizontal_rwphi_t
#define bustype_CAVM_ETR_HORIZONTAL_RWPHI CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_RWPHI "ETR_HORIZONTAL_RWPHI"
#define busnum_CAVM_ETR_HORIZONTAL_RWPHI 0
#define arguments_CAVM_ETR_HORIZONTAL_RWPHI -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_sts
{
    uint32_t u;
    struct cavm_etr_horizontal_sts_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t razwi_0               : 26; /**< [ 31:  6](R/W) Read-As-Zero, Writes Ignored. */
    ...
    /* struct cavm_etr_horizontal_sts_s cn; */
};
typedef union cavm_etr_horizontal_sts cavm_etr_horizontal_sts_t;

#define CAVM_ETR_HORIZONTAL_STS CAVM_ETR_HORIZONTAL_STS_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_STS_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_STS_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e04600400cll;
    __cavm_csr_fatal("ETR_HORIZONTAL_STS", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_STS cavm_etr_horizontal_sts_t
#define bustype_CAVM_ETR_HORIZONTAL_STS CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_STS "ETR_HORIZONTAL_STS"
#define busnum_CAVM_ETR_HORIZONTAL_STS 0
#define arguments_CAVM_ETR_HORIZONTAL_STS -1,-1,-1,-1
 ...
 */
union cavm_etr_horizontal_trg
{
    uint32_t u;
    struct cavm_etr_horizontal_trg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_etr_horizontal_trg_s cn; */
};
typedef union cavm_etr_horizontal_trg cavm_etr_horizontal_trg_t;

#define CAVM_ETR_HORIZONTAL_TRG CAVM_ETR_HORIZONTAL_TRG_FUNC()
static inline uint64_t CAVM_ETR_HORIZONTAL_TRG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_ETR_HORIZONTAL_TRG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_LOKI))
        return 0x87e04600401cll;
    __cavm_csr_fatal("ETR_HORIZONTAL_TRG", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_ETR_HORIZONTAL_TRG cavm_etr_horizontal_trg_t
#define bustype_CAVM_ETR_HORIZONTAL_TRG CSR_TYPE_RSL32b
#define basename_CAVM_ETR_HORIZONTAL_TRG "ETR_HORIZONTAL_TRG"
#define busnum_CAVM_ETR_HORIZONTAL_TRG 0
#define arguments_CAVM_ETR_HORIZONTAL_TRG -1,-1,-1,-1

#endif /* __CAVM_CSRS_ETR_HORIZONTAL_H__ */
