 ...
 */
#define CAVM_NCSI_BAR_E_NCSI_PF_BAR0_CN8 (0x87e00b000000ll)
#define CAVM_NCSI_BAR_E_NCSI_PF_BAR0_CN8_SIZE 0x800000ull
#define CAVM_NCSI_BAR_E_NCSI_PF_BAR0_CN9 (0x87e00b000000ll)
#define CAVM_NCSI_BAR_E_NCSI_PF_BAR0_CN9_SIZE 0x10000ull
...
union cavm_ncsi_bmc2cpu_msg
{
    ...
    /* struct cavm_ncsi_bmc2cpu_msg_s cn; */
};
 ...
 */
union cavm_ncsi_clk_en
{
    uint64_t u;
    struct cavm_ncsi_clk_en_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ncsi_clk_en_s cn; */
};
typedef union cavm_ncsi_clk_en cavm_ncsi_clk_en_t;

#define CAVM_NCSI_CLK_EN CAVM_NCSI_CLK_EN_FUNC()
static inline uint64_t CAVM_NCSI_CLK_EN_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NCSI_CLK_EN_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN96XX))
...
#define bustype_CAVM_NCSI_CLK_EN CSR_TYPE_RSL
#define basename_CAVM_NCSI_CLK_EN "NCSI_CLK_EN"
#define device_bar_CAVM_NCSI_CLK_EN 0x0 /* PF_BAR0 */
#define busnum_CAVM_NCSI_CLK_EN 0
#define arguments_CAVM_NCSI_CLK_EN -1,-1,-1,-1
 ...
 * hardware processing.
 */
union cavm_ncsi_cmd_sw_processx
{
    uint64_t u;
    struct cavm_ncsi_cmd_sw_processx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_NCSI_CMD_SW_PROCESSX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NCSI_CMD_SW_PROCESSX(unsigned long a)
{
...
#define bustype_CAVM_NCSI_CMD_SW_PROCESSX(a) CSR_TYPE_RSL
#define basename_CAVM_NCSI_CMD_SW_PROCESSX(a) "NCSI_CMD_SW_PROCESSX"
#define device_bar_CAVM_NCSI_CMD_SW_PROCESSX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NCSI_CMD_SW_PROCESSX(a) (a)
#define arguments_CAVM_NCSI_CMD_SW_PROCESSX(a) (a),-1,-1,-1
...
union cavm_ncsi_config
{
    ...
    /* struct cavm_ncsi_config_s cn8; */
    struct cavm_ncsi_config_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
        uint64_t pkg_id                : 3;  /**< [  4:  2](R/W/H) Override the NCSI package id
 ...
 */
union cavm_ncsi_const
{
    uint64_t u;
    struct cavm_ncsi_const_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ncsi_const_s cn; */
};
typedef union cavm_ncsi_const cavm_ncsi_const_t;

#define CAVM_NCSI_CONST CAVM_NCSI_CONST_FUNC()
static inline uint64_t CAVM_NCSI_CONST_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NCSI_CONST_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN96XX))
...
#define bustype_CAVM_NCSI_CONST CSR_TYPE_RSL
#define basename_CAVM_NCSI_CONST "NCSI_CONST"
#define device_bar_CAVM_NCSI_CONST 0x0 /* PF_BAR0 */
#define busnum_CAVM_NCSI_CONST 0
#define arguments_CAVM_NCSI_CONST -1,-1,-1,-1
 ...
 */
union cavm_ncsi_csclk_active_pc
{
    uint64_t u;
    struct cavm_ncsi_csclk_active_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ncsi_csclk_active_pc_s cn; */
};
typedef union cavm_ncsi_csclk_active_pc cavm_ncsi_csclk_active_pc_t;

#define CAVM_NCSI_CSCLK_ACTIVE_PC CAVM_NCSI_CSCLK_ACTIVE_PC_FUNC()
static inline uint64_t CAVM_NCSI_CSCLK_ACTIVE_PC_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NCSI_CSCLK_ACTIVE_PC_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN96XX))
...
#define bustype_CAVM_NCSI_CSCLK_ACTIVE_PC CSR_TYPE_RSL
#define basename_CAVM_NCSI_CSCLK_ACTIVE_PC "NCSI_CSCLK_ACTIVE_PC"
...
union cavm_ncsi_int_ena_w1c
{
    ...
    struct cavm_ncsi_int_ena_w1c_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_17_63        : 47;
        uint64_t rx_rmii_underfl       : 1;  /**< [ 16: 16](R/W1C/H) Reads or clears enable for NCSI_INT[RX_RMII_UNDERFL]. */
    ...
    struct cavm_ncsi_int_ena_w1c_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_22_63        : 42;
        uint64_t sw_cmd_to             : 1;  /**< [ 21: 21](R/W1C/H) Reads or clears enable for NCSI_INT[SW_CMD_TO]. */
...
union cavm_ncsi_int_ena_w1s
{
    ...
    struct cavm_ncsi_int_ena_w1s_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_17_63        : 47;
        uint64_t rx_rmii_underfl       : 1;  /**< [ 16: 16](R/W1S/H) Reads or sets enable for NCSI_INT[RX_RMII_UNDERFL]. */
    ...
    struct cavm_ncsi_int_ena_w1s_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_22_63        : 42;
        uint64_t sw_cmd_to             : 1;  /**< [ 21: 21](R/W1S/H) Reads or sets enable for NCSI_INT[SW_CMD_TO]. */
 ...
 */
union cavm_ncsi_mcp_aenx
{
    uint64_t u;
    struct cavm_ncsi_mcp_aenx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ncsi_mcp_aenx_s cn; */
};
typedef union cavm_ncsi_mcp_aenx cavm_ncsi_mcp_aenx_t;

static inline uint64_t CAVM_NCSI_MCP_AENX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NCSI_MCP_AENX(unsigned long a)
{
...
#define bustype_CAVM_NCSI_MCP_AENX(a) CSR_TYPE_RSL
#define basename_CAVM_NCSI_MCP_AENX(a) "NCSI_MCP_AENX"
#define device_bar_CAVM_NCSI_MCP_AENX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NCSI_MCP_AENX(a) (a)
#define arguments_CAVM_NCSI_MCP_AENX(a) (a),-1,-1,-1
 ...
 */
union cavm_ncsi_mcp_aen_ctl
{
    uint64_t u;
    struct cavm_ncsi_mcp_aen_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ncsi_mcp_aen_ctl_s cn; */
};
typedef union cavm_ncsi_mcp_aen_ctl cavm_ncsi_mcp_aen_ctl_t;

#define CAVM_NCSI_MCP_AEN_CTL CAVM_NCSI_MCP_AEN_CTL_FUNC()
static inline uint64_t CAVM_NCSI_MCP_AEN_CTL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NCSI_MCP_AEN_CTL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN96XX))
...
#define bustype_CAVM_NCSI_MCP_AEN_CTL CSR_TYPE_RSL
#define basename_CAVM_NCSI_MCP_AEN_CTL "NCSI_MCP_AEN_CTL"
#define device_bar_CAVM_NCSI_MCP_AEN_CTL 0x0 /* PF_BAR0 */
#define busnum_CAVM_NCSI_MCP_AEN_CTL 0
#define arguments_CAVM_NCSI_MCP_AEN_CTL -1,-1,-1,-1
 ...
 */
union cavm_ncsi_mcp_cmdx
{
    uint64_t u;
    struct cavm_ncsi_mcp_cmdx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ncsi_mcp_cmdx_s cn; */
};
typedef union cavm_ncsi_mcp_cmdx cavm_ncsi_mcp_cmdx_t;

static inline uint64_t CAVM_NCSI_MCP_CMDX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NCSI_MCP_CMDX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=7))
...
#define bustype_CAVM_NCSI_MCP_CMDX(a) CSR_TYPE_RSL
#define basename_CAVM_NCSI_MCP_CMDX(a) "NCSI_MCP_CMDX"
#define device_bar_CAVM_NCSI_MCP_CMDX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NCSI_MCP_CMDX(a) (a)
#define arguments_CAVM_NCSI_MCP_CMDX(a) (a),-1,-1,-1
 ...
 */
union cavm_ncsi_mcp_rspx
{
    uint64_t u;
    struct cavm_ncsi_mcp_rspx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ncsi_mcp_rspx_s cn; */
};
typedef union cavm_ncsi_mcp_rspx cavm_ncsi_mcp_rspx_t;

static inline uint64_t CAVM_NCSI_MCP_RSPX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NCSI_MCP_RSPX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN96XX) && (a<=25))
        return 0x87e00b000700ll + 8ll * ((a) & 0x1f);
    if (cavm_is_model(OCTEONTX_CN98XX) && (a<=25))
        return 0x87e00b000700ll + 8ll * ((a) & 0x1f);
    __cavm_csr_fatal("NCSI_MCP_RSPX", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NCSI_MCP_RSPX(a) cavm_ncsi_mcp_rspx_t
#define bustype_CAVM_NCSI_MCP_RSPX(a) CSR_TYPE_RSL
#define basename_CAVM_NCSI_MCP_RSPX(a) "NCSI_MCP_RSPX"
#define device_bar_CAVM_NCSI_MCP_RSPX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_NCSI_MCP_RSPX(a) (a)
#define arguments_CAVM_NCSI_MCP_RSPX(a) (a),-1,-1,-1
 ...
 */
union cavm_ncsi_mcp_rsp_ctl
{
    uint64_t u;
    struct cavm_ncsi_mcp_rsp_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ncsi_mcp_rsp_ctl_s cn; */
};
typedef union cavm_ncsi_mcp_rsp_ctl cavm_ncsi_mcp_rsp_ctl_t;

#define CAVM_NCSI_MCP_RSP_CTL CAVM_NCSI_MCP_RSP_CTL_FUNC()
static inline uint64_t CAVM_NCSI_MCP_RSP_CTL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NCSI_MCP_RSP_CTL_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN96XX))
...
#define bustype_CAVM_NCSI_MCP_RSP_CTL CSR_TYPE_RSL
#define basename_CAVM_NCSI_MCP_RSP_CTL "NCSI_MCP_RSP_CTL"
#define device_bar_CAVM_NCSI_MCP_RSP_CTL 0x0 /* PF_BAR0 */
#define busnum_CAVM_NCSI_MCP_RSP_CTL 0
#define arguments_CAVM_NCSI_MCP_RSP_CTL -1,-1,-1,-1
...
union cavm_ncsi_msix_vecx_addr
{
    ...
    struct cavm_ncsi_msix_vecx_addr_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ncsi_msix_vecx_addr_s cn9; */
    /* struct cavm_ncsi_msix_vecx_addr_s cn96xxp1; */
    struct cavm_ncsi_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
...
union cavm_ncsi_msix_vecx_ctl
{
    ...
    struct cavm_ncsi_msix_vecx_ctl_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_33_63        : 31;
        uint64_t mask                  : 1;  /**< [ 32: 32](R/W) When set, no MSI-X interrupts are sent to this vector. */
    ...
    /* struct cavm_ncsi_msix_vecx_ctl_s cn9; */
};
...
union cavm_ncsi_rx_stat0
{
    ...
    /* struct cavm_ncsi_rx_stat0_s cn8; */
    struct cavm_ncsi_rx_stat0_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
        uint64_t cnt                   : 48; /**< [ 47:  0](R/W/H) Count of packets through the RX-side NCSI. This includes both pass through and response
...
union cavm_ncsi_rx_stat1
{
    ...
    /* struct cavm_ncsi_rx_stat1_s cn8; */
    struct cavm_ncsi_rx_stat1_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
        uint64_t cnt                   : 48; /**< [ 47:  0](R/W/H) Count of valid bytes through the RX-side NCSI.  This includes both pass through and
 ...
 */
union cavm_ncsi_rx_stat2
{
    uint64_t u;
    struct cavm_ncsi_rx_stat2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_ncsi_rx_stat2_s cn; */
};
typedef union cavm_ncsi_rx_stat2 cavm_ncsi_rx_stat2_t;

#define CAVM_NCSI_RX_STAT2 CAVM_NCSI_RX_STAT2_FUNC()
static inline uint64_t CAVM_NCSI_RX_STAT2_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NCSI_RX_STAT2_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN96XX))
...
#define bustype_CAVM_NCSI_RX_STAT2 CSR_TYPE_RSL
#define basename_CAVM_NCSI_RX_STAT2 "NCSI_RX_STAT2"
#define device_bar_CAVM_NCSI_RX_STAT2 0x0 /* PF_BAR0 */
#define busnum_CAVM_NCSI_RX_STAT2 0
#define arguments_CAVM_NCSI_RX_STAT2 -1,-1,-1,-1
 ...
 */
union cavm_ncsi_sw_to_value
{
    uint64_t u;
    struct cavm_ncsi_sw_to_value_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_ncsi_sw_to_value_s cn; */
};
typedef union cavm_ncsi_sw_to_value cavm_ncsi_sw_to_value_t;

#define CAVM_NCSI_SW_TO_VALUE CAVM_NCSI_SW_TO_VALUE_FUNC()
static inline uint64_t CAVM_NCSI_SW_TO_VALUE_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NCSI_SW_TO_VALUE_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN96XX))
...
#define bustype_CAVM_NCSI_SW_TO_VALUE CSR_TYPE_RSL
#define basename_CAVM_NCSI_SW_TO_VALUE "NCSI_SW_TO_VALUE"
#define device_bar_CAVM_NCSI_SW_TO_VALUE 0x0 /* PF_BAR0 */
#define busnum_CAVM_NCSI_SW_TO_VALUE 0
#define arguments_CAVM_NCSI_SW_TO_VALUE -1,-1,-1,-1
...
union cavm_ncsi_tx_frm_ctl
{
    ...
    /* struct cavm_ncsi_tx_frm_ctl_s cn; */
};
...
union cavm_ncsi_tx_mix
{
    ...
    /* struct cavm_ncsi_tx_mix_s cn8; */
    struct cavm_ncsi_tx_mix_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
...
union cavm_ncsi_tx_ncp_permx_table_hi
{
    ...
    /* struct cavm_ncsi_tx_ncp_permx_table_hi_s cn8; */
    struct cavm_ncsi_tx_ncp_permx_table_hi_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t addr                  : 64; /**< [ 63:  0](SR/W) Specifies the high physical address in formulating a permissions filter for OEM command
                                                                 access.
