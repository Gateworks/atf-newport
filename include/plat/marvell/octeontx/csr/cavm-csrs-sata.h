...
static inline uint64_t CAVM_SATAX_MSIX_PBAX(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_CN96XX_PASS1_X) && ((a<=3) && (b==0)))
...
union cavm_satax_msix_vecx_addr
{
    ...
    struct cavm_satax_msix_vecx_addr_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_satax_msix_vecx_addr_cn8 cn81xx; */
...
static inline uint64_t CAVM_SATAX_MSIX_VECX_ADDR(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_CN96XX_PASS1_X) && ((a<=3) && (b<=4)))
...
static inline uint64_t CAVM_SATAX_UAHC_GBL_DIAGNR3(unsigned long a)
{
    ...
    __cavm_csr_fatal("SATAX_UAHC_GBL_DIAGNR3", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SATAX_UAHC_GBL_GPARAM3(unsigned long a)
{
    ...
    __cavm_csr_fatal("SATAX_UAHC_GBL_GPARAM3", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SATAX_UAHC_P0_DEVSLP(unsigned long a)
{
    ...
    __cavm_csr_fatal("SATAX_UAHC_P0_DEVSLP", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SATAX_UCTL_CAP_CFG(unsigned long a)
{
    ...
    __cavm_csr_fatal("SATAX_UCTL_CAP_CFG", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SATAX_UCTL_CONST(unsigned long a)
{
    ...
    __cavm_csr_fatal("SATAX_UCTL_CONST", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SATAX_UCTL_CSCLK_ACTIVE_PC(unsigned long a)
{
    ...
    __cavm_csr_fatal("SATAX_UCTL_CSCLK_ACTIVE_PC", 1, a, 0, 0, 0, 0, 0);
}
...
union cavm_satax_uctl_intena_w1c
{
    ...
    struct cavm_satax_uctl_intena_w1c_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_14_63        : 50;
        uint64_t uahc_rx_dbe           : 1;  /**< [ 13: 13](R/W1C/H) Reads or clears enable for SATA(0..1)_UCTL_INTSTAT[UAHC_RX_DBE]. */
    ...
    /* struct cavm_satax_uctl_intena_w1c_cn8 cn81xx; */
...
union cavm_satax_uctl_intena_w1s
{
    ...
    struct cavm_satax_uctl_intena_w1s_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_14_63        : 50;
        uint64_t uahc_rx_dbe           : 1;  /**< [ 13: 13](R/W1S/H) Reads or sets enable for SATA(0..1)_UCTL_INTSTAT[UAHC_RX_DBE]. */
    ...
    /* struct cavm_satax_uctl_intena_w1s_cn8 cn81xx; */
...
union cavm_satax_uctl_intstat_w1s
{
    ...
    struct cavm_satax_uctl_intstat_w1s_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_14_63        : 50;
        uint64_t uahc_rx_dbe           : 1;  /**< [ 13: 13](R/W1S/H) Reads or sets SATA(0..1)_UCTL_INTSTAT[UAHC_RX_DBE]. */
    ...
    /* struct cavm_satax_uctl_intstat_w1s_cn8 cn81xx; */
...
static inline uint64_t CAVM_SATAX_UCTL_RAS(unsigned long a)
{
    ...
    __cavm_csr_fatal("SATAX_UCTL_RAS", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SATAX_UCTL_RAS_ENA_W1C(unsigned long a)
{
    ...
    __cavm_csr_fatal("SATAX_UCTL_RAS_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SATAX_UCTL_RAS_ENA_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("SATAX_UCTL_RAS_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_SATAX_UCTL_RAS_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("SATAX_UCTL_RAS_W1S", 1, a, 0, 0, 0, 0, 0);
}
