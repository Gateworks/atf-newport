...
static inline uint64_t CAVM_NDF_DEBUG_FUNC(void)
{
    ...
    __cavm_csr_fatal("NDF_DEBUG", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_NDF_ECC_CNT_FUNC(void)
{
    ...
    __cavm_csr_fatal("NDF_ECC_CNT", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_NDF_MSIX_PBAX(unsigned long a)
{
    ...
    __cavm_csr_fatal("NDF_MSIX_PBAX", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_NDF_MSIX_VECX_ADDR(unsigned long a)
{
    ...
    __cavm_csr_fatal("NDF_MSIX_VECX_ADDR", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_NDF_MSIX_VECX_CTL(unsigned long a)
{
    ...
    __cavm_csr_fatal("NDF_MSIX_VECX_CTL", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_NDF_RAS_INT_FUNC(void)
{
    ...
    __cavm_csr_fatal("NDF_RAS_INT", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_NDF_RAS_INT_ENA_W1C_FUNC(void)
{
    ...
    __cavm_csr_fatal("NDF_RAS_INT_ENA_W1C", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_NDF_RAS_INT_ENA_W1S_FUNC(void)
{
    ...
    __cavm_csr_fatal("NDF_RAS_INT_ENA_W1S", 0, 0, 0, 0, 0);
}
...
static inline uint64_t CAVM_NDF_RAS_INT_W1S_FUNC(void)
{
    ...
    __cavm_csr_fatal("NDF_RAS_INT_W1S", 0, 0, 0, 0, 0);
}
