#ifndef __CAVM_CSRS_NDF_H__
#define __CAVM_CSRS_NDF_H__
 ...
 */
#define CAVM_NDF_BAR_E_NDF_PF_BAR0_CN8 (0x808000000000ll)
#define CAVM_NDF_BAR_E_NDF_PF_BAR0_CN8_SIZE 0x100000ull
#define CAVM_NDF_BAR_E_NDF_PF_BAR0_CN9 (0x808000000000ll)
#define CAVM_NDF_BAR_E_NDF_PF_BAR0_CN9_SIZE 0x10000ull
#define CAVM_NDF_BAR_E_NDF_PF_BAR4 (0x808000f00000ll)
#define CAVM_NDF_BAR_E_NDF_PF_BAR4_SIZE 0x100000ull
 ...
 */
#define CAVM_NDF_INT_VEC_E_INTR (0)
...
union cavm_ndf_cmd
{
    ...
    /* struct cavm_ndf_cmd_s cn; */
};
typedef union cavm_ndf_cmd cavm_ndf_cmd_t;

#define CAVM_NDF_CMD CAVM_NDF_CMD_FUNC()
static inline uint64_t CAVM_NDF_CMD_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_CMD_FUNC(void)
{
    return 0x808000000000ll;
}

#define typedef_CAVM_NDF_CMD cavm_ndf_cmd_t
#define bustype_CAVM_NDF_CMD CSR_TYPE_NCB
#define basename_CAVM_NDF_CMD "NDF_CMD"
#define device_bar_CAVM_NDF_CMD 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_CMD 0
#define arguments_CAVM_NDF_CMD -1,-1,-1,-1
 ...
 * NDF Debug Register
 */
union cavm_ndf_debug
{
    uint64_t u;
    struct cavm_ndf_debug_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndf_debug_s cn; */
};
typedef union cavm_ndf_debug cavm_ndf_debug_t;

#define CAVM_NDF_DEBUG CAVM_NDF_DEBUG_FUNC()
static inline uint64_t CAVM_NDF_DEBUG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_DEBUG_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x8080000000f8ll;
    __cavm_csr_fatal("NDF_DEBUG", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDF_DEBUG cavm_ndf_debug_t
#define bustype_CAVM_NDF_DEBUG CSR_TYPE_NCB
#define basename_CAVM_NDF_DEBUG "NDF_DEBUG"
#define device_bar_CAVM_NDF_DEBUG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_DEBUG 0
#define arguments_CAVM_NDF_DEBUG -1,-1,-1,-1
 ...
 * Sixty-four-bit operations must be used to access this register.
 */
union cavm_ndf_dma_adr
{
    uint64_t u;
    struct cavm_ndf_dma_adr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
typedef union cavm_ndf_dma_adr cavm_ndf_dma_adr_t;

#define CAVM_NDF_DMA_ADR CAVM_NDF_DMA_ADR_FUNC()
static inline uint64_t CAVM_NDF_DMA_ADR_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_DMA_ADR_FUNC(void)
{
    return 0x808000000058ll;
}

#define typedef_CAVM_NDF_DMA_ADR cavm_ndf_dma_adr_t
#define bustype_CAVM_NDF_DMA_ADR CSR_TYPE_NCB
#define basename_CAVM_NDF_DMA_ADR "NDF_DMA_ADR"
#define device_bar_CAVM_NDF_DMA_ADR 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_DMA_ADR 0
#define arguments_CAVM_NDF_DMA_ADR -1,-1,-1,-1
 ...
 * Sixty-four-bit operations must be used to access this register.
 */
union cavm_ndf_dma_cfg
{
    uint64_t u;
    struct cavm_ndf_dma_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndf_dma_cfg_s cn8; */
    struct cavm_ndf_dma_cfg_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t en                    : 1;  /**< [ 63: 63](R/W/H) DMA engine enable.  This bit is cleared at the termination of the DMA.
...
typedef union cavm_ndf_dma_cfg cavm_ndf_dma_cfg_t;

#define CAVM_NDF_DMA_CFG CAVM_NDF_DMA_CFG_FUNC()
static inline uint64_t CAVM_NDF_DMA_CFG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_DMA_CFG_FUNC(void)
{
    return 0x808000000050ll;
}

#define typedef_CAVM_NDF_DMA_CFG cavm_ndf_dma_cfg_t
#define bustype_CAVM_NDF_DMA_CFG CSR_TYPE_NCB
#define basename_CAVM_NDF_DMA_CFG "NDF_DMA_CFG"
#define device_bar_CAVM_NDF_DMA_CFG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_DMA_CFG 0
#define arguments_CAVM_NDF_DMA_CFG -1,-1,-1,-1
 ...
 * Sixty-four-bit operations must be used to access this register.
 */
union cavm_ndf_drbell
{
    uint64_t u;
    struct cavm_ndf_drbell_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndf_drbell_s cn; */
};
typedef union cavm_ndf_drbell cavm_ndf_drbell_t;

#define CAVM_NDF_DRBELL CAVM_NDF_DRBELL_FUNC()
static inline uint64_t CAVM_NDF_DRBELL_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_DRBELL_FUNC(void)
{
    return 0x808000000030ll;
}

#define typedef_CAVM_NDF_DRBELL cavm_ndf_drbell_t
#define bustype_CAVM_NDF_DRBELL CSR_TYPE_NCB
#define basename_CAVM_NDF_DRBELL "NDF_DRBELL"
#define device_bar_CAVM_NDF_DRBELL 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_DRBELL 0
#define arguments_CAVM_NDF_DRBELL -1,-1,-1,-1
 ...
 * Sixty-four-bit operations must be used to access this register.
 */
union cavm_ndf_ecc_cnt
{
    uint64_t u;
    struct cavm_ndf_ecc_cnt_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndf_ecc_cnt_s cn; */
};
typedef union cavm_ndf_ecc_cnt cavm_ndf_ecc_cnt_t;

#define CAVM_NDF_ECC_CNT CAVM_NDF_ECC_CNT_FUNC()
static inline uint64_t CAVM_NDF_ECC_CNT_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_ECC_CNT_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN8XXX))
        return 0x808000000010ll;
    __cavm_csr_fatal("NDF_ECC_CNT", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDF_ECC_CNT cavm_ndf_ecc_cnt_t
#define bustype_CAVM_NDF_ECC_CNT CSR_TYPE_NCB
#define basename_CAVM_NDF_ECC_CNT "NDF_ECC_CNT"
...
typedef union cavm_ndf_int cavm_ndf_int_t;

#define CAVM_NDF_INT CAVM_NDF_INT_FUNC()
static inline uint64_t CAVM_NDF_INT_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_INT_FUNC(void)
{
    return 0x808000000040ll;
}

#define typedef_CAVM_NDF_INT cavm_ndf_int_t
#define bustype_CAVM_NDF_INT CSR_TYPE_NCB
#define basename_CAVM_NDF_INT "NDF_INT"
#define device_bar_CAVM_NDF_INT 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_INT 0
#define arguments_CAVM_NDF_INT -1,-1,-1,-1
 ...
 */
union cavm_ndf_int_ena_w1c
{
    uint64_t u;
    struct cavm_ndf_int_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_10_63        : 54;
    ...
    struct cavm_ndf_int_ena_w1c_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
        uint64_t dma_done              : 1;  /**< [  7:  7](R/W1C/H) Reads or clears enable for NDF_INT[DMA_DONE]. */
    ...
    struct cavm_ndf_int_ena_w1c_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_10_63        : 54;
        uint64_t ncb_overflow          : 1;  /**< [  9:  9](R/W1C/H) Reads or clears enable for NDF_INT[NCB_OVERFLOW]. */
...
typedef union cavm_ndf_int_ena_w1c cavm_ndf_int_ena_w1c_t;

#define CAVM_NDF_INT_ENA_W1C CAVM_NDF_INT_ENA_W1C_FUNC()
static inline uint64_t CAVM_NDF_INT_ENA_W1C_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_INT_ENA_W1C_FUNC(void)
{
    return 0x808000000060ll;
}

#define typedef_CAVM_NDF_INT_ENA_W1C cavm_ndf_int_ena_w1c_t
#define bustype_CAVM_NDF_INT_ENA_W1C CSR_TYPE_NCB
#define basename_CAVM_NDF_INT_ENA_W1C "NDF_INT_ENA_W1C"
#define device_bar_CAVM_NDF_INT_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_INT_ENA_W1C 0
#define arguments_CAVM_NDF_INT_ENA_W1C -1,-1,-1,-1
 ...
 */
union cavm_ndf_int_ena_w1s
{
    uint64_t u;
    struct cavm_ndf_int_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_10_63        : 54;
    ...
    struct cavm_ndf_int_ena_w1s_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
        uint64_t dma_done              : 1;  /**< [  7:  7](R/W1S/H) Reads or sets enable for NDF_INT[DMA_DONE]. */
    ...
    struct cavm_ndf_int_ena_w1s_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_10_63        : 54;
        uint64_t ncb_overflow          : 1;  /**< [  9:  9](R/W1S/H) Reads or sets enable for NDF_INT[NCB_OVERFLOW]. */
...
typedef union cavm_ndf_int_ena_w1s cavm_ndf_int_ena_w1s_t;

#define CAVM_NDF_INT_ENA_W1S CAVM_NDF_INT_ENA_W1S_FUNC()
static inline uint64_t CAVM_NDF_INT_ENA_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_INT_ENA_W1S_FUNC(void)
{
    return 0x808000000068ll;
}

#define typedef_CAVM_NDF_INT_ENA_W1S cavm_ndf_int_ena_w1s_t
#define bustype_CAVM_NDF_INT_ENA_W1S CSR_TYPE_NCB
#define basename_CAVM_NDF_INT_ENA_W1S "NDF_INT_ENA_W1S"
#define device_bar_CAVM_NDF_INT_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_INT_ENA_W1S 0
#define arguments_CAVM_NDF_INT_ENA_W1S -1,-1,-1,-1
 ...
 */
union cavm_ndf_int_w1s
{
    uint64_t u;
    struct cavm_ndf_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_10_63        : 54;
...
typedef union cavm_ndf_int_w1s cavm_ndf_int_w1s_t;

#define CAVM_NDF_INT_W1S CAVM_NDF_INT_W1S_FUNC()
static inline uint64_t CAVM_NDF_INT_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_INT_W1S_FUNC(void)
{
    return 0x808000000048ll;
}

#define typedef_CAVM_NDF_INT_W1S cavm_ndf_int_w1s_t
#define bustype_CAVM_NDF_INT_W1S CSR_TYPE_NCB
#define basename_CAVM_NDF_INT_W1S "NDF_INT_W1S"
#define device_bar_CAVM_NDF_INT_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_INT_W1S 0
#define arguments_CAVM_NDF_INT_W1S -1,-1,-1,-1
...
union cavm_ndf_misc
{
    ...
    /* struct cavm_ndf_misc_s cn; */
};
typedef union cavm_ndf_misc cavm_ndf_misc_t;

#define CAVM_NDF_MISC CAVM_NDF_MISC_FUNC()
static inline uint64_t CAVM_NDF_MISC_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_MISC_FUNC(void)
{
    return 0x808000000008ll;
}

#define typedef_CAVM_NDF_MISC cavm_ndf_misc_t
#define bustype_CAVM_NDF_MISC CSR_TYPE_NCB
#define basename_CAVM_NDF_MISC "NDF_MISC"
#define device_bar_CAVM_NDF_MISC 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_MISC 0
#define arguments_CAVM_NDF_MISC -1,-1,-1,-1
 ...
 */
union cavm_ndf_msix_pbax
{
    uint64_t u;
    struct cavm_ndf_msix_pbax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndf_msix_pbax_s cn; */
};
typedef union cavm_ndf_msix_pbax cavm_ndf_msix_pbax_t;

static inline uint64_t CAVM_NDF_MSIX_PBAX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_MSIX_PBAX(unsigned long a)
{
    if (a==0)
        return 0x808000ff0000ll + 8ll * ((a) & 0x0);
    __cavm_csr_fatal("NDF_MSIX_PBAX", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDF_MSIX_PBAX(a) cavm_ndf_msix_pbax_t
#define bustype_CAVM_NDF_MSIX_PBAX(a) CSR_TYPE_NCB
#define basename_CAVM_NDF_MSIX_PBAX(a) "NDF_MSIX_PBAX"
#define device_bar_CAVM_NDF_MSIX_PBAX(a) 0x4 /* PF_BAR4 */
#define busnum_CAVM_NDF_MSIX_PBAX(a) (a)
#define arguments_CAVM_NDF_MSIX_PBAX(a) (a),-1,-1,-1
 ...
 */
union cavm_ndf_msix_vecx_addr
{
    uint64_t u;
    struct cavm_ndf_msix_vecx_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
    ...
    struct cavm_ndf_msix_vecx_addr_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
...
static inline uint64_t CAVM_NDF_MSIX_VECX_ADDR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_MSIX_VECX_ADDR(unsigned long a)
{
    ...
    __cavm_csr_fatal("NDF_MSIX_VECX_ADDR", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDF_MSIX_VECX_ADDR(a) cavm_ndf_msix_vecx_addr_t
#define bustype_CAVM_NDF_MSIX_VECX_ADDR(a) CSR_TYPE_NCB
#define basename_CAVM_NDF_MSIX_VECX_ADDR(a) "NDF_MSIX_VECX_ADDR"
#define device_bar_CAVM_NDF_MSIX_VECX_ADDR(a) 0x4 /* PF_BAR4 */
#define busnum_CAVM_NDF_MSIX_VECX_ADDR(a) (a)
#define arguments_CAVM_NDF_MSIX_VECX_ADDR(a) (a),-1,-1,-1
 ...
 * This register is the MSI-X vector table, indexed by the NDF_INT_VEC_E enumeration.
 */
union cavm_ndf_msix_vecx_ctl
{
    uint64_t u;
    struct cavm_ndf_msix_vecx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    struct cavm_ndf_msix_vecx_ctl_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_33_63        : 31;
        uint64_t mask                  : 1;  /**< [ 32: 32](R/W) When set, no MSI-X interrupts are sent to this vector. */
    ...
    /* struct cavm_ndf_msix_vecx_ctl_s cn9; */
};
typedef union cavm_ndf_msix_vecx_ctl cavm_ndf_msix_vecx_ctl_t;

static inline uint64_t CAVM_NDF_MSIX_VECX_CTL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_MSIX_VECX_CTL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN8XXX) && (a==0))
        return 0x808000f00008ll + 0x10ll * ((a) & 0x0);
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=1))
        return 0x808000f00008ll + 0x10ll * ((a) & 0x1);
    __cavm_csr_fatal("NDF_MSIX_VECX_CTL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDF_MSIX_VECX_CTL(a) cavm_ndf_msix_vecx_ctl_t
#define bustype_CAVM_NDF_MSIX_VECX_CTL(a) CSR_TYPE_NCB
#define basename_CAVM_NDF_MSIX_VECX_CTL(a) "NDF_MSIX_VECX_CTL"
#define device_bar_CAVM_NDF_MSIX_VECX_CTL(a) 0x4 /* PF_BAR4 */
#define busnum_CAVM_NDF_MSIX_VECX_CTL(a) (a)
#define arguments_CAVM_NDF_MSIX_VECX_CTL(a) (a),-1,-1,-1
 ...
 * must be used to access this register.
 */
union cavm_ndf_ras_int
{
    uint64_t u;
    struct cavm_ndf_ras_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ndf_ras_int_s cn; */
};
typedef union cavm_ndf_ras_int cavm_ndf_ras_int_t;

#define CAVM_NDF_RAS_INT CAVM_NDF_RAS_INT_FUNC()
static inline uint64_t CAVM_NDF_RAS_INT_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_RAS_INT_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x808000000080ll;
    __cavm_csr_fatal("NDF_RAS_INT", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDF_RAS_INT cavm_ndf_ras_int_t
#define bustype_CAVM_NDF_RAS_INT CSR_TYPE_NCB
#define basename_CAVM_NDF_RAS_INT "NDF_RAS_INT"
#define device_bar_CAVM_NDF_RAS_INT 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_RAS_INT 0
#define arguments_CAVM_NDF_RAS_INT -1,-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_ndf_ras_int_ena_w1c
{
    uint64_t u;
    struct cavm_ndf_ras_int_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ndf_ras_int_ena_w1c_s cn; */
};
typedef union cavm_ndf_ras_int_ena_w1c cavm_ndf_ras_int_ena_w1c_t;

#define CAVM_NDF_RAS_INT_ENA_W1C CAVM_NDF_RAS_INT_ENA_W1C_FUNC()
static inline uint64_t CAVM_NDF_RAS_INT_ENA_W1C_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_RAS_INT_ENA_W1C_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x808000000098ll;
    __cavm_csr_fatal("NDF_RAS_INT_ENA_W1C", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDF_RAS_INT_ENA_W1C cavm_ndf_ras_int_ena_w1c_t
#define bustype_CAVM_NDF_RAS_INT_ENA_W1C CSR_TYPE_NCB
#define basename_CAVM_NDF_RAS_INT_ENA_W1C "NDF_RAS_INT_ENA_W1C"
#define device_bar_CAVM_NDF_RAS_INT_ENA_W1C 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_RAS_INT_ENA_W1C 0
#define arguments_CAVM_NDF_RAS_INT_ENA_W1C -1,-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_ndf_ras_int_ena_w1s
{
    uint64_t u;
    struct cavm_ndf_ras_int_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ndf_ras_int_ena_w1s_s cn; */
};
typedef union cavm_ndf_ras_int_ena_w1s cavm_ndf_ras_int_ena_w1s_t;

#define CAVM_NDF_RAS_INT_ENA_W1S CAVM_NDF_RAS_INT_ENA_W1S_FUNC()
static inline uint64_t CAVM_NDF_RAS_INT_ENA_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_RAS_INT_ENA_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x808000000090ll;
    __cavm_csr_fatal("NDF_RAS_INT_ENA_W1S", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDF_RAS_INT_ENA_W1S cavm_ndf_ras_int_ena_w1s_t
#define bustype_CAVM_NDF_RAS_INT_ENA_W1S CSR_TYPE_NCB
#define basename_CAVM_NDF_RAS_INT_ENA_W1S "NDF_RAS_INT_ENA_W1S"
#define device_bar_CAVM_NDF_RAS_INT_ENA_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_RAS_INT_ENA_W1S 0
#define arguments_CAVM_NDF_RAS_INT_ENA_W1S -1,-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_ndf_ras_int_w1s
{
    uint64_t u;
    struct cavm_ndf_ras_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ndf_ras_int_w1s_s cn; */
};
typedef union cavm_ndf_ras_int_w1s cavm_ndf_ras_int_w1s_t;

#define CAVM_NDF_RAS_INT_W1S CAVM_NDF_RAS_INT_W1S_FUNC()
static inline uint64_t CAVM_NDF_RAS_INT_W1S_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_RAS_INT_W1S_FUNC(void)
{
    if (cavm_is_model(OCTEONTX_CN9XXX))
        return 0x808000000088ll;
    __cavm_csr_fatal("NDF_RAS_INT_W1S", 0, 0, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDF_RAS_INT_W1S cavm_ndf_ras_int_w1s_t
#define bustype_CAVM_NDF_RAS_INT_W1S CSR_TYPE_NCB
#define basename_CAVM_NDF_RAS_INT_W1S "NDF_RAS_INT_W1S"
#define device_bar_CAVM_NDF_RAS_INT_W1S 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_RAS_INT_W1S 0
#define arguments_CAVM_NDF_RAS_INT_W1S -1,-1,-1,-1
 ...
 */
union cavm_ndf_st_reg
{
    uint64_t u;
    struct cavm_ndf_st_reg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndf_st_reg_s cn; */
};
typedef union cavm_ndf_st_reg cavm_ndf_st_reg_t;

#define CAVM_NDF_ST_REG CAVM_NDF_ST_REG_FUNC()
static inline uint64_t CAVM_NDF_ST_REG_FUNC(void) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_NDF_ST_REG_FUNC(void)
{
    return 0x808000000038ll;
}

#define typedef_CAVM_NDF_ST_REG cavm_ndf_st_reg_t
#define bustype_CAVM_NDF_ST_REG CSR_TYPE_NCB
#define basename_CAVM_NDF_ST_REG "NDF_ST_REG"
#define device_bar_CAVM_NDF_ST_REG 0x0 /* PF_BAR0 */
#define busnum_CAVM_NDF_ST_REG 0
#define arguments_CAVM_NDF_ST_REG -1,-1,-1,-1

#endif /* __CAVM_CSRS_NDF_H__ */
