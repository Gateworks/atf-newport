 ...
 */
union cavm_rmap_lte_mode_s
{
    uint64_t u[4];
    struct cavm_rmap_lte_mode_s_s
    {
 ...
 */
union cavm_rmap_nr_mode_s
{
    uint64_t u[7];
    struct cavm_rmap_nr_mode_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
 ...
 */
union cavm_rmapx_control
{
    uint64_t u;
    struct cavm_rmapx_control_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_control_s cn; */
};
typedef union cavm_rmapx_control cavm_rmapx_control_t;

static inline uint64_t CAVM_RMAPX_CONTROL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_CONTROL(unsigned long a)
{
...
#define bustype_CAVM_RMAPX_CONTROL(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_CONTROL(a) "RMAPX_CONTROL"
#define busnum_CAVM_RMAPX_CONTROL(a) (a)
...
static inline uint64_t CAVM_RMAPX_ECO(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_ECO(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
 ...
 */
union cavm_rmapx_error_enable0
{
    uint64_t u;
    struct cavm_rmapx_error_enable0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_error_enable0_s cn; */
};
typedef union cavm_rmapx_error_enable0 cavm_rmapx_error_enable0_t;

static inline uint64_t CAVM_RMAPX_ERROR_ENABLE0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_ERROR_ENABLE0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_ERROR_ENABLE0(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_ERROR_ENABLE0(a) "RMAPX_ERROR_ENABLE0"
#define busnum_CAVM_RMAPX_ERROR_ENABLE0(a) (a)
#define arguments_CAVM_RMAPX_ERROR_ENABLE0(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_error_enable1
{
    uint64_t u;
    struct cavm_rmapx_error_enable1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_error_enable1_s cn; */
};
typedef union cavm_rmapx_error_enable1 cavm_rmapx_error_enable1_t;

static inline uint64_t CAVM_RMAPX_ERROR_ENABLE1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_ERROR_ENABLE1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_ERROR_ENABLE1(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_ERROR_ENABLE1(a) "RMAPX_ERROR_ENABLE1"
#define busnum_CAVM_RMAPX_ERROR_ENABLE1(a) (a)
#define arguments_CAVM_RMAPX_ERROR_ENABLE1(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_error_source0
{
    uint64_t u;
    struct cavm_rmapx_error_source0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_rmapx_error_source0_s cn; */
};
typedef union cavm_rmapx_error_source0 cavm_rmapx_error_source0_t;

static inline uint64_t CAVM_RMAPX_ERROR_SOURCE0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_ERROR_SOURCE0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_ERROR_SOURCE0(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_ERROR_SOURCE0(a) "RMAPX_ERROR_SOURCE0"
#define busnum_CAVM_RMAPX_ERROR_SOURCE0(a) (a)
#define arguments_CAVM_RMAPX_ERROR_SOURCE0(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_error_source1
{
    uint64_t u;
    struct cavm_rmapx_error_source1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_34_63        : 30;
    ...
    /* struct cavm_rmapx_error_source1_s cn; */
};
typedef union cavm_rmapx_error_source1 cavm_rmapx_error_source1_t;

static inline uint64_t CAVM_RMAPX_ERROR_SOURCE1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_ERROR_SOURCE1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_ERROR_SOURCE1(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_ERROR_SOURCE1(a) "RMAPX_ERROR_SOURCE1"
#define busnum_CAVM_RMAPX_ERROR_SOURCE1(a) (a)
#define arguments_CAVM_RMAPX_ERROR_SOURCE1(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_jd0_cfg0
{
    uint64_t u;
    struct cavm_rmapx_jd0_cfg0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_jd0_cfg0_s cn; */
};
typedef union cavm_rmapx_jd0_cfg0 cavm_rmapx_jd0_cfg0_t;

static inline uint64_t CAVM_RMAPX_JD0_CFG0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD0_CFG0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD0_CFG0(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD0_CFG0(a) "RMAPX_JD0_CFG0"
#define busnum_CAVM_RMAPX_JD0_CFG0(a) (a)
#define arguments_CAVM_RMAPX_JD0_CFG0(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_jd0_cfg1
{
    uint64_t u;
    struct cavm_rmapx_jd0_cfg1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_jd0_cfg1_s cn; */
};
typedef union cavm_rmapx_jd0_cfg1 cavm_rmapx_jd0_cfg1_t;

static inline uint64_t CAVM_RMAPX_JD0_CFG1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD0_CFG1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD0_CFG1(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD0_CFG1(a) "RMAPX_JD0_CFG1"
#define busnum_CAVM_RMAPX_JD0_CFG1(a) (a)
#define arguments_CAVM_RMAPX_JD0_CFG1(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_jd0_cfg2
{
    uint64_t u;
    struct cavm_rmapx_jd0_cfg2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_jd0_cfg2_s cn; */
};
typedef union cavm_rmapx_jd0_cfg2 cavm_rmapx_jd0_cfg2_t;

static inline uint64_t CAVM_RMAPX_JD0_CFG2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD0_CFG2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD0_CFG2(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD0_CFG2(a) "RMAPX_JD0_CFG2"
#define busnum_CAVM_RMAPX_JD0_CFG2(a) (a)
#define arguments_CAVM_RMAPX_JD0_CFG2(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_jd0_cfg3
{
    uint64_t u;
    struct cavm_rmapx_jd0_cfg3_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_jd0_cfg3_s cn; */
};
typedef union cavm_rmapx_jd0_cfg3 cavm_rmapx_jd0_cfg3_t;

static inline uint64_t CAVM_RMAPX_JD0_CFG3(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD0_CFG3(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD0_CFG3(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD0_CFG3(a) "RMAPX_JD0_CFG3"
#define busnum_CAVM_RMAPX_JD0_CFG3(a) (a)
#define arguments_CAVM_RMAPX_JD0_CFG3(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_jd0_cfg4
{
    uint64_t u;
    struct cavm_rmapx_jd0_cfg4_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_jd0_cfg4_s cn; */
};
typedef union cavm_rmapx_jd0_cfg4 cavm_rmapx_jd0_cfg4_t;

static inline uint64_t CAVM_RMAPX_JD0_CFG4(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD0_CFG4(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD0_CFG4(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD0_CFG4(a) "RMAPX_JD0_CFG4"
#define busnum_CAVM_RMAPX_JD0_CFG4(a) (a)
#define arguments_CAVM_RMAPX_JD0_CFG4(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_jd0_cfg5
{
    uint64_t u;
    struct cavm_rmapx_jd0_cfg5_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_jd0_cfg5_s cn; */
};
typedef union cavm_rmapx_jd0_cfg5 cavm_rmapx_jd0_cfg5_t;

static inline uint64_t CAVM_RMAPX_JD0_CFG5(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD0_CFG5(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD0_CFG5(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD0_CFG5(a) "RMAPX_JD0_CFG5"
#define busnum_CAVM_RMAPX_JD0_CFG5(a) (a)
#define arguments_CAVM_RMAPX_JD0_CFG5(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_jd0_cfg6
{
    uint64_t u;
    struct cavm_rmapx_jd0_cfg6_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_jd0_cfg6_s cn; */
};
typedef union cavm_rmapx_jd0_cfg6 cavm_rmapx_jd0_cfg6_t;

static inline uint64_t CAVM_RMAPX_JD0_CFG6(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD0_CFG6(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD0_CFG6(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD0_CFG6(a) "RMAPX_JD0_CFG6"
#define busnum_CAVM_RMAPX_JD0_CFG6(a) (a)
#define arguments_CAVM_RMAPX_JD0_CFG6(a) (a),-1,-1,-1
 ...
 * This register stores the 1st job configuration word for slot 0.
 */
union cavm_rmapx_jd1_cfg0
{
    uint64_t u;
    struct cavm_rmapx_jd1_cfg0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t phy_mode              : 1;  /**< [ 63: 63](R/W) LTE/NR Mode. 0 = LTE, 1 = NR. */
        uint64_t cfg0_data             : 63; /**< [ 62:  0](R/W) CFG0 Data */
    ...
    /* struct cavm_rmapx_jd1_cfg0_s cn; */
};
typedef union cavm_rmapx_jd1_cfg0 cavm_rmapx_jd1_cfg0_t;

static inline uint64_t CAVM_RMAPX_JD1_CFG0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD1_CFG0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD1_CFG0(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD1_CFG0(a) "RMAPX_JD1_CFG0"
#define busnum_CAVM_RMAPX_JD1_CFG0(a) (a)
#define arguments_CAVM_RMAPX_JD1_CFG0(a) (a),-1,-1,-1
 ...
 * This register stores the 2nd job configuration word for slot 0.
 */
union cavm_rmapx_jd1_cfg1
{
    uint64_t u;
    struct cavm_rmapx_jd1_cfg1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cfg1_data             : 64; /**< [ 63:  0](R/W) CFG1 Data */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_rmapx_jd1_cfg1_s cn; */
};
typedef union cavm_rmapx_jd1_cfg1 cavm_rmapx_jd1_cfg1_t;

static inline uint64_t CAVM_RMAPX_JD1_CFG1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD1_CFG1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD1_CFG1(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD1_CFG1(a) "RMAPX_JD1_CFG1"
#define busnum_CAVM_RMAPX_JD1_CFG1(a) (a)
#define arguments_CAVM_RMAPX_JD1_CFG1(a) (a),-1,-1,-1
 ...
 * This register stores the 3rd job configuration word for slot 0.
 */
union cavm_rmapx_jd1_cfg2
{
    uint64_t u;
    struct cavm_rmapx_jd1_cfg2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cfg2_data             : 64; /**< [ 63:  0](R/W) CFG2 Data */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_rmapx_jd1_cfg2_s cn; */
};
typedef union cavm_rmapx_jd1_cfg2 cavm_rmapx_jd1_cfg2_t;

static inline uint64_t CAVM_RMAPX_JD1_CFG2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD1_CFG2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD1_CFG2(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD1_CFG2(a) "RMAPX_JD1_CFG2"
#define busnum_CAVM_RMAPX_JD1_CFG2(a) (a)
#define arguments_CAVM_RMAPX_JD1_CFG2(a) (a),-1,-1,-1
 ...
 * This register stores the 4th job configuration word for slot 0.
 */
union cavm_rmapx_jd1_cfg3
{
    uint64_t u;
    struct cavm_rmapx_jd1_cfg3_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cfg3_data             : 64; /**< [ 63:  0](R/W) CFG3 Data */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_rmapx_jd1_cfg3_s cn; */
};
typedef union cavm_rmapx_jd1_cfg3 cavm_rmapx_jd1_cfg3_t;

static inline uint64_t CAVM_RMAPX_JD1_CFG3(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD1_CFG3(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD1_CFG3(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD1_CFG3(a) "RMAPX_JD1_CFG3"
#define busnum_CAVM_RMAPX_JD1_CFG3(a) (a)
#define arguments_CAVM_RMAPX_JD1_CFG3(a) (a),-1,-1,-1
 ...
 * This register stores the 5th job configuration word for slot 0.
 */
union cavm_rmapx_jd1_cfg4
{
    uint64_t u;
    struct cavm_rmapx_jd1_cfg4_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cfg4_data             : 64; /**< [ 63:  0](R/W) CFG4 Data */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_rmapx_jd1_cfg4_s cn; */
};
typedef union cavm_rmapx_jd1_cfg4 cavm_rmapx_jd1_cfg4_t;

static inline uint64_t CAVM_RMAPX_JD1_CFG4(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD1_CFG4(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD1_CFG4(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD1_CFG4(a) "RMAPX_JD1_CFG4"
#define busnum_CAVM_RMAPX_JD1_CFG4(a) (a)
#define arguments_CAVM_RMAPX_JD1_CFG4(a) (a),-1,-1,-1
 ...
 * This register stores the 6th job configuration word for slot 0.
 */
union cavm_rmapx_jd1_cfg5
{
    uint64_t u;
    struct cavm_rmapx_jd1_cfg5_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cfg5_data             : 64; /**< [ 63:  0](R/W) CFG5 Data */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_rmapx_jd1_cfg5_s cn; */
};
typedef union cavm_rmapx_jd1_cfg5 cavm_rmapx_jd1_cfg5_t;

static inline uint64_t CAVM_RMAPX_JD1_CFG5(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD1_CFG5(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD1_CFG5(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD1_CFG5(a) "RMAPX_JD1_CFG5"
#define busnum_CAVM_RMAPX_JD1_CFG5(a) (a)
#define arguments_CAVM_RMAPX_JD1_CFG5(a) (a),-1,-1,-1
 ...
 * This register stores the 7th job configuration word for slot 0.
 */
union cavm_rmapx_jd1_cfg6
{
    uint64_t u;
    struct cavm_rmapx_jd1_cfg6_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cfg6_data             : 64; /**< [ 63:  0](R/W) CFG6 Data */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_rmapx_jd1_cfg6_s cn; */
};
typedef union cavm_rmapx_jd1_cfg6 cavm_rmapx_jd1_cfg6_t;

static inline uint64_t CAVM_RMAPX_JD1_CFG6(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD1_CFG6(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD1_CFG6(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD1_CFG6(a) "RMAPX_JD1_CFG6"
#define busnum_CAVM_RMAPX_JD1_CFG6(a) (a)
#define arguments_CAVM_RMAPX_JD1_CFG6(a) (a),-1,-1,-1
 ...
 * This register stores the 1st job configuration word for slot 0.
 */
union cavm_rmapx_jd2_cfg0
{
    uint64_t u;
    struct cavm_rmapx_jd2_cfg0_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t phy_mode              : 1;  /**< [ 63: 63](R/W) LTE/NR Mode. 0 = LTE, 1 = NR. */
        uint64_t cfg0_data             : 63; /**< [ 62:  0](R/W) CFG0 Data */
    ...
    /* struct cavm_rmapx_jd2_cfg0_s cn; */
};
typedef union cavm_rmapx_jd2_cfg0 cavm_rmapx_jd2_cfg0_t;

static inline uint64_t CAVM_RMAPX_JD2_CFG0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD2_CFG0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD2_CFG0(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD2_CFG0(a) "RMAPX_JD2_CFG0"
#define busnum_CAVM_RMAPX_JD2_CFG0(a) (a)
#define arguments_CAVM_RMAPX_JD2_CFG0(a) (a),-1,-1,-1
 ...
 * This register stores the 2nd job configuration word for slot 0.
 */
union cavm_rmapx_jd2_cfg1
{
    uint64_t u;
    struct cavm_rmapx_jd2_cfg1_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cfg1_data             : 64; /**< [ 63:  0](R/W) CFG1 Data */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_rmapx_jd2_cfg1_s cn; */
};
typedef union cavm_rmapx_jd2_cfg1 cavm_rmapx_jd2_cfg1_t;

static inline uint64_t CAVM_RMAPX_JD2_CFG1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD2_CFG1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD2_CFG1(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD2_CFG1(a) "RMAPX_JD2_CFG1"
#define busnum_CAVM_RMAPX_JD2_CFG1(a) (a)
#define arguments_CAVM_RMAPX_JD2_CFG1(a) (a),-1,-1,-1
 ...
 * This register stores the 3rd job configuration word for slot 0.
 */
union cavm_rmapx_jd2_cfg2
{
    uint64_t u;
    struct cavm_rmapx_jd2_cfg2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cfg2_data             : 64; /**< [ 63:  0](R/W) CFG2 Data */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_rmapx_jd2_cfg2_s cn; */
};
typedef union cavm_rmapx_jd2_cfg2 cavm_rmapx_jd2_cfg2_t;

static inline uint64_t CAVM_RMAPX_JD2_CFG2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD2_CFG2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD2_CFG2(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD2_CFG2(a) "RMAPX_JD2_CFG2"
#define busnum_CAVM_RMAPX_JD2_CFG2(a) (a)
#define arguments_CAVM_RMAPX_JD2_CFG2(a) (a),-1,-1,-1
 ...
 * This register stores the 4th job configuration word for slot 0.
 */
union cavm_rmapx_jd2_cfg3
{
    uint64_t u;
    struct cavm_rmapx_jd2_cfg3_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cfg3_data             : 64; /**< [ 63:  0](R/W) CFG3 Data */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_rmapx_jd2_cfg3_s cn; */
};
typedef union cavm_rmapx_jd2_cfg3 cavm_rmapx_jd2_cfg3_t;

static inline uint64_t CAVM_RMAPX_JD2_CFG3(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD2_CFG3(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD2_CFG3(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD2_CFG3(a) "RMAPX_JD2_CFG3"
#define busnum_CAVM_RMAPX_JD2_CFG3(a) (a)
#define arguments_CAVM_RMAPX_JD2_CFG3(a) (a),-1,-1,-1
 ...
 * This register stores the 5th job configuration word for slot 0.
 */
union cavm_rmapx_jd2_cfg4
{
    uint64_t u;
    struct cavm_rmapx_jd2_cfg4_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cfg4_data             : 64; /**< [ 63:  0](R/W) CFG4 Data */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_rmapx_jd2_cfg4_s cn; */
};
typedef union cavm_rmapx_jd2_cfg4 cavm_rmapx_jd2_cfg4_t;

static inline uint64_t CAVM_RMAPX_JD2_CFG4(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD2_CFG4(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD2_CFG4(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD2_CFG4(a) "RMAPX_JD2_CFG4"
#define busnum_CAVM_RMAPX_JD2_CFG4(a) (a)
#define arguments_CAVM_RMAPX_JD2_CFG4(a) (a),-1,-1,-1
 ...
 * This register stores the 6th job configuration word for slot 0.
 */
union cavm_rmapx_jd2_cfg5
{
    uint64_t u;
    struct cavm_rmapx_jd2_cfg5_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cfg5_data             : 64; /**< [ 63:  0](R/W) CFG5 Data */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_rmapx_jd2_cfg5_s cn; */
};
typedef union cavm_rmapx_jd2_cfg5 cavm_rmapx_jd2_cfg5_t;

static inline uint64_t CAVM_RMAPX_JD2_CFG5(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD2_CFG5(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD2_CFG5(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD2_CFG5(a) "RMAPX_JD2_CFG5"
#define busnum_CAVM_RMAPX_JD2_CFG5(a) (a)
#define arguments_CAVM_RMAPX_JD2_CFG5(a) (a),-1,-1,-1
 ...
 * This register stores the 7th job configuration word for slot 0.
 */
union cavm_rmapx_jd2_cfg6
{
    uint64_t u;
    struct cavm_rmapx_jd2_cfg6_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t cfg6_data             : 64; /**< [ 63:  0](R/W) CFG6 Data */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_rmapx_jd2_cfg6_s cn; */
};
typedef union cavm_rmapx_jd2_cfg6 cavm_rmapx_jd2_cfg6_t;

static inline uint64_t CAVM_RMAPX_JD2_CFG6(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_JD2_CFG6(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_JD2_CFG6(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_JD2_CFG6(a) "RMAPX_JD2_CFG6"
#define busnum_CAVM_RMAPX_JD2_CFG6(a) (a)
...
static inline uint64_t CAVM_RMAPX_SCRATCH(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_SCRATCH(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
 ...
 */
union cavm_rmapx_status
{
    uint64_t u;
    struct cavm_rmapx_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_status_s cn; */
};
typedef union cavm_rmapx_status cavm_rmapx_status_t;

static inline uint64_t CAVM_RMAPX_STATUS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_STATUS(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_STATUS(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_STATUS(a) "RMAPX_STATUS"
#define busnum_CAVM_RMAPX_STATUS(a) (a)
#define arguments_CAVM_RMAPX_STATUS(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_tc_config_err_flags
{
    uint64_t u;
    struct cavm_rmapx_tc_config_err_flags_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_tc_config_err_flags_s cn; */
};
typedef union cavm_rmapx_tc_config_err_flags cavm_rmapx_tc_config_err_flags_t;

static inline uint64_t CAVM_RMAPX_TC_CONFIG_ERR_FLAGS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_TC_CONFIG_ERR_FLAGS(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_TC_CONFIG_ERR_FLAGS(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_TC_CONFIG_ERR_FLAGS(a) "RMAPX_TC_CONFIG_ERR_FLAGS"
#define busnum_CAVM_RMAPX_TC_CONFIG_ERR_FLAGS(a) (a)
#define arguments_CAVM_RMAPX_TC_CONFIG_ERR_FLAGS(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_tc_error
{
    uint64_t u;
    struct cavm_rmapx_tc_error_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_tc_error_s cn; */
};
typedef union cavm_rmapx_tc_error cavm_rmapx_tc_error_t;

static inline uint64_t CAVM_RMAPX_TC_ERROR(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_TC_ERROR(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_TC_ERROR(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_TC_ERROR(a) "RMAPX_TC_ERROR"
#define busnum_CAVM_RMAPX_TC_ERROR(a) (a)
#define arguments_CAVM_RMAPX_TC_ERROR(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_tc_error_mask
{
    uint64_t u;
    struct cavm_rmapx_tc_error_mask_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_rmapx_tc_error_mask_s cn; */
};
typedef union cavm_rmapx_tc_error_mask cavm_rmapx_tc_error_mask_t;

static inline uint64_t CAVM_RMAPX_TC_ERROR_MASK(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_TC_ERROR_MASK(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_TC_ERROR_MASK(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_TC_ERROR_MASK(a) "RMAPX_TC_ERROR_MASK"
#define busnum_CAVM_RMAPX_TC_ERROR_MASK(a) (a)
#define arguments_CAVM_RMAPX_TC_ERROR_MASK(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_tc_main_control
{
    uint64_t u;
    struct cavm_rmapx_tc_main_control_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_5_63         : 59;
    ...
    struct cavm_rmapx_tc_main_control_cn
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
...
typedef union cavm_rmapx_tc_main_control cavm_rmapx_tc_main_control_t;

static inline uint64_t CAVM_RMAPX_TC_MAIN_CONTROL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_TC_MAIN_CONTROL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_TC_MAIN_CONTROL(a) CSR_TYPE_RSL
#define basename_CAVM_RMAPX_TC_MAIN_CONTROL(a) "RMAPX_TC_MAIN_CONTROL"
#define busnum_CAVM_RMAPX_TC_MAIN_CONTROL(a) (a)
#define arguments_CAVM_RMAPX_TC_MAIN_CONTROL(a) (a),-1,-1,-1
 ...
 */
union cavm_rmapx_tc_main_reset
{
    uint64_t u;
    struct cavm_rmapx_tc_main_reset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_rmapx_tc_main_reset_s cn; */
};
typedef union cavm_rmapx_tc_main_reset cavm_rmapx_tc_main_reset_t;

static inline uint64_t CAVM_RMAPX_TC_MAIN_RESET(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_TC_MAIN_RESET(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
#define bustype_CAVM_RMAPX_TC_MAIN_RESET(a) CSR_TYPE_RSL
...
static inline uint64_t CAVM_RMAPX_TC_MAIN_START(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_TC_MAIN_START(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CNF95XX) && (a<=1))
...
static inline uint64_t CAVM_RMAPX_TC_STATUSX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_RMAPX_TC_STATUSX(unsigned long a, unsigned long b)
{
