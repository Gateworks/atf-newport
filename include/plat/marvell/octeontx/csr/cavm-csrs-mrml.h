 ...
 */
#define CAVM_MRML_BAR_E_MRML_PF_BAR0_CN8 (0x87e0fc000000ll)
#define CAVM_MRML_BAR_E_MRML_PF_BAR0_CN8_SIZE 0x100000ull
#define CAVM_MRML_BAR_E_MRML_PF_BAR0_CN9 (0x87e0fc000000ll)
#define CAVM_MRML_BAR_E_MRML_PF_BAR0_CN9_SIZE 0x40000ull
...
union cavm_mrml_int_ena_w1c
{
    ...
    /* struct cavm_mrml_int_ena_w1c_s cn8; */
    struct cavm_mrml_int_ena_w1c_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
        uint64_t local_toe             : 1;  /**< [  1:  1](SR/W1C/H) Reads or clears enable for MRML_INT_SUM[LOCAL_TOE]. */
...
union cavm_mrml_int_ena_w1s
{
    ...
    /* struct cavm_mrml_int_ena_w1s_s cn8; */
    struct cavm_mrml_int_ena_w1s_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
        uint64_t local_toe             : 1;  /**< [  1:  1](SR/W1S/H) Reads or sets enable for MRML_INT_SUM[LOCAL_TOE]. */
...
union cavm_mrml_int_local_to
{
    ...
    /* struct cavm_mrml_int_local_to_s cn8; */
    struct cavm_mrml_int_local_to_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
...
union cavm_mrml_int_ocx_to
{
    ...
    /* struct cavm_mrml_int_ocx_to_s cn8; */
    struct cavm_mrml_int_ocx_to_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
...
union cavm_mrml_int_sum
{
    ...
    /* struct cavm_mrml_int_sum_s cn8; */
    struct cavm_mrml_int_sum_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
        uint64_t local_toe             : 1;  /**< [  1:  1](SR/W1C/H) Local timeout error. When set, a local timeout error has occurred. */
...
union cavm_mrml_int_sum_w1s
{
    ...
    /* struct cavm_mrml_int_sum_w1s_s cn8; */
    struct cavm_mrml_int_sum_w1s_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
        uint64_t local_toe             : 1;  /**< [  1:  1](SR/W1S/H) Reads or sets MRML_INT_SUM[LOCAL_TOE]. */
...
union cavm_mrml_msix_vecx_addr
{
    ...
    struct cavm_mrml_msix_vecx_addr_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mrml_msix_vecx_addr_s cn9; */
    /* struct cavm_mrml_msix_vecx_addr_s cn96xxp1; */
    struct cavm_mrml_msix_vecx_addr_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t addr                  : 51; /**< [ 52:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
...
union cavm_mrml_msix_vecx_ctl
{
    ...
    struct cavm_mrml_msix_vecx_ctl_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_33_63        : 31;
        uint64_t mask                  : 1;  /**< [ 32: 32](R/W) When set, no MSI-X interrupts are sent to this vector. */
    ...
    /* struct cavm_mrml_msix_vecx_ctl_s cn9; */
};
