 ...
 */
#define CAVM_ECAM_BAR_E_ECAMX_PF_BAR0_CN8(a) (0x87e048000000ll + 0x1000000ll * (a))
#define CAVM_ECAM_BAR_E_ECAMX_PF_BAR0_CN8_SIZE 0x100000ull
#define CAVM_ECAM_BAR_E_ECAMX_PF_BAR0_CN9(a) (0x87e078000000ll + 0x1000000ll * (a))
#define CAVM_ECAM_BAR_E_ECAMX_PF_BAR0_CN9_SIZE 0x100000ull
#define CAVM_ECAM_BAR_E_ECAMX_PF_BAR2_CN8(a) (0x848000000000ll + 0x1000000000ll * (a))
#define CAVM_ECAM_BAR_E_ECAMX_PF_BAR2_CN8_SIZE 0x1000000000ull
#define CAVM_ECAM_BAR_E_ECAMX_PF_BAR2_CN9(a) (0x878000000000ll + 0x1000000000ll * (a))
#define CAVM_ECAM_BAR_E_ECAMX_PF_BAR2_CN9_SIZE 0x1000000000ull
...
union cavm_ecam_cfg_addr_s
{
    ...
    struct cavm_ecam_cfg_addr_s_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_52_63        : 12;
        uint64_t io                    : 5;  /**< [ 51: 47] Indicates I/O space. */
 ...
 */
union cavm_ecamx_busx_nsdis
{
    uint64_t u;
    struct cavm_ecamx_busx_nsdis_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ecamx_busx_nsdis_s cn; */
};
...
static inline uint64_t CAVM_ECAMX_BUSX_NSDIS(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a<=1) && (b<=255)))
        return 0x87e048030000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0xff);
    __cavm_csr_fatal("ECAMX_BUSX_NSDIS", 2, a, b, 0, 0);
}

#define typedef_CAVM_ECAMX_BUSX_NSDIS(a,b) cavm_ecamx_busx_nsdis_t
#define bustype_CAVM_ECAMX_BUSX_NSDIS(a,b) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_BUSX_NSDIS(a,b) "ECAMX_BUSX_NSDIS"
#define device_bar_CAVM_ECAMX_BUSX_NSDIS(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ECAMX_BUSX_NSDIS(a,b) (a)
#define arguments_CAVM_ECAMX_BUSX_NSDIS(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ecamx_busx_sdis
{
    uint64_t u;
    struct cavm_ecamx_busx_sdis_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ecamx_busx_sdis_s cn; */
};
...
static inline uint64_t CAVM_ECAMX_BUSX_SDIS(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("ECAMX_BUSX_SDIS", 2, a, b, 0, 0);
}

#define typedef_CAVM_ECAMX_BUSX_SDIS(a,b) cavm_ecamx_busx_sdis_t
#define bustype_CAVM_ECAMX_BUSX_SDIS(a,b) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_BUSX_SDIS(a,b) "ECAMX_BUSX_SDIS"
#define device_bar_CAVM_ECAMX_BUSX_SDIS(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ECAMX_BUSX_SDIS(a,b) (a)
#define arguments_CAVM_ECAMX_BUSX_SDIS(a,b) (a),(b),-1,-1
 ...
 * ECAM Bus Secure Disable Registers
 */
union cavm_ecamx_busx_skill
{
    uint64_t u;
    struct cavm_ecamx_busx_skill_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ecamx_busx_skill_s cn; */
};
...
static inline uint64_t CAVM_ECAMX_BUSX_SKILL(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("ECAMX_BUSX_SKILL", 2, a, b, 0, 0);
}

#define typedef_CAVM_ECAMX_BUSX_SKILL(a,b) cavm_ecamx_busx_skill_t
#define bustype_CAVM_ECAMX_BUSX_SKILL(a,b) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_BUSX_SKILL(a,b) "ECAMX_BUSX_SKILL"
#define device_bar_CAVM_ECAMX_BUSX_SKILL(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ECAMX_BUSX_SKILL(a,b) (a)
#define arguments_CAVM_ECAMX_BUSX_SKILL(a,b) (a),(b),-1,-1
...
static inline uint64_t CAVM_ECAMX_CONST(unsigned long a)
{
    ...
    __cavm_csr_fatal("ECAMX_CONST", 1, a, 0, 0, 0);
}
 ...
 */
union cavm_ecamx_devx_nsdis
{
    uint64_t u;
    struct cavm_ecamx_devx_nsdis_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ecamx_devx_nsdis_s cn; */
};
...
static inline uint64_t CAVM_ECAMX_DEVX_NSDIS(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a<=1) && (b<=31)))
        return 0x87e048070000ll + 0x1000000ll * ((a) & 0x1) + 8ll * ((b) & 0x1f);
    __cavm_csr_fatal("ECAMX_DEVX_NSDIS", 2, a, b, 0, 0);
}

#define typedef_CAVM_ECAMX_DEVX_NSDIS(a,b) cavm_ecamx_devx_nsdis_t
#define bustype_CAVM_ECAMX_DEVX_NSDIS(a,b) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_DEVX_NSDIS(a,b) "ECAMX_DEVX_NSDIS"
#define device_bar_CAVM_ECAMX_DEVX_NSDIS(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ECAMX_DEVX_NSDIS(a,b) (a)
#define arguments_CAVM_ECAMX_DEVX_NSDIS(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ecamx_devx_sdis
{
    uint64_t u;
    struct cavm_ecamx_devx_sdis_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
    ...
    /* struct cavm_ecamx_devx_sdis_s cn; */
};
...
static inline uint64_t CAVM_ECAMX_DEVX_SDIS(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("ECAMX_DEVX_SDIS", 2, a, b, 0, 0);
}

#define typedef_CAVM_ECAMX_DEVX_SDIS(a,b) cavm_ecamx_devx_sdis_t
#define bustype_CAVM_ECAMX_DEVX_SDIS(a,b) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_DEVX_SDIS(a,b) "ECAMX_DEVX_SDIS"
#define device_bar_CAVM_ECAMX_DEVX_SDIS(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ECAMX_DEVX_SDIS(a,b) (a)
#define arguments_CAVM_ECAMX_DEVX_SDIS(a,b) (a),(b),-1,-1
 ...
 * ECAM Device Secure Disable Registers
 */
union cavm_ecamx_devx_skill
{
    uint64_t u;
    struct cavm_ecamx_devx_skill_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ecamx_devx_skill_s cn; */
};
...
static inline uint64_t CAVM_ECAMX_DEVX_SKILL(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("ECAMX_DEVX_SKILL", 2, a, b, 0, 0);
}

#define typedef_CAVM_ECAMX_DEVX_SKILL(a,b) cavm_ecamx_devx_skill_t
#define bustype_CAVM_ECAMX_DEVX_SKILL(a,b) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_DEVX_SKILL(a,b) "ECAMX_DEVX_SKILL"
#define device_bar_CAVM_ECAMX_DEVX_SKILL(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ECAMX_DEVX_SKILL(a,b) (a)
#define arguments_CAVM_ECAMX_DEVX_SKILL(a,b) (a),(b),-1,-1
...
static inline uint64_t CAVM_ECAMX_DOMX_BUSX_PERMIT(unsigned long a, unsigned long b, unsigned long c)
{
    ...
    __cavm_csr_fatal("ECAMX_DOMX_BUSX_PERMIT", 3, a, b, c, 0);
}
...
static inline uint64_t CAVM_ECAMX_DOMX_CONST(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("ECAMX_DOMX_CONST", 2, a, b, 0, 0);
}
...
static inline uint64_t CAVM_ECAMX_DOMX_DEVX_PERMIT(unsigned long a, unsigned long b, unsigned long c)
{
    ...
    __cavm_csr_fatal("ECAMX_DOMX_DEVX_PERMIT", 3, a, b, c, 0);
}
...
static inline uint64_t CAVM_ECAMX_DOMX_RSLX_PERMIT(unsigned long a, unsigned long b, unsigned long c)
{
    ...
    __cavm_csr_fatal("ECAMX_DOMX_RSLX_PERMIT", 3, a, b, c, 0);
}
 ...
 */
union cavm_ecamx_nop_of
{
    uint64_t u;
    struct cavm_ecamx_nop_of_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_ECAMX_NOP_OF(unsigned long a)
{
    ...
    __cavm_csr_fatal("ECAMX_NOP_OF", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ECAMX_NOP_OF(a) cavm_ecamx_nop_of_t
#define bustype_CAVM_ECAMX_NOP_OF(a) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_NOP_OF(a) "ECAMX_NOP_OF"
#define device_bar_CAVM_ECAMX_NOP_OF(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ECAMX_NOP_OF(a) (a)
#define arguments_CAVM_ECAMX_NOP_OF(a) (a),-1,-1,-1
 ...
 */
union cavm_ecamx_nop_onf
{
    uint64_t u;
    struct cavm_ecamx_nop_onf_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t ones                  : 64; /**< [ 63:  0](RO) Used internally to handle disabled read/write transactions. */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_ecamx_nop_onf_s cn; */
};
...
static inline uint64_t CAVM_ECAMX_NOP_ONF(unsigned long a)
{
    ...
    __cavm_csr_fatal("ECAMX_NOP_ONF", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ECAMX_NOP_ONF(a) cavm_ecamx_nop_onf_t
#define bustype_CAVM_ECAMX_NOP_ONF(a) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_NOP_ONF(a) "ECAMX_NOP_ONF"
#define device_bar_CAVM_ECAMX_NOP_ONF(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ECAMX_NOP_ONF(a) (a)
#define arguments_CAVM_ECAMX_NOP_ONF(a) (a),-1,-1,-1
 ...
 */
union cavm_ecamx_nop_zf
{
    uint64_t u;
    struct cavm_ecamx_nop_zf_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_ECAMX_NOP_ZF(unsigned long a)
{
    ...
    __cavm_csr_fatal("ECAMX_NOP_ZF", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ECAMX_NOP_ZF(a) cavm_ecamx_nop_zf_t
#define bustype_CAVM_ECAMX_NOP_ZF(a) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_NOP_ZF(a) "ECAMX_NOP_ZF"
#define device_bar_CAVM_ECAMX_NOP_ZF(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ECAMX_NOP_ZF(a) (a)
#define arguments_CAVM_ECAMX_NOP_ZF(a) (a),-1,-1,-1
 ...
 */
union cavm_ecamx_nop_znf
{
    uint64_t u;
    struct cavm_ecamx_nop_znf_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t zeros                 : 64; /**< [ 63:  0](RO) Used internally to handle disabled read/write transactions. */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_ecamx_nop_znf_s cn; */
};
...
static inline uint64_t CAVM_ECAMX_NOP_ZNF(unsigned long a)
{
    ...
    __cavm_csr_fatal("ECAMX_NOP_ZNF", 1, a, 0, 0, 0);
}

#define typedef_CAVM_ECAMX_NOP_ZNF(a) cavm_ecamx_nop_znf_t
#define bustype_CAVM_ECAMX_NOP_ZNF(a) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_NOP_ZNF(a) "ECAMX_NOP_ZNF"
#define device_bar_CAVM_ECAMX_NOP_ZNF(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ECAMX_NOP_ZNF(a) (a)
#define arguments_CAVM_ECAMX_NOP_ZNF(a) (a),-1,-1,-1
 ...
 */
union cavm_ecamx_rslx_nsdis
{
    uint64_t u;
    struct cavm_ecamx_rslx_nsdis_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ecamx_rslx_nsdis_s cn; */
};
...
static inline uint64_t CAVM_ECAMX_RSLX_NSDIS(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("ECAMX_RSLX_NSDIS", 2, a, b, 0, 0);
}

#define typedef_CAVM_ECAMX_RSLX_NSDIS(a,b) cavm_ecamx_rslx_nsdis_t
#define bustype_CAVM_ECAMX_RSLX_NSDIS(a,b) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_RSLX_NSDIS(a,b) "ECAMX_RSLX_NSDIS"
#define device_bar_CAVM_ECAMX_RSLX_NSDIS(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ECAMX_RSLX_NSDIS(a,b) (a)
#define arguments_CAVM_ECAMX_RSLX_NSDIS(a,b) (a),(b),-1,-1
 ...
 * This register is only implemented for ECAM0 which sources RSL.
 */
union cavm_ecamx_rslx_sdis
{
    uint64_t u;
    struct cavm_ecamx_rslx_sdis_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_2_63         : 62;
    ...
    /* struct cavm_ecamx_rslx_sdis_s cn; */
};
...
static inline uint64_t CAVM_ECAMX_RSLX_SDIS(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("ECAMX_RSLX_SDIS", 2, a, b, 0, 0);
}

#define typedef_CAVM_ECAMX_RSLX_SDIS(a,b) cavm_ecamx_rslx_sdis_t
#define bustype_CAVM_ECAMX_RSLX_SDIS(a,b) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_RSLX_SDIS(a,b) "ECAMX_RSLX_SDIS"
#define device_bar_CAVM_ECAMX_RSLX_SDIS(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_ECAMX_RSLX_SDIS(a,b) (a)
#define arguments_CAVM_ECAMX_RSLX_SDIS(a,b) (a),(b),-1,-1
 ...
 * This register is only implemented for ECAM0 which sources RSL.
 */
union cavm_ecamx_rslx_skill
{
    uint64_t u;
    struct cavm_ecamx_rslx_skill_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ecamx_rslx_skill_s cn; */
};
...
static inline uint64_t CAVM_ECAMX_RSLX_SKILL(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("ECAMX_RSLX_SKILL", 2, a, b, 0, 0);
}

#define typedef_CAVM_ECAMX_RSLX_SKILL(a,b) cavm_ecamx_rslx_skill_t
#define bustype_CAVM_ECAMX_RSLX_SKILL(a,b) CSR_TYPE_RSL
#define basename_CAVM_ECAMX_RSLX_SKILL(a,b) "ECAMX_RSLX_SKILL"
...
static inline uint64_t CAVM_ECAMX_SCRATCH(unsigned long a)
{
    ...
    __cavm_csr_fatal("ECAMX_SCRATCH", 1, a, 0, 0, 0);
}
