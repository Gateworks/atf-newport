 ...
 */
#define CAVM_MIO_TWS_BAR_E_MIO_TWSX_PF_BAR0_CN8(a) (0x87e0d0000000ll + 0x1000000ll * (a))
#define CAVM_MIO_TWS_BAR_E_MIO_TWSX_PF_BAR0_CN8_SIZE 0x800000ull
#define CAVM_MIO_TWS_BAR_E_MIO_TWSX_PF_BAR0_CN9(a) (0x87e0d0000000ll + 0x1000000ll * (a))
#define CAVM_MIO_TWS_BAR_E_MIO_TWSX_PF_BAR0_CN9_SIZE 0x10000ull
 ...
 */
union cavm_mio_twsx_access_wdog
{
    uint64_t u;
    struct cavm_mio_twsx_access_wdog_s
    {
    ...
    /* struct cavm_mio_twsx_access_wdog_s cn; */
};
typedef union cavm_mio_twsx_access_wdog cavm_mio_twsx_access_wdog_t;

static inline uint64_t CAVM_MIO_TWSX_ACCESS_WDOG(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_TWSX_ACCESS_WDOG(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=5))
        return 0x87e0d0001040ll + 0x1000000ll * ((a) & 0x7);
    __cavm_csr_fatal("MIO_TWSX_ACCESS_WDOG", 1, a, 0, 0, 0);
}

#define typedef_CAVM_MIO_TWSX_ACCESS_WDOG(a) cavm_mio_twsx_access_wdog_t
#define bustype_CAVM_MIO_TWSX_ACCESS_WDOG(a) CSR_TYPE_RSL
#define basename_CAVM_MIO_TWSX_ACCESS_WDOG(a) "MIO_TWSX_ACCESS_WDOG"
#define device_bar_CAVM_MIO_TWSX_ACCESS_WDOG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_TWSX_ACCESS_WDOG(a) (a)
#define arguments_CAVM_MIO_TWSX_ACCESS_WDOG(a) (a),-1,-1,-1
 ...
 */
union cavm_mio_twsx_clken
{
    uint64_t u;
    struct cavm_mio_twsx_clken_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mio_twsx_clken_s cn; */
};
typedef union cavm_mio_twsx_clken cavm_mio_twsx_clken_t;

static inline uint64_t CAVM_MIO_TWSX_CLKEN(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_TWSX_CLKEN(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=5))
        return 0x87e0d0001078ll + 0x1000000ll * ((a) & 0x7);
    __cavm_csr_fatal("MIO_TWSX_CLKEN", 1, a, 0, 0, 0);
}

#define typedef_CAVM_MIO_TWSX_CLKEN(a) cavm_mio_twsx_clken_t
#define bustype_CAVM_MIO_TWSX_CLKEN(a) CSR_TYPE_RSL
#define basename_CAVM_MIO_TWSX_CLKEN(a) "MIO_TWSX_CLKEN"
#define device_bar_CAVM_MIO_TWSX_CLKEN(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_TWSX_CLKEN(a) (a)
#define arguments_CAVM_MIO_TWSX_CLKEN(a) (a),-1,-1,-1
 ...
 */
union cavm_mio_twsx_const
{
    uint64_t u;
    struct cavm_mio_twsx_const_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mio_twsx_const_s cn; */
};
typedef union cavm_mio_twsx_const cavm_mio_twsx_const_t;

static inline uint64_t CAVM_MIO_TWSX_CONST(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_TWSX_CONST(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=5))
        return 0x87e0d0000000ll + 0x1000000ll * ((a) & 0x7);
    __cavm_csr_fatal("MIO_TWSX_CONST", 1, a, 0, 0, 0);
}

#define typedef_CAVM_MIO_TWSX_CONST(a) cavm_mio_twsx_const_t
#define bustype_CAVM_MIO_TWSX_CONST(a) CSR_TYPE_RSL
#define basename_CAVM_MIO_TWSX_CONST(a) "MIO_TWSX_CONST"
#define device_bar_CAVM_MIO_TWSX_CONST(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_TWSX_CONST(a) (a)
#define arguments_CAVM_MIO_TWSX_CONST(a) (a),-1,-1,-1
...
union cavm_mio_twsx_int_ena_w1c
{
    ...
    struct cavm_mio_twsx_int_ena_w1c_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mio_twsx_int_ena_w1c_s cn9; */
};
...
union cavm_mio_twsx_int_ena_w1s
{
    ...
    struct cavm_mio_twsx_int_ena_w1s_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_3_63         : 61;
        uint64_t core_int              : 1;  /**< [  2:  2](R/W1S/H) Enables reporting of MIO_TWS()_INT[CORE_INT]. */
    ...
    /* struct cavm_mio_twsx_int_ena_w1s_s cn9; */
};
...
union cavm_mio_twsx_int_w1s
{
    ...
    struct cavm_mio_twsx_int_w1s_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_3_63         : 61;
        uint64_t core_int              : 1;  /**< [  2:  2](RO/H) Reads MIO_TWS()_INT[CORE_INT]. */
    ...
    /* struct cavm_mio_twsx_int_w1s_s cn9; */
};
...
union cavm_mio_twsx_io_ctl
{
    ...
    /* struct cavm_mio_twsx_io_ctl_s cn; */
};
typedef union cavm_mio_twsx_io_ctl cavm_mio_twsx_io_ctl_t;

static inline uint64_t CAVM_MIO_TWSX_IO_CTL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_TWSX_IO_CTL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=5))
        return 0x87e0d0001070ll + 0x1000000ll * ((a) & 0x7);
    __cavm_csr_fatal("MIO_TWSX_IO_CTL", 1, a, 0, 0, 0);
}

#define typedef_CAVM_MIO_TWSX_IO_CTL(a) cavm_mio_twsx_io_ctl_t
#define bustype_CAVM_MIO_TWSX_IO_CTL(a) CSR_TYPE_RSL
#define basename_CAVM_MIO_TWSX_IO_CTL(a) "MIO_TWSX_IO_CTL"
#define device_bar_CAVM_MIO_TWSX_IO_CTL(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_TWSX_IO_CTL(a) (a)
#define arguments_CAVM_MIO_TWSX_IO_CTL(a) (a),-1,-1,-1
...
static inline uint64_t CAVM_MIO_TWSX_MSIX_PBAX(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_CN9XXX) && ((a<=5) && (b==0)))
...
union cavm_mio_twsx_msix_vecx_addr
{
    ...
    struct cavm_mio_twsx_msix_vecx_addr_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
union cavm_mio_twsx_msix_vecx_ctl
{
    ...
    struct cavm_mio_twsx_msix_vecx_ctl_cn8
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_33_63        : 31;
        uint64_t mask                  : 1;  /**< [ 32: 32](R/W) When set, no MSI-X interrupts will be sent to this vector. */
    ...
    /* struct cavm_mio_twsx_msix_vecx_ctl_s cn9; */
};
...
union cavm_mio_twsx_sw_twsi
{
    ...
    /* struct cavm_mio_twsx_sw_twsi_s cn8; */
    struct cavm_mio_twsx_sw_twsi_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t v                     : 1;  /**< [ 63: 63](RC/W/H) Valid bit. Set on a write operation (should always be written with a 1). Cleared when a
                                                                 TWSI master-mode operation completes, a TWSI configuration register access completes, or
 ...
 */
union cavm_mio_twsx_tstamp_rx
{
    uint64_t u;
    struct cavm_mio_twsx_tstamp_rx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mio_twsx_tstamp_rx_s cn; */
};
typedef union cavm_mio_twsx_tstamp_rx cavm_mio_twsx_tstamp_rx_t;

static inline uint64_t CAVM_MIO_TWSX_TSTAMP_RX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_TWSX_TSTAMP_RX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=5))
        return 0x87e0d0001068ll + 0x1000000ll * ((a) & 0x7);
    __cavm_csr_fatal("MIO_TWSX_TSTAMP_RX", 1, a, 0, 0, 0);
}

#define typedef_CAVM_MIO_TWSX_TSTAMP_RX(a) cavm_mio_twsx_tstamp_rx_t
#define bustype_CAVM_MIO_TWSX_TSTAMP_RX(a) CSR_TYPE_RSL
#define basename_CAVM_MIO_TWSX_TSTAMP_RX(a) "MIO_TWSX_TSTAMP_RX"
#define device_bar_CAVM_MIO_TWSX_TSTAMP_RX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_TWSX_TSTAMP_RX(a) (a)
#define arguments_CAVM_MIO_TWSX_TSTAMP_RX(a) (a),-1,-1,-1
 ...
 * SCL falling edge. This function is only supported in non-block mode.
 */
union cavm_mio_twsx_tstamp_tx
{
    uint64_t u;
    struct cavm_mio_twsx_tstamp_tx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t nanosec               : 64; /**< [ 63:  0](RO/H) Timestamp in nanoseconds. */
#else /* Word 0 - Little Endian */
    ...
    /* struct cavm_mio_twsx_tstamp_tx_s cn; */
};
typedef union cavm_mio_twsx_tstamp_tx cavm_mio_twsx_tstamp_tx_t;

static inline uint64_t CAVM_MIO_TWSX_TSTAMP_TX(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_TWSX_TSTAMP_TX(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=5))
        return 0x87e0d0001060ll + 0x1000000ll * ((a) & 0x7);
    __cavm_csr_fatal("MIO_TWSX_TSTAMP_TX", 1, a, 0, 0, 0);
}

#define typedef_CAVM_MIO_TWSX_TSTAMP_TX(a) cavm_mio_twsx_tstamp_tx_t
#define bustype_CAVM_MIO_TWSX_TSTAMP_TX(a) CSR_TYPE_RSL
#define basename_CAVM_MIO_TWSX_TSTAMP_TX(a) "MIO_TWSX_TSTAMP_TX"
#define device_bar_CAVM_MIO_TWSX_TSTAMP_TX(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_TWSX_TSTAMP_TX(a) (a)
#define arguments_CAVM_MIO_TWSX_TSTAMP_TX(a) (a),-1,-1,-1
 ...
 */
union cavm_mio_twsx_twsi_block_ctl
{
    uint64_t u;
    struct cavm_mio_twsx_twsi_block_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_33_63        : 31;
...
static inline uint64_t CAVM_MIO_TWSX_TWSI_BLOCK_CTL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_TWSX_TWSI_BLOCK_CTL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=5))
        return 0x87e0d0001048ll + 0x1000000ll * ((a) & 0x7);
    __cavm_csr_fatal("MIO_TWSX_TWSI_BLOCK_CTL", 1, a, 0, 0, 0);
}

#define typedef_CAVM_MIO_TWSX_TWSI_BLOCK_CTL(a) cavm_mio_twsx_twsi_block_ctl_t
#define bustype_CAVM_MIO_TWSX_TWSI_BLOCK_CTL(a) CSR_TYPE_RSL
#define basename_CAVM_MIO_TWSX_TWSI_BLOCK_CTL(a) "MIO_TWSX_TWSI_BLOCK_CTL"
#define device_bar_CAVM_MIO_TWSX_TWSI_BLOCK_CTL(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_TWSX_TWSI_BLOCK_CTL(a) (a)
#define arguments_CAVM_MIO_TWSX_TWSI_BLOCK_CTL(a) (a),-1,-1,-1
 ...
 */
union cavm_mio_twsx_twsi_block_fifo
{
    uint64_t u;
    struct cavm_mio_twsx_twsi_block_fifo_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mio_twsx_twsi_block_fifo_s cn; */
};
typedef union cavm_mio_twsx_twsi_block_fifo cavm_mio_twsx_twsi_block_fifo_t;

static inline uint64_t CAVM_MIO_TWSX_TWSI_BLOCK_FIFO(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_TWSX_TWSI_BLOCK_FIFO(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=5))
        return 0x87e0d0001058ll + 0x1000000ll * ((a) & 0x7);
    __cavm_csr_fatal("MIO_TWSX_TWSI_BLOCK_FIFO", 1, a, 0, 0, 0);
}

#define typedef_CAVM_MIO_TWSX_TWSI_BLOCK_FIFO(a) cavm_mio_twsx_twsi_block_fifo_t
#define bustype_CAVM_MIO_TWSX_TWSI_BLOCK_FIFO(a) CSR_TYPE_RSL
#define basename_CAVM_MIO_TWSX_TWSI_BLOCK_FIFO(a) "MIO_TWSX_TWSI_BLOCK_FIFO"
#define device_bar_CAVM_MIO_TWSX_TWSI_BLOCK_FIFO(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_TWSX_TWSI_BLOCK_FIFO(a) (a)
#define arguments_CAVM_MIO_TWSX_TWSI_BLOCK_FIFO(a) (a),-1,-1,-1
...
{
    uint64_t u;
    struct cavm_mio_twsx_twsi_block_sts_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_mio_twsx_twsi_block_sts_s cn; */
};
typedef union cavm_mio_twsx_twsi_block_sts cavm_mio_twsx_twsi_block_sts_t;

static inline uint64_t CAVM_MIO_TWSX_TWSI_BLOCK_STS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_MIO_TWSX_TWSI_BLOCK_STS(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN9XXX) && (a<=5))
        return 0x87e0d0001050ll + 0x1000000ll * ((a) & 0x7);
    __cavm_csr_fatal("MIO_TWSX_TWSI_BLOCK_STS", 1, a, 0, 0, 0);
}

#define typedef_CAVM_MIO_TWSX_TWSI_BLOCK_STS(a) cavm_mio_twsx_twsi_block_sts_t
#define bustype_CAVM_MIO_TWSX_TWSI_BLOCK_STS(a) CSR_TYPE_RSL
#define basename_CAVM_MIO_TWSX_TWSI_BLOCK_STS(a) "MIO_TWSX_TWSI_BLOCK_STS"
#define device_bar_CAVM_MIO_TWSX_TWSI_BLOCK_STS(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_MIO_TWSX_TWSI_BLOCK_STS(a) (a)
#define arguments_CAVM_MIO_TWSX_TWSI_BLOCK_STS(a) (a),-1,-1,-1
...
union cavm_mio_twsx_twsi_sw
{
    ...
    /* struct cavm_mio_twsx_twsi_sw_s cn8; */
    struct cavm_mio_twsx_twsi_sw_cn9
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t v                     : 2;  /**< [ 63: 62](RC/W/H) Valid bits. These bits are not directly writable. They are set to 11 on any write
                                                                 operation by the TWSI device. They are cleared to 00 on any read operation by software. */
