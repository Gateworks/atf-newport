#ifndef __CAVM_CSRS_DDF_H__
#define __CAVM_CSRS_DDF_H__
 ...
 */
#define CAVM_DDF_BAR_E_DDFX_PF_BAR0(a) (0x809000000000ll + 0ll * (a))
#define CAVM_DDF_BAR_E_DDFX_PF_BAR0_SIZE 0x10000000ull
#define CAVM_DDF_BAR_E_DDFX_PF_BAR4(a) (0x809010000000ll + 0ll * (a))
#define CAVM_DDF_BAR_E_DDFX_PF_BAR4_SIZE 0x100000ull
#define CAVM_DDF_BAR_E_DDFX_VFX_BAR0(a,b) (0x809020000000ll + 0ll * (a) + 0x100000ll * (b))
#define CAVM_DDF_BAR_E_DDFX_VFX_BAR0_SIZE 0x100000ull
#define CAVM_DDF_BAR_E_DDFX_VFX_BAR4(a,b) (0x809030000000ll + 0ll * (a) + 0x100000ll * (b))
#define CAVM_DDF_BAR_E_DDFX_VFX_BAR4_SIZE 0x100000ull
 ...
 */
#define CAVM_DDF_CACPART_E_EVEN (1)
#define CAVM_DDF_CACPART_E_GANG (3)
#define CAVM_DDF_CACPART_E_NONE (0)
#define CAVM_DDF_CACPART_E_NONGANG (2)
 ...
 */
#define CAVM_DDF_COMP_E_FAULT (2)
#define CAVM_DDF_COMP_E_FILTER_TOO_BIG (5)
#define CAVM_DDF_COMP_E_FULL (3)
#define CAVM_DDF_COMP_E_GOOD (1)
#define CAVM_DDF_COMP_E_HDR_ALIGN (0xf)
#define CAVM_DDF_COMP_E_HDR_LT_NEST (8)
#define CAVM_DDF_COMP_E_HDR_TOO_BIG (6)
#define CAVM_DDF_COMP_E_ILLEGAL_OPCODE (0x12)
#define CAVM_DDF_COMP_E_ILLEGAL_QWORDS (4)
#define CAVM_DDF_COMP_E_KEY_GT_NEST (9)
#define CAVM_DDF_COMP_E_KEY_SIZE (0xa)
#define CAVM_DDF_COMP_E_NOTDONE (0)
#define CAVM_DDF_COMP_E_NO_HDR (0xc)
#define CAVM_DDF_COMP_E_NO_RANK (0xb)
#define CAVM_DDF_COMP_E_NO_RB (0xd)
#define CAVM_DDF_COMP_E_RANK_ALIGN (0xe)
#define CAVM_DDF_COMP_E_RB_ALIGN (0x10)
#define CAVM_DDF_COMP_E_RES_ALIGN (0x11)
#define CAVM_DDF_COMP_E_WAY_TOO_BIG (7)
 ...
 */
#define CAVM_DDF_OP_E_FABS_SET (0x18)
#define CAVM_DDF_OP_E_FEMPTY_INS (0x1f)
#define CAVM_DDF_OP_E_FIND (0x10)
#define CAVM_DDF_OP_E_FIND_DEL (0x13)
#define CAVM_DDF_OP_E_FIND_INS (0x12)
#define CAVM_DDF_OP_E_FIND_SET (0x11)
#define CAVM_DDF_OP_E_MATCH (0x20)
#define CAVM_DDF_OP_E_MATCH_DEL (0x23)
#define CAVM_DDF_OP_E_MATCH_INS (0x22)
#define CAVM_DDF_OP_E_MATCH_SET (0x21)
#define CAVM_DDF_OP_E_NOP (0)
#define CAVM_DDF_OP_E_RABS_SET (0x28)
#define CAVM_DDF_OP_E_REMPTY_INS (0x2f)
 ...
 */
#define CAVM_DDF_PF_INT_VEC_E_ECC0 (0)
#define CAVM_DDF_PF_INT_VEC_E_MBOXX(a) (3 + (a))
#define CAVM_DDF_PF_INT_VEC_E_NOINT0 (1)
#define CAVM_DDF_PF_INT_VEC_E_NOINT1 (2)
 ...
 */
#define CAVM_DDF_RAMS_E_COMP_FIFO (0xf)
#define CAVM_DDF_RAMS_E_CQM_BPTR (3)
#define CAVM_DDF_RAMS_E_CQM_CTLMEM (2)
#define CAVM_DDF_RAMS_E_CQM_DONE_CNT (0xd)
#define CAVM_DDF_RAMS_E_CQM_DONE_TIMER (0xe)
#define CAVM_DDF_RAMS_E_CQM_GMID (4)
#define CAVM_DDF_RAMS_E_CQM_INSTFIF0 (5)
#define CAVM_DDF_RAMS_E_CQM_INSTFIF1 (6)
#define CAVM_DDF_RAMS_E_CQM_INSTFIF2 (7)
#define CAVM_DDF_RAMS_E_CQM_INSTFIF3 (8)
#define CAVM_DDF_RAMS_E_CQM_INSTFIF4 (9)
#define CAVM_DDF_RAMS_E_CQM_INSTFIF5 (0xa)
#define CAVM_DDF_RAMS_E_CQM_INSTFIF6 (0xb)
#define CAVM_DDF_RAMS_E_CQM_INSTFIF7 (0xc)
#define CAVM_DDF_RAMS_E_DMEM0 (0x12)
#define CAVM_DDF_RAMS_E_DMEM1 (0x13)
#define CAVM_DDF_RAMS_E_FPA_MEM (0x11)
#define CAVM_DDF_RAMS_E_LFIFO0 (0x14)
#define CAVM_DDF_RAMS_E_LFIFO1 (0x15)
#define CAVM_DDF_RAMS_E_MBOX_MEM (0x10)
#define CAVM_DDF_RAMS_E_MSIX_VMEM (0x16)
#define CAVM_DDF_RAMS_E_NCBI_DATFIF (0)
#define CAVM_DDF_RAMS_E_NCBO_MEM0 (1)
 ...
 */
#define CAVM_DDF_RES_TYPE_E_FIND (1)
#define CAVM_DDF_RES_TYPE_E_MATCH (2)
#define CAVM_DDF_RES_TYPE_E_NOP (0)
 ...
 * Enumerates the MSI-X interrupt vectors.
 */
#define CAVM_DDF_VF_INT_VEC_E_DONE (1)
#define CAVM_DDF_VF_INT_VEC_E_MISC (0)
 ...
 */
union cavm_ddf_inst_find_s
{
    uint64_t u[16];
    struct cavm_ddf_inst_find_s_s
    {
    ...
    /* struct cavm_ddf_inst_find_s_s cn; */
};
 ...
 */
union cavm_ddf_inst_match_s
{
    uint64_t u[16];
    struct cavm_ddf_inst_match_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    struct cavm_ddf_inst_match_s_cn
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t nrec                  : 16; /**< [ 63: 48] Number of records to compare.
                                                                 Typically the same as the number of records in a record block.
...
union cavm_ddf_res_find_s
{
    ...
    /* struct cavm_ddf_res_find_s_s cn; */
};
...
union cavm_ddf_res_match_s
{
    ...
    struct cavm_ddf_res_match_s_cn
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t hitrec                : 16; /**< [ 63: 48] Hit record. Record number in which the key was found or inserted into.
...
static inline uint64_t CAVM_DDFX_CQM_CORE_OBS0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_CQM_CORE_OBS0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x8090000001a0ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_CQM_CORE_OBS0", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DDFX_CQM_CORE_OBS1(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_CQM_CORE_OBS1(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x8090000001a8ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_CQM_CORE_OBS1", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DDFX_NCBI_OBS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_NCBI_OBS(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000190ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_NCBI_OBS", 1, a, 0, 0, 0);
}
 ...
 */
union cavm_ddfx_pf_active_cycles_pc
{
    uint64_t u;
...
typedef union cavm_ddfx_pf_active_cycles_pc cavm_ddfx_pf_active_cycles_pc_t;

static inline uint64_t CAVM_DDFX_PF_ACTIVE_CYCLES_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_ACTIVE_CYCLES_PC(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000010100ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_ACTIVE_CYCLES_PC", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_ACTIVE_CYCLES_PC(a) cavm_ddfx_pf_active_cycles_pc_t
#define bustype_CAVM_DDFX_PF_ACTIVE_CYCLES_PC(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_ACTIVE_CYCLES_PC(a) "DDFX_PF_ACTIVE_CYCLES_PC"
#define device_bar_CAVM_DDFX_PF_ACTIVE_CYCLES_PC(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_ACTIVE_CYCLES_PC(a) (a)
#define arguments_CAVM_DDFX_PF_ACTIVE_CYCLES_PC(a) (a),-1,-1,-1
 ...
 */
union cavm_ddfx_pf_bist_status
{
    uint64_t u;
    struct cavm_ddfx_pf_bist_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_bist_status_s cn; */
};
typedef union cavm_ddfx_pf_bist_status cavm_ddfx_pf_bist_status_t;

static inline uint64_t CAVM_DDFX_PF_BIST_STATUS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_BIST_STATUS(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000160ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_BIST_STATUS", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_BIST_STATUS(a) cavm_ddfx_pf_bist_status_t
#define bustype_CAVM_DDFX_PF_BIST_STATUS(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_BIST_STATUS(a) "DDFX_PF_BIST_STATUS"
...
static inline uint64_t CAVM_DDFX_PF_BP_TEST(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_BP_TEST(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000180ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_BP_TEST", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DDFX_PF_BP_TEST0(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_BP_TEST0(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809008001200ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_BP_TEST0", 1, a, 0, 0, 0);
}
 ...
 */
union cavm_ddfx_pf_cac_miss_pc
{
    uint64_t u;
    struct cavm_ddfx_pf_cac_miss_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_cac_miss_pc_s cn; */
};
typedef union cavm_ddfx_pf_cac_miss_pc cavm_ddfx_pf_cac_miss_pc_t;

static inline uint64_t CAVM_DDFX_PF_CAC_MISS_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_CAC_MISS_PC(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000620ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_CAC_MISS_PC", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_CAC_MISS_PC(a) cavm_ddfx_pf_cac_miss_pc_t
#define bustype_CAVM_DDFX_PF_CAC_MISS_PC(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_CAC_MISS_PC(a) "DDFX_PF_CAC_MISS_PC"
#define device_bar_CAVM_DDFX_PF_CAC_MISS_PC(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_CAC_MISS_PC(a) (a)
#define arguments_CAVM_DDFX_PF_CAC_MISS_PC(a) (a),-1,-1,-1
 ...
 */
union cavm_ddfx_pf_constants
{
    uint64_t u;
    struct cavm_ddfx_pf_constants_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_constants_s cn; */
};
typedef union cavm_ddfx_pf_constants cavm_ddfx_pf_constants_t;

static inline uint64_t CAVM_DDFX_PF_CONSTANTS(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_CONSTANTS(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000000ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_CONSTANTS", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_CONSTANTS(a) cavm_ddfx_pf_constants_t
#define bustype_CAVM_DDFX_PF_CONSTANTS(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_CONSTANTS(a) "DDFX_PF_CONSTANTS"
#define device_bar_CAVM_DDFX_PF_CONSTANTS(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_CONSTANTS(a) (a)
#define arguments_CAVM_DDFX_PF_CONSTANTS(a) (a),-1,-1,-1
 ...
 */
union cavm_ddfx_pf_ctl
{
    uint64_t u;
    struct cavm_ddfx_pf_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_ctl_s cn; */
};
typedef union cavm_ddfx_pf_ctl cavm_ddfx_pf_ctl_t;

static inline uint64_t CAVM_DDFX_PF_CTL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_CTL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000600ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_CTL", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_CTL(a) cavm_ddfx_pf_ctl_t
#define bustype_CAVM_DDFX_PF_CTL(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_CTL(a) "DDFX_PF_CTL"
#define device_bar_CAVM_DDFX_PF_CTL(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_CTL(a) (a)
#define arguments_CAVM_DDFX_PF_CTL(a) (a),-1,-1,-1
 ...
 * This register controls diagnostic features.
 */
union cavm_ddfx_pf_ctl2
{
    uint64_t u;
    struct cavm_ddfx_pf_ctl2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_ctl2_s cn; */
};
typedef union cavm_ddfx_pf_ctl2 cavm_ddfx_pf_ctl2_t;

static inline uint64_t CAVM_DDFX_PF_CTL2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_CTL2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000610ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_CTL2", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_CTL2(a) cavm_ddfx_pf_ctl2_t
#define bustype_CAVM_DDFX_PF_CTL2(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_CTL2(a) "DDFX_PF_CTL2"
#define device_bar_CAVM_DDFX_PF_CTL2(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_CTL2(a) (a)
#define arguments_CAVM_DDFX_PF_CTL2(a) (a),-1,-1,-1
 ...
 * This register controls diagnostic features.
 */
union cavm_ddfx_pf_diag
{
    uint64_t u;
    struct cavm_ddfx_pf_diag_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_diag_s cn; */
};
typedef union cavm_ddfx_pf_diag cavm_ddfx_pf_diag_t;

static inline uint64_t CAVM_DDFX_PF_DIAG(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_DIAG(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000120ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_DIAG", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_DIAG(a) cavm_ddfx_pf_diag_t
#define bustype_CAVM_DDFX_PF_DIAG(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_DIAG(a) "DDFX_PF_DIAG"
#define device_bar_CAVM_DDFX_PF_DIAG(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_DIAG(a) (a)
#define arguments_CAVM_DDFX_PF_DIAG(a) (a),-1,-1,-1
 ...
 * This register controls diagnostic features.
 */
union cavm_ddfx_pf_diag2
{
    uint64_t u;
    struct cavm_ddfx_pf_diag2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_ddfx_pf_diag2_s cn; */
};
typedef union cavm_ddfx_pf_diag2 cavm_ddfx_pf_diag2_t;

static inline uint64_t CAVM_DDFX_PF_DIAG2(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_DIAG2(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000630ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_DIAG2", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_DIAG2(a) cavm_ddfx_pf_diag2_t
#define bustype_CAVM_DDFX_PF_DIAG2(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_DIAG2(a) "DDFX_PF_DIAG2"
#define device_bar_CAVM_DDFX_PF_DIAG2(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_DIAG2(a) (a)
#define arguments_CAVM_DDFX_PF_DIAG2(a) (a),-1,-1,-1
 ...
 */
union cavm_ddfx_pf_diag_camx
{
    uint64_t u;
    struct cavm_ddfx_pf_diag_camx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_diag_camx_s cn; */
};
typedef union cavm_ddfx_pf_diag_camx cavm_ddfx_pf_diag_camx_t;

static inline uint64_t CAVM_DDFX_PF_DIAG_CAMX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_DIAG_CAMX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=127)))
        return 0x809000000800ll + 0ll * ((a) & 0x0) + 8ll * ((b) & 0x7f);
    __cavm_csr_fatal("DDFX_PF_DIAG_CAMX", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_PF_DIAG_CAMX(a,b) cavm_ddfx_pf_diag_camx_t
#define bustype_CAVM_DDFX_PF_DIAG_CAMX(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_DIAG_CAMX(a,b) "DDFX_PF_DIAG_CAMX"
#define device_bar_CAVM_DDFX_PF_DIAG_CAMX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_DIAG_CAMX(a,b) (a)
#define arguments_CAVM_DDFX_PF_DIAG_CAMX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_pf_diag_dmemx
{
    uint64_t u;
    struct cavm_ddfx_pf_diag_dmemx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_diag_dmemx_s cn; */
};
typedef union cavm_ddfx_pf_diag_dmemx cavm_ddfx_pf_diag_dmemx_t;

static inline uint64_t CAVM_DDFX_PF_DIAG_DMEMX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_DIAG_DMEMX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=2047)))
        return 0x809000004000ll + 0ll * ((a) & 0x0) + 8ll * ((b) & 0x7ff);
    __cavm_csr_fatal("DDFX_PF_DIAG_DMEMX", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_PF_DIAG_DMEMX(a,b) cavm_ddfx_pf_diag_dmemx_t
#define bustype_CAVM_DDFX_PF_DIAG_DMEMX(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_DIAG_DMEMX(a,b) "DDFX_PF_DIAG_DMEMX"
#define device_bar_CAVM_DDFX_PF_DIAG_DMEMX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_DIAG_DMEMX(a,b) (a)
#define arguments_CAVM_DDFX_PF_DIAG_DMEMX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_pf_ecc0_ctl
{
    uint64_t u;
    struct cavm_ddfx_pf_ecc0_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_ddfx_pf_ecc0_ctl_s cn; */
};
typedef union cavm_ddfx_pf_ecc0_ctl cavm_ddfx_pf_ecc0_ctl_t;

static inline uint64_t CAVM_DDFX_PF_ECC0_CTL(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_ECC0_CTL(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000200ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_ECC0_CTL", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_ECC0_CTL(a) cavm_ddfx_pf_ecc0_ctl_t
#define bustype_CAVM_DDFX_PF_ECC0_CTL(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_ECC0_CTL(a) "DDFX_PF_ECC0_CTL"
#define device_bar_CAVM_DDFX_PF_ECC0_CTL(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_ECC0_CTL(a) (a)
#define arguments_CAVM_DDFX_PF_ECC0_CTL(a) (a),-1,-1,-1
 ...
 */
union cavm_ddfx_pf_ecc0_ena_w1c
{
    uint64_t u;
    struct cavm_ddfx_pf_ecc0_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_ecc0_ena_w1c_s cn; */
};
typedef union cavm_ddfx_pf_ecc0_ena_w1c cavm_ddfx_pf_ecc0_ena_w1c_t;

static inline uint64_t CAVM_DDFX_PF_ECC0_ENA_W1C(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_ECC0_ENA_W1C(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000250ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_ECC0_ENA_W1C", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_ECC0_ENA_W1C(a) cavm_ddfx_pf_ecc0_ena_w1c_t
#define bustype_CAVM_DDFX_PF_ECC0_ENA_W1C(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_ECC0_ENA_W1C(a) "DDFX_PF_ECC0_ENA_W1C"
#define device_bar_CAVM_DDFX_PF_ECC0_ENA_W1C(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_ECC0_ENA_W1C(a) (a)
#define arguments_CAVM_DDFX_PF_ECC0_ENA_W1C(a) (a),-1,-1,-1
 ...
 */
union cavm_ddfx_pf_ecc0_ena_w1s
{
    uint64_t u;
    struct cavm_ddfx_pf_ecc0_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_ecc0_ena_w1s_s cn; */
};
typedef union cavm_ddfx_pf_ecc0_ena_w1s cavm_ddfx_pf_ecc0_ena_w1s_t;

static inline uint64_t CAVM_DDFX_PF_ECC0_ENA_W1S(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_ECC0_ENA_W1S(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000240ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_ECC0_ENA_W1S", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_ECC0_ENA_W1S(a) cavm_ddfx_pf_ecc0_ena_w1s_t
#define bustype_CAVM_DDFX_PF_ECC0_ENA_W1S(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_ECC0_ENA_W1S(a) "DDFX_PF_ECC0_ENA_W1S"
#define device_bar_CAVM_DDFX_PF_ECC0_ENA_W1S(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_ECC0_ENA_W1S(a) (a)
#define arguments_CAVM_DDFX_PF_ECC0_ENA_W1S(a) (a),-1,-1,-1
 ...
 * purposes, it can also flip one or two bits in the ECC data.
 */
union cavm_ddfx_pf_ecc0_flip
{
    uint64_t u;
    struct cavm_ddfx_pf_ecc0_flip_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_ecc0_flip_s cn; */
};
typedef union cavm_ddfx_pf_ecc0_flip cavm_ddfx_pf_ecc0_flip_t;

static inline uint64_t CAVM_DDFX_PF_ECC0_FLIP(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_ECC0_FLIP(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000210ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_ECC0_FLIP", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_ECC0_FLIP(a) cavm_ddfx_pf_ecc0_flip_t
#define bustype_CAVM_DDFX_PF_ECC0_FLIP(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_ECC0_FLIP(a) "DDFX_PF_ECC0_FLIP"
#define device_bar_CAVM_DDFX_PF_ECC0_FLIP(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_ECC0_FLIP(a) (a)
#define arguments_CAVM_DDFX_PF_ECC0_FLIP(a) (a),-1,-1,-1
 ...
 */
union cavm_ddfx_pf_ecc0_int
{
    uint64_t u;
    struct cavm_ddfx_pf_ecc0_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_ecc0_int_s cn; */
};
typedef union cavm_ddfx_pf_ecc0_int cavm_ddfx_pf_ecc0_int_t;

static inline uint64_t CAVM_DDFX_PF_ECC0_INT(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_ECC0_INT(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000220ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_ECC0_INT", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_ECC0_INT(a) cavm_ddfx_pf_ecc0_int_t
#define bustype_CAVM_DDFX_PF_ECC0_INT(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_ECC0_INT(a) "DDFX_PF_ECC0_INT"
#define device_bar_CAVM_DDFX_PF_ECC0_INT(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_ECC0_INT(a) (a)
#define arguments_CAVM_DDFX_PF_ECC0_INT(a) (a),-1,-1,-1
 ...
 */
union cavm_ddfx_pf_ecc0_int_w1s
{
    uint64_t u;
    struct cavm_ddfx_pf_ecc0_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_ecc0_int_w1s_s cn; */
};
typedef union cavm_ddfx_pf_ecc0_int_w1s cavm_ddfx_pf_ecc0_int_w1s_t;

static inline uint64_t CAVM_DDFX_PF_ECC0_INT_W1S(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_ECC0_INT_W1S(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000230ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_ECC0_INT_W1S", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_ECC0_INT_W1S(a) cavm_ddfx_pf_ecc0_int_w1s_t
#define bustype_CAVM_DDFX_PF_ECC0_INT_W1S(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_ECC0_INT_W1S(a) "DDFX_PF_ECC0_INT_W1S"
#define device_bar_CAVM_DDFX_PF_ECC0_INT_W1S(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_ECC0_INT_W1S(a) (a)
...
static inline uint64_t CAVM_DDFX_PF_ECO(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_ECO(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000140ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_ECO", 1, a, 0, 0, 0);
}
 ...
 */
union cavm_ddfx_pf_inst_latency_pc
{
    uint64_t u;
    struct cavm_ddfx_pf_inst_latency_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_inst_latency_pc_s cn; */
};
typedef union cavm_ddfx_pf_inst_latency_pc cavm_ddfx_pf_inst_latency_pc_t;

static inline uint64_t CAVM_DDFX_PF_INST_LATENCY_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_INST_LATENCY_PC(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000010020ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_INST_LATENCY_PC", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_INST_LATENCY_PC(a) cavm_ddfx_pf_inst_latency_pc_t
#define bustype_CAVM_DDFX_PF_INST_LATENCY_PC(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_INST_LATENCY_PC(a) "DDFX_PF_INST_LATENCY_PC"
#define device_bar_CAVM_DDFX_PF_INST_LATENCY_PC(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_INST_LATENCY_PC(a) (a)
#define arguments_CAVM_DDFX_PF_INST_LATENCY_PC(a) (a),-1,-1,-1
 ...
 */
union cavm_ddfx_pf_inst_req_pc
{
    uint64_t u;
    struct cavm_ddfx_pf_inst_req_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_inst_req_pc_s cn; */
};
typedef union cavm_ddfx_pf_inst_req_pc cavm_ddfx_pf_inst_req_pc_t;

static inline uint64_t CAVM_DDFX_PF_INST_REQ_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_INST_REQ_PC(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000010000ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_INST_REQ_PC", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_INST_REQ_PC(a) cavm_ddfx_pf_inst_req_pc_t
#define bustype_CAVM_DDFX_PF_INST_REQ_PC(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_INST_REQ_PC(a) "DDFX_PF_INST_REQ_PC"
#define device_bar_CAVM_DDFX_PF_INST_REQ_PC(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_INST_REQ_PC(a) (a)
#define arguments_CAVM_DDFX_PF_INST_REQ_PC(a) (a),-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_ddfx_pf_mbox_ena_w1cx
{
    uint64_t u;
    struct cavm_ddfx_pf_mbox_ena_w1cx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_mbox_ena_w1cx_s cn; */
};
typedef union cavm_ddfx_pf_mbox_ena_w1cx cavm_ddfx_pf_mbox_ena_w1cx_t;

static inline uint64_t CAVM_DDFX_PF_MBOX_ENA_W1CX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_MBOX_ENA_W1CX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b==0)))
        return 0x809000000440ll + 0ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __cavm_csr_fatal("DDFX_PF_MBOX_ENA_W1CX", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_PF_MBOX_ENA_W1CX(a,b) cavm_ddfx_pf_mbox_ena_w1cx_t
#define bustype_CAVM_DDFX_PF_MBOX_ENA_W1CX(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_MBOX_ENA_W1CX(a,b) "DDFX_PF_MBOX_ENA_W1CX"
#define device_bar_CAVM_DDFX_PF_MBOX_ENA_W1CX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_MBOX_ENA_W1CX(a,b) (a)
#define arguments_CAVM_DDFX_PF_MBOX_ENA_W1CX(a,b) (a),(b),-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_ddfx_pf_mbox_ena_w1sx
{
    uint64_t u;
    struct cavm_ddfx_pf_mbox_ena_w1sx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_mbox_ena_w1sx_s cn; */
};
typedef union cavm_ddfx_pf_mbox_ena_w1sx cavm_ddfx_pf_mbox_ena_w1sx_t;

static inline uint64_t CAVM_DDFX_PF_MBOX_ENA_W1SX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_MBOX_ENA_W1SX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b==0)))
        return 0x809000000460ll + 0ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __cavm_csr_fatal("DDFX_PF_MBOX_ENA_W1SX", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_PF_MBOX_ENA_W1SX(a,b) cavm_ddfx_pf_mbox_ena_w1sx_t
#define bustype_CAVM_DDFX_PF_MBOX_ENA_W1SX(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_MBOX_ENA_W1SX(a,b) "DDFX_PF_MBOX_ENA_W1SX"
#define device_bar_CAVM_DDFX_PF_MBOX_ENA_W1SX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_MBOX_ENA_W1SX(a,b) (a)
#define arguments_CAVM_DDFX_PF_MBOX_ENA_W1SX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_pf_mbox_intx
{
    uint64_t u;
    struct cavm_ddfx_pf_mbox_intx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_mbox_intx_s cn; */
};
typedef union cavm_ddfx_pf_mbox_intx cavm_ddfx_pf_mbox_intx_t;

static inline uint64_t CAVM_DDFX_PF_MBOX_INTX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_MBOX_INTX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b==0)))
        return 0x809000000400ll + 0ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __cavm_csr_fatal("DDFX_PF_MBOX_INTX", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_PF_MBOX_INTX(a,b) cavm_ddfx_pf_mbox_intx_t
#define bustype_CAVM_DDFX_PF_MBOX_INTX(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_MBOX_INTX(a,b) "DDFX_PF_MBOX_INTX"
#define device_bar_CAVM_DDFX_PF_MBOX_INTX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_MBOX_INTX(a,b) (a)
#define arguments_CAVM_DDFX_PF_MBOX_INTX(a,b) (a),(b),-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_ddfx_pf_mbox_int_w1sx
{
    uint64_t u;
    struct cavm_ddfx_pf_mbox_int_w1sx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_mbox_int_w1sx_s cn; */
};
typedef union cavm_ddfx_pf_mbox_int_w1sx cavm_ddfx_pf_mbox_int_w1sx_t;

static inline uint64_t CAVM_DDFX_PF_MBOX_INT_W1SX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_MBOX_INT_W1SX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b==0)))
        return 0x809000000420ll + 0ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __cavm_csr_fatal("DDFX_PF_MBOX_INT_W1SX", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_PF_MBOX_INT_W1SX(a,b) cavm_ddfx_pf_mbox_int_w1sx_t
#define bustype_CAVM_DDFX_PF_MBOX_INT_W1SX(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_MBOX_INT_W1SX(a,b) "DDFX_PF_MBOX_INT_W1SX"
#define device_bar_CAVM_DDFX_PF_MBOX_INT_W1SX(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_MBOX_INT_W1SX(a,b) (a)
#define arguments_CAVM_DDFX_PF_MBOX_INT_W1SX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_pf_msix_pbax
{
    uint64_t u;
    struct cavm_ddfx_pf_msix_pbax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_msix_pbax_s cn; */
};
typedef union cavm_ddfx_pf_msix_pbax cavm_ddfx_pf_msix_pbax_t;

static inline uint64_t CAVM_DDFX_PF_MSIX_PBAX(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_MSIX_PBAX(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b==0)))
        return 0x8090100f0000ll + 0ll * ((a) & 0x0) + 8ll * ((b) & 0x0);
    __cavm_csr_fatal("DDFX_PF_MSIX_PBAX", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_PF_MSIX_PBAX(a,b) cavm_ddfx_pf_msix_pbax_t
#define bustype_CAVM_DDFX_PF_MSIX_PBAX(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_MSIX_PBAX(a,b) "DDFX_PF_MSIX_PBAX"
#define device_bar_CAVM_DDFX_PF_MSIX_PBAX(a,b) 0x4 /* PF_BAR4 */
#define busnum_CAVM_DDFX_PF_MSIX_PBAX(a,b) (a)
#define arguments_CAVM_DDFX_PF_MSIX_PBAX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_pf_msix_vecx_addr
{
    uint64_t u;
    struct cavm_ddfx_pf_msix_vecx_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_msix_vecx_addr_s cn; */
};
typedef union cavm_ddfx_pf_msix_vecx_addr cavm_ddfx_pf_msix_vecx_addr_t;

static inline uint64_t CAVM_DDFX_PF_MSIX_VECX_ADDR(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_MSIX_VECX_ADDR(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=3)))
        return 0x809010000000ll + 0ll * ((a) & 0x0) + 0x10ll * ((b) & 0x3);
    __cavm_csr_fatal("DDFX_PF_MSIX_VECX_ADDR", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_PF_MSIX_VECX_ADDR(a,b) cavm_ddfx_pf_msix_vecx_addr_t
#define bustype_CAVM_DDFX_PF_MSIX_VECX_ADDR(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_MSIX_VECX_ADDR(a,b) "DDFX_PF_MSIX_VECX_ADDR"
#define device_bar_CAVM_DDFX_PF_MSIX_VECX_ADDR(a,b) 0x4 /* PF_BAR4 */
#define busnum_CAVM_DDFX_PF_MSIX_VECX_ADDR(a,b) (a)
#define arguments_CAVM_DDFX_PF_MSIX_VECX_ADDR(a,b) (a),(b),-1,-1
 ...
 * This register is the MSI-X vector table, indexed by the DDF_PF_INT_VEC_E enumeration.
 */
union cavm_ddfx_pf_msix_vecx_ctl
{
    uint64_t u;
    struct cavm_ddfx_pf_msix_vecx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_msix_vecx_ctl_s cn; */
};
typedef union cavm_ddfx_pf_msix_vecx_ctl cavm_ddfx_pf_msix_vecx_ctl_t;

static inline uint64_t CAVM_DDFX_PF_MSIX_VECX_CTL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_MSIX_VECX_CTL(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=3)))
        return 0x809010000008ll + 0ll * ((a) & 0x0) + 0x10ll * ((b) & 0x3);
    __cavm_csr_fatal("DDFX_PF_MSIX_VECX_CTL", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_PF_MSIX_VECX_CTL(a,b) cavm_ddfx_pf_msix_vecx_ctl_t
#define bustype_CAVM_DDFX_PF_MSIX_VECX_CTL(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_MSIX_VECX_CTL(a,b) "DDFX_PF_MSIX_VECX_CTL"
...
static inline uint64_t CAVM_DDFX_PF_NOINT0_ENA_W1C(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_NOINT0_ENA_W1C(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000540ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_NOINT0_ENA_W1C", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DDFX_PF_NOINT0_ENA_W1S(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_NOINT0_ENA_W1S(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000560ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_NOINT0_ENA_W1S", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DDFX_PF_NOINT0_INT(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_NOINT0_INT(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000500ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_NOINT0_INT", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DDFX_PF_NOINT0_INT_W1S(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_NOINT0_INT_W1S(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000520ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_NOINT0_INT_W1S", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DDFX_PF_NOINT1_ENA_W1C(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_NOINT1_ENA_W1C(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x8090000005a0ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_NOINT1_ENA_W1C", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DDFX_PF_NOINT1_ENA_W1S(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_NOINT1_ENA_W1S(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x8090000005b0ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_NOINT1_ENA_W1S", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DDFX_PF_NOINT1_INT(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_NOINT1_INT(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000580ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_NOINT1_INT", 1, a, 0, 0, 0);
}
...
static inline uint64_t CAVM_DDFX_PF_NOINT1_INT_W1S(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_NOINT1_INT_W1S(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000590ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_NOINT1_INT_W1S", 1, a, 0, 0, 0);
}
 ...
 */
union cavm_ddfx_pf_qx_ctl
{
    uint64_t u;
    struct cavm_ddfx_pf_qx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_qx_ctl_s cn; */
};
typedef union cavm_ddfx_pf_qx_ctl cavm_ddfx_pf_qx_ctl_t;

static inline uint64_t CAVM_DDFX_PF_QX_CTL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_QX_CTL(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809008000000ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_PF_QX_CTL", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_PF_QX_CTL(a,b) cavm_ddfx_pf_qx_ctl_t
#define bustype_CAVM_DDFX_PF_QX_CTL(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_QX_CTL(a,b) "DDFX_PF_QX_CTL"
#define device_bar_CAVM_DDFX_PF_QX_CTL(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_QX_CTL(a,b) (a)
#define arguments_CAVM_DDFX_PF_QX_CTL(a,b) (a),(b),-1,-1
 ...
 * (see DDF()_VQ()_INPROG[INFLIGHT]).
 */
union cavm_ddfx_pf_qx_ctl2
{
    uint64_t u;
    struct cavm_ddfx_pf_qx_ctl2_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_qx_ctl2_s cn; */
};
typedef union cavm_ddfx_pf_qx_ctl2 cavm_ddfx_pf_qx_ctl2_t;

static inline uint64_t CAVM_DDFX_PF_QX_CTL2(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_QX_CTL2(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809008000100ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_PF_QX_CTL2", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_PF_QX_CTL2(a,b) cavm_ddfx_pf_qx_ctl2_t
#define bustype_CAVM_DDFX_PF_QX_CTL2(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_QX_CTL2(a,b) "DDFX_PF_QX_CTL2"
#define device_bar_CAVM_DDFX_PF_QX_CTL2(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_QX_CTL2(a,b) (a)
#define arguments_CAVM_DDFX_PF_QX_CTL2(a,b) (a),(b),-1,-1
 ...
 * (see DDF()_VQ()_INPROG[INFLIGHT]).
 */
union cavm_ddfx_pf_qx_gmctl
{
    uint64_t u;
    struct cavm_ddfx_pf_qx_gmctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_qx_gmctl_s cn; */
};
typedef union cavm_ddfx_pf_qx_gmctl cavm_ddfx_pf_qx_gmctl_t;

static inline uint64_t CAVM_DDFX_PF_QX_GMCTL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_QX_GMCTL(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809008000020ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_PF_QX_GMCTL", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_PF_QX_GMCTL(a,b) cavm_ddfx_pf_qx_gmctl_t
#define bustype_CAVM_DDFX_PF_QX_GMCTL(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_QX_GMCTL(a,b) "DDFX_PF_QX_GMCTL"
#define device_bar_CAVM_DDFX_PF_QX_GMCTL(a,b) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_QX_GMCTL(a,b) (a)
#define arguments_CAVM_DDFX_PF_QX_GMCTL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_pf_rd_latency_pc
{
    uint64_t u;
    struct cavm_ddfx_pf_rd_latency_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_rd_latency_pc_s cn; */
};
typedef union cavm_ddfx_pf_rd_latency_pc cavm_ddfx_pf_rd_latency_pc_t;

static inline uint64_t CAVM_DDFX_PF_RD_LATENCY_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_RD_LATENCY_PC(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000010060ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_RD_LATENCY_PC", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_RD_LATENCY_PC(a) cavm_ddfx_pf_rd_latency_pc_t
#define bustype_CAVM_DDFX_PF_RD_LATENCY_PC(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_RD_LATENCY_PC(a) "DDFX_PF_RD_LATENCY_PC"
#define device_bar_CAVM_DDFX_PF_RD_LATENCY_PC(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_RD_LATENCY_PC(a) (a)
#define arguments_CAVM_DDFX_PF_RD_LATENCY_PC(a) (a),-1,-1,-1
 ...
 */
union cavm_ddfx_pf_rd_req_pc
{
    uint64_t u;
    struct cavm_ddfx_pf_rd_req_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_rd_req_pc_s cn; */
};
typedef union cavm_ddfx_pf_rd_req_pc cavm_ddfx_pf_rd_req_pc_t;

static inline uint64_t CAVM_DDFX_PF_RD_REQ_PC(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_RD_REQ_PC(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000010040ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_RD_REQ_PC", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_RD_REQ_PC(a) cavm_ddfx_pf_rd_req_pc_t
#define bustype_CAVM_DDFX_PF_RD_REQ_PC(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_RD_REQ_PC(a) "DDFX_PF_RD_REQ_PC"
#define device_bar_CAVM_DDFX_PF_RD_REQ_PC(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_RD_REQ_PC(a) (a)
#define arguments_CAVM_DDFX_PF_RD_REQ_PC(a) (a),-1,-1,-1
 ...
 */
union cavm_ddfx_pf_reset
{
    uint64_t u;
    struct cavm_ddfx_pf_reset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ddfx_pf_reset_s cn; */
};
typedef union cavm_ddfx_pf_reset cavm_ddfx_pf_reset_t;

static inline uint64_t CAVM_DDFX_PF_RESET(unsigned long a) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_RESET(unsigned long a)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && (a==0))
        return 0x809000000100ll + 0ll * ((a) & 0x0);
    __cavm_csr_fatal("DDFX_PF_RESET", 1, a, 0, 0, 0);
}

#define typedef_CAVM_DDFX_PF_RESET(a) cavm_ddfx_pf_reset_t
#define bustype_CAVM_DDFX_PF_RESET(a) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_RESET(a) "DDFX_PF_RESET"
#define device_bar_CAVM_DDFX_PF_RESET(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_RESET(a) (a)
#define arguments_CAVM_DDFX_PF_RESET(a) (a),-1,-1,-1
 ...
 */
union cavm_ddfx_pf_vfx_mboxx
{
    uint64_t u;
    struct cavm_ddfx_pf_vfx_mboxx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_pf_vfx_mboxx_s cn; */
};
typedef union cavm_ddfx_pf_vfx_mboxx cavm_ddfx_pf_vfx_mboxx_t;

static inline uint64_t CAVM_DDFX_PF_VFX_MBOXX(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_PF_VFX_MBOXX(unsigned long a, unsigned long b, unsigned long c)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63) && (c<=1)))
        return 0x809008001000ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f) + 0x100ll * ((c) & 0x1);
    __cavm_csr_fatal("DDFX_PF_VFX_MBOXX", 3, a, b, c, 0);
}

#define typedef_CAVM_DDFX_PF_VFX_MBOXX(a,b,c) cavm_ddfx_pf_vfx_mboxx_t
#define bustype_CAVM_DDFX_PF_VFX_MBOXX(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_DDFX_PF_VFX_MBOXX(a,b,c) "DDFX_PF_VFX_MBOXX"
#define device_bar_CAVM_DDFX_PF_VFX_MBOXX(a,b,c) 0x0 /* PF_BAR0 */
#define busnum_CAVM_DDFX_PF_VFX_MBOXX(a,b,c) (a)
#define arguments_CAVM_DDFX_PF_VFX_MBOXX(a,b,c) (a),(b),(c),-1
 ...
 * enumeration.
 */
union cavm_ddfx_vfx_msix_pbax
{
    uint64_t u;
    struct cavm_ddfx_vfx_msix_pbax_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t pend                  : 64; /**< [ 63:  0](RO/H) Pending message for the associated DDF()_PF_MSIX_VEC()_CTL, enumerated by
                                                                 DDF_PF_INT_VEC_E. Bits that have no associated DDF_PF_INT_VEC_E are zero. */
    ...
    /* struct cavm_ddfx_vfx_msix_pbax_s cn; */
};
typedef union cavm_ddfx_vfx_msix_pbax cavm_ddfx_vfx_msix_pbax_t;

static inline uint64_t CAVM_DDFX_VFX_MSIX_PBAX(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VFX_MSIX_PBAX(unsigned long a, unsigned long b, unsigned long c)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63) && (c==0)))
        return 0x8090300f0000ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f) + 8ll * ((c) & 0x0);
    __cavm_csr_fatal("DDFX_VFX_MSIX_PBAX", 3, a, b, c, 0);
}

#define typedef_CAVM_DDFX_VFX_MSIX_PBAX(a,b,c) cavm_ddfx_vfx_msix_pbax_t
#define bustype_CAVM_DDFX_VFX_MSIX_PBAX(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VFX_MSIX_PBAX(a,b,c) "DDFX_VFX_MSIX_PBAX"
#define device_bar_CAVM_DDFX_VFX_MSIX_PBAX(a,b,c) 0x4 /* VF_BAR4 */
#define busnum_CAVM_DDFX_VFX_MSIX_PBAX(a,b,c) (a)
#define arguments_CAVM_DDFX_VFX_MSIX_PBAX(a,b,c) (a),(b),(c),-1
 ...
 */
union cavm_ddfx_vfx_msix_vecx_addr
{
    uint64_t u;
    struct cavm_ddfx_vfx_msix_vecx_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
        uint64_t addr                  : 47; /**< [ 48:  2](R/W) IOVA to use for MSI-X delivery of this vector. */
    ...
    /* struct cavm_ddfx_vfx_msix_vecx_addr_s cn; */
};
typedef union cavm_ddfx_vfx_msix_vecx_addr cavm_ddfx_vfx_msix_vecx_addr_t;

static inline uint64_t CAVM_DDFX_VFX_MSIX_VECX_ADDR(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VFX_MSIX_VECX_ADDR(unsigned long a, unsigned long b, unsigned long c)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63) && (c<=1)))
        return 0x809030000000ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f) + 0x10ll * ((c) & 0x1);
    __cavm_csr_fatal("DDFX_VFX_MSIX_VECX_ADDR", 3, a, b, c, 0);
}

#define typedef_CAVM_DDFX_VFX_MSIX_VECX_ADDR(a,b,c) cavm_ddfx_vfx_msix_vecx_addr_t
#define bustype_CAVM_DDFX_VFX_MSIX_VECX_ADDR(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VFX_MSIX_VECX_ADDR(a,b,c) "DDFX_VFX_MSIX_VECX_ADDR"
#define device_bar_CAVM_DDFX_VFX_MSIX_VECX_ADDR(a,b,c) 0x4 /* VF_BAR4 */
#define busnum_CAVM_DDFX_VFX_MSIX_VECX_ADDR(a,b,c) (a)
#define arguments_CAVM_DDFX_VFX_MSIX_VECX_ADDR(a,b,c) (a),(b),(c),-1
 ...
 * This register is the MSI-X vector table, indexed by the DDF_VF_INT_VEC_E enumeration.
 */
union cavm_ddfx_vfx_msix_vecx_ctl
{
    uint64_t u;
    struct cavm_ddfx_vfx_msix_vecx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_33_63        : 31;
        uint64_t mask                  : 1;  /**< [ 32: 32](R/W) When set, no MSI-X interrupts are sent to this vector. */
    ...
    /* struct cavm_ddfx_vfx_msix_vecx_ctl_s cn; */
};
typedef union cavm_ddfx_vfx_msix_vecx_ctl cavm_ddfx_vfx_msix_vecx_ctl_t;

static inline uint64_t CAVM_DDFX_VFX_MSIX_VECX_CTL(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VFX_MSIX_VECX_CTL(unsigned long a, unsigned long b, unsigned long c)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63) && (c<=1)))
        return 0x809030000008ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f) + 0x10ll * ((c) & 0x1);
    __cavm_csr_fatal("DDFX_VFX_MSIX_VECX_CTL", 3, a, b, c, 0);
}

#define typedef_CAVM_DDFX_VFX_MSIX_VECX_CTL(a,b,c) cavm_ddfx_vfx_msix_vecx_ctl_t
#define bustype_CAVM_DDFX_VFX_MSIX_VECX_CTL(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VFX_MSIX_VECX_CTL(a,b,c) "DDFX_VFX_MSIX_VECX_CTL"
#define device_bar_CAVM_DDFX_VFX_MSIX_VECX_CTL(a,b,c) 0x4 /* VF_BAR4 */
#define busnum_CAVM_DDFX_VFX_MSIX_VECX_CTL(a,b,c) (a)
#define arguments_CAVM_DDFX_VFX_MSIX_VECX_CTL(a,b,c) (a),(b),(c),-1
 ...
 */
union cavm_ddfx_vfx_pf_mboxx
{
    uint64_t u;
    struct cavm_ddfx_vfx_pf_mboxx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_vfx_pf_mboxx_s cn; */
};
typedef union cavm_ddfx_vfx_pf_mboxx cavm_ddfx_vfx_pf_mboxx_t;

static inline uint64_t CAVM_DDFX_VFX_PF_MBOXX(unsigned long a, unsigned long b, unsigned long c) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VFX_PF_MBOXX(unsigned long a, unsigned long b, unsigned long c)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63) && (c<=1)))
        return 0x809020001000ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f) + 8ll * ((c) & 0x1);
    __cavm_csr_fatal("DDFX_VFX_PF_MBOXX", 3, a, b, c, 0);
}

#define typedef_CAVM_DDFX_VFX_PF_MBOXX(a,b,c) cavm_ddfx_vfx_pf_mboxx_t
#define bustype_CAVM_DDFX_VFX_PF_MBOXX(a,b,c) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VFX_PF_MBOXX(a,b,c) "DDFX_VFX_PF_MBOXX"
#define device_bar_CAVM_DDFX_VFX_PF_MBOXX(a,b,c) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VFX_PF_MBOXX(a,b,c) (a)
#define arguments_CAVM_DDFX_VFX_PF_MBOXX(a,b,c) (a),(b),(c),-1
 ...
 */
union cavm_ddfx_vqx_ctl
{
    uint64_t u;
    struct cavm_ddfx_vqx_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ddfx_vqx_ctl_s cn; */
};
typedef union cavm_ddfx_vqx_ctl cavm_ddfx_vqx_ctl_t;

static inline uint64_t CAVM_DDFX_VQX_CTL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_CTL(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000100ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_CTL", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_CTL(a,b) cavm_ddfx_vqx_ctl_t
#define bustype_CAVM_DDFX_VQX_CTL(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_CTL(a,b) "DDFX_VQX_CTL"
#define device_bar_CAVM_DDFX_VQX_CTL(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_CTL(a,b) (a)
#define arguments_CAVM_DDFX_VQX_CTL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_vqx_done
{
    uint64_t u;
    struct cavm_ddfx_vqx_done_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_vqx_done_s cn; */
};
typedef union cavm_ddfx_vqx_done cavm_ddfx_vqx_done_t;

static inline uint64_t CAVM_DDFX_VQX_DONE(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_DONE(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000420ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_DONE", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_DONE(a,b) cavm_ddfx_vqx_done_t
#define bustype_CAVM_DDFX_VQX_DONE(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_DONE(a,b) "DDFX_VQX_DONE"
#define device_bar_CAVM_DDFX_VQX_DONE(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_DONE(a,b) (a)
#define arguments_CAVM_DDFX_VQX_DONE(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_vqx_done_ack
{
    uint64_t u;
    struct cavm_ddfx_vqx_done_ack_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_ddfx_vqx_done_ack_s cn; */
};
typedef union cavm_ddfx_vqx_done_ack cavm_ddfx_vqx_done_ack_t;

static inline uint64_t CAVM_DDFX_VQX_DONE_ACK(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_DONE_ACK(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000440ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_DONE_ACK", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_DONE_ACK(a,b) cavm_ddfx_vqx_done_ack_t
#define bustype_CAVM_DDFX_VQX_DONE_ACK(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_DONE_ACK(a,b) "DDFX_VQX_DONE_ACK"
#define device_bar_CAVM_DDFX_VQX_DONE_ACK(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_DONE_ACK(a,b) (a)
#define arguments_CAVM_DDFX_VQX_DONE_ACK(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_vqx_done_ena_w1c
{
    uint64_t u;
    struct cavm_ddfx_vqx_done_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ddfx_vqx_done_ena_w1c_s cn; */
};
typedef union cavm_ddfx_vqx_done_ena_w1c cavm_ddfx_vqx_done_ena_w1c_t;

static inline uint64_t CAVM_DDFX_VQX_DONE_ENA_W1C(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_DONE_ENA_W1C(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000478ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_DONE_ENA_W1C", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_DONE_ENA_W1C(a,b) cavm_ddfx_vqx_done_ena_w1c_t
#define bustype_CAVM_DDFX_VQX_DONE_ENA_W1C(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_DONE_ENA_W1C(a,b) "DDFX_VQX_DONE_ENA_W1C"
#define device_bar_CAVM_DDFX_VQX_DONE_ENA_W1C(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_DONE_ENA_W1C(a,b) (a)
#define arguments_CAVM_DDFX_VQX_DONE_ENA_W1C(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_vqx_done_ena_w1s
{
    uint64_t u;
    struct cavm_ddfx_vqx_done_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ddfx_vqx_done_ena_w1s_s cn; */
};
typedef union cavm_ddfx_vqx_done_ena_w1s cavm_ddfx_vqx_done_ena_w1s_t;

static inline uint64_t CAVM_DDFX_VQX_DONE_ENA_W1S(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_DONE_ENA_W1S(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000470ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_DONE_ENA_W1S", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_DONE_ENA_W1S(a,b) cavm_ddfx_vqx_done_ena_w1s_t
#define bustype_CAVM_DDFX_VQX_DONE_ENA_W1S(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_DONE_ENA_W1S(a,b) "DDFX_VQX_DONE_ENA_W1S"
#define device_bar_CAVM_DDFX_VQX_DONE_ENA_W1S(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_DONE_ENA_W1S(a,b) (a)
#define arguments_CAVM_DDFX_VQX_DONE_ENA_W1S(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_vqx_done_int_w1c
{
    uint64_t u;
    struct cavm_ddfx_vqx_done_int_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_ddfx_vqx_done_int_w1c_s cn; */
};
typedef union cavm_ddfx_vqx_done_int_w1c cavm_ddfx_vqx_done_int_w1c_t;

static inline uint64_t CAVM_DDFX_VQX_DONE_INT_W1C(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_DONE_INT_W1C(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000468ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_DONE_INT_W1C", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_DONE_INT_W1C(a,b) cavm_ddfx_vqx_done_int_w1c_t
#define bustype_CAVM_DDFX_VQX_DONE_INT_W1C(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_DONE_INT_W1C(a,b) "DDFX_VQX_DONE_INT_W1C"
#define device_bar_CAVM_DDFX_VQX_DONE_INT_W1C(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_DONE_INT_W1C(a,b) (a)
#define arguments_CAVM_DDFX_VQX_DONE_INT_W1C(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_vqx_done_int_w1s
{
    uint64_t u;
    struct cavm_ddfx_vqx_done_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
        uint64_t done                  : 1;  /**< [  0:  0](RO/H) Done interrupt. See DDF()_VQ()_DONE[DONE].  Note this bit is read-only, to acknowledge
    ...
    /* struct cavm_ddfx_vqx_done_int_w1s_s cn; */
};
typedef union cavm_ddfx_vqx_done_int_w1s cavm_ddfx_vqx_done_int_w1s_t;

static inline uint64_t CAVM_DDFX_VQX_DONE_INT_W1S(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_DONE_INT_W1S(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000460ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_DONE_INT_W1S", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_DONE_INT_W1S(a,b) cavm_ddfx_vqx_done_int_w1s_t
#define bustype_CAVM_DDFX_VQX_DONE_INT_W1S(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_DONE_INT_W1S(a,b) "DDFX_VQX_DONE_INT_W1S"
#define device_bar_CAVM_DDFX_VQX_DONE_INT_W1S(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_DONE_INT_W1S(a,b) (a)
#define arguments_CAVM_DDFX_VQX_DONE_INT_W1S(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_vqx_done_wait
{
    uint64_t u;
    struct cavm_ddfx_vqx_done_wait_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_vqx_done_wait_s cn; */
};
typedef union cavm_ddfx_vqx_done_wait cavm_ddfx_vqx_done_wait_t;

static inline uint64_t CAVM_DDFX_VQX_DONE_WAIT(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_DONE_WAIT(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000400ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_DONE_WAIT", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_DONE_WAIT(a,b) cavm_ddfx_vqx_done_wait_t
#define bustype_CAVM_DDFX_VQX_DONE_WAIT(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_DONE_WAIT(a,b) "DDFX_VQX_DONE_WAIT"
#define device_bar_CAVM_DDFX_VQX_DONE_WAIT(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_DONE_WAIT(a,b) (a)
#define arguments_CAVM_DDFX_VQX_DONE_WAIT(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_vqx_doorbell
{
    uint64_t u;
    struct cavm_ddfx_vqx_doorbell_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_ddfx_vqx_doorbell_s cn; */
};
typedef union cavm_ddfx_vqx_doorbell cavm_ddfx_vqx_doorbell_t;

static inline uint64_t CAVM_DDFX_VQX_DOORBELL(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_DOORBELL(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000600ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_DOORBELL", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_DOORBELL(a,b) cavm_ddfx_vqx_doorbell_t
#define bustype_CAVM_DDFX_VQX_DOORBELL(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_DOORBELL(a,b) "DDFX_VQX_DOORBELL"
#define device_bar_CAVM_DDFX_VQX_DOORBELL(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_DOORBELL(a,b) (a)
#define arguments_CAVM_DDFX_VQX_DOORBELL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_vqx_inprog
{
    uint64_t u;
    struct cavm_ddfx_vqx_inprog_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
    ...
    /* struct cavm_ddfx_vqx_inprog_s cn; */
};
typedef union cavm_ddfx_vqx_inprog cavm_ddfx_vqx_inprog_t;

static inline uint64_t CAVM_DDFX_VQX_INPROG(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_INPROG(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000410ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_INPROG", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_INPROG(a,b) cavm_ddfx_vqx_inprog_t
#define bustype_CAVM_DDFX_VQX_INPROG(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_INPROG(a,b) "DDFX_VQX_INPROG"
#define device_bar_CAVM_DDFX_VQX_INPROG(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_INPROG(a,b) (a)
#define arguments_CAVM_DDFX_VQX_INPROG(a,b) (a),(b),-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_ddfx_vqx_misc_ena_w1c
{
    uint64_t u;
    struct cavm_ddfx_vqx_misc_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ddfx_vqx_misc_ena_w1c_s cn; */
};
typedef union cavm_ddfx_vqx_misc_ena_w1c cavm_ddfx_vqx_misc_ena_w1c_t;

static inline uint64_t CAVM_DDFX_VQX_MISC_ENA_W1C(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_MISC_ENA_W1C(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000518ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_MISC_ENA_W1C", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_MISC_ENA_W1C(a,b) cavm_ddfx_vqx_misc_ena_w1c_t
#define bustype_CAVM_DDFX_VQX_MISC_ENA_W1C(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_MISC_ENA_W1C(a,b) "DDFX_VQX_MISC_ENA_W1C"
#define device_bar_CAVM_DDFX_VQX_MISC_ENA_W1C(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_MISC_ENA_W1C(a,b) (a)
#define arguments_CAVM_DDFX_VQX_MISC_ENA_W1C(a,b) (a),(b),-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_ddfx_vqx_misc_ena_w1s
{
    uint64_t u;
    struct cavm_ddfx_vqx_misc_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct cavm_ddfx_vqx_misc_ena_w1s_s cn; */
};
typedef union cavm_ddfx_vqx_misc_ena_w1s cavm_ddfx_vqx_misc_ena_w1s_t;

static inline uint64_t CAVM_DDFX_VQX_MISC_ENA_W1S(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_MISC_ENA_W1S(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000510ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_MISC_ENA_W1S", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_MISC_ENA_W1S(a,b) cavm_ddfx_vqx_misc_ena_w1s_t
#define bustype_CAVM_DDFX_VQX_MISC_ENA_W1S(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_MISC_ENA_W1S(a,b) "DDFX_VQX_MISC_ENA_W1S"
#define device_bar_CAVM_DDFX_VQX_MISC_ENA_W1S(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_MISC_ENA_W1S(a,b) (a)
#define arguments_CAVM_DDFX_VQX_MISC_ENA_W1S(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_vqx_misc_int
{
    uint64_t u;
    struct cavm_ddfx_vqx_misc_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct cavm_ddfx_vqx_misc_int_s cn; */
};
typedef union cavm_ddfx_vqx_misc_int cavm_ddfx_vqx_misc_int_t;

static inline uint64_t CAVM_DDFX_VQX_MISC_INT(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_MISC_INT(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000500ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_MISC_INT", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_MISC_INT(a,b) cavm_ddfx_vqx_misc_int_t
#define bustype_CAVM_DDFX_VQX_MISC_INT(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_MISC_INT(a,b) "DDFX_VQX_MISC_INT"
#define device_bar_CAVM_DDFX_VQX_MISC_INT(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_MISC_INT(a,b) (a)
#define arguments_CAVM_DDFX_VQX_MISC_INT(a,b) (a),(b),-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_ddfx_vqx_misc_int_w1s
{
    uint64_t u;
    struct cavm_ddfx_vqx_misc_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct cavm_ddfx_vqx_misc_int_w1s_s cn; */
};
typedef union cavm_ddfx_vqx_misc_int_w1s cavm_ddfx_vqx_misc_int_w1s_t;

static inline uint64_t CAVM_DDFX_VQX_MISC_INT_W1S(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_MISC_INT_W1S(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000508ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_MISC_INT_W1S", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_MISC_INT_W1S(a,b) cavm_ddfx_vqx_misc_int_w1s_t
#define bustype_CAVM_DDFX_VQX_MISC_INT_W1S(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_MISC_INT_W1S(a,b) "DDFX_VQX_MISC_INT_W1S"
#define device_bar_CAVM_DDFX_VQX_MISC_INT_W1S(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_MISC_INT_W1S(a,b) (a)
#define arguments_CAVM_DDFX_VQX_MISC_INT_W1S(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ddfx_vqx_saddr
{
    uint64_t u;
    struct cavm_ddfx_vqx_saddr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_49_63        : 15;
    ...
    /* struct cavm_ddfx_vqx_saddr_s cn; */
};
typedef union cavm_ddfx_vqx_saddr cavm_ddfx_vqx_saddr_t;

static inline uint64_t CAVM_DDFX_VQX_SADDR(unsigned long a, unsigned long b) __attribute__ ((pure, always_inline));
static inline uint64_t CAVM_DDFX_VQX_SADDR(unsigned long a, unsigned long b)
{
    if (cavm_is_model(OCTEONTX_CN83XX) && ((a==0) && (b<=63)))
        return 0x809020000200ll + 0ll * ((a) & 0x0) + 0x100000ll * ((b) & 0x3f);
    __cavm_csr_fatal("DDFX_VQX_SADDR", 2, a, b, 0, 0);
}

#define typedef_CAVM_DDFX_VQX_SADDR(a,b) cavm_ddfx_vqx_saddr_t
#define bustype_CAVM_DDFX_VQX_SADDR(a,b) CSR_TYPE_NCB
#define basename_CAVM_DDFX_VQX_SADDR(a,b) "DDFX_VQX_SADDR"
#define device_bar_CAVM_DDFX_VQX_SADDR(a,b) 0x0 /* VF_BAR0 */
#define busnum_CAVM_DDFX_VQX_SADDR(a,b) (a)
#define arguments_CAVM_DDFX_VQX_SADDR(a,b) (a),(b),-1,-1

#endif /* __CAVM_CSRS_DDF_H__ */
