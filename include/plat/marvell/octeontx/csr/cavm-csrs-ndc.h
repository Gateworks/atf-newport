#ifndef __CAVM_CSRS_NDC_H__
#define __CAVM_CSRS_NDC_H__
 ...
 */
#define CAVM_NDC_AF_INT_VEC_E_INTR (0)
 ...
 */
#define CAVM_NDC_CTYPE_E_BYPASS (1)
#define CAVM_NDC_CTYPE_E_CACHING (0)
 ...
 */
#define CAVM_NDC_IDX_E_NIXX_RX(a) (0 + 4 * (a))
#define CAVM_NDC_IDX_E_NIXX_TX(a) (1 + 4 * (a))
 ...
 */
union cavm_ndcx_af_active_pc
{
    uint64_t u;
    struct cavm_ndcx_af_active_pc_s
    {
    ...
    /* struct cavm_ndcx_af_active_pc_s cn; */
};
typedef union cavm_ndcx_af_active_pc cavm_ndcx_af_active_pc_t;
...
static inline uint64_t CAVM_NDCX_AF_ACTIVE_PC(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000078ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_ACTIVE_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_ACTIVE_PC(a) cavm_ndcx_af_active_pc_t
#define bustype_CAVM_NDCX_AF_ACTIVE_PC(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_ACTIVE_PC(a) "NDCX_AF_ACTIVE_PC"
#define device_bar_CAVM_NDCX_AF_ACTIVE_PC(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_ACTIVE_PC(a) (a)
#define arguments_CAVM_NDCX_AF_ACTIVE_PC(a) (a),-1,-1,-1
 ...
 */
union cavm_ndcx_af_bankx_hit_pc
{
    uint64_t u;
    struct cavm_ndcx_af_bankx_hit_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_bankx_hit_pc_s cn; */
};
typedef union cavm_ndcx_af_bankx_hit_pc cavm_ndcx_af_bankx_hit_pc_t;
...
static inline uint64_t CAVM_NDCX_AF_BANKX_HIT_PC(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_CN98XX) && ((a<=5) && (b<=15)))
        return 0x8400c0001000ll + 0x10000000ll * ((a) & 0x7) + 8ll * ((b) & 0xf);
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=5) && (b<=15)))
        return 0x8400c0001000ll + 0x10000000ll * ((a) & 0x7) + 8ll * ((b) & 0xf);
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=15)))
        return 0x8400c0001000ll + 0x10000000ll * ((a) & 0x7) + 8ll * ((b) & 0xf);
    __cavm_csr_fatal("NDCX_AF_BANKX_HIT_PC", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_BANKX_HIT_PC(a,b) cavm_ndcx_af_bankx_hit_pc_t
#define bustype_CAVM_NDCX_AF_BANKX_HIT_PC(a,b) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BANKX_HIT_PC(a,b) "NDCX_AF_BANKX_HIT_PC"
#define device_bar_CAVM_NDCX_AF_BANKX_HIT_PC(a,b) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BANKX_HIT_PC(a,b) (a)
#define arguments_CAVM_NDCX_AF_BANKX_HIT_PC(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ndcx_af_bankx_indexx_busy
{
    uint64_t u;
    struct cavm_ndcx_af_bankx_indexx_busy_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_bankx_indexx_busy_s cn; */
};
typedef union cavm_ndcx_af_bankx_indexx_busy cavm_ndcx_af_bankx_indexx_busy_t;
...
static inline uint64_t CAVM_NDCX_AF_BANKX_INDEXX_BUSY(unsigned long a, unsigned long b, unsigned long c)
{
    ...
    if (cavm_is_model(OCTEONTX_CN98XX) && ((a<=5) && (b<=15) && (c<=3)))
        return 0x8400c0000600ll + 0x10000000ll * ((a) & 0x7) + 0x20ll * ((b) & 0xf) + 8ll * ((c) & 0x3);
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=5) && (b<=15) && (c<=3)))
        return 0x8400c0000600ll + 0x10000000ll * ((a) & 0x7) + 0x20ll * ((b) & 0xf) + 8ll * ((c) & 0x3);
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=15) && (c<=3)))
        return 0x8400c0000600ll + 0x10000000ll * ((a) & 0x7) + 0x20ll * ((b) & 0xf) + 8ll * ((c) & 0x3);
    __cavm_csr_fatal("NDCX_AF_BANKX_INDEXX_BUSY", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_BANKX_INDEXX_BUSY(a,b,c) cavm_ndcx_af_bankx_indexx_busy_t
#define bustype_CAVM_NDCX_AF_BANKX_INDEXX_BUSY(a,b,c) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BANKX_INDEXX_BUSY(a,b,c) "NDCX_AF_BANKX_INDEXX_BUSY"
#define device_bar_CAVM_NDCX_AF_BANKX_INDEXX_BUSY(a,b,c) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BANKX_INDEXX_BUSY(a,b,c) (a)
#define arguments_CAVM_NDCX_AF_BANKX_INDEXX_BUSY(a,b,c) (a),(b),(c),-1
 ...
 * These registers provide raw access to the cache metadata. For diagnostic use only.
 */
union cavm_ndcx_af_bankx_indexx_dirty
{
    uint64_t u;
    struct cavm_ndcx_af_bankx_indexx_dirty_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_bankx_indexx_dirty_s cn; */
};
typedef union cavm_ndcx_af_bankx_indexx_dirty cavm_ndcx_af_bankx_indexx_dirty_t;
...
#define typedef_CAVM_NDCX_AF_BANKX_INDEXX_DIRTY(a,b,c) cavm_ndcx_af_bankx_indexx_dirty_t
#define bustype_CAVM_NDCX_AF_BANKX_INDEXX_DIRTY(a,b,c) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BANKX_INDEXX_DIRTY(a,b,c) "NDCX_AF_BANKX_INDEXX_DIRTY"
#define device_bar_CAVM_NDCX_AF_BANKX_INDEXX_DIRTY(a,b,c) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BANKX_INDEXX_DIRTY(a,b,c) (a)
#define arguments_CAVM_NDCX_AF_BANKX_INDEXX_DIRTY(a,b,c) (a),(b),(c),-1
 ...
 * These registers provide raw access to the cache metadata. For diagnostic use only.
 */
union cavm_ndcx_af_bankx_indexx_lock
{
    uint64_t u;
    struct cavm_ndcx_af_bankx_indexx_lock_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_bankx_indexx_lock_s cn; */
};
typedef union cavm_ndcx_af_bankx_indexx_lock cavm_ndcx_af_bankx_indexx_lock_t;
...
#define typedef_CAVM_NDCX_AF_BANKX_INDEXX_LOCK(a,b,c) cavm_ndcx_af_bankx_indexx_lock_t
#define bustype_CAVM_NDCX_AF_BANKX_INDEXX_LOCK(a,b,c) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BANKX_INDEXX_LOCK(a,b,c) "NDCX_AF_BANKX_INDEXX_LOCK"
#define device_bar_CAVM_NDCX_AF_BANKX_INDEXX_LOCK(a,b,c) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BANKX_INDEXX_LOCK(a,b,c) (a)
#define arguments_CAVM_NDCX_AF_BANKX_INDEXX_LOCK(a,b,c) (a),(b),(c),-1
 ...
 * These registers provide raw access to the cache metadata. For diagnostic use only.
 */
union cavm_ndcx_af_bankx_indexx_vld
{
    uint64_t u;
    struct cavm_ndcx_af_bankx_indexx_vld_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_bankx_indexx_vld_s cn; */
};
typedef union cavm_ndcx_af_bankx_indexx_vld cavm_ndcx_af_bankx_indexx_vld_t;
...
#define typedef_CAVM_NDCX_AF_BANKX_INDEXX_VLD(a,b,c) cavm_ndcx_af_bankx_indexx_vld_t
#define bustype_CAVM_NDCX_AF_BANKX_INDEXX_VLD(a,b,c) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BANKX_INDEXX_VLD(a,b,c) "NDCX_AF_BANKX_INDEXX_VLD"
#define device_bar_CAVM_NDCX_AF_BANKX_INDEXX_VLD(a,b,c) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BANKX_INDEXX_VLD(a,b,c) (a)
#define arguments_CAVM_NDCX_AF_BANKX_INDEXX_VLD(a,b,c) (a),(b),(c),-1
 ...
 */
union cavm_ndcx_af_bankx_linex_metadata
{
    uint64_t u;
    struct cavm_ndcx_af_bankx_linex_metadata_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_bankx_linex_metadata_s cn; */
};
typedef union cavm_ndcx_af_bankx_linex_metadata cavm_ndcx_af_bankx_linex_metadata_t;
...
static inline uint64_t CAVM_NDCX_AF_BANKX_LINEX_METADATA(unsigned long a, unsigned long b, unsigned long c)
{
    ...
    if (cavm_is_model(OCTEONTX_CN98XX) && ((a<=5) && (b<=15) && (c<=255)))
        return 0x8400c0010000ll + 0x10000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0xf) + 8ll * ((c) & 0xff);
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=5) && (b<=15) && (c<=255)))
        return 0x8400c0010000ll + 0x10000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0xf) + 8ll * ((c) & 0xff);
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=15) && (c<=255)))
        return 0x8400c0010000ll + 0x10000000ll * ((a) & 0x7) + 0x1000ll * ((b) & 0xf) + 8ll * ((c) & 0xff);
    __cavm_csr_fatal("NDCX_AF_BANKX_LINEX_METADATA", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_BANKX_LINEX_METADATA(a,b,c) cavm_ndcx_af_bankx_linex_metadata_t
#define bustype_CAVM_NDCX_AF_BANKX_LINEX_METADATA(a,b,c) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BANKX_LINEX_METADATA(a,b,c) "NDCX_AF_BANKX_LINEX_METADATA"
#define device_bar_CAVM_NDCX_AF_BANKX_LINEX_METADATA(a,b,c) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BANKX_LINEX_METADATA(a,b,c) (a)
#define arguments_CAVM_NDCX_AF_BANKX_LINEX_METADATA(a,b,c) (a),(b),(c),-1
 ...
 */
union cavm_ndcx_af_bankx_linex_wordx
{
    uint64_t u;
    struct cavm_ndcx_af_bankx_linex_wordx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_bankx_linex_wordx_s cn; */
};
typedef union cavm_ndcx_af_bankx_linex_wordx cavm_ndcx_af_bankx_linex_wordx_t;
...
static inline uint64_t CAVM_NDCX_AF_BANKX_LINEX_WORDX(unsigned long a, unsigned long b, unsigned long c, unsigned long d)
{
    ...
    if (cavm_is_model(OCTEONTX_CN98XX) && ((a<=5) && (b<=15) && (c<=255) && (d<=15)))
        return 0x8400c0100000ll + 0x10000000ll * ((a) & 0x7) + 0x8000ll * ((b) & 0xf) + 0x80ll * ((c) & 0xff) + 8ll * ((d) & 0xf);
    if (cavm_is_model(OCTEONTX_CNF95XX) && ((a<=5) && (b<=15) && (c<=255) && (d<=15)))
        return 0x8400c0100000ll + 0x10000000ll * ((a) & 0x7) + 0x8000ll * ((b) & 0xf) + 0x80ll * ((c) & 0xff) + 8ll * ((d) & 0xf);
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=15) && (c<=255) && (d<=15)))
        return 0x8400c0100000ll + 0x10000000ll * ((a) & 0x7) + 0x8000ll * ((b) & 0xf) + 0x80ll * ((c) & 0xff) + 8ll * ((d) & 0xf);
    __cavm_csr_fatal("NDCX_AF_BANKX_LINEX_WORDX", 4, a, b, c, d, 0, 0);
}

#define typedef_CAVM_NDCX_AF_BANKX_LINEX_WORDX(a,b,c,d) cavm_ndcx_af_bankx_linex_wordx_t
#define bustype_CAVM_NDCX_AF_BANKX_LINEX_WORDX(a,b,c,d) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BANKX_LINEX_WORDX(a,b,c,d) "NDCX_AF_BANKX_LINEX_WORDX"
#define device_bar_CAVM_NDCX_AF_BANKX_LINEX_WORDX(a,b,c,d) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BANKX_LINEX_WORDX(a,b,c,d) (a)
#define arguments_CAVM_NDCX_AF_BANKX_LINEX_WORDX(a,b,c,d) (a),(b),(c),(d)
 ...
 */
union cavm_ndcx_af_bankx_miss_pc
{
    uint64_t u;
    struct cavm_ndcx_af_bankx_miss_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_bankx_miss_pc_s cn; */
};
typedef union cavm_ndcx_af_bankx_miss_pc cavm_ndcx_af_bankx_miss_pc_t;
...
#define typedef_CAVM_NDCX_AF_BANKX_MISS_PC(a,b) cavm_ndcx_af_bankx_miss_pc_t
#define bustype_CAVM_NDCX_AF_BANKX_MISS_PC(a,b) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BANKX_MISS_PC(a,b) "NDCX_AF_BANKX_MISS_PC"
#define device_bar_CAVM_NDCX_AF_BANKX_MISS_PC(a,b) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BANKX_MISS_PC(a,b) (a)
#define arguments_CAVM_NDCX_AF_BANKX_MISS_PC(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ndcx_af_bank_ctl_done
{
    uint64_t u;
    struct cavm_ndcx_af_bank_ctl_done_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_NDCX_AF_BANK_CTL_DONE(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000048ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_BANK_CTL_DONE", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_BANK_CTL_DONE(a) cavm_ndcx_af_bank_ctl_done_t
#define bustype_CAVM_NDCX_AF_BANK_CTL_DONE(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BANK_CTL_DONE(a) "NDCX_AF_BANK_CTL_DONE"
#define device_bar_CAVM_NDCX_AF_BANK_CTL_DONE(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BANK_CTL_DONE(a) (a)
#define arguments_CAVM_NDCX_AF_BANK_CTL_DONE(a) (a),-1,-1,-1
 ...
 */
union cavm_ndcx_af_banks_ctl
{
    uint64_t u;
    struct cavm_ndcx_af_banks_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_banks_ctl_s cn; */
};
typedef union cavm_ndcx_af_banks_ctl cavm_ndcx_af_banks_ctl_t;
...
static inline uint64_t CAVM_NDCX_AF_BANKS_CTL(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000040ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_BANKS_CTL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_BANKS_CTL(a) cavm_ndcx_af_banks_ctl_t
#define bustype_CAVM_NDCX_AF_BANKS_CTL(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BANKS_CTL(a) "NDCX_AF_BANKS_CTL"
#define device_bar_CAVM_NDCX_AF_BANKS_CTL(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BANKS_CTL(a) (a)
#define arguments_CAVM_NDCX_AF_BANKS_CTL(a) (a),-1,-1,-1
 ...
 */
union cavm_ndcx_af_blk_rst
{
    uint64_t u;
    struct cavm_ndcx_af_blk_rst_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_blk_rst_s cn; */
};
typedef union cavm_ndcx_af_blk_rst cavm_ndcx_af_blk_rst_t;
...
static inline uint64_t CAVM_NDCX_AF_BLK_RST(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c00002f0ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_BLK_RST", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_BLK_RST(a) cavm_ndcx_af_blk_rst_t
#define bustype_CAVM_NDCX_AF_BLK_RST(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BLK_RST(a) "NDCX_AF_BLK_RST"
#define device_bar_CAVM_NDCX_AF_BLK_RST(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BLK_RST(a) (a)
#define arguments_CAVM_NDCX_AF_BLK_RST(a) (a),-1,-1,-1
 ...
 */
union cavm_ndcx_af_bp_testx
{
    uint64_t u;
    struct cavm_ndcx_af_bp_testx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_NDCX_AF_BP_TESTX(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=3)))
        return 0x8400c0000200ll + 0x10000000ll * ((a) & 0x7) + 8ll * ((b) & 0x3);
    __cavm_csr_fatal("NDCX_AF_BP_TESTX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_BP_TESTX(a,b) cavm_ndcx_af_bp_testx_t
#define bustype_CAVM_NDCX_AF_BP_TESTX(a,b) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BP_TESTX(a,b) "NDCX_AF_BP_TESTX"
#define device_bar_CAVM_NDCX_AF_BP_TESTX(a,b) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BP_TESTX(a,b) (a)
#define arguments_CAVM_NDCX_AF_BP_TESTX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ndcx_af_bp_test_enable
{
    uint64_t u;
    struct cavm_ndcx_af_bp_test_enable_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_bp_test_enable_s cn; */
};
typedef union cavm_ndcx_af_bp_test_enable cavm_ndcx_af_bp_test_enable_t;
...
static inline uint64_t CAVM_NDCX_AF_BP_TEST_ENABLE(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c00001f8ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_BP_TEST_ENABLE", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_BP_TEST_ENABLE(a) cavm_ndcx_af_bp_test_enable_t
#define bustype_CAVM_NDCX_AF_BP_TEST_ENABLE(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_BP_TEST_ENABLE(a) "NDCX_AF_BP_TEST_ENABLE"
#define device_bar_CAVM_NDCX_AF_BP_TEST_ENABLE(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_BP_TEST_ENABLE(a) (a)
#define arguments_CAVM_NDCX_AF_BP_TEST_ENABLE(a) (a),-1,-1,-1
 ...
 */
union cavm_ndcx_af_cams_rd_interval
{
    uint64_t u;
    struct cavm_ndcx_af_cams_rd_interval_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_NDCX_AF_CAMS_RD_INTERVAL(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000080ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_CAMS_RD_INTERVAL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_CAMS_RD_INTERVAL(a) cavm_ndcx_af_cams_rd_interval_t
#define bustype_CAVM_NDCX_AF_CAMS_RD_INTERVAL(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_CAMS_RD_INTERVAL(a) "NDCX_AF_CAMS_RD_INTERVAL"
#define device_bar_CAVM_NDCX_AF_CAMS_RD_INTERVAL(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_CAMS_RD_INTERVAL(a) (a)
#define arguments_CAVM_NDCX_AF_CAMS_RD_INTERVAL(a) (a),-1,-1,-1
 ...
 */
union cavm_ndcx_af_clk_en
{
    uint64_t u;
    struct cavm_ndcx_af_clk_en_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_clk_en_s cn; */
};
typedef union cavm_ndcx_af_clk_en cavm_ndcx_af_clk_en_t;
...
static inline uint64_t CAVM_NDCX_AF_CLK_EN(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000020ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_CLK_EN", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_CLK_EN(a) cavm_ndcx_af_clk_en_t
#define bustype_CAVM_NDCX_AF_CLK_EN(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_CLK_EN(a) "NDCX_AF_CLK_EN"
#define device_bar_CAVM_NDCX_AF_CLK_EN(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_CLK_EN(a) (a)
#define arguments_CAVM_NDCX_AF_CLK_EN(a) (a),-1,-1,-1
 ...
 */
union cavm_ndcx_af_const
{
    uint64_t u;
    struct cavm_ndcx_af_const_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_const_s cn; */
};
typedef union cavm_ndcx_af_const cavm_ndcx_af_const_t;
...
static inline uint64_t CAVM_NDCX_AF_CONST(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000000ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_CONST", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_CONST(a) cavm_ndcx_af_const_t
#define bustype_CAVM_NDCX_AF_CONST(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_CONST(a) "NDCX_AF_CONST"
#define device_bar_CAVM_NDCX_AF_CONST(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_CONST(a) (a)
#define arguments_CAVM_NDCX_AF_CONST(a) (a),-1,-1,-1
...
union cavm_ndcx_af_ctl
{
    ...
    struct cavm_ndcx_af_ctl_cn96xxp1
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    struct cavm_ndcx_af_ctl_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
        uint64_t en_flush_on_inval     : 1;  /**< [ 19: 19](R/W) When set, invalidate requests will flush the corresponding entry back to
    ...
    /* struct cavm_ndcx_af_ctl_cn96xxp3 loki; */
};
...
static inline uint64_t CAVM_NDCX_AF_CTL(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000030ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_CTL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_CTL(a) cavm_ndcx_af_ctl_t
#define bustype_CAVM_NDCX_AF_CTL(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_CTL(a) "NDCX_AF_CTL"
#define device_bar_CAVM_NDCX_AF_CTL(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_CTL(a) (a)
#define arguments_CAVM_NDCX_AF_CTL(a) (a),-1,-1,-1
 ...
 */
union cavm_ndcx_af_eco
{
    uint64_t u;
    struct cavm_ndcx_af_eco_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_ndcx_af_eco_s cn; */
};
typedef union cavm_ndcx_af_eco cavm_ndcx_af_eco_t;
...
static inline uint64_t CAVM_NDCX_AF_ECO(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000010ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_ECO", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_ECO(a) cavm_ndcx_af_eco_t
#define bustype_CAVM_NDCX_AF_ECO(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_ECO(a) "NDCX_AF_ECO"
#define device_bar_CAVM_NDCX_AF_ECO(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_ECO(a) (a)
#define arguments_CAVM_NDCX_AF_ECO(a) (a),-1,-1,-1
 ...
 * NDC Hash Registers
 */
union cavm_ndcx_af_hashx
{
    uint64_t u;
    struct cavm_ndcx_af_hashx_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_hashx_s cn; */
};
typedef union cavm_ndcx_af_hashx cavm_ndcx_af_hashx_t;
...
static inline uint64_t CAVM_NDCX_AF_HASHX(unsigned long a, unsigned long b)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=5)))
        return 0x8400c0000300ll + 0x10000000ll * ((a) & 0x7) + 8ll * ((b) & 0x7);
    __cavm_csr_fatal("NDCX_AF_HASHX", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_HASHX(a,b) cavm_ndcx_af_hashx_t
#define bustype_CAVM_NDCX_AF_HASHX(a,b) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_HASHX(a,b) "NDCX_AF_HASHX"
#define device_bar_CAVM_NDCX_AF_HASHX(a,b) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_HASHX(a,b) (a)
#define arguments_CAVM_NDCX_AF_HASHX(a,b) (a),(b),-1,-1
 ...
 */
union cavm_ndcx_af_intr
{
    uint64_t u;
    struct cavm_ndcx_af_intr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
static inline uint64_t CAVM_NDCX_AF_INTR(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000058ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_INTR", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_INTR(a) cavm_ndcx_af_intr_t
#define bustype_CAVM_NDCX_AF_INTR(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_INTR(a) "NDCX_AF_INTR"
#define device_bar_CAVM_NDCX_AF_INTR(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_INTR(a) (a)
#define arguments_CAVM_NDCX_AF_INTR(a) (a),-1,-1,-1
 ...
 */
union cavm_ndcx_af_intr_ena_w1c
{
    uint64_t u;
    struct cavm_ndcx_af_intr_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
...
static inline uint64_t CAVM_NDCX_AF_INTR_ENA_W1C(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000070ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_INTR_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_INTR_ENA_W1C(a) cavm_ndcx_af_intr_ena_w1c_t
#define bustype_CAVM_NDCX_AF_INTR_ENA_W1C(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_INTR_ENA_W1C(a) "NDCX_AF_INTR_ENA_W1C"
#define device_bar_CAVM_NDCX_AF_INTR_ENA_W1C(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_INTR_ENA_W1C(a) (a)
#define arguments_CAVM_NDCX_AF_INTR_ENA_W1C(a) (a),-1,-1,-1
 ...
 */
union cavm_ndcx_af_intr_ena_w1s
{
    uint64_t u;
    struct cavm_ndcx_af_intr_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
...
static inline uint64_t CAVM_NDCX_AF_INTR_ENA_W1S(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000068ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_INTR_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_INTR_ENA_W1S(a) cavm_ndcx_af_intr_ena_w1s_t
#define bustype_CAVM_NDCX_AF_INTR_ENA_W1S(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_INTR_ENA_W1S(a) "NDCX_AF_INTR_ENA_W1S"
#define device_bar_CAVM_NDCX_AF_INTR_ENA_W1S(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_INTR_ENA_W1S(a) (a)
#define arguments_CAVM_NDCX_AF_INTR_ENA_W1S(a) (a),-1,-1,-1
 ...
 */
union cavm_ndcx_af_intr_w1s
{
    uint64_t u;
    struct cavm_ndcx_af_intr_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_48_63        : 16;
...
static inline uint64_t CAVM_NDCX_AF_INTR_W1S(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000060ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_INTR_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_INTR_W1S(a) cavm_ndcx_af_intr_w1s_t
#define bustype_CAVM_NDCX_AF_INTR_W1S(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_INTR_W1S(a) "NDCX_AF_INTR_W1S"
#define device_bar_CAVM_NDCX_AF_INTR_W1S(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_INTR_W1S(a) (a)
 ...
 */
union cavm_ndcx_af_portx_rtx_rwx_lat_pc
{
    uint64_t u;
    struct cavm_ndcx_af_portx_rtx_rwx_lat_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_portx_rtx_rwx_lat_pc_s cn; */
};
typedef union cavm_ndcx_af_portx_rtx_rwx_lat_pc cavm_ndcx_af_portx_rtx_rwx_lat_pc_t;
...
static inline uint64_t CAVM_NDCX_AF_PORTX_RTX_RWX_LAT_PC(unsigned long a, unsigned long b, unsigned long c, unsigned long d)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=5) && (c<=1) && (d<=1)))
        return 0x8400c0000e00ll + 0x10000000ll * ((a) & 0x7) + 0x20ll * ((b) & 0x7) + 0x10ll * ((c) & 0x1) + 8ll * ((d) & 0x1);
    __cavm_csr_fatal("NDCX_AF_PORTX_RTX_RWX_LAT_PC", 4, a, b, c, d, 0, 0);
}

#define typedef_CAVM_NDCX_AF_PORTX_RTX_RWX_LAT_PC(a,b,c,d) cavm_ndcx_af_portx_rtx_rwx_lat_pc_t
#define bustype_CAVM_NDCX_AF_PORTX_RTX_RWX_LAT_PC(a,b,c,d) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_PORTX_RTX_RWX_LAT_PC(a,b,c,d) "NDCX_AF_PORTX_RTX_RWX_LAT_PC"
#define device_bar_CAVM_NDCX_AF_PORTX_RTX_RWX_LAT_PC(a,b,c,d) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_PORTX_RTX_RWX_LAT_PC(a,b,c,d) (a)
#define arguments_CAVM_NDCX_AF_PORTX_RTX_RWX_LAT_PC(a,b,c,d) (a),(b),(c),(d)
 ...
 */
union cavm_ndcx_af_portx_rtx_rwx_ostdn_pc
{
    uint64_t u;
    struct cavm_ndcx_af_portx_rtx_rwx_ostdn_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_portx_rtx_rwx_ostdn_pc_s cn; */
};
typedef union cavm_ndcx_af_portx_rtx_rwx_ostdn_pc cavm_ndcx_af_portx_rtx_rwx_ostdn_pc_t;
...
static inline uint64_t CAVM_NDCX_AF_PORTX_RTX_RWX_OSTDN_PC(unsigned long a, unsigned long b, unsigned long c, unsigned long d)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=5) && (c<=1) && (d<=1)))
        return 0x8400c0000d00ll + 0x10000000ll * ((a) & 0x7) + 0x20ll * ((b) & 0x7) + 0x10ll * ((c) & 0x1) + 8ll * ((d) & 0x1);
    __cavm_csr_fatal("NDCX_AF_PORTX_RTX_RWX_OSTDN_PC", 4, a, b, c, d, 0, 0);
}

#define typedef_CAVM_NDCX_AF_PORTX_RTX_RWX_OSTDN_PC(a,b,c,d) cavm_ndcx_af_portx_rtx_rwx_ostdn_pc_t
#define bustype_CAVM_NDCX_AF_PORTX_RTX_RWX_OSTDN_PC(a,b,c,d) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_PORTX_RTX_RWX_OSTDN_PC(a,b,c,d) "NDCX_AF_PORTX_RTX_RWX_OSTDN_PC"
#define device_bar_CAVM_NDCX_AF_PORTX_RTX_RWX_OSTDN_PC(a,b,c,d) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_PORTX_RTX_RWX_OSTDN_PC(a,b,c,d) (a)
#define arguments_CAVM_NDCX_AF_PORTX_RTX_RWX_OSTDN_PC(a,b,c,d) (a),(b),(c),(d)
 ...
 */
union cavm_ndcx_af_portx_rtx_rwx_req_pc
{
    uint64_t u;
    struct cavm_ndcx_af_portx_rtx_rwx_req_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_portx_rtx_rwx_req_pc_s cn; */
};
typedef union cavm_ndcx_af_portx_rtx_rwx_req_pc cavm_ndcx_af_portx_rtx_rwx_req_pc_t;
...
static inline uint64_t CAVM_NDCX_AF_PORTX_RTX_RWX_REQ_PC(unsigned long a, unsigned long b, unsigned long c, unsigned long d)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=5) && (c<=1) && (d<=1)))
        return 0x8400c0000c00ll + 0x10000000ll * ((a) & 0x7) + 0x20ll * ((b) & 0x7) + 0x10ll * ((c) & 0x1) + 8ll * ((d) & 0x1);
    __cavm_csr_fatal("NDCX_AF_PORTX_RTX_RWX_REQ_PC", 4, a, b, c, d, 0, 0);
}

#define typedef_CAVM_NDCX_AF_PORTX_RTX_RWX_REQ_PC(a,b,c,d) cavm_ndcx_af_portx_rtx_rwx_req_pc_t
#define bustype_CAVM_NDCX_AF_PORTX_RTX_RWX_REQ_PC(a,b,c,d) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_PORTX_RTX_RWX_REQ_PC(a,b,c,d) "NDCX_AF_PORTX_RTX_RWX_REQ_PC"
#define device_bar_CAVM_NDCX_AF_PORTX_RTX_RWX_REQ_PC(a,b,c,d) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_PORTX_RTX_RWX_REQ_PC(a,b,c,d) (a)
#define arguments_CAVM_NDCX_AF_PORTX_RTX_RWX_REQ_PC(a,b,c,d) (a),(b),(c),(d)
 ...
 */
union cavm_ndcx_af_portx_rwx_cant_alloc_pc
{
    uint64_t u;
    struct cavm_ndcx_af_portx_rwx_cant_alloc_pc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_portx_rwx_cant_alloc_pc_s cn; */
};
typedef union cavm_ndcx_af_portx_rwx_cant_alloc_pc cavm_ndcx_af_portx_rwx_cant_alloc_pc_t;
...
static inline uint64_t CAVM_NDCX_AF_PORTX_RWX_CANT_ALLOC_PC(unsigned long a, unsigned long b, unsigned long c)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && ((a<=5) && (b<=5) && (c<=1)))
        return 0x8400c0000f00ll + 0x10000000ll * ((a) & 0x7) + 0x20ll * ((b) & 0x7) + 0x10ll * ((c) & 0x1);
    __cavm_csr_fatal("NDCX_AF_PORTX_RWX_CANT_ALLOC_PC", 3, a, b, c, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_PORTX_RWX_CANT_ALLOC_PC(a,b,c) cavm_ndcx_af_portx_rwx_cant_alloc_pc_t
#define bustype_CAVM_NDCX_AF_PORTX_RWX_CANT_ALLOC_PC(a,b,c) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_PORTX_RWX_CANT_ALLOC_PC(a,b,c) "NDCX_AF_PORTX_RWX_CANT_ALLOC_PC"
 ...
 */
union cavm_ndcx_af_scratch
{
    uint64_t u;
    struct cavm_ndcx_af_scratch_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_ndcx_af_scratch_s cn; */
};
typedef union cavm_ndcx_af_scratch cavm_ndcx_af_scratch_t;
...
static inline uint64_t CAVM_NDCX_AF_SCRATCH(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c0000018ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_AF_SCRATCH", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_AF_SCRATCH(a) cavm_ndcx_af_scratch_t
#define bustype_CAVM_NDCX_AF_SCRATCH(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_AF_SCRATCH(a) "NDCX_AF_SCRATCH"
#define device_bar_CAVM_NDCX_AF_SCRATCH(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_AF_SCRATCH(a) (a)
#define arguments_CAVM_NDCX_AF_SCRATCH(a) (a),-1,-1,-1
 ...
 */
union cavm_ndcx_priv_af_int_cfg
{
    uint64_t u;
    struct cavm_ndcx_priv_af_int_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_ndcx_priv_af_int_cfg_s cn; */
};
typedef union cavm_ndcx_priv_af_int_cfg cavm_ndcx_priv_af_int_cfg_t;
...
static inline uint64_t CAVM_NDCX_PRIV_AF_INT_CFG(unsigned long a)
{
    ...
    if (cavm_is_model(OCTEONTX_LOKI) && (a<=5))
        return 0x8400c00002f8ll + 0x10000000ll * ((a) & 0x7);
    __cavm_csr_fatal("NDCX_PRIV_AF_INT_CFG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_NDCX_PRIV_AF_INT_CFG(a) cavm_ndcx_priv_af_int_cfg_t
#define bustype_CAVM_NDCX_PRIV_AF_INT_CFG(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_NDCX_PRIV_AF_INT_CFG(a) "NDCX_PRIV_AF_INT_CFG"
#define device_bar_CAVM_NDCX_PRIV_AF_INT_CFG(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_NDCX_PRIV_AF_INT_CFG(a) (a)
#define arguments_CAVM_NDCX_PRIV_AF_INT_CFG(a) (a),-1,-1,-1

#endif /* __CAVM_CSRS_NDC_H__ */
