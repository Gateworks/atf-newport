 ...
 */
#define CAVM_REE_AF_INT_VEC_E_AQ (3)
#define CAVM_REE_AF_INT_VEC_E_QUE_DONE (2)
#define CAVM_REE_AF_INT_VEC_E_RAS (0)
#define CAVM_REE_AF_INT_VEC_E_RVU (1)
...
#define CAVM_REE_DESC_MODE_E_STOP_ANY_MATCH (2)
...
#define CAVM_REE_L2LD_CMD_E_LDI (1)
#define CAVM_REE_L2LD_CMD_E_LDT (4)
#define CAVM_REE_L2LD_CMD_E_LDWB (5)
#define CAVM_REE_L2LD_CMD_E_LDY (3)
 ...
 * Enumerates the MSI-X interrupt vectors.
 */
#define CAVM_REE_LF_INT_VEC_E_MISC (1)
#define CAVM_REE_LF_INT_VEC_E_QUE_DONE (0)
 ...
 */
#define CAVM_REE_ROF_TYPE_E_CHECK_CSR_CHECKSUM (4)
#define CAVM_REE_ROF_TYPE_E_CHECK_CSR_CHECKSUM_EXCLUDE_EM (5)
#define CAVM_REE_ROF_TYPE_E_CHECK_CSR_EQ (1)
#define CAVM_REE_ROF_TYPE_E_CHECK_CSR_GTE (2)
#define CAVM_REE_ROF_TYPE_E_CHECK_CSR_LTE (3)
#define CAVM_REE_ROF_TYPE_E_EM (7)
#define CAVM_REE_ROF_TYPE_E_IM (6)
#define CAVM_REE_ROF_TYPE_E_LEGACY_INSTR (0)
...
#define CAVM_REE_RTRU_INIT_MODE_E_RESERVED_INIT_MODE_0 (0)
#define CAVM_REE_RTRU_INIT_MODE_E_RESERVED_INIT_MODE_3 (3)
...
#define CAVM_REE_STYPE_E_STP (2)
#define CAVM_REE_STYPE_E_STT (1)
#define CAVM_REE_STYPE_E_STY (3)
...
union cavm_ree_af_aq_inst_s
{
    ...
    /* struct cavm_ree_af_aq_inst_s_s cn; */
};
 ...
 */
union cavm_ree_match_s
{
    uint64_t u;
    struct cavm_ree_match_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
 ...
 * structure.
 */
union cavm_ree_res_s
{
    uint64_t u[8];
    struct cavm_ree_res_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
{
    uint32_t u;
    struct cavm_ree_res_status_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    struct cavm_ree_res_status_s_cn
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint32_t reserved_16_31        : 16;
...
static inline uint64_t CAVM_REEX_AF_ACTIVE_PC(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_ACTIVE_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_ACTIVE_PC(a) cavm_reex_af_active_pc_t
#define bustype_CAVM_REEX_AF_ACTIVE_PC(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_ACTIVE_PC(a) "REEX_AF_ACTIVE_PC"
#define device_bar_CAVM_REEX_AF_ACTIVE_PC(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_ACTIVE_PC(a) (a)
#define arguments_CAVM_REEX_AF_ACTIVE_PC(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_aq_ctl_cfg
{
    uint64_t u;
    struct cavm_reex_af_aq_ctl_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct cavm_reex_af_aq_ctl_cfg_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_CTL_CFG(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_CTL_CFG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_CTL_CFG(a) cavm_reex_af_aq_ctl_cfg_t
#define bustype_CAVM_REEX_AF_AQ_CTL_CFG(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_CTL_CFG(a) "REEX_AF_AQ_CTL_CFG"
#define device_bar_CAVM_REEX_AF_AQ_CTL_CFG(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_CTL_CFG(a) (a)
#define arguments_CAVM_REEX_AF_AQ_CTL_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_aq_done
{
    uint64_t u;
    struct cavm_reex_af_aq_done_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_reex_af_aq_done_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_DONE(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_DONE", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_DONE(a) cavm_reex_af_aq_done_t
#define bustype_CAVM_REEX_AF_AQ_DONE(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_DONE(a) "REEX_AF_AQ_DONE"
#define device_bar_CAVM_REEX_AF_AQ_DONE(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_DONE(a) (a)
#define arguments_CAVM_REEX_AF_AQ_DONE(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_aq_done_ack
{
    uint64_t u;
    struct cavm_reex_af_aq_done_ack_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_reex_af_aq_done_ack_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_DONE_ACK(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_DONE_ACK", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_DONE_ACK(a) cavm_reex_af_aq_done_ack_t
#define bustype_CAVM_REEX_AF_AQ_DONE_ACK(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_DONE_ACK(a) "REEX_AF_AQ_DONE_ACK"
#define device_bar_CAVM_REEX_AF_AQ_DONE_ACK(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_DONE_ACK(a) (a)
 ...
 */
union cavm_reex_af_aq_done_int_ena_w1c
{
    uint64_t u;
    struct cavm_reex_af_aq_done_int_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_reex_af_aq_done_int_ena_w1c_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_DONE_INT_ENA_W1C(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_DONE_INT_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_DONE_INT_ENA_W1C(a) cavm_reex_af_aq_done_int_ena_w1c_t
#define bustype_CAVM_REEX_AF_AQ_DONE_INT_ENA_W1C(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_DONE_INT_ENA_W1C(a) "REEX_AF_AQ_DONE_INT_ENA_W1C"
#define device_bar_CAVM_REEX_AF_AQ_DONE_INT_ENA_W1C(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_DONE_INT_ENA_W1C(a) (a)
#define arguments_CAVM_REEX_AF_AQ_DONE_INT_ENA_W1C(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_aq_done_int_ena_w1s
{
    uint64_t u;
    struct cavm_reex_af_aq_done_int_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_reex_af_aq_done_int_ena_w1s_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_DONE_INT_ENA_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_DONE_INT_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_DONE_INT_ENA_W1S(a) cavm_reex_af_aq_done_int_ena_w1s_t
#define bustype_CAVM_REEX_AF_AQ_DONE_INT_ENA_W1S(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_DONE_INT_ENA_W1S(a) "REEX_AF_AQ_DONE_INT_ENA_W1S"
 ...
 */
union cavm_reex_af_aq_doorbell
{
    uint64_t u;
    struct cavm_reex_af_aq_doorbell_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_reex_af_aq_doorbell_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_DOORBELL(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_DOORBELL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_DOORBELL(a) cavm_reex_af_aq_doorbell_t
#define bustype_CAVM_REEX_AF_AQ_DOORBELL(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_DOORBELL(a) "REEX_AF_AQ_DOORBELL"
#define device_bar_CAVM_REEX_AF_AQ_DOORBELL(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_DOORBELL(a) (a)
#define arguments_CAVM_REEX_AF_AQ_DOORBELL(a) (a),-1,-1,-1
...
union cavm_reex_af_aq_ena
{
    ...
    /* struct cavm_reex_af_aq_ena_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_ENA(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_ENA", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_ENA(a) cavm_reex_af_aq_ena_t
#define bustype_CAVM_REEX_AF_AQ_ENA(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_ENA(a) "REEX_AF_AQ_ENA"
#define device_bar_CAVM_REEX_AF_AQ_ENA(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_ENA(a) (a)
#define arguments_CAVM_REEX_AF_AQ_ENA(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_aq_int
{
    uint64_t u;
    struct cavm_reex_af_aq_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_reex_af_aq_int_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_INT(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_INT", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_INT(a) cavm_reex_af_aq_int_t
#define bustype_CAVM_REEX_AF_AQ_INT(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_INT(a) "REEX_AF_AQ_INT"
#define device_bar_CAVM_REEX_AF_AQ_INT(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_INT(a) (a)
#define arguments_CAVM_REEX_AF_AQ_INT(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_aq_int_ena_w1c
{
    uint64_t u;
    struct cavm_reex_af_aq_int_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
    ...
    /* struct cavm_reex_af_aq_int_ena_w1c_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_INT_ENA_W1C(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_INT_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_INT_ENA_W1C(a) cavm_reex_af_aq_int_ena_w1c_t
#define bustype_CAVM_REEX_AF_AQ_INT_ENA_W1C(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_INT_ENA_W1C(a) "REEX_AF_AQ_INT_ENA_W1C"
#define device_bar_CAVM_REEX_AF_AQ_INT_ENA_W1C(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_INT_ENA_W1C(a) (a)
#define arguments_CAVM_REEX_AF_AQ_INT_ENA_W1C(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_aq_int_ena_w1s
{
    uint64_t u;
    struct cavm_reex_af_aq_int_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
    ...
    /* struct cavm_reex_af_aq_int_ena_w1s_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_INT_ENA_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_INT_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_INT_ENA_W1S(a) cavm_reex_af_aq_int_ena_w1s_t
#define bustype_CAVM_REEX_AF_AQ_INT_ENA_W1S(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_INT_ENA_W1S(a) "REEX_AF_AQ_INT_ENA_W1S"
#define device_bar_CAVM_REEX_AF_AQ_INT_ENA_W1S(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_INT_ENA_W1S(a) (a)
#define arguments_CAVM_REEX_AF_AQ_INT_ENA_W1S(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_aq_int_w1s
{
    uint64_t u;
    struct cavm_reex_af_aq_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_4_63         : 60;
    ...
    /* struct cavm_reex_af_aq_int_w1s_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_INT_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_INT_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_INT_W1S(a) cavm_reex_af_aq_int_w1s_t
#define bustype_CAVM_REEX_AF_AQ_INT_W1S(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_INT_W1S(a) "REEX_AF_AQ_INT_W1S"
#define device_bar_CAVM_REEX_AF_AQ_INT_W1S(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_INT_W1S(a) (a)
#define arguments_CAVM_REEX_AF_AQ_INT_W1S(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_aq_outstand_job
{
    uint64_t u;
    struct cavm_reex_af_aq_outstand_job_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_9_63         : 55;
    ...
    /* struct cavm_reex_af_aq_outstand_job_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_OUTSTAND_JOB(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_OUTSTAND_JOB", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_OUTSTAND_JOB(a) cavm_reex_af_aq_outstand_job_t
#define bustype_CAVM_REEX_AF_AQ_OUTSTAND_JOB(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_OUTSTAND_JOB(a) "REEX_AF_AQ_OUTSTAND_JOB"
#define device_bar_CAVM_REEX_AF_AQ_OUTSTAND_JOB(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_OUTSTAND_JOB(a) (a)
#define arguments_CAVM_REEX_AF_AQ_OUTSTAND_JOB(a) (a),-1,-1,-1
...
static inline uint64_t CAVM_REEX_AF_AQ_PP_WAIT(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_PP_WAIT", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_PP_WAIT(a) cavm_reex_af_aq_pp_wait_t
#define bustype_CAVM_REEX_AF_AQ_PP_WAIT(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_PP_WAIT(a) "REEX_AF_AQ_PP_WAIT"
#define device_bar_CAVM_REEX_AF_AQ_PP_WAIT(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_PP_WAIT(a) (a)
#define arguments_CAVM_REEX_AF_AQ_PP_WAIT(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_aq_sbuf_addr
{
    uint64_t u;
    struct cavm_reex_af_aq_sbuf_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_reex_af_aq_sbuf_addr_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_SBUF_ADDR(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_SBUF_ADDR", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_SBUF_ADDR(a) cavm_reex_af_aq_sbuf_addr_t
#define bustype_CAVM_REEX_AF_AQ_SBUF_ADDR(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_SBUF_ADDR(a) "REEX_AF_AQ_SBUF_ADDR"
#define device_bar_CAVM_REEX_AF_AQ_SBUF_ADDR(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_SBUF_ADDR(a) (a)
#define arguments_CAVM_REEX_AF_AQ_SBUF_ADDR(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_aq_sbuf_ctl
{
    uint64_t u;
    struct cavm_reex_af_aq_sbuf_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_reex_af_aq_sbuf_ctl_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_AQ_SBUF_CTL(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_AQ_SBUF_CTL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_AQ_SBUF_CTL(a) cavm_reex_af_aq_sbuf_ctl_t
#define bustype_CAVM_REEX_AF_AQ_SBUF_CTL(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_AQ_SBUF_CTL(a) "REEX_AF_AQ_SBUF_CTL"
#define device_bar_CAVM_REEX_AF_AQ_SBUF_CTL(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_AQ_SBUF_CTL(a) (a)
...
union cavm_reex_af_blk_rst
{
    ...
    /* struct cavm_reex_af_blk_rst_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_BLK_RST(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_BLK_RST", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_BLK_RST(a) cavm_reex_af_blk_rst_t
#define bustype_CAVM_REEX_AF_BLK_RST(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_BLK_RST(a) "REEX_AF_BLK_RST"
 ...
 */
union cavm_reex_af_cmd_ctl
{
    uint64_t u;
    struct cavm_reex_af_cmd_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_reex_af_cmd_ctl_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_CMD_CTL(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_CMD_CTL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_CMD_CTL(a) cavm_reex_af_cmd_ctl_t
#define bustype_CAVM_REEX_AF_CMD_CTL(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_CMD_CTL(a) "REEX_AF_CMD_CTL"
#define device_bar_CAVM_REEX_AF_CMD_CTL(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_CMD_CTL(a) (a)
#define arguments_CAVM_REEX_AF_CMD_CTL(a) (a),-1,-1,-1
 ...
 * chip.
 */
union cavm_reex_af_constants
{
    uint64_t u;
    struct cavm_reex_af_constants_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_reex_af_constants_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_CONSTANTS(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_CONSTANTS", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_CONSTANTS(a) cavm_reex_af_constants_t
#define bustype_CAVM_REEX_AF_CONSTANTS(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_CONSTANTS(a) "REEX_AF_CONSTANTS"
#define device_bar_CAVM_REEX_AF_CONSTANTS(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_CONSTANTS(a) (a)
#define arguments_CAVM_REEX_AF_CONSTANTS(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_core_reset
{
    uint64_t u;
    struct cavm_reex_af_core_reset_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_reex_af_core_reset_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_CORE_RESET(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_CORE_RESET", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_CORE_RESET(a) cavm_reex_af_core_reset_t
#define bustype_CAVM_REEX_AF_CORE_RESET(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_CORE_RESET(a) "REEX_AF_CORE_RESET"
#define device_bar_CAVM_REEX_AF_CORE_RESET(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_CORE_RESET(a) (a)
#define arguments_CAVM_REEX_AF_CORE_RESET(a) (a),-1,-1,-1
...
static inline uint64_t CAVM_REEX_AF_CRDT_HALT_NCB_REQ_PC(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_CRDT_HALT_NCB_REQ_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_CRDT_HALT_NCB_REQ_PC(a) cavm_reex_af_crdt_halt_ncb_req_pc_t
#define bustype_CAVM_REEX_AF_CRDT_HALT_NCB_REQ_PC(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_CRDT_HALT_NCB_REQ_PC(a) "REEX_AF_CRDT_HALT_NCB_REQ_PC"
#define device_bar_CAVM_REEX_AF_CRDT_HALT_NCB_REQ_PC(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_CRDT_HALT_NCB_REQ_PC(a) (a)
#define arguments_CAVM_REEX_AF_CRDT_HALT_NCB_REQ_PC(a) (a),-1,-1,-1
 ...
 * values for normal operation. Changing the values of the fields may be useful for diagnostics.
 */
union cavm_reex_af_ctl_cfg
{
    uint64_t u;
    struct cavm_reex_af_ctl_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_reex_af_ctl_cfg_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_CTL_CFG(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_CTL_CFG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_CTL_CFG(a) cavm_reex_af_ctl_cfg_t
#define bustype_CAVM_REEX_AF_CTL_CFG(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_CTL_CFG(a) "REEX_AF_CTL_CFG"
#define device_bar_CAVM_REEX_AF_CTL_CFG(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_CTL_CFG(a) (a)
#define arguments_CAVM_REEX_AF_CTL_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_dbg_quex_sta
{
    uint64_t u;
    struct cavm_reex_af_dbg_quex_sta_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_reex_af_dbg_quex_sta_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_DBG_QUEX_STA(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("REEX_AF_DBG_QUEX_STA", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_DBG_QUEX_STA(a,b) cavm_reex_af_dbg_quex_sta_t
#define bustype_CAVM_REEX_AF_DBG_QUEX_STA(a,b) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_DBG_QUEX_STA(a,b) "REEX_AF_DBG_QUEX_STA"
...
union cavm_reex_af_em_base
{
    ...
    /* struct cavm_reex_af_em_base_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_EM_BASE(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_EM_BASE", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_EM_BASE(a) cavm_reex_af_em_base_t
#define bustype_CAVM_REEX_AF_EM_BASE(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_EM_BASE(a) "REEX_AF_EM_BASE"
#define device_bar_CAVM_REEX_AF_EM_BASE(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_EM_BASE(a) (a)
#define arguments_CAVM_REEX_AF_EM_BASE(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_em_pf_func
{
    uint64_t u;
    struct cavm_reex_af_em_pf_func_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct cavm_reex_af_em_pf_func_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_EM_PF_FUNC(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_EM_PF_FUNC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_EM_PF_FUNC(a) cavm_reex_af_em_pf_func_t
#define bustype_CAVM_REEX_AF_EM_PF_FUNC(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_EM_PF_FUNC(a) "REEX_AF_EM_PF_FUNC"
...
static inline uint64_t CAVM_REEX_AF_INST_LATENCY_PC(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_INST_LATENCY_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_INST_LATENCY_PC(a) cavm_reex_af_inst_latency_pc_t
#define bustype_CAVM_REEX_AF_INST_LATENCY_PC(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_INST_LATENCY_PC(a) "REEX_AF_INST_LATENCY_PC"
#define device_bar_CAVM_REEX_AF_INST_LATENCY_PC(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_INST_LATENCY_PC(a) (a)
#define arguments_CAVM_REEX_AF_INST_LATENCY_PC(a) (a),-1,-1,-1
...
static inline uint64_t CAVM_REEX_AF_INST_REQ_PC(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_INST_REQ_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_INST_REQ_PC(a) cavm_reex_af_inst_req_pc_t
#define bustype_CAVM_REEX_AF_INST_REQ_PC(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_INST_REQ_PC(a) "REEX_AF_INST_REQ_PC"
#define device_bar_CAVM_REEX_AF_INST_REQ_PC(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_INST_REQ_PC(a) (a)
#define arguments_CAVM_REEX_AF_INST_REQ_PC(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_lf_rst
{
    uint64_t u;
    struct cavm_reex_af_lf_rst_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_reex_af_lf_rst_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_LF_RST(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_LF_RST", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_LF_RST(a) cavm_reex_af_lf_rst_t
#define bustype_CAVM_REEX_AF_LF_RST(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_LF_RST(a) "REEX_AF_LF_RST"
#define device_bar_CAVM_REEX_AF_LF_RST(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_LF_RST(a) (a)
#define arguments_CAVM_REEX_AF_LF_RST(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_pf_func
{
    uint64_t u;
    struct cavm_reex_af_pf_func_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct cavm_reex_af_pf_func_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_PF_FUNC(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_PF_FUNC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_PF_FUNC(a) cavm_reex_af_pf_func_t
#define bustype_CAVM_REEX_AF_PF_FUNC(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_PF_FUNC(a) "REEX_AF_PF_FUNC"
#define device_bar_CAVM_REEX_AF_PF_FUNC(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_PF_FUNC(a) (a)
#define arguments_CAVM_REEX_AF_PF_FUNC(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_quex_gcfg
{
    uint64_t u;
    struct cavm_reex_af_quex_gcfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
        uint64_t il2_ldwb              : 1;  /**< [ 15: 15](R/W) Instruction load don't write back.
    ...
    /* struct cavm_reex_af_quex_gcfg_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_QUEX_GCFG(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("REEX_AF_QUEX_GCFG", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_QUEX_GCFG(a,b) cavm_reex_af_quex_gcfg_t
#define bustype_CAVM_REEX_AF_QUEX_GCFG(a,b) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_QUEX_GCFG(a,b) "REEX_AF_QUEX_GCFG"
#define device_bar_CAVM_REEX_AF_QUEX_GCFG(a,b) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_QUEX_GCFG(a,b) (a)
#define arguments_CAVM_REEX_AF_QUEX_GCFG(a,b) (a),(b),-1,-1
 ...
 */
union cavm_reex_af_quex_gmctl
{
    uint64_t u;
    struct cavm_reex_af_quex_gmctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_16_63        : 48;
    ...
    /* struct cavm_reex_af_quex_gmctl_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_QUEX_GMCTL(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("REEX_AF_QUEX_GMCTL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_QUEX_GMCTL(a,b) cavm_reex_af_quex_gmctl_t
#define bustype_CAVM_REEX_AF_QUEX_GMCTL(a,b) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_QUEX_GMCTL(a,b) "REEX_AF_QUEX_GMCTL"
#define device_bar_CAVM_REEX_AF_QUEX_GMCTL(a,b) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_QUEX_GMCTL(a,b) (a)
#define arguments_CAVM_REEX_AF_QUEX_GMCTL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_reex_af_quex_sbuf_ctl
{
    uint64_t u;
    struct cavm_reex_af_quex_sbuf_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_reex_af_quex_sbuf_ctl_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_QUEX_SBUF_CTL(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("REEX_AF_QUEX_SBUF_CTL", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_QUEX_SBUF_CTL(a,b) cavm_reex_af_quex_sbuf_ctl_t
#define bustype_CAVM_REEX_AF_QUEX_SBUF_CTL(a,b) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_QUEX_SBUF_CTL(a,b) "REEX_AF_QUEX_SBUF_CTL"
#define device_bar_CAVM_REEX_AF_QUEX_SBUF_CTL(a,b) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_QUEX_SBUF_CTL(a,b) (a)
#define arguments_CAVM_REEX_AF_QUEX_SBUF_CTL(a,b) (a),(b),-1,-1
 ...
 */
union cavm_reex_af_ras
{
    uint64_t u;
    struct cavm_reex_af_ras_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_3_63         : 61;
...
static inline uint64_t CAVM_REEX_AF_RAS(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_RAS", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_RAS(a) cavm_reex_af_ras_t
#define bustype_CAVM_REEX_AF_RAS(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_RAS(a) "REEX_AF_RAS"
#define device_bar_CAVM_REEX_AF_RAS(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_RAS(a) (a)
#define arguments_CAVM_REEX_AF_RAS(a) (a),-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_reex_af_ras_ena_w1c
{
    uint64_t u;
    struct cavm_reex_af_ras_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_3_63         : 61;
    ...
    /* struct cavm_reex_af_ras_ena_w1c_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_RAS_ENA_W1C(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_RAS_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_RAS_ENA_W1C(a) cavm_reex_af_ras_ena_w1c_t
#define bustype_CAVM_REEX_AF_RAS_ENA_W1C(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_RAS_ENA_W1C(a) "REEX_AF_RAS_ENA_W1C"
#define device_bar_CAVM_REEX_AF_RAS_ENA_W1C(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_RAS_ENA_W1C(a) (a)
#define arguments_CAVM_REEX_AF_RAS_ENA_W1C(a) (a),-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_reex_af_ras_ena_w1s
{
    uint64_t u;
    struct cavm_reex_af_ras_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_3_63         : 61;
    ...
    /* struct cavm_reex_af_ras_ena_w1s_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_RAS_ENA_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_RAS_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_RAS_ENA_W1S(a) cavm_reex_af_ras_ena_w1s_t
#define bustype_CAVM_REEX_AF_RAS_ENA_W1S(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_RAS_ENA_W1S(a) "REEX_AF_RAS_ENA_W1S"
#define device_bar_CAVM_REEX_AF_RAS_ENA_W1S(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_RAS_ENA_W1S(a) (a)
#define arguments_CAVM_REEX_AF_RAS_ENA_W1S(a) (a),-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_reex_af_ras_w1s
{
    uint64_t u;
    struct cavm_reex_af_ras_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_3_63         : 61;
    ...
    /* struct cavm_reex_af_ras_w1s_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_RAS_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_RAS_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_RAS_W1S(a) cavm_reex_af_ras_w1s_t
#define bustype_CAVM_REEX_AF_RAS_W1S(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_RAS_W1S(a) "REEX_AF_RAS_W1S"
#define device_bar_CAVM_REEX_AF_RAS_W1S(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_RAS_W1S(a) (a)
#define arguments_CAVM_REEX_AF_RAS_W1S(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_rd_latency_pc
{
    uint64_t u;
...
static inline uint64_t CAVM_REEX_AF_RD_LATENCY_PC(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_RD_LATENCY_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_RD_LATENCY_PC(a) cavm_reex_af_rd_latency_pc_t
#define bustype_CAVM_REEX_AF_RD_LATENCY_PC(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_RD_LATENCY_PC(a) "REEX_AF_RD_LATENCY_PC"
#define device_bar_CAVM_REEX_AF_RD_LATENCY_PC(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_RD_LATENCY_PC(a) (a)
#define arguments_CAVM_REEX_AF_RD_LATENCY_PC(a) (a),-1,-1,-1
...
static inline uint64_t CAVM_REEX_AF_RD_REQ_PC(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_RD_REQ_PC", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_RD_REQ_PC(a) cavm_reex_af_rd_req_pc_t
#define bustype_CAVM_REEX_AF_RD_REQ_PC(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_RD_REQ_PC(a) "REEX_AF_RD_REQ_PC"
 ...
 */
union cavm_reex_af_rvu_int
{
    uint64_t u;
    struct cavm_reex_af_rvu_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_reex_af_rvu_int_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_RVU_INT(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_RVU_INT", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_RVU_INT(a) cavm_reex_af_rvu_int_t
#define bustype_CAVM_REEX_AF_RVU_INT(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_RVU_INT(a) "REEX_AF_RVU_INT"
#define device_bar_CAVM_REEX_AF_RVU_INT(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_RVU_INT(a) (a)
#define arguments_CAVM_REEX_AF_RVU_INT(a) (a),-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_reex_af_rvu_int_ena_w1c
{
    uint64_t u;
    struct cavm_reex_af_rvu_int_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_reex_af_rvu_int_ena_w1c_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_RVU_INT_ENA_W1C(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_RVU_INT_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_RVU_INT_ENA_W1C(a) cavm_reex_af_rvu_int_ena_w1c_t
#define bustype_CAVM_REEX_AF_RVU_INT_ENA_W1C(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_RVU_INT_ENA_W1C(a) "REEX_AF_RVU_INT_ENA_W1C"
#define device_bar_CAVM_REEX_AF_RVU_INT_ENA_W1C(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_RVU_INT_ENA_W1C(a) (a)
#define arguments_CAVM_REEX_AF_RVU_INT_ENA_W1C(a) (a),-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_reex_af_rvu_int_ena_w1s
{
    uint64_t u;
    struct cavm_reex_af_rvu_int_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_reex_af_rvu_int_ena_w1s_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_RVU_INT_ENA_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_RVU_INT_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_RVU_INT_ENA_W1S(a) cavm_reex_af_rvu_int_ena_w1s_t
#define bustype_CAVM_REEX_AF_RVU_INT_ENA_W1S(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_RVU_INT_ENA_W1S(a) "REEX_AF_RVU_INT_ENA_W1S"
#define device_bar_CAVM_REEX_AF_RVU_INT_ENA_W1S(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_RVU_INT_ENA_W1S(a) (a)
#define arguments_CAVM_REEX_AF_RVU_INT_ENA_W1S(a) (a),-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_reex_af_rvu_int_w1s
{
    uint64_t u;
    struct cavm_reex_af_rvu_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_reex_af_rvu_int_w1s_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_RVU_INT_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_RVU_INT_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_RVU_INT_W1S(a) cavm_reex_af_rvu_int_w1s_t
#define bustype_CAVM_REEX_AF_RVU_INT_W1S(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_RVU_INT_W1S(a) "REEX_AF_RVU_INT_W1S"
#define device_bar_CAVM_REEX_AF_RVU_INT_W1S(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_RVU_INT_W1S(a) (a)
#define arguments_CAVM_REEX_AF_RVU_INT_W1S(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_af_rvu_lf_cfg_debug
{
    uint64_t u;
    struct cavm_reex_af_rvu_lf_cfg_debug_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_40_63        : 24;
    ...
    /* struct cavm_reex_af_rvu_lf_cfg_debug_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_RVU_LF_CFG_DEBUG(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_RVU_LF_CFG_DEBUG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_RVU_LF_CFG_DEBUG(a) cavm_reex_af_rvu_lf_cfg_debug_t
#define bustype_CAVM_REEX_AF_RVU_LF_CFG_DEBUG(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_RVU_LF_CFG_DEBUG(a) "REEX_AF_RVU_LF_CFG_DEBUG"
 ...
 */
union cavm_reex_af_throttle
{
    uint64_t u;
    struct cavm_reex_af_throttle_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_7_63         : 57;
    ...
    /* struct cavm_reex_af_throttle_s cn; */
};
...
static inline uint64_t CAVM_REEX_AF_THROTTLE(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_AF_THROTTLE", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_AF_THROTTLE(a) cavm_reex_af_throttle_t
#define bustype_CAVM_REEX_AF_THROTTLE(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_AF_THROTTLE(a) "REEX_AF_THROTTLE"
#define device_bar_CAVM_REEX_AF_THROTTLE(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_AF_THROTTLE(a) (a)
#define arguments_CAVM_REEX_AF_THROTTLE(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_lf_done
{
    uint64_t u;
    struct cavm_reex_lf_done_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
...
static inline uint64_t CAVM_REEX_LF_DONE(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_DONE", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_DONE(a) cavm_reex_lf_done_t
#define bustype_CAVM_REEX_LF_DONE(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_DONE(a) "REEX_LF_DONE"
#define device_bar_CAVM_REEX_LF_DONE(a) 0x2 /* RVU_BAR2 */
#define busnum_CAVM_REEX_LF_DONE(a) (a)
#define arguments_CAVM_REEX_LF_DONE(a) (a),-1,-1,-1
 ...
 * This register is written by software to acknowledge interrupts.
 */
union cavm_reex_lf_done_ack
{
    uint64_t u;
    struct cavm_reex_lf_done_ack_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_reex_lf_done_ack_s cn; */
};
...
static inline uint64_t CAVM_REEX_LF_DONE_ACK(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_DONE_ACK", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_DONE_ACK(a) cavm_reex_lf_done_ack_t
#define bustype_CAVM_REEX_LF_DONE_ACK(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_DONE_ACK(a) "REEX_LF_DONE_ACK"
#define device_bar_CAVM_REEX_LF_DONE_ACK(a) 0x2 /* RVU_BAR2 */
#define busnum_CAVM_REEX_LF_DONE_ACK(a) (a)
 ...
 */
union cavm_reex_lf_done_int_ena_w1c
{
    uint64_t u;
    struct cavm_reex_lf_done_int_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
        uint64_t done_ena              : 1;  /**< [  0:  0](R/W1C/H) Writing 1 will disable DONEINT for this queue. Writing 0 has no effect.
    ...
    /* struct cavm_reex_lf_done_int_ena_w1c_s cn; */
};
...
static inline uint64_t CAVM_REEX_LF_DONE_INT_ENA_W1C(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_DONE_INT_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_DONE_INT_ENA_W1C(a) cavm_reex_lf_done_int_ena_w1c_t
#define bustype_CAVM_REEX_LF_DONE_INT_ENA_W1C(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_DONE_INT_ENA_W1C(a) "REEX_LF_DONE_INT_ENA_W1C"
#define device_bar_CAVM_REEX_LF_DONE_INT_ENA_W1C(a) 0x2 /* RVU_BAR2 */
#define busnum_CAVM_REEX_LF_DONE_INT_ENA_W1C(a) (a)
#define arguments_CAVM_REEX_LF_DONE_INT_ENA_W1C(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_lf_done_int_ena_w1s
{
    uint64_t u;
    struct cavm_reex_lf_done_int_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
    ...
    /* struct cavm_reex_lf_done_int_ena_w1s_s cn; */
};
...
static inline uint64_t CAVM_REEX_LF_DONE_INT_ENA_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_DONE_INT_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_DONE_INT_ENA_W1S(a) cavm_reex_lf_done_int_ena_w1s_t
#define bustype_CAVM_REEX_LF_DONE_INT_ENA_W1S(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_DONE_INT_ENA_W1S(a) "REEX_LF_DONE_INT_ENA_W1S"
...
{
    uint64_t u;
    struct cavm_reex_lf_done_wait_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_reex_lf_done_wait_s cn; */
};
...
static inline uint64_t CAVM_REEX_LF_DONE_WAIT(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_DONE_WAIT", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_DONE_WAIT(a) cavm_reex_lf_done_wait_t
#define bustype_CAVM_REEX_LF_DONE_WAIT(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_DONE_WAIT(a) "REEX_LF_DONE_WAIT"
#define device_bar_CAVM_REEX_LF_DONE_WAIT(a) 0x2 /* RVU_BAR2 */
#define busnum_CAVM_REEX_LF_DONE_WAIT(a) (a)
#define arguments_CAVM_REEX_LF_DONE_WAIT(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_lf_doorbell
{
    uint64_t u;
    struct cavm_reex_lf_doorbell_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_reex_lf_doorbell_s cn; */
};
...
static inline uint64_t CAVM_REEX_LF_DOORBELL(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_DOORBELL", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_DOORBELL(a) cavm_reex_lf_doorbell_t
#define bustype_CAVM_REEX_LF_DOORBELL(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_DOORBELL(a) "REEX_LF_DOORBELL"
#define device_bar_CAVM_REEX_LF_DOORBELL(a) 0x2 /* RVU_BAR2 */
#define busnum_CAVM_REEX_LF_DOORBELL(a) (a)
#define arguments_CAVM_REEX_LF_DOORBELL(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_lf_ena
{
    uint64_t u;
    struct cavm_reex_lf_ena_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_1_63         : 63;
...
static inline uint64_t CAVM_REEX_LF_ENA(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_ENA", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_ENA(a) cavm_reex_lf_ena_t
#define bustype_CAVM_REEX_LF_ENA(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_ENA(a) "REEX_LF_ENA"
#define device_bar_CAVM_REEX_LF_ENA(a) 0x2 /* RVU_BAR2 */
#define busnum_CAVM_REEX_LF_ENA(a) (a)
#define arguments_CAVM_REEX_LF_ENA(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_lf_misc_int
{
    uint64_t u;
    struct cavm_reex_lf_misc_int_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_10_63        : 54;
    ...
    /* struct cavm_reex_lf_misc_int_s cn; */
};
...
static inline uint64_t CAVM_REEX_LF_MISC_INT(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_MISC_INT", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_MISC_INT(a) cavm_reex_lf_misc_int_t
#define bustype_CAVM_REEX_LF_MISC_INT(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_MISC_INT(a) "REEX_LF_MISC_INT"
#define device_bar_CAVM_REEX_LF_MISC_INT(a) 0x2 /* RVU_BAR2 */
#define busnum_CAVM_REEX_LF_MISC_INT(a) (a)
#define arguments_CAVM_REEX_LF_MISC_INT(a) (a),-1,-1,-1
 ...
 * This register clears interrupt enable bits.
 */
union cavm_reex_lf_misc_int_ena_w1c
{
    uint64_t u;
    struct cavm_reex_lf_misc_int_ena_w1c_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_10_63        : 54;
    ...
    /* struct cavm_reex_lf_misc_int_ena_w1c_s cn; */
};
...
static inline uint64_t CAVM_REEX_LF_MISC_INT_ENA_W1C(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_MISC_INT_ENA_W1C", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_MISC_INT_ENA_W1C(a) cavm_reex_lf_misc_int_ena_w1c_t
#define bustype_CAVM_REEX_LF_MISC_INT_ENA_W1C(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_MISC_INT_ENA_W1C(a) "REEX_LF_MISC_INT_ENA_W1C"
#define device_bar_CAVM_REEX_LF_MISC_INT_ENA_W1C(a) 0x2 /* RVU_BAR2 */
#define busnum_CAVM_REEX_LF_MISC_INT_ENA_W1C(a) (a)
#define arguments_CAVM_REEX_LF_MISC_INT_ENA_W1C(a) (a),-1,-1,-1
 ...
 * This register sets interrupt enable bits.
 */
union cavm_reex_lf_misc_int_ena_w1s
{
    uint64_t u;
    struct cavm_reex_lf_misc_int_ena_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_10_63        : 54;
    ...
    /* struct cavm_reex_lf_misc_int_ena_w1s_s cn; */
};
...
static inline uint64_t CAVM_REEX_LF_MISC_INT_ENA_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_MISC_INT_ENA_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_MISC_INT_ENA_W1S(a) cavm_reex_lf_misc_int_ena_w1s_t
#define bustype_CAVM_REEX_LF_MISC_INT_ENA_W1S(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_MISC_INT_ENA_W1S(a) "REEX_LF_MISC_INT_ENA_W1S"
#define device_bar_CAVM_REEX_LF_MISC_INT_ENA_W1S(a) 0x2 /* RVU_BAR2 */
#define busnum_CAVM_REEX_LF_MISC_INT_ENA_W1S(a) (a)
#define arguments_CAVM_REEX_LF_MISC_INT_ENA_W1S(a) (a),-1,-1,-1
 ...
 * This register sets interrupt bits.
 */
union cavm_reex_lf_misc_int_w1s
{
    uint64_t u;
    struct cavm_reex_lf_misc_int_w1s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_10_63        : 54;
    ...
    /* struct cavm_reex_lf_misc_int_w1s_s cn; */
};
...
static inline uint64_t CAVM_REEX_LF_MISC_INT_W1S(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_MISC_INT_W1S", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_MISC_INT_W1S(a) cavm_reex_lf_misc_int_w1s_t
#define bustype_CAVM_REEX_LF_MISC_INT_W1S(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_MISC_INT_W1S(a) "REEX_LF_MISC_INT_W1S"
#define device_bar_CAVM_REEX_LF_MISC_INT_W1S(a) 0x2 /* RVU_BAR2 */
#define busnum_CAVM_REEX_LF_MISC_INT_W1S(a) (a)
#define arguments_CAVM_REEX_LF_MISC_INT_W1S(a) (a),-1,-1,-1
 ...
 * from the doorbell count to the time it is retired.
 */
union cavm_reex_lf_outstand_job
{
    uint64_t u;
    struct cavm_reex_lf_outstand_job_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_8_63         : 56;
    ...
    /* struct cavm_reex_lf_outstand_job_s cn; */
};
...
static inline uint64_t CAVM_REEX_LF_OUTSTAND_JOB(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_OUTSTAND_JOB", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_OUTSTAND_JOB(a) cavm_reex_lf_outstand_job_t
#define bustype_CAVM_REEX_LF_OUTSTAND_JOB(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_OUTSTAND_JOB(a) "REEX_LF_OUTSTAND_JOB"
#define device_bar_CAVM_REEX_LF_OUTSTAND_JOB(a) 0x2 /* RVU_BAR2 */
#define busnum_CAVM_REEX_LF_OUTSTAND_JOB(a) (a)
#define arguments_CAVM_REEX_LF_OUTSTAND_JOB(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_lf_sbuf_addr
{
    uint64_t u;
    struct cavm_reex_lf_sbuf_addr_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_53_63        : 11;
        uint64_t ptr                   : 46; /**< [ 52:  7](R/W/H) Instruction buffer pointer bits \<52:7\> (128-byte aligned). Behavior is unpredictable if
    ...
    /* struct cavm_reex_lf_sbuf_addr_s cn; */
};
...
static inline uint64_t CAVM_REEX_LF_SBUF_ADDR(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_LF_SBUF_ADDR", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_LF_SBUF_ADDR(a) cavm_reex_lf_sbuf_addr_t
#define bustype_CAVM_REEX_LF_SBUF_ADDR(a) CSR_TYPE_RVU_PFVF_BAR2
#define basename_CAVM_REEX_LF_SBUF_ADDR(a) "REEX_LF_SBUF_ADDR"
#define device_bar_CAVM_REEX_LF_SBUF_ADDR(a) 0x2 /* RVU_BAR2 */
#define busnum_CAVM_REEX_LF_SBUF_ADDR(a) (a)
#define arguments_CAVM_REEX_LF_SBUF_ADDR(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_priv_af_int_cfg
{
    uint64_t u;
    struct cavm_reex_priv_af_int_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_reex_priv_af_int_cfg_s cn; */
};
...
static inline uint64_t CAVM_REEX_PRIV_AF_INT_CFG(unsigned long a)
{
    ...
    __cavm_csr_fatal("REEX_PRIV_AF_INT_CFG", 1, a, 0, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_PRIV_AF_INT_CFG(a) cavm_reex_priv_af_int_cfg_t
#define bustype_CAVM_REEX_PRIV_AF_INT_CFG(a) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_PRIV_AF_INT_CFG(a) "REEX_PRIV_AF_INT_CFG"
#define device_bar_CAVM_REEX_PRIV_AF_INT_CFG(a) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_PRIV_AF_INT_CFG(a) (a)
#define arguments_CAVM_REEX_PRIV_AF_INT_CFG(a) (a),-1,-1,-1
 ...
 */
union cavm_reex_priv_lfx_cfg
{
    uint64_t u;
    struct cavm_reex_priv_lfx_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_reex_priv_lfx_cfg_s cn; */
};
...
static inline uint64_t CAVM_REEX_PRIV_LFX_CFG(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("REEX_PRIV_LFX_CFG", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_PRIV_LFX_CFG(a,b) cavm_reex_priv_lfx_cfg_t
#define bustype_CAVM_REEX_PRIV_LFX_CFG(a,b) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_PRIV_LFX_CFG(a,b) "REEX_PRIV_LFX_CFG"
#define device_bar_CAVM_REEX_PRIV_LFX_CFG(a,b) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_PRIV_LFX_CFG(a,b) (a)
#define arguments_CAVM_REEX_PRIV_LFX_CFG(a,b) (a),(b),-1,-1
 ...
 */
union cavm_reex_priv_lfx_int_cfg
{
    uint64_t u;
    struct cavm_reex_priv_lfx_int_cfg_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_20_63        : 44;
    ...
    /* struct cavm_reex_priv_lfx_int_cfg_s cn; */
};
...
static inline uint64_t CAVM_REEX_PRIV_LFX_INT_CFG(unsigned long a, unsigned long b)
{
    ...
    __cavm_csr_fatal("REEX_PRIV_LFX_INT_CFG", 2, a, b, 0, 0, 0, 0);
}

#define typedef_CAVM_REEX_PRIV_LFX_INT_CFG(a,b) cavm_reex_priv_lfx_int_cfg_t
#define bustype_CAVM_REEX_PRIV_LFX_INT_CFG(a,b) CSR_TYPE_RVU_PF_BAR0
#define basename_CAVM_REEX_PRIV_LFX_INT_CFG(a,b) "REEX_PRIV_LFX_INT_CFG"
#define device_bar_CAVM_REEX_PRIV_LFX_INT_CFG(a,b) 0x0 /* RVU_BAR0 */
#define busnum_CAVM_REEX_PRIV_LFX_INT_CFG(a,b) (a)
#define arguments_CAVM_REEX_PRIV_LFX_INT_CFG(a,b) (a),(b),-1,-1

#endif /* __CAVM_CSRS_REE_H__ */
