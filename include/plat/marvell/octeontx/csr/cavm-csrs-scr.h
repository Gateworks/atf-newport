#ifndef __CAVM_CSRS_SCR_H__
#define __CAVM_CSRS_SCR_H__
 ...
 */
#define CAVM_SCR_CMP_TYPE_E_EQ (0)
#define CAVM_SCR_CMP_TYPE_E_GE (4)
#define CAVM_SCR_CMP_TYPE_E_GT (5)
#define CAVM_SCR_CMP_TYPE_E_LE (1)
#define CAVM_SCR_CMP_TYPE_E_LT (2)
#define CAVM_SCR_CMP_TYPE_E_NE (3)
 ...
 */
union cavm_scr_cmp_and_exit_s
{
    uint64_t u[2];
    struct cavm_scr_cmp_and_exit_s_s
    {
    ...
    /* struct cavm_scr_cmp_and_exit_s_s cn; */
};
 ...
 */
union cavm_scr_cmp_and_jump_s
{
    uint64_t u[2];
    struct cavm_scr_cmp_and_jump_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t op                    : 8;  /**< [ 63: 56] Opcode. */
        uint64_t rsl64                 : 1;  /**< [ 55: 55] The RSL bus size.
    ...
    /* struct cavm_scr_cmp_and_jump_s_s cn; */
};
 ...
 */
union cavm_scr_cmp_and_spin_s
{
    uint64_t u[2];
    struct cavm_scr_cmp_and_spin_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t op                    : 8;  /**< [ 63: 56] Opcode. */
    ...
    /* struct cavm_scr_cmp_and_spin_s_s cn; */
};
 ...
 */
union cavm_scr_exit_s
{
    uint64_t u[2];
    struct cavm_scr_exit_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t op                    : 8;  /**< [ 63: 56] Opcode. */
 ...
 */
union cavm_scr_generic_s
{
    uint64_t u[2];
    struct cavm_scr_generic_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t op                    : 8;  /**< [ 63: 56] Opcode. */
        uint64_t reserved_0_55         : 56;
 ...
 */
union cavm_scr_noop_s
{
    uint64_t u[2];
    struct cavm_scr_noop_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t op                    : 8;  /**< [ 63: 56] Opcode. */
        uint64_t reserved_0_55         : 56;
 ...
 */
union cavm_scr_setup_cmp_s
{
    uint64_t u[2];
    struct cavm_scr_setup_cmp_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t op                    : 8;  /**< [ 63: 56] Opcode. */
    ...
    /* struct cavm_scr_setup_cmp_s_s cn; */
};
 ...
 */
union cavm_scr_wait_s
{
    uint64_t u[2];
    struct cavm_scr_wait_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t op                    : 8;  /**< [ 63: 56] Opcode. */
 ...
 */
union cavm_scr_write32_s
{
    uint64_t u[2];
    struct cavm_scr_write32_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t op                    : 8;  /**< [ 63: 56] Opcode. */
    ...
    /* struct cavm_scr_write32_s_s cn9; */
    /* struct cavm_scr_write32_s_s cn96xxp1; */
    struct cavm_scr_write32_s_cn96xxp3
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t op                    : 8;  /**< [ 63: 56] Opcode. */
        uint64_t addr                  : 56; /**< [ 55:  0] Address. The address must be to a permitted address, or the write will be
 ...
 */
union cavm_scr_write64_s
{
    uint64_t u[2];
    struct cavm_scr_write64_s_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t op                    : 8;  /**< [ 63: 56] Opcode. */
