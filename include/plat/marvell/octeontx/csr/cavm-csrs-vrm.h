#ifndef __CAVM_CSRS_VRM_H__
#define __CAVM_CSRS_VRM_H__
 ...
 */
#define CAVM_VRM_BAR_E_VRMX_PF_BAR0(a) (0x87e021000000ll + 0x1000000ll * (a))
#define CAVM_VRM_BAR_E_VRMX_PF_BAR0_SIZE 0x100000ull
 ...
 */
#define CAVM_VRM_TYPE_E_ISL6367 (1)
#define CAVM_VRM_TYPE_E_PMB_LIN (0)
#define CAVM_VRM_TYPE_E_PMB_VID (2)
#define CAVM_VRM_TYPE_E_PMB_VID_TPS53641 (4)
 ...
 */
union cavm_vrm_tws_twsi_sw_s
{
    uint64_t u;
    struct cavm_vrm_tws_twsi_sw_s_s
    {
    ...
    /* struct cavm_vrm_tws_twsi_sw_s_s cn; */
};
 ...
 */
union cavm_vrmx_alt_fuse
{
    uint64_t u;
    struct cavm_vrmx_alt_fuse_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_vrmx_alt_fuse_s cn; */
};
...
#define bustype_CAVM_VRMX_ALT_FUSE(a) CSR_TYPE_RSL
#define basename_CAVM_VRMX_ALT_FUSE(a) "VRMX_ALT_FUSE"
#define device_bar_CAVM_VRMX_ALT_FUSE(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_VRMX_ALT_FUSE(a) (a)
#define arguments_CAVM_VRMX_ALT_FUSE(a) (a),-1,-1,-1
 ...
 */
union cavm_vrmx_device_status
{
    uint64_t u;
    struct cavm_vrmx_device_status_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_vrmx_device_status_s cn; */
};
...
#define bustype_CAVM_VRMX_DEVICE_STATUS(a) CSR_TYPE_RSL
#define basename_CAVM_VRMX_DEVICE_STATUS(a) "VRMX_DEVICE_STATUS"
#define device_bar_CAVM_VRMX_DEVICE_STATUS(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_VRMX_DEVICE_STATUS(a) (a)
 ...
 */
union cavm_vrmx_fuse_bypass
{
    uint64_t u;
    struct cavm_vrmx_fuse_bypass_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_vrmx_fuse_bypass_s cn; */
};
...
#define bustype_CAVM_VRMX_FUSE_BYPASS(a) CSR_TYPE_RSL
#define basename_CAVM_VRMX_FUSE_BYPASS(a) "VRMX_FUSE_BYPASS"
#define device_bar_CAVM_VRMX_FUSE_BYPASS(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_VRMX_FUSE_BYPASS(a) (a)
#define arguments_CAVM_VRMX_FUSE_BYPASS(a) (a),-1,-1,-1
 ...
 */
union cavm_vrmx_misc_info
{
    uint64_t u;
    struct cavm_vrmx_misc_info_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_vrmx_misc_info_s cn; */
};
...
#define bustype_CAVM_VRMX_MISC_INFO(a) CSR_TYPE_RSL
#define basename_CAVM_VRMX_MISC_INFO(a) "VRMX_MISC_INFO"
#define device_bar_CAVM_VRMX_MISC_INFO(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_VRMX_MISC_INFO(a) (a)
#define arguments_CAVM_VRMX_MISC_INFO(a) (a),-1,-1,-1
 ...
 */
union cavm_vrmx_telemetry_cmnd
{
    uint64_t u;
    struct cavm_vrmx_telemetry_cmnd_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_vrmx_telemetry_cmnd_s cn; */
};
...
#define bustype_CAVM_VRMX_TELEMETRY_CMND(a) CSR_TYPE_RSL
#define basename_CAVM_VRMX_TELEMETRY_CMND(a) "VRMX_TELEMETRY_CMND"
#define device_bar_CAVM_VRMX_TELEMETRY_CMND(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_VRMX_TELEMETRY_CMND(a) (a)
#define arguments_CAVM_VRMX_TELEMETRY_CMND(a) (a),-1,-1,-1
 ...
 */
union cavm_vrmx_telemetry_read
{
    uint64_t u;
    struct cavm_vrmx_telemetry_read_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
        uint64_t reserved_32_63        : 32;
    ...
    /* struct cavm_vrmx_telemetry_read_s cn; */
};
...
#define bustype_CAVM_VRMX_TELEMETRY_READ(a) CSR_TYPE_RSL
#define basename_CAVM_VRMX_TELEMETRY_READ(a) "VRMX_TELEMETRY_READ"
#define device_bar_CAVM_VRMX_TELEMETRY_READ(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_VRMX_TELEMETRY_READ(a) (a)
#define arguments_CAVM_VRMX_TELEMETRY_READ(a) (a),-1,-1,-1
 ...
 */
union cavm_vrmx_trip
{
    uint64_t u;
    struct cavm_vrmx_trip_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
...
#define bustype_CAVM_VRMX_TRIP(a) CSR_TYPE_RSL
#define basename_CAVM_VRMX_TRIP(a) "VRMX_TRIP"
#define device_bar_CAVM_VRMX_TRIP(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_VRMX_TRIP(a) (a)
#define arguments_CAVM_VRMX_TRIP(a) (a),-1,-1,-1
 ...
 */
union cavm_vrmx_ts_temp_conv_coeff_fsm
{
    uint64_t u;
    struct cavm_vrmx_ts_temp_conv_coeff_fsm_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_vrmx_ts_temp_conv_coeff_fsm_s cn; */
};
...
#define bustype_CAVM_VRMX_TS_TEMP_CONV_COEFF_FSM(a) CSR_TYPE_RSL
#define basename_CAVM_VRMX_TS_TEMP_CONV_COEFF_FSM(a) "VRMX_TS_TEMP_CONV_COEFF_FSM"
#define device_bar_CAVM_VRMX_TS_TEMP_CONV_COEFF_FSM(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_VRMX_TS_TEMP_CONV_COEFF_FSM(a) (a)
#define arguments_CAVM_VRMX_TS_TEMP_CONV_COEFF_FSM(a) (a),-1,-1,-1
 ...
 */
union cavm_vrmx_ts_temp_conv_ctl
{
    uint64_t u;
    struct cavm_vrmx_ts_temp_conv_ctl_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_vrmx_ts_temp_conv_ctl_s cn; */
};
...
#define bustype_CAVM_VRMX_TS_TEMP_CONV_CTL(a) CSR_TYPE_RSL
#define basename_CAVM_VRMX_TS_TEMP_CONV_CTL(a) "VRMX_TS_TEMP_CONV_CTL"
#define device_bar_CAVM_VRMX_TS_TEMP_CONV_CTL(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_VRMX_TS_TEMP_CONV_CTL(a) (a)
#define arguments_CAVM_VRMX_TS_TEMP_CONV_CTL(a) (a),-1,-1,-1
 ...
 */
union cavm_vrmx_ts_temp_conv_result
{
    uint64_t u;
    struct cavm_vrmx_ts_temp_conv_result_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_vrmx_ts_temp_conv_result_s cn; */
};
...
#define bustype_CAVM_VRMX_TS_TEMP_CONV_RESULT(a) CSR_TYPE_RSL
#define basename_CAVM_VRMX_TS_TEMP_CONV_RESULT(a) "VRMX_TS_TEMP_CONV_RESULT"
#define device_bar_CAVM_VRMX_TS_TEMP_CONV_RESULT(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_VRMX_TS_TEMP_CONV_RESULT(a) (a)
#define arguments_CAVM_VRMX_TS_TEMP_CONV_RESULT(a) (a),-1,-1,-1
 ...
 */
union cavm_vrmx_ts_temp_noff_mc
{
    uint64_t u;
    struct cavm_vrmx_ts_temp_noff_mc_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_vrmx_ts_temp_noff_mc_s cn; */
};
...
#define bustype_CAVM_VRMX_TS_TEMP_NOFF_MC(a) CSR_TYPE_RSL
#define basename_CAVM_VRMX_TS_TEMP_NOFF_MC(a) "VRMX_TS_TEMP_NOFF_MC"
#define device_bar_CAVM_VRMX_TS_TEMP_NOFF_MC(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_VRMX_TS_TEMP_NOFF_MC(a) (a)
#define arguments_CAVM_VRMX_TS_TEMP_NOFF_MC(a) (a),-1,-1,-1
 ...
 */
union cavm_vrmx_tws_twsi_sw
{
    uint64_t u;
    struct cavm_vrmx_tws_twsi_sw_s
    {
#if __BYTE_ORDER == __BIG_ENDIAN /* Word 0 - Big Endian */
    ...
    /* struct cavm_vrmx_tws_twsi_sw_s cn; */
};
...
#define bustype_CAVM_VRMX_TWS_TWSI_SW(a) CSR_TYPE_RSL
#define basename_CAVM_VRMX_TWS_TWSI_SW(a) "VRMX_TWS_TWSI_SW"
#define device_bar_CAVM_VRMX_TWS_TWSI_SW(a) 0x0 /* PF_BAR0 */
#define busnum_CAVM_VRMX_TWS_TWSI_SW(a) (a)
#define arguments_CAVM_VRMX_TWS_TWSI_SW(a) (a),-1,-1,-1

#endif /* __CAVM_CSRS_VRM_H__ */
