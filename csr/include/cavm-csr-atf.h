...
//#define CSR_READ_T(base, csr) cavm_csr_read(base, offset_##csr, bustype_##csr, busnum_##csr, sizeof(typedef_##csr))

//#define CSR_WRITE_T(base, csr, value) cavm_csr_write(base, offset_##csr, bustype_##csr, busnum_##csr, sizeof(typedef_##csr), value)
