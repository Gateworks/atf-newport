...
case $build_name in
	...
	*_cn9131_ddr32* )    build_flags="DEBUG=0 USE_COHERENT_MEM=0 LOG_LEVEL=20 WORKAROUND_CVE_2018_3639=0 DDR32=1"; ;;
	*_cn9131* )    build_flags="DEBUG=0 USE_COHERENT_MEM=0 LOG_LEVEL=20 WORKAROUND_CVE_2018_3639=0 CP_NUM=2"; ;;
	*_cn9132_ddr32* )    build_flags="DEBUG=0 USE_COHERENT_MEM=0 LOG_LEVEL=20 WORKAROUND_CVE_2018_3639=0 DDR32=1"; ;;
