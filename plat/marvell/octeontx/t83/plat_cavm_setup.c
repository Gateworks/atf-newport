...
void plat_add_mmio_node(unsigned long node)
{
	...
	for (i = 0; i < 2; i++) {
		add_map_record(CSR_PA(node, CAVM_SMMU_BAR_E_SMMUX_PF_BAR0_CN8(i)), CAVM_SMMU_BAR_E_SMMUX_PF_BAR0_CN8_SIZE, attr);
		add_map_record(CSR_PA(node, CAVM_SMMU_BAR_E_SMMUX_PF_BAR4(i)), CAVM_SMMU_BAR_E_SMMUX_PF_BAR4_SIZE, attr);
	}
	...
	for (i = 0; i < 2; i++)
		add_map_record(CSR_PA(node, CAVM_LMC_BAR_E_LMCX_PF_BAR0(i)), CAVM_LMC_BAR_E_LMCX_PF_BAR0_SIZE, attr);
	...
	for (i = 0; i < 4; i++) {
		add_map_record(CSR_PA(node, CAVM_L2C_CBC_BAR_E_L2C_CBCX_PF_BAR0(i)), CAVM_L2C_CBC_BAR_E_L2C_CBCX_PF_BAR0_SIZE, attr);
		add_map_record(CSR_PA(node, CAVM_L2C_MCI_BAR_E_L2C_MCIX_PF_BAR0(i)), CAVM_L2C_MCI_BAR_E_L2C_MCIX_PF_BAR0_SIZE, attr);
	}
	for (i = 0; i < 4; i++)
		add_map_record(CSR_PA(node, CAVM_L2C_TAD_BAR_E_L2C_TADX_PF_BAR0(i)), CAVM_L2C_TAD_BAR_E_L2C_TADX_PF_BAR0_SIZE, attr);
	...
	for (i = 0; i < 2; i++) {
		add_map_record(CSR_PA(node, CAVM_ECAM_BAR_E_ECAMX_PF_BAR0_CN8(i)), CAVM_ECAM_BAR_E_ECAMX_PF_BAR0_CN8_SIZE, attr);
		add_map_record(CSR_PA(node, ECAM_PF_BAR2(i)), CAVM_ECAM_BAR_E_ECAMX_PF_BAR2_CN8_SIZE, attr);
	}

	add_map_record(CSR_PA(node, CAVM_SLI_BAR_E_SLIX_PF_BAR0_CN83XX(0)), CAVM_SLI_BAR_E_SLIX_PF_BAR0_CN83XX_SIZE, attr);
