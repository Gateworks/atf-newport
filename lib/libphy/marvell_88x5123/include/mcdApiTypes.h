...
{
    MCD_MODE_UNKNOWN,
    MCD_MODE_P100_40_C,  /* AutoNeg with both 40G/100G CR4 advertised */
    MCD_MODE_P100L,      /* X5121 and X5123: 100G-LR4 PCS No FEC No AN */
    MCD_MODE_P100S,      /* X5121 and X5123: 100G-SR4 PCS w/FEC No AN */
    MCD_MODE_P100C,      /* X5121 and X5123: 100G-CR4 PCS w/FEC AN advertises only 100G-CR4 */
    MCD_MODE_P100K,      /* X5121 and X5123: 100G-KR4 PCS w/FEC AN advertises only 100G-KR4*/
    MCD_MODE_P40L,       /* X5121, X5123 and X2381: 40G-LR4/SR4 PCS No FEC No AN */
    MCD_MODE_P40C,       /* X5121, X5123 and X2381: 40G-CR4 PCS No FEC AN advertises only 40G-CR4 */
    MCD_MODE_P40K,       /* X5121, X5123 and X2381: 40G-KR4 PCS No FEC AN advertises only 40G-KR4 */
    MCD_MODE_P100_40_K,  /* AutoNeg with both 40G/100G KR4 advertised */
                         /* Repeater Modes */
    MCD_MODE_R100L,      /* X5121 and X5123 */
    MCD_MODE_R100C,      /* X5121 and X5123 */
    MCD_MODE_R25L,       /* X5121 and X5123 */
    MCD_MODE_R25C,       /* X5121 and X5123 */
    MCD_MODE_BM21L,      /* X5121 only */
    MCD_MODE_BM21C,      /* X5121 only */

    MCD_MODE_R10L,       /* X5121, X5123 and X2381: 10GB-SR/LR repeater mode No PCS/FEC/AN */
    MCD_MODE_R10K,       /* X5121, X5123 and X2381: 10GB-CR/KR repeater mode No PCS/FEC AN enabled */

    MCD_MODE_R40L,       /* X5121, X5123 and X2381 */
    MCD_MODE_R40C,       /* X5121, X5123 and X2381 */
    ...
    MCD_MODE_G100K,
                            /* new modes for X5123                                     */
    MCD_MODE_P50R2L,        /* 50GBase-R2                                              */
    MCD_MODE_P50R2S,        /* 50GBase-R2                                              */
    MCD_MODE_P40R2L,        /* 40GBase-R2                                              */
    MCD_MODE_P40R2S,        /* 40GBase-R2                                              */
    MCD_MODE_P25L,          /* 25GBase-R1                                              */
    MCD_MODE_P25S,          /* 25GBase-R1                                              */
    MCD_MODE_P10L,          /* 10GBase-R1                                              */
    MCD_MODE_P10S,          /* 10GBase-R1                                              */
    MCD_MODE_P2_5,          /* 2.5Gusxgmii                                             */
    MCD_MODE_P1,            /* 1000Base-X                                              */
    MCD_MODE_G21L,          /* GEARBOX 40GBase-R2 (host Side) to 40GBase-R4 (Line Side)*/
    MCD_MODE_P40S,          /* 40GBase-R4 with FEC                                     */
    MCD_MODE_P2_5S,         /* 2.5G Basex                                              */
    MCD_MODE_P1_SGMII,      /* 1G SGMII                                                */
    MCD_MODE_R1L,           /* 1000Base-X repeater mode No PCS/FEC/AN                  */
